  ...
  ConvexGeometry(List vertices) : super() {
    ...
    var addPoint = (vertexId) {
      ...
      for (var h = 0; h < hole.length; h++) {
        ...
        faces.add([hole[h][0], hole[h][1], vertexId]);
    ...
    for (var i = 0; i < faces.length; i++) {
      ...
      this.faces.add(new Face3(faces[i][0], faces[i][1], faces[i][2]));
    ...
    for (var i = 0; i < this.faces.length; i++) {
      ...
      this.faceVertexUvs[0].add(
          [_vertexUv(this.vertices[face.a]), _vertexUv(this.vertices[face.b]), _vertexUv(this.vertices[face.c])]);
