...
// FOG
      ...
      "defaultnormal_vertex": [
          ...
          "#endif",
          "vec3 transformedNormal = normalMatrix * objectNormal;"].join("\n"),
    ...
    __ShaderLib = {
      ...
      'lambert': {
        ...
        'uniforms': UniformsUtils.merge(
            [UniformsLib["common"], UniformsLib["fog"], UniformsLib["lights"], UniformsLib["shadowmap"], {
