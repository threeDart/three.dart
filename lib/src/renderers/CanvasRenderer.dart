...
//  get domElement() {  _domElement;  }
  ...
  CanvasRenderer( [Map parameters] ) 
  {
    ...
    //var _canvas = parameters['canvas'] !== null ? parameters['canvas'] : document.createElement( 'canvas' );
...
//    if ( material.map != null || material.envMap != null )
  ...
  void patternPath( num x0, num y0, num x1, num y1, num x2, num y2, num u0, num v0, num u1, num v1, num u2, num v2, Dynamic texture )
  {  
  ...
  void clipImage( num x0, num y0, num x1, num y1, num x2, num y2, num u0, num v0, num u1, num v1, num u2, num v2, Dynamic image )
  {
    // http://extremelysatisfactorytotalitarianism.com/blog/?p=2120
