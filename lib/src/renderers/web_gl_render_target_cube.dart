...
class WebGLRenderTargetCube extends WebGLRenderTarget {
  ...
  WebGLRenderTargetCube(num width, num height, {int wrapS: ClampToEdgeWrapping, int wrapT: ClampToEdgeWrapping,
      int magFilter: LinearFilter, int minFilter: LinearMipMapLinearFilter, int anisotropy: 1, int format: RGBAFormat,
      int type: UnsignedByteType, bool depthBuffer: true, bool stencilBuffer: true})
      : activeCubeFace = 0,
        super(
          width,
          height,
