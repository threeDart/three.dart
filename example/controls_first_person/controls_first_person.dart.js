...
// Native classes
// Method closures
$$.BoundClosure$i1 = [L, {"": "BoundClosure;_self,_target,_receiver,__js_helper$_name",
  call$1: function(p0) {
...
$$.BoundClosure$20 = [S, {"": "BoundClosure;_self,_target,_receiver,__js_helper$_name",
  call$2: function(p0, p1) {
    return this._target.call(this._self, p0, p1);
  },
  $is_args2: true
...
["FirstPersonControls", "package:three/extras/controls/first_person_controls.dart", , L, {
FirstPersonControls: {"": "Object;object<,target,domElement,movementSpeed,lookSpeed,lookVertical,autoForward,activeLook,heightSpeed,heightCoef,heightMin,heightMax,constrainVertical,verticalMin,verticalMax,autoSpeedFactor,mouseX,mouseY,lat,lon,phi,theta,moveForward,moveBackward,moveLeft,moveRight,moveUp,moveDown,freeze,mouseDragOn,viewHalfX,viewHalfY",
  handleResize$0: function() {
    if (J.$eq(this.domElement, document.body)) {
      ...
      t1 = J.get$offsetWidth$x(this.domElement);
      if (typeof t1 !== "number")
        throw t1.$div();
      this.viewHalfX = t1 / 2;
      t1 = J.get$offsetHeight$x(this.domElement);
      if (typeof t1 !== "number")
        throw t1.$div();
      this.viewHalfY = t1 / 2;
    }
  ...
  onMouseDown$1: function(_, $event) {
    var t1;
    if (!J.$eq(this.domElement, document.body))
      J.focus$0$x(this.domElement);
    t1 = J.getInterceptor$x($event);
    t1.preventDefault$0($event);
    $event.stopPropagation();
    if (this.activeLook)
      switch (t1.get$button($event)) {
        case 0:
  ...
  get$onMouseDown: function(_receiver) {
    return new L.BoundClosure$i1(this, L.FirstPersonControls.prototype.onMouseDown$1, _receiver, "onMouseDown$1");
  },
  ...
  get$onMouseUp: function(_receiver) {
    return new L.BoundClosure$i1(this, L.FirstPersonControls.prototype.onMouseUp$1, _receiver, "onMouseUp$1");
  },
  onMouseMove$1: function(_, $event) {
    var t1, t2, t3;
    t1 = J.$eq(this.domElement, document.body);
    t2 = J.getInterceptor$x($event);
    t3 = this.viewHalfX;
    if (t1) {
      t1 = t2.get$page($event).x;
      if (typeof t1 !== "number")
        throw t1.$sub();
      this.mouseX = t1 - t3;
      t3 = new P.Point($event.pageX, $event.pageY);
      ...
      t1 = t2.get$page($event).x;
      t2 = J.get$offsetLeft$x(this.domElement);
      if (typeof t1 !== "number")
        throw t1.$sub();
      if (typeof t2 !== "number")
        throw H.iae(t2);
      this.mouseX = t1 - t2 - t3;
      t3 = new P.Point($event.pageX, $event.pageY);
      H.setRuntimeTypeInfo(t3, [null]);
      t3 = t3.y;
      t2 = J.get$offsetTop$x(this.domElement);
      if (typeof t3 !== "number")
        throw t3.$sub();
      if (typeof t2 !== "number")
        throw H.iae(t2);
      this.mouseY = t3 - t2 - this.viewHalfY;
    }
  },
  get$onMouseMove: function(_receiver) {
    return new L.BoundClosure$i1(this, L.FirstPersonControls.prototype.onMouseMove$1, _receiver, "onMouseMove$1");
  },
  ...
  get$onKeyDown: function(_receiver) {
    return new L.BoundClosure$i1(this, L.FirstPersonControls.prototype.onKeyDown$1, _receiver, "onKeyDown$1");
  },
  ...
  get$onKeyUp: function(_receiver) {
    return new L.BoundClosure$i1(this, L.FirstPersonControls.prototype.onKeyUp$1, _receiver, "onKeyUp$1");
  },
  update$1: function(delta) {
    var t1, y, t2, y0, actualMoveSpeed, actualLookSpeed, targetPosition, t3, t4, t5, t6, verticalLookRatio;
    if (this.freeze)
      return;
    else {
      if (this.heightSpeed) {
        t1 = this.object.position.storage[1];
        y = this.heightMin;
        t2 = this.heightMax;
        if (t1 < y)
          y0 = y;
          ...
          y0 = t1 > t2 ? t2 : t1;
        this.autoSpeedFactor = delta * ((y0 - y) * this.heightCoef);
      } else
      ...
      if (t1) {
        t1 = this.object;
        t1.translate$2(t1, -(actualMoveSpeed + this.autoSpeedFactor), t1._vector.setValues$3(0, 0, 1));
      }
      if (this.moveBackward) {
        t1 = this.object;
        t1.translate$2(t1, actualMoveSpeed, t1._vector.setValues$3(0, 0, 1));
      }
      if (this.moveLeft) {
        t1 = this.object;
        t1.translate$2(t1, -actualMoveSpeed, t1._vector.setValues$3(1, 0, 0));
      }
      if (this.moveRight) {
        t1 = this.object;
        t1.translate$2(t1, actualMoveSpeed, t1._vector.setValues$3(1, 0, 0));
      ...
      if (this.moveUp) {
        t1 = this.object;
        t1.translate$2(t1, actualMoveSpeed, t1._vector.setValues$3(0, 1, 0));
      }
      if (this.moveDown) {
        t1 = this.object;
        t1.translate$2(t1, -actualMoveSpeed, t1._vector.setValues$3(0, 1, 0));
      ...
      if (!this.activeLook)
        actualLookSpeed = 0;
      this.lon = this.lon + this.mouseX * actualLookSpeed;
      t1 = this.lookVertical;
      if (t1)
        this.lat = this.lat - this.mouseY * actualLookSpeed;
      this.lat = P.max(-85, P.min(85, this.lat));
      this.phi = (90 - this.lat) * 3.141592653589793 / 180;
      this.theta = this.lon * 3.141592653589793 / 180;
      targetPosition = this.target;
      t2 = this.object.position.storage;
      t3 = t2[0];
      t4 = this.phi;
      t4 = Math.sin(t4);
      t5 = this.theta;
      t6 = targetPosition.storage;
      t6[0] = t3 + 100 * t4 * Math.cos(t5);
      t5 = t2[1];
      t4 = this.phi;
      t6[1] = t5 + 100 * Math.cos(t4);
      t2 = t2[2];
      t3 = this.phi;
      t3 = Math.sin(t3);
      t4 = this.theta;
      t6[2] = t2 + 100 * t3 * Math.sin(t4);
    }
    t2 = this.constrainVertical;
    verticalLookRatio = t2 ? 3.141592653589793 / (this.verticalMax - this.verticalMin) : 1;
    this.lon = this.lon + this.mouseX * 0;
    if (t1)
      this.lat = this.lat - this.mouseY * 0 * verticalLookRatio;
    this.lat = P.max(-85, P.min(85, this.lat));
    this.phi = (90 - this.lat) * 3.141592653589793 / 180;
    this.theta = this.lon * 3.141592653589793 / 180;
    if (t2)
      this.phi = Z.mapLinear(this.phi, 0, 3.141592653589793, this.verticalMin, this.verticalMax);
    t1 = this.object.position.storage;
    t2 = t1[0];
    t3 = this.phi;
    t3 = Math.sin(t3);
    t4 = this.theta;
    t6[0] = t2 + 100 * t3 * Math.cos(t4);
    t2 = t1[1];
    t3 = this.phi;
    t6[1] = t2 + 100 * Math.cos(t3);
    t1 = t1[2];
    t2 = this.phi;
    t2 = Math.sin(t2);
    t3 = this.theta;
    t6[2] = t1 + 100 * t2 * Math.sin(t3);
    this.object.lookAt$1(targetPosition);
  },
  FirstPersonControls$2: function(object, domElement) {
    var t1, t2;
    this.domElement = domElement != null ? domElement : document.body;
    if (!J.$eq(this.domElement, document.body))
      J.set$tabIndex$x(this.domElement, -1);
    t1 = J.get$onContextMenu$x(this.domElement);
    t2 = new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new L.FirstPersonControls_closure()), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    J.get$onMouseMove$x(this.domElement).listen$1(this.get$onMouseMove(this));
    J.get$onMouseDown$x(this.domElement).listen$1(this.get$onMouseDown(this));
    J.get$onMouseUp$x(this.domElement).listen$1(this.get$onMouseUp(this));
    J.get$onKeyDown$x(this.domElement).listen$1(this.get$onKeyDown(this));
    J.get$onKeyUp$x(this.domElement).listen$1(this.get$onKeyUp(this));
    this.handleResize$0();
  },
  static: {
FirstPersonControls$: function(object, domElement) {
  ...
  t1 = new L.FirstPersonControls(object, new T.Vector3(t1), null, 1, 0.005, true, false, true, false, 1, 0, 1, false, 0, 3.141592653589793, 0, 0, 0, 0, 0, 0, 0, false, false, false, false, false, false, false, false, 0, 0);
  t1.FirstPersonControls$2(object, domElement);
  return t1;
}}

},

FirstPersonControls_closure: {"": "Closure;",
...
["", "controls_first_person.dart", , X, {
main: function() {
  var game, t1, t2;
  game = new X.Game(null, null, null, null, null, null);
  game.init$0();
  t1 = window;
  t2 = game.get$animate();
  C.Window_methods._ensureRequestAnimationFrame$0(t1);
  C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(t2));
  game.controls.update$1(1);
  game.renderer.render$2(game.scene, game.camera);
},

Game: {"": "Object;container,camera,scene,renderer,controls,particles",
  init$0: function() {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16;
    this.container = W._ElementFactoryProvider_createElement_tag("div", null);
    t1 = document.body;
    t1.toString;
    new W._ChildNodeListLazy(t1)._this.appendChild(this.container);
    ...
    this.camera = t16;
    this.scene = S.Scene$();
    this.renderer = S.CanvasRenderer$(null);
    this.renderer.setSize$2(window.innerWidth, window.innerHeight);
    t16 = P.List_List(null, S.Particle);
    H.setRuntimeTypeInfo(t16, [S.Particle]);
    this.particles = t16;
    this.makeParticles$0();
    J.get$nodes$x(this.container)._this.appendChild(this.renderer.domElement);
    this.controls = L.FirstPersonControls$(this.camera, this.renderer.domElement);
    this.controls.movementSpeed = 2;
  },
  makeParticles$0: function() {
    var i, material, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, particle;
    for (i = 0; i < 500; ++i) {
      material = S.ParticleCanvasMaterial$(0, 205, 100, 204, 1, Math.random() * 8421504 + 8421504, true, true, "", 1, false, false, 0, 0, this.get$particleRender(), 0, false, true);
      t1 = $.Object3DCount;
      $.Object3DCount = t1 + 1;
      ...
      t11 = new Float32Array(3);
      t11.$dartCachedLength = t11.length;
      particle = new S.Particle(material, t1, "", t2, null, [], t3, t4, t5, t6, "XYZ", null, null, null, true, null, t7, t8, t9, true, true, t10, false, 0, 1, true, false, false, true, new T.Vector3(t11), null, null);
      t11 = particle.position.storage;
      t11[0] = Math.random() * 1000 - 500;
      t11[1] = Math.random() * 1000 - 500;
      t11[2] = Math.random() * 1000 - 500;
      t11 = Math.random() * 10 + 10;
      t10 = particle.scale.storage;
      t10[1] = t11;
      t10[0] = t11;
      t11 = this.scene;
  ...
  particleRender$1: function(context) {
    ...
    context.arc(0, 0, 1, 0, 6.283185307179586, true);
    context.fill();
  },
  get$particleRender: function() {
    return new H.BoundClosure$1(this, X.Game.prototype.particleRender$1, null, "particleRender$1");
  },
  ...
  get$animate: function() {
    return new H.BoundClosure$1(this, X.Game.prototype.animate$1, null, "animate$1");
  }
}},
1],
...
Document: {"": "Node;",
  get$onContextMenu: function(receiver) {
    var t1 = new W._EventStream(receiver, C.EventStreamProvider_contextmenu._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  get$onKeyDown: function(receiver) {
    var t1 = new W._EventStream(receiver, C.EventStreamProvider_keydown._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  ...
  get$onMouseMove: function(receiver) {
    var t1 = new W._EventStream(receiver, C.EventStreamProvider_mousemove._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  get$onMouseUp: function(receiver) {
    var t1 = new W._EventStream(receiver, C.EventStreamProvider_mouseup._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
...
Element: {"": "Node;tabIndex},offsetHeight=,offsetLeft=,offsetTop=,offsetWidth=",
  toString$0: function(receiver) {
  ...
  get$onContextMenu: function(receiver) {
    var t1 = new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_contextmenu._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  get$onKeyDown: function(receiver) {
    var t1 = new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_keydown._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  get$onKeyUp: function(receiver) {
  ...
  get$onMouseMove: function(receiver) {
    var t1 = new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_mousemove._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  get$onMouseUp: function(receiver) {
    var t1 = new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_mouseup._eventType, false);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
  "%": ";Element"
...
Object3D: {"": "Object;visible<",
  translate$2: function(_, distance, axis) {
    var t1;
    this.matrix.rotate3$1(axis);
    axis.normalize$0();
    t1 = this.position;
    t1.add$1(t1, axis.scale$1(axis, distance));
  },
...
//# sourceMappingURL=controls_first_person.dart.js.map
//@ sourceMappingURL=controls_first_person.dart.js.map
