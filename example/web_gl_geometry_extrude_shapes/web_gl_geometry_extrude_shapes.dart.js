...
makeLookAt: function(m, eye, center, up) {
  ...
  x = t1.normalize$0(t1);
  if (x.get$length(x) === 0) {
    z.set$x(z, z.get$x(z) + 0.0001);
    t1 = up.cross$1(z);
    x = t1.normalize$0(t1);
  }
  y = J.normalize$0$x(z.cross$1(x));
  t1 = x.storage;
  t2 = y.storage;
  m.setValues$16(t1[0], t1[1], t1[2], 0, t2[0], t2[1], t2[2], 0, z.get$x(z), z.get$y(z), z.get$z(z), 0, 0, 0, 0, 1);
  return m;
},
...
CurvePath: {"": "Curve;",
  ...
  getCurveLengths$0: function() {
    ...
    if (t1 != null && t1.length === this.curves.length)
      return t1;
    lengths = [];
    t1 = this.curves;
    il = t1.length;
  ...
  updateMatrixWorld$1$force: function(force) {
    ...
    if (this.matrixWorldNeedsUpdate || force) {
      ...
      if (t1 != null) {
        ...
        t1 = this.scaleWorld;
        S.decompose(this.matrixWorld, t2, this.rotationWorld, t1);
        t3 = this.rotationObject;
        S.decompose(this.matrix, this.translationObject, t3, this.scaleObject);
        S.compose(this.matrixWorld, t2, t3, t1);
      } else
...
Path: {"": "CurvePath;useSpacedPoints,_points,actions,curves,_bends,autoClose,cacheLengths,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  ...
  lineTo$2: function(_, x, y) {
    ...
    t4[0] = x;
    t4[1] = y;
    this.curves.push(new S.LineCurve(t3, t2, null, null, false));
  ...
  quadraticCurveTo$4: function(_, aCPx, aCPy, aX, aY) {
    ...
    t5[0] = aX;
    t5[1] = aY;
    this.curves.push(new S.QuadraticBezierCurve(t3, t2, t4, null, null, false));
  ...
  bezierCurveTo$6: function(_, aCP1x, aCP1y, aCP2x, aCP2y, aX, aY) {
    ...
    t6[0] = aX;
    t6[1] = aY;
    this.curves.push(new S.CubicBezierCurve(t3, t2, t4, t5, null, null, false));
    t1.push(new S.PathAction("bezierCurveTo", [aCP1x, aCP1y, aCP2x, aCP2y, aX, aY]));
  },
  arc$6: function(_, aX, aY, aRadius, aStartAngle, aEndAngle, aClockwise) {
    var t1, t2, t3, lastargs, x0, y0;
    t1 = this.actions;
    t2 = t1.length;
    t3 = t2 - 1;
    if (t3 < 0)
    ...
    if (typeof y0 !== "number")
      throw H.iae(y0);
    this.absellipse$7(aX + x0, aY + y0, aRadius, aRadius, aStartAngle, aEndAngle, aClockwise);
  },
  ...
  getSpacedPoints$2: function(divisions, closedPath) {
    ...
    points = [];
    for (i = 0; i < 40; ++i)
      points.push(this.getPoint$1(i / 40));
    return points;
  },
  getSpacedPoints$1: function(divisions) {
    return this.getSpacedPoints$2(divisions, false);
    ...
    for (t1 = this.actions, i = 0, cpx = null, cpy = null, cpx2 = null, cpy2 = null, cpx1 = null, cpy1 = null, cpx0 = null, cpy0 = null, laste = null, j = null, t = null, tx = null, ty = null; t2 = t1.length, i < t2; ++i) {
      ...
      switch (item.action) {
        ...
        case "splineThru":
          ...
          if (0 >= args.length)
            throw H.ioore(args, 0);
          n = C.JSInt_methods.$mul(12, J.get$length$asx(args[0]));
          if (0 >= args.length)
            throw H.ioore(args, 0);
          C.JSArray_methods.addAll$1(spts, args[0]);
...
CylinderGeometry: {"": "Geometry;radiusTop,radiusBottom,height,segmentsRadius,segmentsHeight,openEnded,id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  CylinderGeometry$6: function(radiusTop, radiusBottom, height, segmentsRadius, segmentsHeight, openEnded) {
    var t1, heightHalf, segmentsX, segmentsY, vertices, uvs, t2, y, verticesRow, uvsRow, v, radius, t3, t4, x, u, t5, vertex, t6, t7, tanTheta, na, nb, t8, t9, t10, x0, v1, y0, v2, v3, v4, n1, n2, n3, n4, uv1, uv2, uv3, uv4;
    t1 = this.height;
    if (typeof t1 !== "number")
      throw t1.$div();
    heightHalf = t1 / 2;
    ...
    for (t1 = this.radiusBottom, t2 = this.radiusTop, y = 0; y <= segmentsY; ++y) {
      ...
      for (t3 = 1 - v, t4 = -v, x = 0; x <= segmentsX; ++x) {
        ...
        t5 = new Float32Array(3);
        t5.$dartCachedLength = t5.length;
        vertex = new T.Vector3(t5);
        t5 = u * 3.141592653589793 * 2;
        t6 = vertex.storage;
        t6[0] = radius * Math.sin(t5);
        t7 = this.height;
        if (typeof t7 !== "number")
          throw H.iae(t7);
        t6[1] = t4 * t7 + heightHalf;
        t6[2] = radius * Math.cos(t5);
    ...
    for (t3 = this.faceVertexUvs, t4 = t2 !== 0, x = 0; x < segmentsX; x = x0) {
      ...
      if (t4) {
        if (0 >= t6)
          throw H.ioore(vertices, 0);
        t6 = vertices[0];
        if (x >= t6.length)
          throw H.ioore(t6, x);
        na = J.clone$0$x(J.$index$asx(t5, t6[x]));
        t6 = this.vertices;
        ...
        if (t7 >= t5.length)
          throw H.ioore(t5, t7);
        nb = J.clone$0$x(J.$index$asx(t6, t5[t7]));
      } else {
        if (1 >= t6)
          throw H.ioore(vertices, 1);
        t6 = vertices[1];
        if (x >= t6.length)
          throw H.ioore(t6, x);
        na = J.clone$0$x(J.$index$asx(t5, t6[x]));
      ...
      if (typeof t9 !== "number")
        throw H.iae(t9);
      t5.$indexSet(na, 1, Math.sqrt(t6 * t7 + t8 * t9) * tanTheta);
      t5.normalize$0(na);
      ...
      if (typeof t10 !== "number")
        throw H.iae(t10);
      t6.$indexSet(nb, 1, Math.sqrt(t7 * t8 + t9 * t10) * tanTheta);
      t5.normalize$0(na);
      for (x0 = x + 1, y = 0; y < segmentsY; y = y0) {
        t7 = vertices.length;
        if (y >= t7)
          throw H.ioore(vertices, y);
        t8 = vertices[y];
        t9 = t8.length;
        if (x >= t9)
          throw H.ioore(t8, x);
        ...
        if (x >= t8.length)
          throw H.ioore(t8, x);
        uv1 = J.clone$0$x(t8[x]);
        if (y0 >= uvs.length)
          throw H.ioore(uvs, y0);
        t8 = uvs[y0];
        if (x >= t8.length)
          throw H.ioore(t8, x);
        uv2 = J.clone$0$x(t8[x]);
        if (y0 >= uvs.length)
          throw H.ioore(uvs, y0);
        t8 = uvs[y0];
        if (x0 >= t8.length)
          throw H.ioore(t8, x0);
        uv3 = J.clone$0$x(t8[x0]);
        if (y >= uvs.length)
          throw H.ioore(uvs, y);
        t8 = uvs[y];
        if (x0 >= t8.length)
          throw H.ioore(t8, x0);
        uv4 = J.clone$0$x(t8[x0]);
        t8 = this.faces;
        t9 = [v1, v2, v3, v4];
        t7 = new S.Face4(t9, null, null, null, null, null, null, null);
        t7.Face$4(t9, [n1, n2, n3, n4], null, null);
        t8.push(t7);
        t3[0].push([uv1, uv2, uv3, uv4]);
      }
    }
    t4 = !this.openEnded;
    if (t4 && t2 > 0) {
      ...
      for (x = 0; x < segmentsX; x = x0) {
        ...
        if (x >= t5.length)
          throw H.ioore(t5, x);
        uv1 = J.clone$0$x(t5[x]);
        if (0 >= uvs.length)
          throw H.ioore(uvs, 0);
        t5 = uvs[0];
        if (x0 >= t5.length)
          throw H.ioore(t5, x0);
        uv2 = J.clone$0$x(t5[x0]);
        t5 = uv2.get$u();
        t6 = this.faces;
        t2 = [v1, v2, t2 - 1];
        t7 = new S.Face3(t2, null, null, null, null, null, null, null);
        t7.Face$4(t2, [n1, n2, n3], null, null);
        t6.push(t7);
        t3[0].push([uv1, uv2, new S.UV(t5, 0)]);
      }
    }
    if (t4 && t1 > 0) {
      t1 = this.vertices;
      ...
      for (x = 0; x < segmentsX; x = x0) {
        ...
        if (x0 >= t2.length)
          throw H.ioore(t2, x0);
        uv1 = J.clone$0$x(t2[x0]);
        if (y >= uvs.length)
          throw H.ioore(uvs, y);
        t2 = uvs[y];
        if (x >= t2.length)
          throw H.ioore(t2, x);
        uv2 = J.clone$0$x(t2[x]);
        t2 = uv2.get$u();
        t4 = this.faces;
        t1 = [v1, v2, t1 - 1];
        t5 = new S.Face3(t1, null, null, null, null, null, null, null);
        t5.Face$4(t1, [n1, n2, n3], null, null);
        t4.push(t5);
        t3[0].push([uv1, uv2, new S.UV(t2, 1)]);
      }
    }
...
CylinderGeometry$: function(radiusTop, radiusBottom, height, segmentsRadius, segmentsHeight, openEnded) {
  ...
  t2 = new S.CylinderGeometry(radiusTop, radiusBottom, height, segmentsRadius, segmentsHeight, openEnded, t1, "", t2, [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, null);
  t2.CylinderGeometry$6(radiusTop, radiusBottom, height, segmentsRadius, segmentsHeight, openEnded);
  return t2;
}}
...
ExtrudeGeometry: {"": "Geometry;shapes,shapebb,id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  addShape$14$UVGenerator: function(shape, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, $frames, material, extrudeMaterial, UVGenerator) {
    var t1, uvgen, extrudePts, t2, t3, splineTube, binormal, normal, position2, shapesOffset, shapePoints, vertices, holes, ahole, h, faces, vertices0, vlen, flen, t4, contourMovements, il, j, t5, i, k, t6, holesMovements, verticesMovements, oneHoleMovements, t7, t8, b, vert, t, bs, t9, t10, t11, t12, t13, s, z, t14, face, layeroffset;
    t1 = {};
    ...
    for (; i < vlen; ++i) {
      ...
      t7 = J.getInterceptor$x(vert);
      t8 = splineTube.normals;
      if (0 >= t8.length)
        throw H.ioore(t8, 0);
      t8 = normal.setFrom$1(t8[0]);
      t8.scale$1(t8, t7.get$x(vert));
      t8 = splineTube.binormals;
      if (0 >= t8.length)
        throw H.ioore(t8, 0);
      t8 = binormal.setFrom$1(t8[0]);
      t8.scale$1(t8, t7.get$y(vert));
      if (0 >= extrudePts.length)
        throw H.ioore(extrudePts, 0);
      t7 = position2.setFrom$1(extrudePts[0]);
      t7 = t7.add$1(t7, normal);
      t7.add$1(t7, binormal);
      t7 = t6[0];
      t8 = t6[1];
      t9 = t6[2];
      t10 = this.vertices;
    ...
    for (s = 1; s <= steps; ++s)
      for (i = 0; i < vlen; ++i) {
        ...
        if (s >= t8.length)
          throw H.ioore(t8, s);
        t8 = normal.setFrom$1(t8[s]);
        t8.scale$1(t8, t7.get$x(vert));
        t8 = splineTube.binormals;
        if (s >= t8.length)
          throw H.ioore(t8, s);
        t8 = binormal.setFrom$1(t8[s]);
        t8.scale$1(t8, t7.get$y(vert));
        if (s >= extrudePts.length)
          throw H.ioore(extrudePts, s);
        t7 = position2.setFrom$1(extrudePts[s]);
        t7 = t7.add$1(t7, normal);
        t7.add$1(t7, binormal);
        t7 = t6[0];
        t8 = t6[1];
    ...
    for (b = t1.bevelSegments_0 - 1, t3 = steps - 1; b >= 0; --b) {
      ...
      while (true) {
        ...
        oneHoleMovements = holesMovements[h];
        t6 = J.getInterceptor$asx(ahole);
        t7 = oneHoleMovements.length;
        i = 0;
        while (true) {
          t8 = t6.get$length(ahole);
          if (typeof t8 !== "number")
            throw H.iae(t8);
          if (!(i < t8))
            break;
          ...
          if (i >= t7)
            throw H.ioore(oneHoleMovements, i);
          t9 = oneHoleMovements[i];
          if (t9 == null)
            H.printToConsole("die");
          vert = J.add$1$ax(J.scale$1$x(J.clone$0$x(t9), bs), t8);
          t8 = J.getInterceptor$x(vert);
          t9 = t8.get$x(vert);
          t8 = t8.get$y(vert);
          if (t3 < 0 || t3 >= extrudePts.length)
            throw H.ioore(extrudePts, t3);
          t10 = J.get$y$x(extrudePts[t3]);
          if (typeof t8 !== "number")
            throw t8.$add();
          if (typeof t10 !== "number")
            throw H.iae(t10);
...
TubeGeometry: {"": "Geometry;path,segments,nSegments,radius,segmentsRadius,closed,grid,tangents,normals,binormals,debug,id,name,vertices,colors,three$Geometry$normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  TubeGeometry$6: function(path, segments, radius, segmentsRadius, $closed, debug) {
    var numpoints, t1, pos2, t2, t3, t4, t5, v, cx, cy, i, t6, pos, tangent, normal, binormal, t7, j, t8, t9, t10, t11, t12, t13, t14, ip, jp, a, b, c, d, uva, uvb, uvc, uvd, i0, j0;
    if (debug)
      this.debug = S.Object3D$();
    numpoints = segments + 1;
    t1 = new Float32Array(3);
    t1.$dartCachedLength = t1.length;
    pos2 = new T.Vector3(t1);
    this._frenetFrames$3(path, segments, $closed);
    t1 = this.grid;
    J.set$length$asx(t1, numpoints);
    for (t2 = this.segmentsRadius, t3 = pos2.storage, t4 = this.radius, t5 = numpoints - 1, v = null, cx = null, cy = null, i = 0; i < numpoints; ++i) {
      t6 = P.List_List(t2, null);
      if (i >= t1.length)
        throw H.ioore(t1, i);
      t1[i] = t6;
      pos = path.getPoint$1(path.getUtoTmapping$1(i / t5));
      t6 = this.tangents;
      if (i >= t6.length)
        throw H.ioore(t6, i);
      tangent = t6[i];
      ...
      if (debug) {
        t6 = this.debug;
        t6.add$1(t6, S.ArrowHelper$(tangent, pos, t4, 255));
        t6 = this.debug;
        t6.add$1(t6, S.ArrowHelper$(normal, pos, t4, 16711680));
        t6 = this.debug;
        t6.add$1(t6, S.ArrowHelper$(binormal, pos, t4, 65280));
      }
      if (typeof t2 !== "number")
        throw H.iae(t2);
      t6 = J.getInterceptor$x(normal);
      t7 = J.getInterceptor$x(binormal);
      j = 0;
      for (; j < t2; ++j) {
        ...
        cy = t4 * Math.sin(v);
        pos2.setFrom$1(pos);
        t3[0] = t3[0] + (cx * t6.get$x(normal) + cy * t7.get$x(binormal));
        t3[1] = t3[1] + (cx * t6.get$y(normal) + cy * t7.get$y(binormal));
        t3[2] = t3[2] + (cx * t6.get$z(normal) + cy * t7.get$z(binormal));
        if (i >= t1.length)
          throw H.ioore(t1, i);
        t8 = t1[i];
        t9 = t3[0];
        ...
        t14[2] = t11;
        J.add$1$ax(t12, t13);
        t13 = J.get$length$asx(this.vertices);
        if (j >= t8.length)
          throw H.ioore(t8, j);
        t8[j] = t13 - 1;
      }
    ...
    while (true) {
      ...
      for (; j < t2; j = j0) {
        if ($closed) {
          ...
          if (typeof t4 !== "number")
            throw H.iae(t4);
          ip = C.JSInt_methods.$mod(i0, t4);
        } else
          ip = i0;
        j0 = j + 1;
        jp = C.JSInt_methods.$mod(j0, t2);
        t4 = t1.length;
        if (i >= t4)
          throw H.ioore(t1, i);
        t5 = t1[i];
        ...
        t4 = this.faces;
        t6 = [a, b, c, d];
        t5 = new S.Face4(t6, null, null, null, null, null, null, null);
        t5.Face$4(t6, null, null, null);
        t4.push(t5);
        t3[0].push([uva, uvb, uvc, uvd]);
      }
      i = i0;
    }
    this.computeCentroids$0();
...
TubeGeometry$: function(path, segments, radius, segmentsRadius, $closed, debug) {
  ...
  t2 = [];
  H.setRuntimeTypeInfo(t2, [T.Vector3]);
  t2 = new S.TubeGeometry(null, null, null, radius, segmentsRadius, null, [], null, null, null, null, t1, "", t2, [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, null);
...
ArrowHelper: {"": "Object3D;line,cone,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,customDepthMaterial,__data",
  setDirection$1: function(dir) {
    ...
    t1.setValues$3(0, 1, 0);
    t2 = J.clone$0$x(dir);
    t2 = t1.dot$1(t2.normalize$0(t2));
    radians = Math.acos(t2);
    t1 = new Float32Array(16);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Matrix4(t1);
    t1.setIdentity$0();
    this.matrix = t1.rotate$2(t1, axis.normalize$0(axis), radians);
    this.rotation = S.calcEulerFromRotationMatrix(this.matrix, this.eulerOrder);
  },
  ArrowHelper$4: function(dir, origin, $length, hex) {
    var lineGeometry, t1, t2, coneGeometry;
    lineGeometry = S.Geometry$();
    t1 = lineGeometry.vertices;
    t2 = new Float32Array(3);
    t2.$dartCachedLength = t2.length;
    J.add$1$ax(t1, new T.Vector3(t2));
    t2 = lineGeometry.vertices;
    t1 = new Float32Array(3);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector3(t1);
    t1.setValues$3(0, 1, 0);
    ...
    t2 = $.MaterialCount;
    $.MaterialCount = t2 + 1;
    this.line = S.Line$(lineGeometry, new S.LineBasicMaterial(t1, 1, "round", "round", true, false, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), 0);
    this.add$1(this, this.line);
    coneGeometry = S.CylinderGeometry$(0, 0.05, 0.25, 5, 1, false);
    t2 = S.Color$(hex);
    t1 = $.MaterialCount;
    $.MaterialCount = t1 + 1;
    this.cone = S.Mesh$(coneGeometry, new S.MeshBasicMaterial(t2, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t1, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
    this.cone.position.setValues$3(0, 1, 0);
    this.add$1(this, this.cone);
    if (origin != null)
      this.position = origin;
    this.setDirection$1(dir);
    this.scale.setValues$3($length, $length, $length);
  },
  static: {
ArrowHelper$: function(dir, origin, $length, hex) {
  ...
  t11 = new Float32Array(3);
  t11.$dartCachedLength = t11.length;
  t11 = new S.ArrowHelper(null, null, t1, "", t2, null, [], t3, t4, t5, t6, "XYZ", null, null, null, true, null, t7, t8, t9, true, true, t10, false, 0, 1, true, false, false, true, new T.Vector3(t11), null, null);
  t11.ArrowHelper$4(dir, origin, $length, hex);
  return t11;
}}
...
Face: {"": "Object;indices<,normal@,vertexNormals?,vertexColors<,color>,centroid<",
  get$size: function(_) {
  ...
  Face$4: function(indices, normalOrVertexNormals, colorOrVertexColors, materialIndex) {
    ...
    t1 = new T.Vector3(t1);
    this.normal = t1;
    t1 = J.getInterceptor(normalOrVertexNormals);
    this.vertexNormals = typeof normalOrVertexNormals === "object" && normalOrVertexNormals !== null && (normalOrVertexNormals.constructor === Array || !!t1.$isList) ? normalOrVertexNormals : [];
...
Geometry: {"": "Object;id*,name,vertices@,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets<,morphColors,morphNormals<,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  computeVertexNormals$0: function() {
    ...
    if (t2 == null) {
      this.__tmpVertices = [];
      J.forEach$1$ax(this.vertices, new S.Geometry_computeVertexNormals_closure(this));
      t1.vertices_1 = this.__tmpVertices;
      H.IterableMixinWorkaround_forEach(this.faces, new S.Geometry_computeVertexNormals_closure0());
    } else {
      t1.vertices_1 = t2;
      vl = J.get$length$asx(this.vertices);
      for (t2 = t1.vertices_1, v = 0; v < vl; ++v) {
        if (v >= t2.length)
          throw H.ioore(t2, v);
        t3 = t2[v].storage;
        t3[0] = 0;
    ...
    H.IterableMixinWorkaround_forEach(this.faces, new S.Geometry_computeVertexNormals_closure1(t1));
    t2 = t1.vertices_1;
    t2.toString;
    H.IterableMixinWorkaround_forEach(t2, new S.Geometry_computeVertexNormals_closure2());
    H.IterableMixinWorkaround_forEach(this.faces, new S.Geometry_computeVertexNormals_closure3(t1));
  },
...
Geometry_computeVertexNormals_closure: {"": "Closure;this_2",
  call$1: function(_) {
    var t1, t2;
    t1 = this.this_2.__tmpVertices;
    t2 = new Float32Array(3);
    t2.$dartCachedLength = t2.length;
    return t1.push(new T.Vector3(t2));
  },
  $is_args1: true
},

Geometry_computeVertexNormals_closure0: {"": "Closure;",
  call$1: function(face) {
    face.set$vertexNormals(P.List_List$generate(J.get$size$x(face), new S.Geometry_computeVertexNormals__closure1(), false, null));
  },
  $is_args1: true
},

Geometry_computeVertexNormals__closure1: {"": "Closure;",
  call$1: function(_) {
    var t1 = new Float32Array(3);
    t1.$dartCachedLength = t1.length;
...
Geometry_computeVertexNormals_closure1: {"": "Closure;box_1",
  call$1: function(face) {
    H.IterableMixinWorkaround_forEach(face.get$indices(), new S.Geometry_computeVertexNormals__closure0(this.box_1, face));
  },
  $is_args1: true
},

Geometry_computeVertexNormals__closure0: {"": "Closure;box_1,face_3",
  call$1: function(idx) {
    var t1 = this.box_1.vertices_1;
    if (idx >>> 0 !== idx || idx >= t1.length)
      throw H.ioore(t1, idx);
    t1 = t1[idx];
    t1.add$1(t1, this.face_3.normal);
  },
  $is_args1: true
},

Geometry_computeVertexNormals_closure2: {"": "Closure;",
  call$1: function(v) {
    return J.normalize$0$x(v);
  },
  $is_args1: true
},

Geometry_computeVertexNormals_closure3: {"": "Closure;box_1",
  call$1: function(face) {
    var t1 = {};
    t1.i_0 = 0;
    H.IterableMixinWorkaround_forEach(face.get$indices(), new S.Geometry_computeVertexNormals__closure(t1, this.box_1, face));
  },
  $is_args1: true
},

Geometry_computeVertexNormals__closure: {"": "Closure;box_0,box_1,face_4",
  call$1: function(idx) {
    var t1, t2, t3;
    t1 = this.face_4.vertexNormals;
    t2 = this.box_0;
    t3 = t2.i_0;
    t2.i_0 = t3 + 1;
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  initMeshBuffers$2: function(geometryGroup, object) {
    ...
    (!!t1.$isMesh || !!t1.$isLine ? t1.get$geometry() : null).skinWeights;
    t1 = (t3 * 1 + t4 * 2) * 3;
    ...
    if (dirtyMorphTargets === true)
      for (n1 = null, n2 = null, n3 = null, n4 = null, vk = 0, vka = null, nka = null, chf = null, faceVertexNormals = null; false; ++vk) {
        ...
        for (f = 0, offset_morphTarget = 0; f < fl; ++f) {
          ...
          v1 = t2.$index(t2, face.get$a(face));
          t2 = morphTargets[vk].get$vertices();
          v2 = t2.$index(t2, face.get$b(face));
          t2 = morphTargets[vk].get$vertices();
          v3 = t2.$index(t2, face.get$c(face));
          morphTargetsArrays.length;
          vka = morphTargetsArrays[vk];
          t2 = v1.get$x(v1);
          t3 = C.JS_CONST_ZYJ(vka);
          ...
          if (material.get$morphNormals() === true) {
            ...
            if (needsSmoothNormals) {
              ...
              faceVertexNormals = t3.$index(t3, chf);
        ...
        for (f = 0; f < fl; ++f) {
          ...
          v3 = t2.$index(t2, face.get$c(face));
          t2 = morphTargets[vk].get$vertices();
          v4 = t2.$index(t2, face.get$d(face));
          morphTargetsArrays.length;
          vka = morphTargetsArrays[vk];
          t2 = v1.get$x(v1);
          t3 = C.JS_CONST_ZYJ(vka);
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    var object, t1, t2, shaderID, maxLightCount, maxShadows, maxBones, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, attributes, i;
    object = webglobject.get$object();
    ...
    if (t9)
      ...
      t18 = true;
    t18 = t18 && t1.get$morphTargets();
    t2 = typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial;
    if (t2)
      t19 = t3;
    else
      t19 = true;
    t19 = t19 && t1.get$morphNormals();
    t20 = this.maxMorphTargets;
    t21 = this.maxMorphNormals;
    t22 = maxLightCount.$index(maxLightCount, "directional");
    t23 = maxLightCount.$index(maxLightCount, "point");
    t24 = maxLightCount.$index(maxLightCount, "spot");
    t25 = maxLightCount.$index(maxLightCount, "hemi");
    t26 = this.shadowMapEnabled && object.get$receiveShadow();
    t27 = t1.get$alphaTest();
    t28 = (typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false) && t1.get$wrapAround();
    material.program = this.buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround(shaderID, t4, t5, t6, t7, t8, t27, null, null, null, t1.get$side() === 2, t11, t1.get$side() === 1, fog, false, t12, t10, maxBones, t22, t25, t21, t20, t23, maxShadows, t24, false, t19, t18, null, false, this.shadowMapCascade, this.shadowMapDebug, t26, this.shadowMapType, false, t16, t13, t15, t17, t14, t28);
  ...
  refreshUniformsCommon$2: function(uniforms, material) {
    var t1, t2, t3, t4, t5, t6, uvScaleMap, offset, repeat;
    t1 = material._material;
    t2 = J.getInterceptor$x(t1);
    ...
    if (t5)
      ...
      t6 = true;
    J.set$value$x(t4, t6 ? t2.get$map(t1) : null);
    ...
    if ((t4 ? t2.get$map(t1) : null) != null) {
      if (t5)
        ...
        t4 = true;
      uvScaleMap = t4 ? t2.get$map(t1) : null;
    } else {
      if (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false)
        ;
      uvScaleMap = null;
...
WebGLMaterial: {"": "Object;_material,program<,_fragmentShader,_vertexShader,_uniforms,uniformsList,numSupportedMorphTargets,numSupportedMorphNormals,shadowPass?",
  ...
  get$wireframe: function() {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return (typeof t1 !== "object" || t1 === null || !t2.$isLineBasicMaterial) && t1.get$wireframe();
  },
  ...
  get$_hasVertexColors: function() {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isLineBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial;
  },
...
["", "web_gl_geometry_extrude_shapes.dart", , O, {
main: function() {
  ...
  C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(O.animate$closure));
  O.render();
},

_addGeometry: function(geometry, color, x, y, z, rx, ry, rz, s) {
  var t1, t2, t3, t4, t5, t6, t7, mesh;
  t1 = S.Color$(color);
  t2 = S.Color$(16777215);
  t3 = S.Color$(0);
  t4 = new Float32Array(3);
  ...
  t7 = $.MaterialCount;
  $.MaterialCount = t7 + 1;
  mesh = L.createMultiMaterialObject(geometry, [new S.MeshLambertMaterial(null, t1, t2, t3, false, t4, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t5, 0, 0.2, 1, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null), new S.MeshBasicMaterial(t6, null, null, null, null, 0, 1, 0.98, 2, true, 1, "round", "round", false, false, 0, true, "", t7, 0, 0.3, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null)]);
...
init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, light, randomPoints, i, randomSpline, circleShape, rectShape, pts, l, a, starShape, smileyShape, smileyEye1Path, smileyEye2Path, smileyMouthPath, circle3d, tube;
  ...
  t16.set$y(t16, 50);
  t16 = $.scene;
  t16.add$1(t16, $.parent);
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  new T.Vector3(t16).setValues$3(30, 12, 83);
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  new T.Vector3(t16).setValues$3(40, 20, 67);
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  new T.Vector3(t16).setValues$3(60, 40, 99);
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  new T.Vector3(t16).setValues$3(10, 60, 49);
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  new T.Vector3(t16).setValues$3(25, 80, 40);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 10, -10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(10, 0, -10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(20, 0, 0);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(30, 0, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(30, 0, 20);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(20, 0, 30);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(10, 0, 30);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 0, 30);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(-10, 10, 30);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(-10, 20, 30);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 30, 30);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(10, 30, 30);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(20, 30, 15);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(10, 30, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 30, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(-10, 20, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(-10, 10, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 0, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(10, -10, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(20, -15, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(30, -15, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(40, -15, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(50, -15, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(60, 0, 10);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(70, 0, 0);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(80, 0, 0);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(90, 0, 0);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(100, 0, 0);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, -40, -40);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 40, -40);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 140, -40);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  new T.Vector3(t1).setValues$3(0, 40, 40);
  t1 = new Float32Array(3);
  ...
  for (i = 0; i < 10; ++i) {
    ...
    t5[1] = t2 * 200;
    t5[2] = t3 * 200;
    randomPoints.push(t4);
  }
  randomSpline = new S.SplineCurve3(randomPoints, null, null, false);
  circleShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  circleShape.Path$1(null);
  circleShape.actions.push(new S.PathAction("moveTo", [0, 4]));
  circleShape.quadraticCurveTo$4(circleShape, 4, 4, 4, 0);
  circleShape.quadraticCurveTo$4(circleShape, 4, -4, 0, -4);
  circleShape.quadraticCurveTo$4(circleShape, -4, -4, -4, 0);
  circleShape.quadraticCurveTo$4(circleShape, -4, 4, 0, 4);
  rectShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  rectShape.Path$1(null);
  rectShape.actions.push(new S.PathAction("moveTo", [-6, -2]));
  rectShape.lineTo$2(rectShape, -6, 2);
  rectShape.lineTo$2(rectShape, 6, 2);
  rectShape.lineTo$2(rectShape, 6, -6);
  rectShape.lineTo$2(rectShape, -6, -6);
  pts = [];
  for (i = 0; i < 10; ++i) {
    l = C.JSInt_methods.$mod(i, 2) === 1 ? 5 : 10;
  ...
  starShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  starShape.Path$1(pts);
  ...
  smileyShape.arc$6(smileyShape, 40, 40, 40, 0, 6.283185307179586, false);
  smileyEye1Path = S.Path$(null);
  smileyEye1Path.actions.push(new S.PathAction("moveTo", [35, 20]));
  smileyEye1Path.arc$6(smileyEye1Path, 25, 20, 10, 0, 6.283185307179586, true);
  ...
  smileyEye2Path.arc$6(smileyEye2Path, 55, 20, 10, 0, 6.283185307179586, true);
  ...
  circle3d = starShape.extrude$5$amount$bevelEnabled$bevelSegments$extrudePath$steps(200, false, 2, randomSpline, 150);
  tube = S.TubeGeometry$(randomSpline, 150, 4, 5, false, true);
  O._addGeometry(circle3d, 16716049, -100, 0, 0, 0, 0, 0, 1);
  O._addGeometry(tube, 65297, 0, 0, 0, 0, 0, 0, 1);
  ...
  t1 = new W._EventStream(document, C.EventStreamProvider_mousedown._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(O.onDocumentMouseDown$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t1 = new W._EventStream(document, C.EventStreamProvider_touchstart._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(O.onDocumentTouchStart$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t3._tryResume$0();
  t1 = new W._EventStream(document, C.EventStreamProvider_touchmove._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t4 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(O.onDocumentTouchMove$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t4, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t4._tryResume$0();
  $.mouseEvts = [t2, t3, t4];
  t4 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t4, [null]);
  t3 = new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(O.onWindowResize$closure), t4._useCapture);
...
cancelMouseEvts: function() {
  H.IterableMixinWorkaround_forEach($.get$mouseEvts(), new O.cancelMouseEvts_closure());
  $.mouseEvts = [];
},
...
onDocumentMouseDown: function($event) {
  ...
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(O.onDocumentMouseMove$closure), t2._useCapture);
  ...
  H.setRuntimeTypeInfo(t2, [null]);
  t4 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(O.onDocumentMouseUp$closure), t2._useCapture);
  ...
  H.setRuntimeTypeInfo(t2, [null]);
  t5 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(O.onDocumentMouseOut$closure), t2._useCapture);
...
init.globalFunctions.onWindowResize$closure = O.onWindowResize$closure = new H.Closure$1(O.onWindowResize, "onWindowResize$closure");
init.globalFunctions.onDocumentMouseDown$closure = O.onDocumentMouseDown$closure = new H.Closure$1(O.onDocumentMouseDown, "onDocumentMouseDown$closure");
init.globalFunctions.onDocumentMouseMove$closure = O.onDocumentMouseMove$closure = new H.Closure$1(O.onDocumentMouseMove, "onDocumentMouseMove$closure");
init.globalFunctions.onDocumentMouseUp$closure = O.onDocumentMouseUp$closure = new H.Closure$1(O.onDocumentMouseUp, "onDocumentMouseUp$closure");
init.globalFunctions.onDocumentMouseOut$closure = O.onDocumentMouseOut$closure = new H.Closure$1(O.onDocumentMouseOut, "onDocumentMouseOut$closure");
init.globalFunctions.onDocumentTouchStart$closure = O.onDocumentTouchStart$closure = new H.Closure$1(O.onDocumentTouchStart, "onDocumentTouchStart$closure");
init.globalFunctions.onDocumentTouchMove$closure = O.onDocumentTouchMove$closure = new H.Closure$1(O.onDocumentTouchMove, "onDocumentTouchMove$closure");
init.globalFunctions.animate$closure = O.animate$closure = new H.Closure$1(O.animate, "animate$closure");
...
//# sourceMappingURL=web_gl_geometry_extrude_shapes.dart.js.map
//@ sourceMappingURL=web_gl_geometry_extrude_shapes.dart.js.map
