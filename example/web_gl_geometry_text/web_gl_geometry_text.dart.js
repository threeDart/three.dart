...
loadFace: function(data) {
  ...
  family = J.toLowerCase$0$s(t1.$index(data, "familyName"));
  t2 = $.get$_faces();
  if (t2.$index(t2, family) == null) {
    t2 = $.get$_faces();
    t2.$indexSet(t2, family, H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  }
  t2 = $.get$_faces();
  if (J.$index$asx(t2.$index(t2, family), t1.$index(data, "cssFontWeight")) == null) {
    t2 = $.get$_faces();
    J.$indexSet$ax(t2.$index(t2, family), t1.$index(data, "cssFontWeight"), H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  }
  t2 = $.get$_faces();
  J.$indexSet$ax(J.$index$asx(t2.$index(t2, family), t1.$index(data, "cssFontWeight")), t1.$index(data, "cssFontStyle"), data);
  t2 = $.get$_faces();
  J.$indexSet$ax(J.$index$asx(t2.$index(t2, family), t1.$index(data, "cssFontWeight")), t1.$index(data, "cssFontStyle"), data);
  return data;
},
...
drawText: function(text) {
  var t1, face, t2, scale, chars, $length, fontPaths, i, offset, ret;
  t1 = $.get$_faces();
  face = J.$index$asx(J.$index$asx(t1.$index(t1, $._face), $._weight), $._style);
  t1 = $._size;
  t2 = J.$index$asx(face, "resolution");
  if (typeof t2 !== "number")
    throw H.iae(t2);
  scale = t1 / t2;
  chars = text.split("");
  ...
  for (i = 0, offset = 0; i < $length; ++i) {
    if (i >= chars.length)
      throw H.ioore(chars, i);
    ret = Y.extractGlyphPoints(chars[i], face, scale, offset, new S.Path(false, null, [], [], [], false, null, null, null, false));
    t1 = ret.$index(ret, "offset");
    if (typeof t1 !== "number")
      throw H.iae(t1);
    offset += t1;
    fontPaths.push(ret.$index(ret, "path"));
  }
  return H.fillLiteralMap(["paths", fontPaths, "offset", offset / 2], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
},

extractGlyphPoints: function(c, face, scale, offset, path) {
  var t1, glyph, outline, t2, $length, t3, i, i2, x, y, cpx, cpy, cpx0, cpy0, cpx1, cpy1, cpx2, cpy2, laste, i0;
  t1 = J.getInterceptor$asx(face);
  glyph = J.$index$asx(t1.$index(face, "glyphs"), c);
  if (glyph == null)
    glyph = J.$index$asx(t1.$index(face, "glyphs"), "?");
  if (glyph == null)
    return;
  t1 = J.getInterceptor$asx(glyph);
  if (t1.$index(glyph, "o") != null) {
    outline = t1.$index(glyph, "_cachedOutline");
    if (outline == null) {
      t1.$indexSet(glyph, "_cachedOutline", J.split$1$s(t1.$index(glyph, "o"), " "));
      outline = t1.$index(glyph, "_cachedOutline");
    }
    t2 = J.getInterceptor$asx(outline);
    $length = t2.get$length(outline);
    ...
    for (; i < $length;) {
      i0 = i + 1;
      switch (t2.$index(outline, i)) {
        case "m":
          i = i0 + 1;
          x = J.$add$ns(J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i0), null, null), scale), offset);
          i0 = i + 1;
          y = J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i), null, null), scale);
          path.actions.push(new S.PathAction("moveTo", [x, y]));
          i = i0;
          break;
        case "l":
          i = i0 + 1;
          ...
          i0 = i + 1;
          y = J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i), null, null), scale);
          path.lineTo$2(path, x, y);
          i = i0;
          break;
        case "q":
          i = i0 + 1;
          cpx = J.$add$ns(J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i0), null, null), scale), offset);
          i0 = i + 1;
          cpy = J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i), null, null), scale);
          i = i0 + 1;
          cpx1 = J.$add$ns(J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i0), null, null), scale), offset);
          i0 = i + 1;
          cpy1 = J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i), null, null), scale);
          path.quadraticCurveTo$4(path, cpx1, cpy1, cpx, cpy);
          i = i0;
          break;
        case "b":
          i = i0 + 1;
          ...
          cpx1 = J.$add$ns(J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i0), null, null), scale), offset);
          i0 = i + 1;
          cpy1 = J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i), null, null), t3);
          i = i0 + 1;
          cpx2 = J.$add$ns(J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i0), null, null), scale), offset);
          i0 = i + 1;
          cpy2 = J.$mul$n(H.Primitives_parseInt(t2.$index(outline, i), null, null), t3);
          path.bezierCurveTo$6(path, cpx, cpy, cpx1, cpy1, cpx2, cpy2);
          i = i0;
          break;
        default:
          i = i0;
  ...
  return H.fillLiteralMap(["offset", J.$mul$n(t1.$index(glyph, "ha"), scale), "path", path], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
},

generateShapes: function(text, size, curveSegments, font, weight, style) {
  var t1, data, paths, shapes, pl, p;
  t1 = $.get$_faces();
  J.$index$asx(J.$index$asx(t1.$index(t1, font), weight), style);
  $.get$_faces();
  $._size = size;
  ...
  $._weight = weight;
  $._style = style;
  data = Y.drawText(text);
  paths = data.$index(data, "paths");
  shapes = [];
  t1 = J.getInterceptor$asx(paths);
  pl = t1.get$length(paths);
  if (typeof pl !== "number")
    throw H.iae(pl);
  p = 0;
  for (; p < pl; ++p)
    C.JSArray_methods.addAll$1(shapes, t1.$index(paths, p).toShapes$0());
  return shapes;
},
...
triangleArea: function(vectorA, vectorB, vectorC) {
  return 0.5 * J.get$length$asx(J.$sub$n(vectorB, vectorA).cross$1(J.$sub$n(vectorC, vectorA)));
}}],
...
HttpRequest_getString: function(url, onProgress, withCredentials) {
  var t1 = W.HttpRequest_request(url, null, null, onProgress, null, null, null, withCredentials);
  return t1.then$1(t1, new W.HttpRequest_getString_closure());
},
...
HttpRequest_request: function(url, method, mimeType, onProgress, requestHeaders, responseType, sendData, withCredentials) {
  ...
  t2._tryResume$0();
  t2 = new W._EventStream(xhr, C.EventStreamProvider_error0._eventType, false);
...
UIEvent: {"": "Event;which=", "%": "CompositionEvent|FocusEvent|SVGZoomEvent|TextEvent;UIEvent"},
...
Curve: {"": "Object;needsUpdate@",
  ...
  getLengths$1$divisions: function(divisions) {
    var t1, cache, last, sum, p, current, t2, t3, t4, t5, t6, distance;
  ...
  getUtoTmapping$2$distance: function(u, distance) {
    var arcLengths, il, t1, targetArcLength, high, high0, low, i, comparison, lengthAfter;
    arcLengths = this.getLengths$0();
    il = arcLengths.length;
    t1 = il - 1;
    if (t1 < 0)
      throw H.ioore(arcLengths, t1);
    targetArcLength = u * arcLengths[t1];
    high = il - 1;
    ...
    if (typeof targetArcLength !== "number")
      throw targetArcLength.$sub();
    return (high0 + (targetArcLength - t1) / (lengthAfter - t1)) / high;
  },
...
EllipseCurve: {"": "Curve2D;aX,aY,xRadius,yRadius,aStartAngle,aEndAngle,aClockwise,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  getPoint$1: function(t) {
    var t1, deltaAngle, angle, tx, ty, t2;
    t1 = this.aStartAngle;
    deltaAngle = J.$sub$n(this.aEndAngle, t1);
    if (this.aClockwise !== true)
      t = 1 - t;
    if (typeof deltaAngle !== "number")
      throw H.iae(deltaAngle);
    angle = J.$add$ns(t1, t * deltaAngle);
    t1 = typeof angle !== "number";
    if (t1)
      H.throwExpression(new P.ArgumentError(angle));
    tx = J.$add$ns(this.aX, J.$mul$n(this.xRadius, Math.cos(angle)));
    if (t1)
      H.throwExpression(new P.ArgumentError(angle));
    ty = J.$add$ns(this.aY, J.$mul$n(this.yRadius, Math.sin(angle)));
    t1 = new Float32Array(2);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector2(t1);
    t2 = t1.storage;
...
Path: {"": "CurvePath;useSpacedPoints,_points,actions,curves,_bends,autoClose,cacheLengths,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  lineTo$2: function(_, x, y) {
    var lastargs, t1, t2, x0, y0, t3;
    lastargs = C.JSArray_methods.get$last(this.actions).args;
    t1 = lastargs.length;
    t2 = t1 - 2;
    if (t2 < 0)
      throw H.ioore(lastargs, t2);
    x0 = lastargs[t2];
    t2 = t1 - 1;
    if (t2 < 0)
      throw H.ioore(lastargs, t2);
    ...
    t3[0] = x;
    t3[1] = y;
    this.curves.push(new S.LineCurve(t2, t1, null, null, false));
    this.actions.push(new S.PathAction("lineTo", [x, y]));
  },
  quadraticCurveTo$4: function(_, aCPx, aCPy, aX, aY) {
    var lastargs, t1, t2, x0, y0, t3, t4, t5, t6;
    lastargs = C.JSArray_methods.get$last(this.actions).args;
    t1 = lastargs.length;
    t2 = t1 - 2;
    if (t2 < 0)
      throw H.ioore(lastargs, t2);
    x0 = J.toDouble$0$n(lastargs[t2]);
    t2 = t1 - 1;
    if (t2 < 0)
      throw H.ioore(lastargs, t2);
    y0 = J.toDouble$0$n(lastargs[t2]);
    t2 = new Float32Array(2);
    t2.$dartCachedLength = t2.length;
    t2 = new T.Vector2(t2);
    t1 = t2.storage;
    t1[0] = x0;
    t1[1] = y0;
    t1 = J.toDouble$0$n(aCPx);
    t3 = J.toDouble$0$n(aCPy);
    ...
    t5[0] = t1;
    t5[1] = t3;
    t3 = J.toDouble$0$n(aX);
    t5 = J.toDouble$0$n(aY);
    t1 = new Float32Array(2);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector2(t1);
    t6 = t1.storage;
    t6[0] = t3;
    t6[1] = t5;
    this.curves.push(new S.QuadraticBezierCurve(t2, t4, t1, null, null, false));
    this.actions.push(new S.PathAction("quadraticCurveTo", [aCPx, aCPy, aX, aY]));
  },
  bezierCurveTo$6: function(_, aCP1x, aCP1y, aCP2x, aCP2y, aX, aY) {
    var lastargs, t1, t2, x0, y0, t3, t4, t5, t6, t7;
    lastargs = C.JSArray_methods.get$last(this.actions).args;
    t1 = lastargs.length;
    t2 = t1 - 2;
    if (t2 < 0)
    ...
    t1[0] = x0;
    t1[1] = y0;
    t1 = J.toDouble$0$n(aCP1x);
    t3 = J.toDouble$0$n(aCP1y);
    t4 = new Float32Array(2);
    t4.$dartCachedLength = t4.length;
    t4 = new T.Vector2(t4);
    t5 = t4.storage;
    t5[0] = t1;
    t5[1] = t3;
    t3 = J.toDouble$0$n(aCP2x);
    t5 = J.toDouble$0$n(aCP2y);
    t1 = new Float32Array(2);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector2(t1);
    t6 = t1.storage;
    t6[0] = t3;
    t6[1] = t5;
    t5 = J.toDouble$0$n(aX);
    t6 = J.toDouble$0$n(aY);
    ...
    t7[0] = t5;
    t7[1] = t6;
    this.curves.push(new S.CubicBezierCurve(t2, t4, t1, t3, null, null, false));
    this.actions.push(new S.PathAction("bezierCurveTo", [aCP1x, aCP1y, aCP2x, aCP2y, aX, aY]));
  },
  splineThru$1: function(pts) {
    var lastargs, t1, t2, x0, y0, npts;
    lastargs = C.JSArray_methods.get$last(this.actions).args;
    t1 = lastargs.length;
    t2 = t1 - 2;
    if (t2 < 0)
    ...
    this.curves.push(new S.SplineCurve(npts, null, null, false));
    this.actions.push(new S.PathAction("splineThru", [pts]));
  },
  arc$6: function(_, aX, aY, aRadius, aStartAngle, aEndAngle, aClockwise) {
    ...
    if (t1 < 0)
      throw H.ioore(lastargs, t1);
    y0 = lastargs[t1];
    this.absellipse$7(J.$add$ns(aX, x0), J.$add$ns(aY, y0), aRadius, aRadius, aStartAngle, aEndAngle, aClockwise);
  },
  ellipse$7: function(_, aX, aY, xRadius, yRadius, aStartAngle, aEndAngle, aClockwise) {
    var lastargs, t1, t2, x0, y0;
    lastargs = C.JSArray_methods.get$last(this.actions).args;
    t1 = lastargs.length;
    t2 = t1 - 2;
    if (t2 < 0)
    ...
    if (t2 < 0)
      throw H.ioore(lastargs, t2);
    y0 = lastargs[t2];
    this.absellipse$7(J.$add$ns(aX, x0), J.$add$ns(aY, y0), xRadius, yRadius, aStartAngle, aEndAngle, aClockwise);
  },
  absellipse$7: function(aX, aY, xRadius, yRadius, aStartAngle, aEndAngle, aClockwise) {
    ...
    t1 = curve.getPoint$1(aClockwise === true ? 1 : 0).storage;
    args.push(t1[0]);
    args.push(t1[1]);
  ...
  getPoints$2: function(divisions, closedPath) {
    var points, i, cpx, cpy, cpx2, cpy2, cpx1, cpy1, cpx0, cpy0, laste, j, t, tx, ty, t1, t2, item, args, t3, t4, k, last, spts, n, spline, aX, aY, aRadius, aStartAngle, aEndAngle, deltaAngle, t5, angle, t6, t7, xRadius, yRadius, t8, lastPoint;
    if (this.useSpacedPoints)
      return this.getSpacedPoints$2(divisions, closedPath);
    points = [];
    for (i = 0, cpx = null, cpy = null, cpx2 = null, cpy2 = null, cpx1 = null, cpy1 = null, cpx0 = null, cpy0 = null, laste = null, j = null, t = null, tx = null, ty = null; t1 = this.actions, t2 = t1.length, i < t2; ++i) {
      item = t1[i];
      args = item.args;
      switch (item.action) {
        case "moveTo":
        ...
        case "bezierCurveTo":
          ...
          for (j = 1; j <= 12; ++j) {
            ...
            if (typeof cpx !== "number")
              throw H.iae(cpx);
            tx = t1 * cpx0 + t3 * cpx1 + t2 * cpx2 + t4 * cpx;
            if (typeof cpy0 !== "number")
              throw H.iae(cpy0);
            if (typeof cpy1 !== "number")
              throw H.iae(cpy1);
            ...
            if (typeof cpy !== "number")
              throw H.iae(cpy);
            ty = t1 * cpy0 + t3 * cpy1 + t2 * cpy2 + t4 * cpy;
            t4 = new Float32Array(2);
            t4.$dartCachedLength = t4.length;
            t4 = new T.Vector2(t4);
            t2 = t4.storage;
        ...
        case "arc":
          ...
          if (5 >= t3)
            throw H.ioore(args, 5);
          t3 = args[5];
          deltaAngle = J.$sub$n(aEndAngle, aStartAngle);
          for (t1 = J.getInterceptor$ns(aY), t2 = J.getInterceptor$n(aRadius), t4 = J.getInterceptor$ns(aX), t5 = J.getInterceptor$ns(aStartAngle), t3 = t3 !== true, j = 1; j <= 24; ++j) {
            t = j / 24;
            if (t3)
              t = 1 - t;
            if (typeof deltaAngle !== "number")
              throw H.iae(deltaAngle);
            angle = t5.$add(aStartAngle, t * deltaAngle);
            t6 = typeof angle !== "number";
            if (t6)
              H.throwExpression(new P.ArgumentError(angle));
            tx = t4.$add(aX, t2.$mul(aRadius, Math.cos(angle)));
            if (t6)
              H.throwExpression(new P.ArgumentError(angle));
            ty = t1.$add(aY, t2.$mul(aRadius, Math.sin(angle)));
        ...
        case "ellipse":
          ...
          t1 = args[6];
          deltaAngle = J.$sub$n(aEndAngle, aStartAngle);
          for (t2 = J.getInterceptor$n(yRadius), t3 = J.getInterceptor$ns(aY), t4 = J.getInterceptor$n(xRadius), t5 = J.getInterceptor$ns(aX), t6 = J.getInterceptor$ns(aStartAngle), t1 = t1 !== true, j = 1; j <= 24; ++j) {
            t = j / 24;
            if (t1)
              t = 1 - t;
            if (typeof deltaAngle !== "number")
              throw H.iae(deltaAngle);
            angle = t6.$add(aStartAngle, t * deltaAngle);
            t7 = typeof angle !== "number";
            if (t7)
              H.throwExpression(new P.ArgumentError(angle));
            tx = t5.$add(aX, t4.$mul(xRadius, Math.cos(angle)));
            if (t7)
              H.throwExpression(new P.ArgumentError(angle));
            ty = t3.$add(aY, t2.$mul(yRadius, Math.sin(angle)));
  ...
  toShapes$0: function() {
    var subPaths, lastPath, i, t1, item, action, shapes, t2, tmpPath, tmpShape;
    subPaths = [];
    lastPath = S.Path$(null);
    for (i = 0; t1 = this.actions, i < t1.length; ++i) {
      item = t1[i];
      action = item.action;
      if (action === "moveTo")
        if (lastPath.actions.length !== 0) {
          subPaths.push(lastPath);
          lastPath = new S.Path(false, null, [], [], [], false, null, null, null, false);
        }
      lastPath._applyAction$2(action, item.args);
    }
    if (lastPath.actions.length !== 0)
      subPaths.push(lastPath);
    t1 = subPaths.length;
    ...
    shapes = [];
    if (0 >= t1)
      throw H.ioore(subPaths, 0);
    t1 = Y.area(subPaths[0].getPoints$0());
    t2 = subPaths.length;
    if (t2 === 1) {
      if (0 >= t2)
        throw H.ioore(subPaths, 0);
      tmpPath = subPaths[0];
      tmpShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
      tmpShape.Path$1(null);
    ...
    if (!(t1 < 0)) {
      ...
      for (i = 0; i < subPaths.length; ++i) {
        tmpPath = subPaths[i];
        if (Y.area(tmpPath.getPoints$0()) < 0) {
          tmpShape.actions = tmpPath.actions;
          tmpShape.curves = tmpPath.curves;
          shapes.push(tmpShape);
          tmpShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
      ...
      for (i = 0, tmpShape = null; i < subPaths.length; ++i) {
        tmpPath = subPaths[i];
        if (Y.area(tmpPath.getPoints$0()) < 0) {
          if (tmpShape != null)
            shapes.push(tmpShape);
  ...
  _applyAction$2: function(action, args) {
    ...
    switch (action) {
      case "moveTo":
        ...
        if (1 >= t1)
          throw H.ioore(args, 1);
        t1 = args[1];
        this.actions.push(new S.PathAction("moveTo", [t2, t1]));
        break;
      case "lineTo":
        t1 = args.length;
        if (0 >= t1)
      ...
      case "quadraticCurveTo":
        ...
        if (3 >= t1)
          throw H.ioore(args, 3);
        this.quadraticCurveTo$4(this, t2, t3, t4, args[3]);
        break;
      case "bezierCurveTo":
        t1 = args.length;
        if (0 >= t1)
        ...
        if (5 >= t1)
          throw H.ioore(args, 5);
        this.bezierCurveTo$6(this, t2, t3, t4, t5, t6, args[5]);
        break;
      case "splineThru":
        if (0 >= args.length)
          throw H.ioore(args, 0);
        this.splineThru$1(args[0]);
        break;
      case "arc":
        t1 = args.length;
        if (0 >= t1)
        ...
        if (5 >= t1)
          throw H.ioore(args, 5);
        this.arc$6(this, t2, t3, t4, t5, t6, args[5]);
        break;
      case "ellipse":
        t1 = args.length;
        if (0 >= t1)
        ...
        if (6 >= t1)
          throw H.ioore(args, 6);
        this.ellipse$7(this, t2, t3, t4, t5, t6, t7, args[6]);
        break;
      default:
    }
  },
...
ExtrudeGeometry: {"": "Geometry;",
  ...
  addShape$14$UVGenerator: function(shape, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, $frames, material, extrudeMaterial, UVGenerator) {
    var t1, uvgen, shapesOffset, shapePoints, vertices, holes, t2, ahole, h, t3, faces, vertices0, vlen, flen, t4, contourMovements, il, j, t5, i, k, t6, holesMovements, verticesMovements, oneHoleMovements, t7, t8, b, vert, t, bs, t9, t10, t11, t12, t13, s, offset, face, layeroffset;
    t1 = {};
    ...
    for (b = 0, vert = null; t6 = t1.bevelSegments_0, b < t6; ++b) {
      t = b / t6;
      bs = bevelSize * Math.sin(t * 3.141592653589793 / 2);
    ...
    for (; i < vlen; ++i) {
      if (bevelEnabled) {
        t6 = t3.$index(vertices0, i);
        if (i >= verticesMovements.length)
          throw H.ioore(verticesMovements, i);
        t7 = verticesMovements[i];
        if (t7 == null)
          H.printToConsole("die");
        vert = J.add$1$ax(J.scale$1$x(J.clone$0$x(t7), bevelSize), t6);
      } else
        vert = t3.$index(vertices0, i);
      t6 = J.getInterceptor$x(vert);
      t7 = t6.get$x(vert);
      t6 = t6.get$y(vert);
      t8 = this.vertices;
      t9 = new Float32Array(3);
    ...
    for (t6 = amount / steps, s = 1; s <= steps; ++s)
    ...
    for (b = t1.bevelSegments_0 - 1; b >= 0; --b) {
      t = b / t1.bevelSegments_0;
      bs = bevelSize * Math.sin(t * 3.141592653589793 / 2);
      t3 = amount + bevelThickness * (1 - t);
      i = 0;
      while (true) {
        t6 = t4.get$length(vertices);
        if (typeof t6 !== "number")
          throw H.iae(t6);
        if (!(i < t6))
          break;
        t6 = t4.$index(vertices, i);
        if (i >= t5)
          throw H.ioore(contourMovements, i);
        t7 = contourMovements[i];
        if (t7 == null)
          H.printToConsole("die");
        t7 = t7.clone$0(t7);
        t7 = t7.scale$1(t7, bs);
...
PlaneGeometry: {"": "Geometry;id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  PlaneGeometry$4: function(width, height, segmentsWidth, segmentsHeight) {
    var width_half, height_half, segment_width, segment_height, t1, normal, iy, ix, t2, t3, t4, iy0, t5, ix0, t6, face, t7, t8, t9, t10, faceVertexUV, newUVs;
    width_half = width / 2;
    height_half = height / 2;
    segment_width = width / 1;
    segment_height = height / 1;
    t1 = new Float32Array(3);
    t1.$dartCachedLength = t1.length;
    normal = new T.Vector3(t1);
    normal.setValues$3(0, 0, 1);
    for (iy = 0; iy < 2; ++iy)
      for (t1 = -(iy * segment_height - height_half), ix = 0; ix < 2; ++ix) {
        t2 = this.vertices;
        t3 = new Float32Array(3);
        t3.$dartCachedLength = t3.length;
        t3 = new T.Vector3(t3);
        t4 = t3.storage;
        t4[0] = ix * segment_width - width_half;
        t4[1] = t1;
        t4[2] = 0;
        J.add$1$ax(t2, t3);
      }
    for (t1 = this.faceVertexUvs, iy = 0; iy < 1; iy = iy0)
      for (t2 = 2 * iy, iy0 = iy + 1, t3 = 2 * iy0, t4 = iy / 1, t5 = iy0 / 1, ix = 0; ix < 1; ix = ix0) {
        ix0 = ix + 1;
        t6 = [ix + t2, ix + t3, ix0 + t3, ix0 + t2];
        ...
        faceVertexUV = t1[0];
        newUVs = P.List_List(null, null);
        t10 = ix / 1;
        t9 = ix0 / 1;
        C.JSArray_methods.addAll$1(newUVs, [new S.UV(t10, t4), new S.UV(t10, t5), new S.UV(t9, t5), new S.UV(t9, t4)]);
...
PlaneGeometry$: function(width, height, segmentsWidth, segmentsHeight) {
  ...
  t2 = new S.PlaneGeometry(t1, "", t2, [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, null);
  t2.PlaneGeometry$4(width, height, segmentsWidth, segmentsHeight);
  return t2;
}}

},

TextGeometry: {"": "ExtrudeGeometry;shapes,shapebb,id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data", static: {
TextGeometry_TextGeometry: function(text, height, bend, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, material, extrudeMaterial, size, font, weight, style) {
  var textShapes, t1, t2, max, t3, t4;
  textShapes = Y.generateShapes(text, size, curveSegments, font, weight, style);
  if (bend) {
    t1 = textShapes.length;
    t2 = t1 - 1;
    if (t2 < 0)
      throw H.ioore(textShapes, t2);
    max = textShapes[t2].getBoundingBox$0().get$maxX();
    t2 = new Float32Array(2);
    t2.$dartCachedLength = t2.length;
    t1 = max.$div(max, 2);
    t3 = new Float32Array(2);
    ...
    t1[0] = max;
    t1[1] = 0;
    bendPath = new S.QuadraticBezierCurve(new T.Vector2(t2), t3, t4, null, null, false);
  } else
    bendPath = null;
  t1 = $.GeometryCount;
  $.GeometryCount = t1 + 1;
  t2 = [];
  H.setRuntimeTypeInfo(t2, [T.Vector3]);
  t2 = new S.TextGeometry(textShapes, null, t1, "", t2, [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, null);
  t2.ExtrudeGeometry$13$amount$bendPath$bevelEnabled$bevelSegments$bevelSize$bevelThickness$curveSegments$extrudeMaterial$extrudePath$frames$material$steps(textShapes, height, bendPath, bevelEnabled, bevelSegments, bevelSize, bevelThickness, curveSegments, extrudeMaterial, extrudePath, null, material, steps);
  return t2;
}}
},
    ...
    for (t1 = this._frustum, i = 0, j = null, jl = null, shadowMap = null, shadowMatrix = null, shadowCamera = null, buffer = null, material = null, webglObject = null, object = null, renderList = null; i < il; ++i) {
      ...
      for (; j < jl; ++j) {
        ...
        if (webglObject.get$render() === true) {
          ...
          t4 = object.get$material();
          t5 = J.getInterceptor(t4);
          if (typeof t4 === "object" && t4 !== null && !!t5.$isMeshFaceMaterial) {
...
Color: {"": "Object;_r,_g,_b",
  ...
  copy$1: function(color) {
    this._r = C.JSNumber_methods.toDouble$0(color._r);
    this._g = C.JSNumber_methods.toDouble$0(color._g);
    this._b = C.JSNumber_methods.toDouble$0(color._b);
    return this;
  },
  copyGammaToLinear$1: function(color) {
    var t1 = color._r;
    this._r = C.JSNumber_methods.toDouble$0(t1 * t1);
    t1 = color._g;
    this._g = C.JSNumber_methods.toDouble$0(t1 * t1);
    t1 = color._b;
    this._b = C.JSNumber_methods.toDouble$0(t1 * t1);
    return this;
  },
...
Face: {"": "Object;indices<,normal@,vertexNormals@,vertexColors<,color>,materialIndex<,centroid<",
  get$size: function(_) {
...
Geometry: {"": "Object;id*,name,vertices@,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals<,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  computeBoundingBox$0: function() {
    var t1, t2, firstPosition, min, max, vl, v, position, t3, t4, t5;
    if (this.boundingBox == null) {
      t1 = new Float32Array(3);
      t1.$dartCachedLength = t1.length;
      t2 = new Float32Array(3);
      t2.$dartCachedLength = t2.length;
      this.boundingBox = new S.BoundingBox(new T.Vector3(t1), new T.Vector3(t2));
    }
    t1 = this.vertices;
    if (J.get$length$asx(t1) > 0) {
      if (0 < 0 || 0 >= t1.length)
        throw H.ioore(t1, 0);
      firstPosition = t1[0];
      this.boundingBox.min.setFrom$1(firstPosition);
      this.boundingBox.max.setFrom$1(firstPosition);
      t1 = this.boundingBox;
      min = t1.min;
      max = t1.max;
      vl = J.get$length$asx(this.vertices);
      for (t1 = max.storage, t2 = min.storage, v = 1; v < vl; ++v) {
        position = J.$index$asx(this.vertices, v);
        ...
        if (t4 < t5)
          ...
          if (typeof t4 !== "number")
            throw t4.$gt();
          if (t4 > t5)
            t1[1] = t3.get$y(position);
        }
        t4 = t3.get$z(position);
        t5 = t2[2];
        if (typeof t4 !== "number")
          throw t4.$lt();
        if (t4 < t5)
          t2[2] = t3.get$z(position);
        else {
          t4 = t3.get$z(position);
          t5 = t1[2];
          if (typeof t4 !== "number")
...
PointLight: {"": "Light;_three$_position,intensity<,distance<,color,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,customDepthMaterial,__data", $isPointLight: true},
...
MeshFaceMaterial: {"": "Material;materials,name,id,side,opacity,blending,blendSrc,blendDst,blendEquation,alphaTest,polygonOffset,polygonOffsetFactor,polygonOffsetUnits,transparent,depthTest,depthWrite,overdraw,visible,needsUpdate,__data", $isMeshFaceMaterial: true},
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  setClearColor$2: function(color, alpha) {
  ...
  getBufferMaterial$2: function(object, geometryGroup) {
    var t1, t2, t3, material;
    t1 = object.object;
    t2 = t1.get$material();
    t3 = J.getInterceptor(t2);
    if (typeof t2 === "object" && t2 !== null && !!t3.$isMeshFaceMaterial) {
      t1 = H.interceptedTypeCast(t1.get$material(), "$isMeshFaceMaterial").materials;
  ...
  setupMorphTargets$3: function(material, geometryGroup, object) {
    ...
    for (t1 = material._material, t2 = !t1.$isMeshPhongMaterial, t3 = !!t1.$isShaderMaterial, influenceIndex = null, m = 0; m < material.numSupportedMorphTargets;) {
      ...
      if (t5) {
        ...
        if ((!!t1.$isMeshPhongMaterial || t3) && t1.get$morphNormals()) {
          t4 = this._gl;
  ...
  unrollBufferMaterial$1: function(object) {
    var buffer, t1, t2, t3, meshMaterial, materialIndex, material;
    ...
    if (typeof t2 === "object" && t2 !== null && !!t3.$isMeshFaceMaterial) {
      ...
      if (J.$ge$n(materialIndex, 0)) {
        t1 = (!!t1.$isMesh || !!t1.$isLine ? t1.get$geometry() : null).materials;
        if (materialIndex >>> 0 !== materialIndex || materialIndex >= t1.length)
          throw H.ioore(t1, materialIndex);
        t1 = t1[materialIndex];
        if (t1.__data == null)
          t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
        t2 = t1.__data;
  ...
  sortFacesByMaterial$2: function(geometry, material) {
    var hash_map, t1, t2, usesFaceMaterial, fl, f, face, materialIndex, groupHash, vertices, t3, t4;
    hash_map = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    t1 = geometry._geometry;
    t1.morphNormals;
    t2 = J.getInterceptor(material);
    usesFaceMaterial = typeof material === "object" && material !== null && !!t2.$isMeshFaceMaterial;
    ...
    for (f = 0; f < fl; ++f) {
      ...
      if (f >= t2.length)
        throw H.ioore(t2, f);
      face = t2[f];
      materialIndex = usesFaceMaterial ? J.toString$0(face.materialIndex) : "0";
      if (hash_map.$index(hash_map, materialIndex) == null)
        hash_map.$indexSet(hash_map, materialIndex, H.fillLiteralMap(["hash", materialIndex, "counter", 0], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
      groupHash = H.S(J.$index$asx(hash_map.$index(hash_map, materialIndex), "hash")) + "_" + H.S(J.$index$asx(hash_map.$index(hash_map, materialIndex), "counter"));
      t2 = geometry.geometryGroups;
      if (t2.$index(t2, groupHash) == null) {
        t2 = geometry.geometryGroups;
        t2.$indexSet(t2, groupHash, new S.WebGLGeometry(null, 0, [], [], H.Primitives_parseInt(materialIndex, null, null), 0, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null));
      }
      t2 = face.indices;
      vertices = t2.length;
      ...
      if (t3 + vertices > 65535) {
        t3 = hash_map.$index(hash_map, materialIndex);
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    var object, t1, shaderID, maxLightCount, maxShadows, maxBones, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, t32, attributes, i;
    object = webglobject.get$object();
    ...
    t9 = !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial || false ? t1.get$map(t1) : null;
    t10 = !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial ? t1.get$envMap() : null;
    t11 = !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial ? t1.get$lightMap() : null;
    ...
    if (t8)
      ...
      t15 = true;
    t15 = t15 ? t1.get$specularMap() : null;
    t16 = material.get$_hasVertexColors() ? t1.get$vertexColors() : 0;
    t17 = material.get$_hasFog() && t1.get$fog();
    t18 = (!!t1.$isMeshBasicMaterial || t12 || t2) && t1.get$skinning();
    if (this.supportsBoneTextures === true)
      t19 = false;
    else
      t19 = false;
    t20 = (!!t1.$isMeshBasicMaterial || t12 || t2) && t1.get$morphTargets();
    t21 = (t12 || t2) && t1.get$morphNormals();
    t22 = this.maxMorphTargets;
    t23 = this.maxMorphNormals;
    t24 = maxLightCount.$index(maxLightCount, "directional");
    t25 = maxLightCount.$index(maxLightCount, "point");
    t26 = maxLightCount.$index(maxLightCount, "spot");
    t27 = maxLightCount.$index(maxLightCount, "hemi");
    t28 = this.shadowMapEnabled && object.get$receiveShadow();
    t29 = t12 && H.interceptedTypeCast(t1, "$isMeshPhongMaterial").metal;
    t30 = t12 && H.interceptedTypeCast(t1, "$isMeshPhongMaterial").perPixel;
    t31 = t12 && t1.get$wrapAround();
    t32 = t1.side;
    material.program = this.buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround(shaderID, t3, t4, t5, t6, t7, t1.alphaTest, null, null, t13, t32 === 2, t10, t32 === 1, fog, false, t11, t9, maxBones, t24, t27, t23, t22, t25, maxShadows, t26, t29, t21, t20, t14, t30, this.shadowMapCascade, this.shadowMapDebug, t28, this.shadowMapType, false, t18, t15, t17, t19, t16, t31);
    attributes = material.program.attributes;
    if ((!!t1.$isMeshBasicMaterial || t12 || t2) && t1.get$morphTargets()) {
  ...
  setProgram$5: function(camera, lights, fog, material, object) {
    ...
    if ((!!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial || t2) && t1.get$skinning()) {
      if (this.supportsBoneTextures === true)
    ...
    if (refreshMaterial) {
      ...
      if (t5)
        if (t2)
          t1 = (!!t1.$isMeshBasicMaterial || t4 || false) && t1.get$skinning();
        else
          t1 = true;
      else
        t1 = true;
  ...
  refreshUniformsCommon$2: function(uniforms, material) {
    ...
    J.set$value$x(t3, !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial || false ? t1.get$map(t1) : null);
    t3 = uniforms.$index(uniforms, "lightMap");
    J.set$value$x(t3, !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial ? t1.get$lightMap() : null);
    t3 = uniforms.$index(uniforms, "specularMap");
    J.set$value$x(t3, !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial ? t1.get$specularMap() : null);
    t3 = !!t1.$isMeshPhongMaterial;
    if (t3)
      ;
    if (t3)
      ;
    if (!!t1.$isMeshBasicMaterial || t3 || false)
      ;
    if (t4)
      t5 = t3;
    else
  ...
  refreshUniformsFog$2: function(uniforms, fog) {
    ...
    J.set$value$x(uniforms.$index(uniforms, "fogNear"), fog.near);
    J.set$value$x(uniforms.$index(uniforms, "fogFar"), fog.far);
  },
  refreshUniformsPhong$2: function(uniforms, material) {
    ...
    if (this.gammaInput) {
      ...
      J.get$value$x(uniforms.$index(uniforms, "emissive")).copyGammaToLinear$1(t2.emissive);
      t1 = J.get$value$x(uniforms.$index(uniforms, "specular"));
      t1.copyGammaToLinear$1(t3 ? t2.specular : null);
    } else {
      J.set$value$x(uniforms.$index(uniforms, "ambient"), t2.get$ambient());
      J.set$value$x(uniforms.$index(uniforms, "emissive"), t2.emissive);
      t1 = uniforms.$index(uniforms, "specular");
      J.set$value$x(t1, t3 ? t2.specular : null);
    }
    if (t3 && t2.get$wrapAround())
  ...
  setupLights$2: function(program, lights) {
    var zlights, dirColors, dirPositions, pointColors, pointPositions, pointDistances, spotColors, hemiSkyColors, hemiGroundColors, ll, t1, t2, t3, t4, t5, l, r, g, b, color, skyColor, groundColor, intensity, intensitySq, position, distance, dirLength, pointLength, spotLength, hemiLength, dirCount, pointCount, spotCount, hemiCount, dirOffset, pointOffset, spotOffset, hemiOffset, light, t6, t7, t8, l0;
    ...
    pointPositions = J.$index$asx(zlights.$index(zlights, "point"), "positions");
    ...
    for (t1 = this.gammaInput, t2 = J.getInterceptor$asx(pointColors), t3 = J.getInterceptor$asx(pointPositions), t4 = J.getInterceptor$asx(dirColors), t5 = J.getInterceptor$asx(dirPositions), l = 0, r = 0, g = 0, b = 0, color = null, skyColor = null, groundColor = null, intensity = null, intensitySq = null, position = null, distance = null, dirLength = 0, pointLength = 0, spotLength = 0, hemiLength = 0, dirCount = 0, pointCount = 0, spotCount = 0, hemiCount = 0, dirOffset = 0, pointOffset = 0, spotOffset = 0, hemiOffset = 0; l < ll; ++l) {
      if (l >= lights.length)
        throw H.ioore(lights, l);
      light = lights[l];
      t6 = J.getInterceptor(light);
      t7 = typeof light === "object" && light !== null && !!t6.$isDirectionalLight;
      t8 = !t7;
      if ((t7 || false) && light.get$onlyShadow() || t6.get$visible(light) !== true)
        continue;
      color = t6.get$color(light);
      if (t7 || typeof light === "object" && light !== null && !!t6.$isPointLight) {
      ...
      if (t7) {
        ...
        t6 = this._direction;
        t6.normalize$0(t6);
        t6 = this._direction.storage;
        if (t6[0] === 0 && t6[1] === 0 && t6[2] === 0)
          continue;
        dirOffset = dirLength * 3;
        t6 = dirOffset + 3;
        t4.set$length(dirColors, t6);
        t5.set$length(dirPositions, t6);
        t5.$indexSet(dirPositions, dirOffset, this._direction.storage[0]);
        t5.$indexSet(dirPositions, dirOffset + 1, this._direction.storage[1]);
        t5.$indexSet(dirPositions, dirOffset + 2, this._direction.storage[2]);
        if (t1) {
          if (typeof intensity !== "number")
            throw intensity.$mul();
        ...
        ++dirLength;
      } else if (typeof light === "object" && light !== null && !!t6.$isPointLight) {
        ++pointCount;
        if (!light.visible)
          continue;
        pointOffset = pointLength * 3;
        t6 = pointOffset + 3;
        t2.set$length(pointColors, t6);
        t3.set$length(pointPositions, t6);
        if (t1) {
          if (typeof intensity !== "number")
            throw intensity.$mul();
          this.setColorGamma$4(pointColors, pointOffset, color, intensity * intensity);
        } else
          this.setColorLinear$4(pointColors, pointOffset, color, intensity);
        position = light.matrixWorld.getTranslation$0();
        t6 = position.storage;
        t3.$indexSet(pointPositions, pointOffset, t6[0]);
        t3.$indexSet(pointPositions, pointOffset + 1, t6[1]);
        t3.$indexSet(pointPositions, pointOffset + 2, t6[2]);
        if (pointDistances == null) {
          pointDistances = P.List_List(null, null);
          pointDistances.push(0);
        }
        t6 = J.getInterceptor$asx(pointDistances);
        if (t6.get$length(pointDistances) === 0)
          t6.add$1(pointDistances, 0);
        t6.$indexSet(pointDistances, pointLength, distance);
        ++pointLength;
      }
    }
    ll = P.max(t4.get$length(dirColors), dirCount * 3);
    for (l = dirLength * 3; l < ll; ++l)
      t4.$indexSet(dirColors, l, 0);
    ll = P.max(t2.get$length(pointColors), pointCount * 3);
    for (l = pointLength * 3; l < ll; ++l)
      t2.$indexSet(pointColors, l, 0);
  ...
  allocateLights$1: function(lights) {
    var ll, t1, l, dirLights, pointLights, spotLights, hemiLights, light, t2, t3;
    ll = J.get$length$asx(lights);
    for (t1 = lights.length, l = 0, dirLights = 0, pointLights = 0, spotLights = 0, hemiLights = 0; l < ll; ++l) {
      ...
      t3 = typeof light === "object" && light !== null && !!t2.$isDirectionalLight;
      if ((t3 || false) && light.get$onlyShadow())
        continue;
      if (t3)
        ++dirLights;
      if (typeof light === "object" && light !== null && !!t2.$isPointLight)
        ++pointLights;
    }
...
WebGLMaterial: {"": "Object;_material,program<,_fragmentShader,_vertexShader,_uniforms,uniformsList,numSupportedMorphTargets,numSupportedMorphNormals,shadowPass?",
  ...
  get$morphTargets: function() {
    var t1 = this._material;
    return (!!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial || !!t1.$isShaderMaterial) && t1.get$morphTargets();
  },
  get$morphNormals: function() {
    var t1 = this._material;
    t1 = !!t1.$isMeshPhongMaterial || !!t1.$isShaderMaterial;
  ...
  get$map: function(_) {
    var t1 = this._material;
    return !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial || false ? t1.get$map(t1) : null;
  },
  map$1: function($receiver, arg0) {
  ...
  get$lightMap: function() {
    var t1 = this._material;
    return !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial ? t1.get$lightMap() : null;
  },
  ...
  get$specularMap: function() {
    var t1 = this._material;
    return !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial ? t1.get$specularMap() : null;
  },
  ...
  get$skinning: function() {
    var t1 = this._material;
    return (!!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial || !!t1.$isShaderMaterial) && t1.get$skinning();
  },
  get$size: function(_) {
    return;
  },
  ...
  get$_hasVertexColors: function() {
    var t1 = this._material;
    return !!t1.$isLineBasicMaterial || !!t1.$isMeshBasicMaterial || !!t1.$isMeshPhongMaterial || !!t1.$isShaderMaterial;
  },
...
FogLinear: {"": "Object;color>,near,far"},
...
["", "web_gl_geometry_text.dart", , S, {
loadFonts: function() {
  var t1 = new H.MappedListIterable(["fonts/helvetiker_regular.json"], new S.loadFonts_closure());
  H.setRuntimeTypeInfo(t1, [null, null]);
  return P.Future_wait(t1);
},
...
main: function() {
  ...
  $.windowHalfY = t1 / 2;
  t1 = S.loadFonts();
  t1.then$1(t1, new S.main_closure());
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, dirLight, pointLight, plane;
  ...
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  t16 = new S.PerspectiveCamera(30, t1 / t2, null, null, null, null, null, null, t3, t4, t5, 1, 1500, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  t16.updateProjectionMatrix$0();
  t16.position.setValues$3(0, 400, 700);
  $.camera = t16;
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  t16 = new T.Vector3(t16);
  ...
  $.cameraTarget = t16;
  t16 = S.Scene$();
  t16.fog = new S.FogLinear(S.Color$(0), 250, 1400);
  $.scene = t16;
  dirLight = S.DirectionalLight$(16777215, 0.125, 0);
  t16 = dirLight.position.setValues$3(0, 0, 1);
  t16.normalize$0(t16);
  t16 = $.scene;
  t16.add$1(t16, dirLight);
  t16 = S.Color$(16777215);
  t15 = $.Object3DCount;
  $.Object3DCount = t15 + 1;
  t14 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  t13 = new Float32Array(3);
  t13.$dartCachedLength = t13.length;
  t13 = new T.Vector3(t13);
  t13.setValues$3(0, 1, 0);
  t12 = new Float32Array(3);
  t12.$dartCachedLength = t12.length;
  t12 = new T.Vector3(t12);
  ...
  t7 = new T.Matrix4(t7);
  t7.setIdentity$0();
  t6 = T.Quaternion$identity();
  t5 = new Float32Array(3);
  t5.$dartCachedLength = t5.length;
  pointLight = new S.PointLight(null, 1.5, 0, t16, t15, "", t14, null, [], t13, t12, t11, t10, "XYZ", null, null, null, true, null, t9, t8, t7, true, true, t6, false, 0, 1, true, false, false, true, new T.Vector3(t5), null, null);
  t5 = new Float32Array(3);
  t5.$dartCachedLength = t5.length;
  pointLight._three$_position = new T.Vector3(t5);
  pointLight.position.setValues$3(0, 100, 90);
  t5 = $.scene;
  t5.add$1(t5, pointLight);
  pointLight.color.setHSL$3(Math.random(), 1, 0.5);
  t5 = S.Color$(16777215);
  t6 = S.Color$(16777215);
  t7 = S.Color$(0);
  t8 = S.Color$(1118481);
  ...
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  t2 = new S.MeshPhongMaterial(t5, t6, t7, t8, 30, false, false, false, t1, null, null, null, 1, null, null, null, null, 0, 1, 0.98, 1, false, 1, "round", "round", false, false, false, 0, true, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
  if (t2.normalScale == null) {
    t1 = new Float32Array(2);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector2(t1);
    t3 = t1.storage;
  ...
  t1 = $.MaterialCount;
  $.MaterialCount = t1 + 1;
  $.material = new S.MeshFaceMaterial([t2, t7], "", t1, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
  t1 = S.Object3D$();
  t1.position.storage[1] = 100;
  $.parent = t1;
  t1 = $.scene;
  t1.add$1(t1, $.parent);
  S.createText();
  t1 = S.PlaneGeometry$(10000, 10000, null, null);
  t7 = S.Color$(16777215);
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  plane = S.Mesh$(t1, new S.MeshBasicMaterial(t7, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t2, 0, 0.5, 1, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null));
  plane.position.storage[1] = 100;
  plane.rotation.storage[0] = -1.5707963267948966;
  t2 = $.scene;
  t2.add$1(t2, plane);
  t2 = S.WebGLRenderer$(true, true, null, 0, 0, null, "highp", true, false, true);
  t2.setSize$2(window.innerWidth, window.innerHeight);
  t2.setClearColor$2(S.Color$(0), 1);
  $.renderer = t2;
  J.get$nodes$x($.container)._this.appendChild($.renderer.canvas);
  t2 = document;
  t7 = new W._EventStream(t2, C.EventStreamProvider_mousedown._eventType, false);
  H.setRuntimeTypeInfo(t7, [null]);
  t1 = new W._EventStreamSubscription(0, t7._target, t7._eventType, W._wrapZone(S.onDocumentMouseDown$closure), t7._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t7, "_EventStream", 0)]);
  t1._tryResume$0();
  t1 = new W._EventStream(t2, C.EventStreamProvider_touchstart._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t7 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(S.onDocumentTouchStart$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t7, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t7._tryResume$0();
  t7 = new W._EventStream(t2, C.EventStreamProvider_touchmove._eventType, false);
  H.setRuntimeTypeInfo(t7, [null]);
  t1 = new W._EventStreamSubscription(0, t7._target, t7._eventType, W._wrapZone(S.onDocumentTouchMove$closure), t7._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t7, "_EventStream", 0)]);
  t1._tryResume$0();
  t1 = new W._EventStream(t2, C.EventStreamProvider_keypress._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t7 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(S.onDocumentKeyPress$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t7, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t7._tryResume$0();
  t2 = new W._EventStream(t2, C.EventStreamProvider_keydown._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t7 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(S.onDocumentKeyDown$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t7, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t7._tryResume$0();
  t7 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t7, [null]);
  t2 = new W._EventStreamSubscription(0, t7._target, t7._eventType, W._wrapZone(S.onWindowResize$closure), t7._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t7, "_EventStream", 0)]);
  t2._tryResume$0();
},
...
onDocumentKeyDown: function($event) {
  ...
  if (J.get$keyCode$x($event) === 8) {
    $event.preventDefault();
    t1 = $.text;
    $.text = C.JSString_methods.substring$2(t1, 0, t1.length - 1);
    S.refreshText();
    return false;
  }
},
...
onDocumentKeyPress: function($event) {
  var keyCode, ch;
  keyCode = J.get$which$x($event);
  if (keyCode === 8)
    $event.preventDefault();
  else {
    ch = P.String_String$fromCharCode(keyCode);
    $.text = $.text + ch;
    S.refreshText();
  }
},
...
createText: function() {
  var t1, t2, centerOffset;
  $.textGeo = S.TextGeometry_TextGeometry($.text, $.height, false, $.bevelThickness, $.bevelSize, 3, $.bevelEnabled, $.curveSegments, 1, null, null, 0, 1, $.size, $.font, $.weight, $.style);
  t1 = $.textGeo;
  t1.materials = $.material.materials;
  t1.computeBoundingBox$0();
  $.textGeo.computeVertexNormals$0();
  if (!$.bevelEnabled) {
    t1 = $.height;
    t2 = $.size;
    H.IterableMixinWorkaround_forEach($.textGeo.faces, new S.createText_closure(0.1 * (t1 * t2)));
  }
  t1 = $.textGeo;
  t2 = t1.boundingBox;
  centerOffset = -0.5 * (t2.max.storage[0] - t2.min.storage[0]);
  t1 = S.Mesh$(t1, $.material);
  t2 = t1.position.storage;
  t2[0] = centerOffset;
  t2[1] = $.hover;
  t2[2] = 0;
  t2 = t1.rotation.storage;
  t2[0] = 0;
  t2[1] = 6.283185307179586;
  $.textMesh1 = t1;
  t1 = $.parent;
  t1.add$1(t1, $.textMesh1);
  if ($.mirror) {
    t1 = S.Mesh$($.textGeo, $.material);
    t2 = t1.position.storage;
    t2[0] = centerOffset;
    t2[1] = -$.hover;
    t2[2] = $.height;
    t2 = t1.rotation.storage;
    t2[0] = 3.141592653589793;
    t2[1] = 6.283185307179586;
    $.textMesh2 = t1;
    t1 = $.parent;
    t1.add$1(t1, $.textMesh2);
  }
},

refreshText: function() {
  var t1 = $.parent;
  t1.remove$1(t1, $.textMesh1);
  if ($.mirror) {
    t1 = $.parent;
    t1.remove$1(t1, $.textMesh2);
  }
  return;
},
...
onDocumentMouseUp: function($event) {
  H.IterableMixinWorkaround_forEach($.get$_mouseSubscriptions(), new S.onDocumentMouseUp_closure());
},

onDocumentMouseOut: function($event) {
  H.IterableMixinWorkaround_forEach($.get$_mouseSubscriptions(), new S.onDocumentMouseOut_closure());
},
...
onDocumentTouchStart: function($event) {
  ...
  if (J.get$touches$x($event).length === 1) {
    ...
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    t1 = t1[0].get$pageX();
    $.mouseXOnMouseDown = t1.$sub(t1, $.windowHalfX);
    $.targetRotationOnMouseDown = $.targetRotation;
  }
},
...
loadFonts_closure: {"": "Closure;",
  call$1: function(path) {
    var t1 = W.HttpRequest_getString(path, null, null);
    return t1.then$1(t1, new S.loadFonts__closure());
  },
  $is_args1: true
},

loadFonts__closure: {"": "Closure;",
  call$1: function(data) {
    Y.loadFace(C.C_JsonCodec.decode$1(data));
  },
  $is_args1: true
},
...
createText_closure: {"": "Closure;triangleAreaHeuristics_0",
  call$1: function(face) {
    var j, t1;
    if (J.$eq(face.get$materialIndex(), 1)) {
      H.IterableMixinWorkaround_forEach(face.get$vertexNormals(), new S.createText__closure());
      if (N.triangleArea(J.$index$asx($.textGeo.vertices, face.get$a(face)), J.$index$asx($.textGeo.vertices, face.get$b(face)), J.$index$asx($.textGeo.vertices, face.get$c(face))) > this.triangleAreaHeuristics_0)
        for (j = 0; t1 = face.vertexNormals, j < t1.length; ++j)
          t1[j].setFrom$1(face.normal);
    }
  },
  $is_args1: true
},

createText__closure: {"": "Closure;",
  call$1: function(normal) {
    var t1 = J.getInterceptor$x(normal);
    t1.set$z(normal, 0);
    t1.normalize$0(normal);
  },
  $is_args1: true
},

onDocumentMouseUp_closure: {"": "Closure;",
  call$1: function(s) {
    J.cancel$0$x(s);
  },
  $is_args1: true
...
onDocumentMouseOut_closure: {"": "Closure;",
  call$1: function(s) {
    J.cancel$0$x(s);
  },
  $is_args1: true
...
init.globalFunctions.onDocumentKeyDown$closure = S.onDocumentKeyDown$closure = new H.Closure$1(S.onDocumentKeyDown, "onDocumentKeyDown$closure");
init.globalFunctions.onDocumentKeyPress$closure = S.onDocumentKeyPress$closure = new H.Closure$1(S.onDocumentKeyPress, "onDocumentKeyPress$closure");
...
Isolate.$lazy($, "_faces", "_faces", "get$_faces", function() {
...
Isolate.$lazy($, "_mouseSubscriptions", "_mouseSubscriptions", "get$_mouseSubscriptions", function() {
  return [];
});
// Native classes
...
//# sourceMappingURL=web_gl_geometry_text.dart.js.map
//@ sourceMappingURL=web_gl_geometry_text.dart.js.map
