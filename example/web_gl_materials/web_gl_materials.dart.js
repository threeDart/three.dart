...
InputElement: {"": "HtmlElement;height%,name=,type=,value%,width%", "%": "HTMLInputElement"},
...
Color: {"": "Object;_r,_g,_b",
  ...
  setHSV$3: function(h, s, v) {
    ...
    if (v === 0) {
      ...
      t1 = h * 6;
      i = C.JSNumber_methods.toInt$0(Math.floor(t1));
      f = t1 - i;
      p = v * (1 - s);
      q = v * (1 - s * f);
      t = v * (1 - s * (1 - f));
...
Face: {"": "Object;normal@,vertexColors<,color>,materialIndex@,centroid<",
...
MeshDepthMaterial: {"": "Material;_parameters,shading<,wireframe<,wireframeLinewidth<,name,id,side,opacity,blending,blendSrc,blendDst,blendEquation,alphaTest,polygonOffset,polygonOffsetFactor,polygonOffsetUnits,transparent,depthTest,depthWrite,overdraw,visible,needsUpdate,__data", $isMeshDepthMaterial: true},
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  sortFacesByMaterial$2: function(geometry, material) {
    var hash_map, t1, usesFaceMaterial, fl, f, t2, face, materialIndex, groupHash, vertices, t3, t4;
    hash_map = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    t1 = geometry._geometry;
    t1.morphNormals;
    usesFaceMaterial = !!material.$isMeshFaceMaterial;
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    var object, t1, shaderID, t2, maxLightCount, maxShadows, maxBones, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, t32, t33, attributes, i;
    object = webglobject.get$object();
    t1 = material._material;
    if (!!t1.$isMeshDepthMaterial)
      shaderID = "depth";
    ...
    if (shaderID != null) {
      t2 = S.ShaderLib();
      this.setMaterialShaders$2(material, t2.$index(t2, shaderID));
    }
  ...
  setProgram$5: function(camera, lights, fog, material, object) {
    ...
    if (refreshMaterial) {
      ...
      else if (!!t1.$isMeshDepthMaterial) {
  ...
  refreshUniformsCommon$2: function(uniforms, material) {
    var t1, t2, t3, t4, uvScaleMap, offset, repeat, t5, t6;
    t1 = material._material;
  ...
  setupLights$2: function(program, lights) {
    ...
    for (t1 = this.gammaInput, t2 = J.getInterceptor$asx(pointColors), t3 = J.getInterceptor$asx(pointPositions), t4 = J.getInterceptor$asx(dirColors), t5 = J.getInterceptor$asx(dirPositions), l = 0, r = 0, g = 0, b = 0, color = null, skyColor = null, groundColor = null, intensity = null, intensitySq = null, position = null, distance = null, dirLength = 0, pointLength = 0, spotLength = 0, hemiLength = 0, dirCount = 0, pointCount = 0, spotCount = 0, hemiCount = 0, dirOffset = 0, pointOffset = 0, spotOffset = 0, hemiOffset = 0; l < ll; ++l) {
      ...
      if (typeof light === "object" && light !== null && !!t6.$isAmbientLight) {
        if (!light.visible)
          continue;
        t6 = J.getInterceptor$x(color);
        if (t1) {
          r += t6.get$r(color) * t6.get$r(color);
  ...
  setTexture$2: function(texture, slot) {
    var t1, image, isImagePowerOfTwo, glFormat, glType, mipmaps, i, mipmap, t2;
...
WebGLMaterial: {"": "Object;_material,program<,_fragmentShader,_vertexShader,_uniforms,uniformsList,numSupportedMorphTargets,numSupportedMorphNormals,shadowPass?",
  ...
  get$needsNormals: function() {
    ...
    if (!!t1.$isMeshBasicMaterial)
      ...
      t2 = false;
    return !(t2 || !!t1.$isMeshDepthMaterial);
  },
  get$id: function(_) {
...
["", "web_gl_materials.dart", , V, {
main: function() {
  V.init();
  var t1 = window;
  C.Window_methods._ensureRequestAnimationFrame$0(t1);
  C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(V.animate$closure));
  V.render();
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, geometry, i, line, texture, geometry_smooth, geometry_flat, geometry_pieces, l, material, sphere, directionalLight;
  ...
  $.camera = t16;
  $.camera.position.setValues$3(0, 200, 800);
  $.scene = S.Scene$();
  t16 = S.Color$(3158064);
  t15 = $.MaterialCount;
  $.MaterialCount = t15 + 1;
  ...
  line = S.Line$(geometry, new S.LineBasicMaterial(t16, 1, "round", "round", true, false, "", t15, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), 1);
  t1 = $.scene;
  t1.add$1(t1, line);
  texture = S.Texture$(V.generateTexture(), null, 1, 1, 6, 8, 18, 10, 1);
  ...
  t6 = $.MaterialCount;
  $.MaterialCount = t6 + 1;
  t1.push(new S.MeshLambertMaterial(null, t2, t3, t4, false, t5, texture, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t6, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null));
  t6 = S.Color$(14540253);
  t5 = S.Color$(16777215);
  t4 = S.Color$(0);
  t2 = new Float32Array(3);
  ...
  t3 = $.MaterialCount;
  $.MaterialCount = t3 + 1;
  t1.push(new S.MeshLambertMaterial(null, t6, t5, t4, false, t2, null, null, null, null, 0, 1, 0.98, 1, false, 1, "round", "round", false, false, false, 0, true, "", t3, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t3 = S.Color$(14540253);
  t2 = S.Color$(197379);
  t4 = S.Color$(0);
  t5 = S.Color$(39168);
  ...
  t7 = $.MaterialCount;
  $.MaterialCount = t7 + 1;
  t7 = new S.MeshPhongMaterial(t3, t2, t4, t5, 30, false, false, false, t6, null, null, null, 1, null, null, null, null, 0, 1, 0.98, 1, false, 1, "round", "round", false, false, false, 0, true, "", t7, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
  ...
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  t1.push(new S.MeshNormalMaterial(1, false, 1, null, null, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t2 = S.Color$(16755200);
  t3 = $.MaterialCount;
  $.MaterialCount = t3 + 1;
  t1.push(new S.MeshBasicMaterial(t2, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t3, 0, 1, 2, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null));
  t3 = S.Color$(14540253);
  t2 = S.Color$(16777215);
  t4 = S.Color$(0);
  t5 = new Float32Array(3);
  ...
  t6 = $.MaterialCount;
  $.MaterialCount = t6 + 1;
  t1.push(new S.MeshLambertMaterial(null, t3, t2, t4, false, t5, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t6, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t6 = S.Color$(14540253);
  t5 = S.Color$(197379);
  t4 = S.Color$(0);
  t2 = S.Color$(39168);
  ...
  t7 = $.MaterialCount;
  $.MaterialCount = t7 + 1;
  t7 = new S.MeshPhongMaterial(t6, t5, t4, t2, 30, false, false, false, t3, texture, null, null, 1, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t7, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null);
  if (t7.normalScale == null) {
    t2 = new Float32Array(2);
    t2.$dartCachedLength = t2.length;
    t2 = new T.Vector2(t2);
  ...
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  t1.push(new S.MeshNormalMaterial(2, false, 1, null, null, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t2 = S.Color$(16755200);
  t3 = $.MaterialCount;
  $.MaterialCount = t3 + 1;
  t1.push(new S.MeshBasicMaterial(t2, null, null, null, null, 0, 1, 0.98, 2, true, 1, "round", "round", false, false, 0, true, "", t3, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t3 = $.MaterialCount;
  $.MaterialCount = t3 + 1;
  t1.push(new S.MeshDepthMaterial(null, 2, false, 1, "", t3, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t3 = S.Color$(6710886);
  t2 = S.Color$(0);
  t4 = S.Color$(16711680);
  t5 = new Float32Array(3);
  ...
  t7 = $.MaterialCount;
  $.MaterialCount = t7 + 1;
  t7 = new S.MeshPhongMaterial(t6, t5, t4, t2, 10, false, false, false, t3, null, null, null, 1, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t7, 0, 0.9, 1, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null);
  if (t7.normalScale == null) {
    t2 = new Float32Array(2);
    t2.$dartCachedLength = t2.length;
    t2 = new T.Vector2(t2);
  ...
  t3 = $.MaterialCount;
  $.MaterialCount = t3 + 1;
  t1.push(new S.MeshBasicMaterial(t2, texture, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t3, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null));
  geometry_smooth = S.SphereGeometry$(70, 32, 16, 0, 6.283185307179586, 0, 3.141592653589793);
  geometry_flat = S.SphereGeometry$(70, 32, 16, 0, 6.283185307179586, 0, 3.141592653589793);
  geometry_pieces = S.SphereGeometry$(70, 32, 16, 0, 6.283185307179586, 0, 3.141592653589793);
  H.IterableMixinWorkaround_forEach(geometry_pieces.faces, new V.init_closure(C.C__Random));
  geometry_pieces.materials = $.get$materials();
  t3 = $.get$materials();
  t2 = $.get$materials();
  t1 = $.MaterialCount;
  $.MaterialCount = t1 + 1;
  t3.push(new S.MeshFaceMaterial(t2, "", t1, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  $.objects = [];
  for (l = $.get$materials().length, i = 0; i < l; ++i) {
    t1 = $.get$materials();
    if (i >= t1.length)
      throw H.ioore(t1, i);
    material = t1[i];
    if (!!material.$isMeshFaceMaterial)
      geometry = geometry_pieces;
    else
      geometry = material.get$shading() === 1 ? geometry_flat : geometry_smooth;
    sphere = S.Mesh$(geometry, material);
    t1 = sphere.position;
    t1 = t1.storage;
    t1[0] = C.JSInt_methods.$mod(i, 4) * 200 - 400;
    t1[2] = C.JSNumber_methods.toInt$0(Math.floor(i / 4)) * 200 - 200;
    t1 = sphere.rotation;
    t1.storage[0] = (Math.random() * 200 >>> 0) - 100;
    t1 = sphere.rotation;
    t1.storage[1] = (Math.random() * 200 >>> 0) - 100;
    t1 = sphere.rotation;
    t1.storage[2] = (Math.random() * 200 >>> 0) - 100;
    $.objects.push(sphere);
    t1 = $.scene;
    t1.add$1(t1, sphere);
  }
  t1 = S.SphereGeometry$(4, 8, 8, 0, 6.283185307179586, 0, 3.141592653589793);
  t2 = S.Color$(16777215);
  t3 = $.MaterialCount;
  $.MaterialCount = t3 + 1;
  $.particleLight = S.Mesh$(t1, new S.MeshBasicMaterial(t2, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t3, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t3 = $.scene;
  t3.add$1(t3, $.particleLight);
  t3 = $.scene;
  t2 = S.Color$(1118481);
  t1 = $.Object3DCount;
  $.Object3DCount = t1 + 1;
  ...
  t11 = new T.Matrix4(t11);
  t11.setIdentity$0();
  t12 = T.Quaternion$identity();
  t13 = new Float32Array(3);
  t13.$dartCachedLength = t13.length;
  t3.add$1(t3, new S.AmbientLight(t2, t1, "", t4, null, [], t5, t6, t7, t8, "XYZ", null, null, null, true, null, t9, t10, t11, true, true, t12, false, 0, 1, true, false, false, true, new T.Vector3(t13), null, null));
  directionalLight = S.DirectionalLight$(16777215, 0.125, 0);
  directionalLight.position.storage[0] = Math.random() - 0.5;
  directionalLight.position.storage[1] = Math.random() - 0.5;
  directionalLight.position.storage[2] = Math.random() - 0.5;
  t13 = directionalLight.position;
  t13.normalize$0(t13);
  t13 = $.scene;
  t13.add$1(t13, directionalLight);
  t13 = S.Color$(16777215);
  t12 = $.Object3DCount;
  $.Object3DCount = t12 + 1;
  ...
  t4 = new T.Matrix4(t4);
  t4.setIdentity$0();
  t1 = T.Quaternion$identity();
  t2 = new Float32Array(3);
  t2.$dartCachedLength = t2.length;
  t2 = new S.PointLight(null, 1, 0, t13, t12, "", t11, null, [], t10, t9, t8, t7, "XYZ", null, null, null, true, null, t6, t5, t4, true, true, t1, false, 0, 1, true, false, false, true, new T.Vector3(t2), null, null);
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  t2._three$_position = new T.Vector3(t1);
  $.pointLight = t2;
  t2 = $.scene;
  t2.add$1(t2, $.pointLight);
  ...
  t2 = $.container;
  t2.toString;
  new W._ChildNodeListLazy(t2)._this.appendChild($.renderer.canvas);
  t2 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(V.onWindowResize$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
},
...
generateTexture: function() {
  var canvas, t1, context, image, l, y, i, j, x, t2, t3, t4;
  canvas = W.CanvasElement_CanvasElement(null, null);
  t1 = J.getInterceptor$x(canvas);
  t1.set$width(canvas, 256);
  t1.set$height(canvas, 256);
  context = t1.get$context2D(canvas);
  image = P.convertNativeToDart_ImageData(context.getImageData(0, 0, 256, 256));
  for (t1 = J.getInterceptor$x(image), l = C.JS_CONST_ZYJ(t1.get$data(image)), y = 0, i = 0, j = 0; i < l; i += 4, ++j) {
    x = C.JSInt_methods.$mod(j, 256);
    if (x === 0)
      ++y;
    t2 = t1.get$data(image);
    if (i >= C.JS_CONST_ZYJ(t2))
      throw H.ioore(t2, i);
    t2[i] = 255;
    t2 = t1.get$data(image);
    t3 = i + 1;
    if (t3 >= C.JS_CONST_ZYJ(t2))
      throw H.ioore(t2, t3);
    t2[t3] = 255;
    t3 = t1.get$data(image);
    t2 = i + 2;
    ...
    t2 = t1.get$data(image);
    t3 = i + 3;
    t4 = C.JSNumber_methods.toInt$0(Math.floor((x ^ y) >>> 0));
    if (t3 >= C.JS_CONST_ZYJ(t2))
      throw H.ioore(t2, t3);
    t2[t3] = t4;
  }
  C.CanvasRenderingContext2D_methods.putImageData$3(context, image, 0, 0);
  return canvas;
},
...
render: function() {
  var timer, t1, t2, t3;
  timer = 0.0001 * P.DateTime$_now().millisecondsSinceEpoch;
  t1 = $.camera.position;
  t1.storage[0] = Math.cos(timer) * 1000;
  t1 = $.camera.position;
  t1.storage[2] = Math.sin(timer) * 1000;
  $.camera.lookAt$1($.scene.position);
  t1 = $.objects;
  t1.toString;
  H.IterableMixinWorkaround_forEach(t1, new V.render_closure());
  t1 = $.get$materials();
  t2 = $.get$materials().length - 3;
  if (t2 < 0 || t2 >= t1.length)
    throw H.ioore(t1, t2);
  t2 = t1[t2].get$emissive();
  t1 = 35 * timer;
  t2.setHSV$3(0.54, 1, 0.7 * (0.5 + 0.5 * Math.sin(t1)));
  t2 = $.get$materials();
  t3 = $.get$materials().length - 4;
  if (t3 < 0 || t3 >= t2.length)
    throw H.ioore(t2, t3);
  t3 = t2[t3].get$emissive();
  t3.setHSV$3(0.04, 1, 0.7 * (0.5 + 0.5 * Math.cos(t1)));
  t1 = $.particleLight.position;
  t1 = t1.storage;
  t1[0] = Math.sin(timer * 7) * 300;
  t1[1] = Math.cos(timer * 5) * 400;
  t1[2] = Math.cos(timer * 3) * 300;
  t1 = $.pointLight.position;
  t2 = $.particleLight.position.storage;
  t1 = t1.storage;
  t1[0] = t2[0];
  t1[1] = t2[1];
  t1[2] = t2[2];
...
init_closure: {"": "Closure;rnd_0",
  call$1: function(face) {
    face.set$materialIndex(this.rnd_0.nextInt$1($.get$materials().length));
  },
  $is_args1: true
},
...
render_closure: {"": "Closure;",
  call$1: function(object) {
    var t1 = object.get$rotation().storage;
    t1[0] = t1[0] + 0.01;
    t1 = object.rotation.storage;
    t1[1] = t1[1] + 0.005;
  },
  $is_args1: true
}},
...
init.globalFunctions.onWindowResize$closure = V.onWindowResize$closure = new H.Closure$1(V.onWindowResize, "onWindowResize$closure");
init.globalFunctions.animate$closure = V.animate$closure = new H.Closure$1(V.animate, "animate$closure");
...
Isolate.$lazy($, "materials", "materials", "get$materials", function() {
  return [];
});
// Native classes
...
//# sourceMappingURL=web_gl_materials.dart.js.map
//@ sourceMappingURL=web_gl_materials.dart.js.map
