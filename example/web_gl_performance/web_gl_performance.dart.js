...
Matrix: {"": "Interceptor;a=,b=,c=", "%": "SVGMatrix"},
    ...
    for (t1 = this._frustum, i = 0, j = null, jl = null, shadowMap = null, shadowMatrix = null, shadowCamera = null, buffer = null, material = null, webglObject = null, object = null, renderList = null; i < il; ++i) {
      ...
      for (; j < jl; ++j) {
        ...
        if (t4.get$visible(object) === true && object.get$castShadow())
          if (typeof object !== "object" || object === null || !t4.$isMesh || !object.frustumCulled || t1.contains$1(t1, object)) {
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  initMeshBuffers$2: function(geometryGroup, object) {
    var t1, t2, t3, geometry, faces3, faces4, t4, t5, nvertices, material, uvType, normalType, vertexColorType, t6, t7, ml, m;
    t1 = object.object;
    t2 = J.getInterceptor(t1);
    t3 = typeof t1 !== "object" || t1 === null || !t2.$isMesh;
    geometry = typeof t1 === "object" && t1 !== null && !!t2.$isMesh || typeof t1 === "object" && t1 !== null && !!t2.$isLine ? t1.get$geometry() : null;
    ...
    t6 = nvertices * 3;
    t7 = new Float32Array(t6);
    t7.$dartCachedLength = t7.length;
    geometryGroup.__vertexArray = t7;
    if (normalType !== 0) {
      t7 = new Float32Array(t6);
      t7.$dartCachedLength = t7.length;
      geometryGroup.__normalArray = t7;
    }
    if (geometry.hasTangents) {
      t7 = new Float32Array(nvertices * 4);
      t7.$dartCachedLength = t7.length;
      geometryGroup.__tangentArray = t7;
    }
    if (vertexColorType === true) {
      t7 = new Float32Array(t6);
      t7.$dartCachedLength = t7.length;
      geometryGroup.__colorArray = t7;
    }
    if (uvType) {
      if (geometry.faceUvs.length > 0 || geometry.faceVertexUvs.length > 0) {
        t7 = new Float32Array(nvertices * 2);
        t7.$dartCachedLength = t7.length;
        geometryGroup.__uvArray = t7;
      }
      if (geometry.faceUvs.length > 1 || geometry.faceVertexUvs.length > 1) {
        t7 = new Float32Array(nvertices * 2);
        t7.$dartCachedLength = t7.length;
        geometryGroup.__uv2Array = t7;
      }
    }
    if ((typeof t1 === "object" && t1 !== null && !!t2.$isMesh || typeof t1 === "object" && t1 !== null && !!t2.$isLine ? t1.get$geometry() : null).skinWeights.length !== 0)
      t1 = (typeof t1 === "object" && t1 !== null && !!t2.$isMesh || typeof t1 === "object" && t1 !== null && !!t2.$isLine ? t1.get$geometry() : null).skinIndices.length !== 0;
    else
      t1 = false;
    if (t1) {
      t1 = nvertices * 4;
  ...
  setMeshBuffers$5: function(geometryGroup, object, hint, dispose, material) {
    ...
    t2 = J.getInterceptor(t1);
    t3 = typeof t1 !== "object" || t1 === null || !t2.$isMesh;
    if ((typeof t1 === "object" && t1 !== null && !!t2.$isMesh || typeof t1 === "object" && t1 !== null && !!t2.$isLine ? t1.get$geometry() : null) != null) {
      t1 = typeof t1 === "object" && t1 !== null && !!t2.$isMesh || typeof t1 === "object" && t1 !== null && !!t2.$isLine ? t1.get$geometry() : null;
      if (t1.__data == null)
    ...
    if (dirtyMorphTargets === true) {
      ...
      for (n1 = null, n2 = null, n3 = null, n4 = null, vk = 0, vka = null, nka = null, chf = null, faceVertexNormals = null; vk < vkl; ++vk) {
        ...
        for (f = 0, offset_morphTarget = 0; f < fl; ++f) {
          ...
          v1 = J.$index$asx(morphTargets[vk].vertices, face.get$a(face));
          if (vk >= morphTargets.length)
            throw H.ioore(morphTargets, vk);
          v2 = J.$index$asx(morphTargets[vk].vertices, face.get$b(face));
          if (vk >= morphTargets.length)
            throw H.ioore(morphTargets, vk);
          v3 = J.$index$asx(morphTargets[vk].vertices, face.get$c(face));
          ...
          if (material.get$morphNormals() === true) {
            ...
            if (needsSmoothNormals) {
              ...
              t8 = t8.get$vertexNormals();
              faceVertexNormals = t8.$index(t8, chf);
        ...
        for (f = 0; f < fl; ++f) {
          ...
          if (vk >= morphTargets.length)
            throw H.ioore(morphTargets, vk);
          v4 = J.$index$asx(morphTargets[vk].vertices, face.get$d(face));
          if (vk >= morphTargetsArrays.length)
            throw H.ioore(morphTargetsArrays, vk);
          vka = morphTargetsArrays[vk];
          t2 = J.getInterceptor$x(v1);
          ...
          if (material.get$morphNormals() === true) {
            ...
            if (needsSmoothNormals) {
              if (vk >= 0)
                throw H.ioore(morphNormals, vk);
              t11 = t11.get$vertexNormals();
              faceVertexNormals = t11.$index(t11, chf);
              n1 = faceVertexNormals.get$a(faceVertexNormals);
              n2 = faceVertexNormals.get$b(faceVertexNormals);
              n3 = faceVertexNormals.get$c(faceVertexNormals);
    ...
    if (obj_skinWeights.length !== 0) {
      ...
      for (f = 0; f < fl; ++f) {
        ...
        if (0 >= t4)
          throw H.ioore(t15, 0);
        t19 = t15[0];
        t20 = obj_skinIndices.length;
        if (t19 >>> 0 !== t19 || t19 >= t20)
          throw H.ioore(obj_skinIndices, t19);
        ...
        if (3 >= t4)
          throw H.ioore(t15, 3);
        t15 = t15[3];
        if (t15 >>> 0 !== t15 || t15 >= t20)
          throw H.ioore(obj_skinIndices, t15);
        si4 = obj_skinIndices[t15];
        t15 = si1.storage;
        t20 = t15[0];
        t4 = C.JS_CONST_ZYJ(skinIndexArray);
        if (offset_skin >= t4)
          throw H.ioore(skinIndexArray, offset_skin);
        skinIndexArray[offset_skin] = t20;
        t20 = t15[1];
        if (t3 >= t4)
          throw H.ioore(skinIndexArray, t3);
        skinIndexArray[t3] = t20;
        t20 = t15[2];
        if (t5 >= t4)
          throw H.ioore(skinIndexArray, t5);
        skinIndexArray[t5] = t20;
        t15 = t15[3];
        if (t6 >= t4)
          throw H.ioore(skinIndexArray, t6);
  ...
  _render$4$forceClear$renderTarget: function(scene, c, forceClear, renderTarget) {
    ...
    for (; i < il; ++i) {
      ...
      if (t4.get$visible(object) === true)
        if (!(typeof object === "object" && object !== null && !!t4.$isMesh || false) || !object.get$frustumCulled() || t1.contains$1(t1, object)) {
  ...
  renderObjectsImmediate$7: function(renderList, materialType, camera, lights, fog, useBlending, overrideMaterial) {
    var t1, il, material, i, webglObject, material0;
    t1 = J.getInterceptor$asx(renderList);
    il = t1.get$length(renderList);
    if (typeof il !== "number")
      throw H.iae(il);
  ...
  sortFacesByMaterial$2: function(geometry, material) {
    var hash_map, t1, numMorphTargets, fl, f, t2, face, groupHash, vertices, t3, t4;
    ...
    for (f = 0; f < fl; ++f) {
      ...
      if (t2.$index(t2, groupHash) == null) {
        t2 = geometry.geometryGroups;
        t2.$indexSet(t2, groupHash, new S.WebGLGeometry(null, 0, [], [], H.Primitives_parseInt("0", null, null), numMorphTargets, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null));
      }
      t2 = face.indices;
      vertices = t2.length;
  ...
  addObject$2: function(object, scene) {
    ...
    if (!webglobject.__webglInit) {
      ...
      t2.$dartCachedLength = t2.length;
      webglobject._normalMatrix = new T.Matrix3(t2);
      ...
      if (typeof object === "object" && object !== null && !!t1.$isMesh) {
        ...
        t2 = object.geometry;
        t3 = J.getInterceptor(t2);
        if (typeof t2 === "object" && t2 !== null && !!t3.$isGeometry && true) {
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    ...
    if (!!t1.$isMeshNormalMaterial)
      shaderID = "normal";
    else if (!!t1.$isMeshBasicMaterial)
      shaderID = "basic";
  ...
  setProgram$5: function(camera, lights, fog, material, object) {
    ...
    if (refreshMaterial) {
      ...
      else if (!!t1.$isMeshNormalMaterial)
        J.set$value$x(m_uniforms.$index(m_uniforms, "opacity"), t1.opacity);
...
main: function() {
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(M.onDocumentMouseMove$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  M.init();
  t2 = window;
  C.Window_methods._ensureRequestAnimationFrame$0(t2);
  C.Window_methods._requestAnimationFrame$1(t2, W._wrapZone(M.animate$closure));
  M.render();
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, loader;
  ...
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  t16 = new S.PerspectiveCamera(60, t1 / t2, null, null, null, null, null, null, t3, t4, t5, 1, 10000, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  t16.updateProjectionMatrix$0();
  $.camera = t16;
  $.camera.position.storage[2] = 3200;
  $.scene = S.Scene$();
  t16 = $.MaterialCount;
  $.MaterialCount = t16 + 1;
  loader = new S.JSONLoader(null, null, null, null, "anonymous");
  loader.Loader$1(false);
  loader.load$2(loader, "obj/Suzanne.js", new M.init_closure(new S.MeshNormalMaterial(2, false, 1, null, null, "", t16, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null)));
  $.renderer = S.WebGLRenderer$(true, true, null, 0, 16777215, null, "highp", true, false, true);
  $.renderer.setSize$2(window.innerWidth, window.innerHeight);
  J.add$1$ax(J.get$children$x($.container), $.renderer.canvas);
  t1 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(M.onWindowResize$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
},
...
render: function() {
  ...
  t3 = t2[1];
  t2[1] = t3 + (-$.mouseY - t3) * 0.05;
  t1.lookAt$1($.scene.position);
  for (il = $.get$objects().length, i = 0; i < il; ++i) {
    t1 = $.get$objects();
    if (i >= t1.length)
      throw H.ioore(t1, i);
    t1 = t1[i].rotation.storage;
    t1[0] = t1[0] + 0.01;
    t1 = $.get$objects();
    if (i >= t1.length)
      throw H.ioore(t1, i);
...
init_closure: {"": "Closure;material_0",
  call$1: function(geometry) {
    var t1, i, mesh, t2, t3;
    geometry.computeVertexNormals$0();
    for (t1 = this.material_0, i = 0; i < 5000; ++i) {
      mesh = S.Mesh$(geometry, t1);
      mesh.position.storage[0] = Math.random() * 8000 - 4000;
      mesh.position.storage[1] = Math.random() * 8000 - 4000;
      mesh.position.storage[2] = Math.random() * 8000 - 4000;
      mesh.rotation.storage[0] = Math.random() * 360 * 0.017453292519943295;
      mesh.rotation.storage[1] = Math.random() * 360 * 0.017453292519943295;
      t2 = Math.random() * 50 + 100;
      t3 = mesh.scale.storage;
      t3[2] = t2;
      t3[1] = t2;
      t3[0] = t2;
      $.get$objects().push(mesh);
      t2 = $.scene;
      t2.add$1(t2, mesh);
    }
  },
...
init.globalFunctions.onDocumentMouseMove$closure = M.onDocumentMouseMove$closure = new H.Closure$1(M.onDocumentMouseMove, "onDocumentMouseMove$closure");
...
//# sourceMappingURL=web_gl_performance.dart.js.map
//@ sourceMappingURL=web_gl_performance.dart.js.map
