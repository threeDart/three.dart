...
InputElement: {"": "HtmlElement;height%,name=,type=,value%,width%", $isNode: true, "%": "HTMLInputElement"},
...
CurvePath: {"": "Curve;",
  ...
  getTransformedPoints$2$bends: function(segments, bends) {
    ...
    if (bends == null)
      bends = this._bends;
    for (bends.length, i = 0; false; ++i) {
      if (i >= 0)
        throw H.ioore(bends, i);
...
Path: {"": "CurvePath;useSpacedPoints,_points,actions,curves,_bends,autoClose,cacheLengths,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  ...
  getPoints$2: function(divisions, closedPath) {
    var points, i, cpx, cpy, cpx2, cpy2, cpx1, cpy1, cpx0, cpy0, laste, j, t, tx, ty, t1, t2, item, args, t3, t4, k, last, spts, n, spline, aX, aY, aRadius, aStartAngle, aEndAngle, deltaAngle, tdivisions, t5, angle, t6, t7, xRadius, yRadius, t8, lastPoint;
    ...
    for (i = 0, cpx = null, cpy = null, cpx2 = null, cpy2 = null, cpx1 = null, cpy1 = null, cpx0 = null, cpy0 = null, laste = null, j = null, t = null, tx = null, ty = null; t1 = this.actions, t2 = t1.length, i < t2; ++i) {
      ...
      switch (item.action) {
        ...
        case "arc":
          ...
          for (t1 = J.getInterceptor$ns(aY), t2 = J.getInterceptor$n(aRadius), t4 = J.getInterceptor$ns(aX), t5 = J.getInterceptor$ns(aStartAngle), t3 = t3 !== true, j = 1; j <= tdivisions; ++j) {
            t = j / tdivisions;
            if (t3)
              t = 1 - t;
            if (typeof deltaAngle !== "number")
        ...
        case "ellipse":
          ...
          if (typeof divisions !== "number")
            throw divisions.$mul();
          tdivisions = divisions * 2;
          for (t2 = J.getInterceptor$n(yRadius), t3 = J.getInterceptor$ns(aY), t4 = J.getInterceptor$n(xRadius), t5 = J.getInterceptor$ns(aX), t6 = J.getInterceptor$ns(aStartAngle), t1 = t1 !== true, j = 1; j <= tdivisions; ++j) {
            t = j / tdivisions;
            if (t1)
              t = 1 - t;
            if (typeof deltaAngle !== "number")
...
ShapeGeometry: {"": "Geometry;shapes,shapebb,id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  addShapeList$4: function(shapes, curveSegments, material, UVGenerator) {
    var sl, s;
    sl = shapes.length;
    for (s = 0; s < sl; ++s) {
      if (s >= shapes.length)
        throw H.ioore(shapes, s);
      this.addShape$4(shapes[s], curveSegments, material, UVGenerator);
    }
  },
  addShape$4: function(shape, curveSegments, material, UVGenerator) {
    var uvgen, shapesOffset, shapePoints, vertices, holes, t1, i, t2, hole, faces, vertices0, vlen, flen, vert, t3, t4, t5, t6, face, a, b, c;
    uvgen = new S.ExtrudeGeometryWorldUVGenerator();
    shapesOffset = J.get$length$asx(this.vertices);
    shapePoints = shape.extractPoints$1(curveSegments);
    vertices = shapePoints.$index(shapePoints, "shape");
    holes = shapePoints.$index(shapePoints, "holes");
    if (!(Y.area(vertices) < 0)) {
      vertices = J.toList$0$ax(J.get$reversed$ax(vertices));
      t1 = J.getInterceptor$asx(holes);
      i = 0;
      while (true) {
        t2 = t1.get$length(holes);
        ...
        if (!(i < t2))
          break;
        hole = t1.$index(holes, i);
        if (Y.area(hole) < 0)
          t1.$indexSet(holes, i, J.toList$0$ax(J.get$reversed$ax(hole)));
        ++i;
      }
    }
    ...
    while (true) {
      ...
      C.JSArray_methods.addAll$1(vertices0, hole);
      ++i;
    }
    t1 = J.getInterceptor$asx(vertices0);
    vlen = t1.get$length(vertices0);
    flen = faces.length;
    J.get$length$asx(vertices);
    if (typeof vlen !== "number")
      throw H.iae(vlen);
    i = 0;
    for (; i < vlen; ++i) {
      vert = t1.$index(vertices0, i);
      t2 = this.vertices;
      t3 = J.getInterceptor$x(vert);
      t4 = J.toDouble$0$n(t3.get$x(vert));
      t3 = J.toDouble$0$n(t3.get$y(vert));
      t5 = new Float32Array(3);
      t5.$dartCachedLength = t5.length;
      t5 = new T.Vector3(t5);
      t6 = t5.storage;
    ...
    for (t1 = this.faceVertexUvs, i = 0; i < flen; ++i) {
      if (i >= faces.length)
        throw H.ioore(faces, i);
      face = faces[i];
      t2 = J.getInterceptor$asx(face);
      a = J.$add$ns(t2.$index(face, 0), shapesOffset);
      b = J.$add$ns(t2.$index(face, 1), shapesOffset);
      c = J.$add$ns(t2.$index(face, 2), shapesOffset);
      t2 = this.faces;
      t3 = [a, b, c];
      t4 = new S.Face3(t3, null, null, null, null, null, material, null);
      t4.Face$4(t3, null, null, material);
      t2.push(t4);
      t1[0].push(uvgen.generateTopUV$6(this, shape, null, a, b, c));
    }
  },
  ShapeGeometry$4$UVGenerator$curveSegments$material: function(shapes, UVGenerator, curveSegments, material) {
    this.shapebb = C.JSArray_methods.get$last(this.shapes).getBoundingBox$0();
    this.addShapeList$4(this.shapes, curveSegments, material, UVGenerator);
    this.computeCentroids$0();
    this.computeFaceNormals$0();
  },
  static: {
ShapeGeometry$: function(shapes, UVGenerator, curveSegments, material) {
  var t1, t2;
  t1 = $.GeometryCount;
  $.GeometryCount = t1 + 1;
  t2 = [];
  H.setRuntimeTypeInfo(t2, [T.Vector3]);
  t2 = new S.ShapeGeometry(shapes, null, t1, "", t2, [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, null);
  t2.ShapeGeometry$4$UVGenerator$curveSegments$material(shapes, UVGenerator, curveSegments, material);
  return t2;
}}
...
Face: {"": "Object;normal@,vertexColors<,color>,centroid<",
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  setupMorphTargets$3: function(material, geometryGroup, object) {
    ...
    for (t1 = material._material, t2 = !!t1.$isShaderMaterial, influenceIndex = null, m = 0; m < material.numSupportedMorphTargets;) {
      ...
      if (t4) {
        ...
        if (influenceIndex >>> 0 !== influenceIndex || influenceIndex >= t4.length)
          throw H.ioore(t4, influenceIndex);
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    var object, t1, shaderID, maxLightCount, maxShadows, maxBones, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, attributes, i;
    object = webglobject.get$object();
  ...
  setProgram$5: function(camera, lights, fog, material, object) {
    var t1, program, p_uniforms, t2, m_uniforms, t3, refreshMaterial, t4;
  ...
  refreshUniformsCommon$2: function(uniforms, material) {
    ...
    if (t4)
      ...
      t5 = true;
    J.set$value$x(t3, t5 ? t1.get$map(t1) : null);
    t3 = uniforms.$index(uniforms, "lightMap");
    if (t4)
      t5 = false;
    else
      t5 = true;
    J.set$value$x(t3, t5 ? t1.get$lightMap() : null);
    t3 = uniforms.$index(uniforms, "specularMap");
    if (t4)
      t5 = false;
    else
      t5 = true;
    J.set$value$x(t3, t5 ? t1.get$specularMap() : null);
    if (t4)
      t3 = false;
    else
      t3 = true;
    ...
    if (t3)
      ;
    t3 = uniforms.$index(uniforms, "envMap");
    if (t4)
      t5 = false;
    else
      t5 = true;
    J.set$value$x(t3, t5 ? t1.get$envMap() : null);
    t3 = uniforms.$index(uniforms, "flipEnvMap");
    if (t4)
      t5 = false;
    else
      t5 = true;
    ...
    J.set$value$x(uniforms.$index(uniforms, "combine"), t1.combine);
...
init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, fontshapes;
  ...
  $.camera = t16;
  t16 = $.camera;
  t16.position.storage[2] = 1200;
  t15 = $.scene;
  t15.add$1(t15, t16);
  fontshapes = Y.generateShapes("Hello world", 100, 4, "helvetiker", "normal", "normal");
  t16 = S.Color$(16711680);
  t15 = $.MaterialCount;
  $.MaterialCount = t15 + 1;
  $.fontmesh = S.Mesh$(S.ShapeGeometry$(fontshapes, null, 20, null), new S.MeshBasicMaterial(t16, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t15, 2, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t15 = $.scene;
  t15.add$1(t15, $.fontmesh);
  ...
  t15 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t15, [null]);
  t16 = new W._EventStreamSubscription(0, t15._target, t15._eventType, W._wrapZone(S.onWindowResize$closure), t15._useCapture);
  H.setRuntimeTypeInfo(t16, [H.getRuntimeTypeArgument(t15, "_EventStream", 0)]);
  t16._tryResume$0();
},
...
//# sourceMappingURL=web_gl_text.dart.js.map
//@ sourceMappingURL=web_gl_text.dart.js.map
