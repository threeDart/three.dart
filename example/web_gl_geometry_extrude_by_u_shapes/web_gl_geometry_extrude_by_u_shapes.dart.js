...
Path_Path: function(path_OR_text) {
  return new Path();
},
...
Curve: {"": "Object;needsUpdate@",
  ...
  getUPoints$2: function(uList, closedPath) {
    var pts, t1;
    pts = [];
    for (t1 = new H.ListIterator(uList, uList.length, 0, null); t1.moveNext$0();)
      pts.push(this.getPointAt$1(t1._current));
    return pts;
  },
...
CurvePath: {"": "Curve;curves,_bends,autoClose,cacheLengths,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  ...
  static: {
CurvePath$: function() {
  return new S.CurvePath([], [], false, null, null, null, false);
}}
...
Shape: {"": "Path0;holes,useSpacedPoints,_points,actions,curves,_bends,autoClose,cacheLengths,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  ...
  getPointsHoles$1: function(divisions) {
    var t1, il, holesPts, t2, t3, i;
    t1 = this.holes;
    il = t1.length;
    holesPts = P.List_List(il, null);
    for (t2 = t1.length, t3 = this._bends, i = 0; i < il; ++i) {
      if (i >= t2)
        throw H.ioore(t1, i);
      holesPts[i] = t1[i].getTransformedPoints$2$bends(divisions, t3);
    }
    return holesPts;
  },
  getSpacedPointsHoles$1: function(divisions) {
    ...
    for (t2 = t1.length, t3 = this._bends, i = 0; i < il; ++i) {
      if (i >= t2)
        throw H.ioore(t1, i);
      holesPts[i] = t1[i].getTransformedSpacedPoints$2(divisions, t3);
    }
    return holesPts;
  },
...
ExtrudeGeometry: {"": "Geometry;shapes,shapebb,id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  addShape$14$UVGenerator: function(shape, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, $frames, material, extrudeMaterial, UVGenerator) {
    var t1, uvgen, nSteps, divisions, extrudePts, t2, t3, splineTube, binormal, normal, position2, shapesOffset, shapePoints, vertices, holes, ahole, h, faces, vertices0, vlen, flen, t4, contourMovements, il, j, t5, i, k, t6, holesMovements, verticesMovements, oneHoleMovements, t7, t8, b, vert, t, bs, t9, t10, t11, t12, t13, s, z, t14, face, layeroffset;
    t1 = {};
    t1.bevelSegments_0 = bevelSegments;
    uvgen = new S.ExtrudeGeometryWorldUVGenerator();
    nSteps = steps.length;
    divisions = [0];
    C.JSArray_methods.addAll$1(divisions, steps);
    ...
    for (b = t1.bevelSegments_0 - 1, t3 = nSteps - 1; b >= 0; --b) {
    ...
    t1 = new S.ExtrudeGeometry_addShape_sidewalls(t1, nSteps, vlen, new S.ExtrudeGeometry_addShape_f4(this, shape, extrudeMaterial, uvgen, shapesOffset));
...
["", "web_gl_geometry_extrude_by_u_shapes.dart", , O, {
main: function() {
...
init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, light, pts, i, l, a, starShape, curvepath, randomPoints, extrudeUSteps, curvepathLength, initU, curve, d, circleShape, rectShape, smileyShape, smileyEye1Path, smileyEye2Path, smileyMouthPath, circle3d, tube;
  ...
  t2.$dartCachedLength = t2.length;
  t2 = new T.Vector3(t2);
  t2.setValues$3(100, 0, 0);
  t3 = new Float32Array(3);
  t3.$dartCachedLength = t3.length;
  t3 = new T.Vector3(t3);
  t3.setValues$3(100, 0, 0);
  t4 = new Float32Array(3);
  t4.$dartCachedLength = t4.length;
  t4 = new T.Vector3(t4);
  t4.setValues$3(200, 50, 0);
  curvepath = S.CurvePath$();
  t5 = curvepath.curves;
  t5.push(new S.LineCurve3(new T.Vector3(t1), t2, null, null, false));
  t5.push(new S.LineCurve3(t3, t4, null, null, false));
  t4 = new Float32Array(3);
  t4.$dartCachedLength = t4.length;
  t4 = new T.Vector3(t4);
  t4.setValues$3(200, 50, 0);
  ...
  t5.push(new S.SplineCurve3(randomPoints, null, null, false));
  extrudeUSteps = P.List_List(null, null);
  curvepathLength = J.get$last$ax(curvepath.getCurveLengths$0());
  for (t1 = new H.ListIterator(t5, t5.length, 0, null), initU = 0; t1.moveNext$0();) {
    curve = t1._current;
    t2 = J.getInterceptor$asx(curve);
    if (typeof curve === "object" && curve !== null && !!t2.$isLineCurve3) {
      initU = J.$add$ns(initU, C.JSNumber_methods.$tdiv(J.get$last$ax(curve.getLengths$0()), curvepathLength));
      extrudeUSteps.push(initU);
    } else {
      for (t3 = J.getInterceptor$ns(initU), d = 0; d <= 40; ++d) {
        t4 = t2.get$length(curve);
        if (typeof t4 !== "number")
          throw t4.$div();
        extrudeUSteps.push(t3.$add(initU, d / 40 * (t4 / curvepathLength)));
      }
      initU = C.JSArray_methods.get$last(extrudeUSteps);
    }
  }
  P.print("[WebGL_Geometry_Extrude_By_U_Shapes] " + H.S(extrudeUSteps));
  ...
  smileyEye1Path = W.Path_Path(null);
  smileyEye1Path.moveTo(35, 20);
  smileyEye1Path.arc(25, 20, 10, 0, 6.283185307179586, true);
  t1 = smileyShape.holes;
  t1.push(smileyEye1Path);
  smileyEye2Path = W.Path_Path(null);
  smileyEye2Path.moveTo(65, 20);
  smileyEye2Path.arc(55, 20, 10, 0, 6.283185307179586, true);
  t1.push(smileyEye2Path);
  smileyMouthPath = W.Path_Path(null);
  ...
  tube = S.TubeGeometry$(curvepath, 40, 4, 5, false, true);
...
//# sourceMappingURL=web_gl_geometry_extrude_by_u_shapes.dart.js.map
//@ sourceMappingURL=web_gl_geometry_extrude_by_u_shapes.dart.js.map
