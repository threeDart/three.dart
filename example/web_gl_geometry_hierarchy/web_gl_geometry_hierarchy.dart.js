...
["", "web_gl_geometry_hierarchy.dart", , B, {
main: function() {
  var t1, t2;
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(B.onDocumentMouseMove$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  B.init();
  t2 = window;
  C.Window_methods._ensureRequestAnimationFrame$0(t2);
  C.Window_methods._requestAnimationFrame$1(t2, W._wrapZone(B.animate$closure));
  B.render();
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, geometry, material, i, mesh;
  ...
  $.scene = S.Scene$();
  $.scene.fog = new S.FogLinear(S.Color$(16777215), 1, 10000);
  t16 = $.scene;
  t16.add$1(t16, $.camera);
  geometry = S.CubeGeometry$(100, 100, 100, 1, 1, 1, null, null);
  t16 = $.MaterialCount;
  $.MaterialCount = t16 + 1;
  material = new S.MeshNormalMaterial(1, false, 1, null, null, "", t16, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
  $.group = S.Object3D$();
  for (i = 0; i < 1000; ++i) {
    mesh = S.Mesh$(geometry, material);
    t1 = mesh.position;
    t1.storage[0] = (Math.random() * 2000 >>> 0) - 1000;
    t1 = mesh.position;
    t1.storage[1] = (Math.random() * 2000 >>> 0) - 1000;
    t1 = mesh.position;
    t1.storage[2] = (Math.random() * 2000 >>> 0) - 1000;
...
render: function() {
  var time, t1, t2, t3, t4, t5, t6;
  time = P.DateTime$_now().millisecondsSinceEpoch * 0.001;
  t1 = Math.sin(time * 0.7);
  t2 = Math.sin(time * 0.3);
  t3 = Math.sin(time * 0.2);
  t4 = $.camera;
  t5 = t4.position.storage;
  t6 = t5[0];
  t5[0] = t6 + ($.mouseX - t6) * 0.05;
  t6 = t5[1];
  t5[1] = t6 + (-$.mouseY - t6) * 0.05;
  t4.lookAt$1($.scene.position);
  t4 = $.group.rotation.storage;
  t4[0] = t1 * 0.5;
  t4[1] = t2 * 0.5;
  t4[2] = t3 * 0.5;
...
init.globalFunctions.onDocumentMouseMove$closure = B.onDocumentMouseMove$closure = new H.Closure$1(B.onDocumentMouseMove, "onDocumentMouseMove$closure");
...
//# sourceMappingURL=web_gl_geometry_hierarchy.dart.js.map
//@ sourceMappingURL=web_gl_geometry_hierarchy.dart.js.map
