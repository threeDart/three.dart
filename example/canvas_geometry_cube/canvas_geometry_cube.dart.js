...
init: function() {
  var t1, info, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, materials, i;
  $.targetRotation = 0;
  ...
  t1.set$innerHtml(info, "Drag to spin the cube");
  ...
  for (i = 0; i < 6; ++i) {
    ...
    t2.setHex$1(t1 * 16777215);
    t1 = $.MaterialCount;
    $.MaterialCount = t1 + 1;
    materials.push(new S.MeshBasicMaterial(t2, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t1, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  }
  t1 = S.CubeGeometry$(200, 200, 200, 1, 1, 1, materials, null);
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  $.cube = S.Mesh$(t1, new S.MeshFaceMaterial(materials, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t2 = $.cube;
  t2.position.storage[1] = 150;
  t1 = $.scene;
  t1.add$1(t1, t2);
  t2 = S.PlaneGeometry$(200, 200, null, null);
  t1 = S.Color$(14737632);
  t3 = $.MaterialCount;
  $.MaterialCount = t3 + 1;
  $.plane = S.Mesh$(t2, new S.MeshBasicMaterial(t1, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t3, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, true, true, true, null));
  t3 = $.plane;
  t3.rotation.storage[0] = -1.5707963267948966;
  t1 = $.scene;
  t1.add$1(t1, t3);
  ...
  t3 = new W._EventStream(document, C.EventStreamProvider_mousedown._eventType, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t1 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(S.onDocumentMouseDown$closure), t3._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t1._tryResume$0();
  t3 = new W._EventStream(document, C.EventStreamProvider_touchstart._eventType, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(S.onDocumentTouchStart$closure), t3._useCapture);
  ...
  H.setRuntimeTypeInfo(t3, [null]);
  t4 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(S.onDocumentTouchMove$closure), t3._useCapture);
  H.setRuntimeTypeInfo(t4, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t4._tryResume$0();
  $.evtSubscriptions = [t1, t2, t4];
},
...
onDocumentMouseDown: function($event) {
  ...
  P.print("onMouseDown mouseX = " + H.S($.mouseXOnMouseDown) + " targRot = " + H.S($.targetRotationOnMouseDown));
},
...
onDocumentMouseMove: function($event) {
  ...
  if (typeof t2 !== "number")
    throw H.iae(t2);
  $.mouseX = t1 - t2;
  t2 = $.targetRotationOnMouseDown;
  t1 = $.mouseX;
  t3 = $.mouseXOnMouseDown;
  if (typeof t1 !== "number")
    throw t1.$sub();
  if (typeof t3 !== "number")
    throw H.iae(t3);
  if (typeof t2 !== "number")
    throw t2.$add();
  $.targetRotation = t2 + (t1 - t3) * 0.02;
  P.print("onMouseMove mouseX = " + H.S($.mouseX) + " targRot = " + H.S($.targetRotation));
},

cancelEvtSubscriptions: function() {
  H.IterableMixinWorkaround_forEach($.get$evtSubscriptions(), new S.cancelEvtSubscriptions_closure());
  $.evtSubscriptions = [];
},

onDocumentMouseUp: function($event) {
  S.cancelEvtSubscriptions();
},
...
cancelEvtSubscriptions_closure: {"": "Closure;",
  call$1: function(s) {
    return s.cancel$0();
  },
  $is_args1: true
...
CubeGeometry: {"": "Geometry;_sides,segmentsWidth,segmentsHeight,segmentsDepth,id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  CubeGeometry$8: function(width, height, depth, segmentsWidth, segmentsHeight, segmentsDepth, materialOrList, sides) {
    ...
    if (this._sides.px)
      this.buildPlane$8("z", "y", -1, -1, depth, height, width_half, 0);
    if (this._sides.nx)
      this.buildPlane$8("z", "y", 1, -1, depth, height, -width_half, 1);
    if (this._sides.py)
      this.buildPlane$8("x", "z", 1, 1, width, depth, height_half, 2);
    if (this._sides.ny)
      this.buildPlane$8("x", "z", 1, -1, width, depth, -height_half, 3);
    if (this._sides.pz)
      this.buildPlane$8("x", "y", 1, -1, width, height, depth_half, 4);
    if (this._sides.nz)
      this.buildPlane$8("x", "y", -1, -1, width, height, -depth_half, 5);
...
Projector_projectScene_closure: {"": "Closure;box_0,this_1,near_2,far_3",
  call$1: function(o) {
    var t1, t2, t3, t4, material, vtx, t5, t6, t7, t8, visible, uvs;
    t1 = this.box_0;
    ...
    if (typeof t3 === "object" && t3 !== null && !!t4.$isMesh) {
      ...
      t1.isFaceMaterial_25 = !!t3.$isMeshFaceMaterial;
...
Material: {"": "Object;side<,opacity>,blending<,overdraw<,visible<",
  get$_data: function() {
    if (this.__data == null)
      this.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    return this.__data;
...
CanvasRenderer: {"": "Object;domElement,_autoClear,_sortObjects,_sortElements,_canvasWidth,_canvasHeight,_canvasWidthHalf,_canvasHeightHalf,_clearColor,_clearOpacity,_camera,_canvas,_context,_contextGlobalAlpha,_contextGlobalCompositeOperation,_contextStrokeStyle,_contextFillStyle,_contextLineCap,_contextLineJoin,_contextLineWidth,_clipRect,_clearRect,_bboxRect,_info,_renderData,_three$_elements,_lights,_projector,_v5,_v6,_v1x,_v1y,_v2x,_v2y,_v3x,_v3y,_v4x,_v4y,_v5x,_v5y,_v6x,_v6y,_color,_color1,_color2,_color3,_color4,_patterns,_imagedatas,_near,_far,_image,_uvs,_uv1x,_uv1y,_uv2x,_uv2y,_uv3x,_uv3y,_enableLighting,_ambientLight,_directionalLights,_pointLights,_pi2,_vector3,_pixelMapImage,_pixelMapData,_gradientMapQuality,_pixelMap,_pixelMapContext,_gradientMap,_gradientMapContext,debug",
  ...
  render$2: function(scene, camera) {
    ...
    for (e = 0; e < el; ++e) {
      ...
      if (typeof material === "object" && material !== null && !!t1.$isMeshFaceMaterial)
        material = element.get$faceMaterial();
      if (material == null || J.get$opacity$x(material) === 0)
        continue;
      t1 = this._bboxRect;
      t1._isEmpty = true;
      t1._left = 0;
  ...
  calculateLights$1: function(lights) {
    ...
    for (l = 0; l < ll; ++l) {
      ...
      light = lights[l];
      lightColor = light.get$color(light);
  ...
  renderParticle$4: function(v1, element, material, scene) {
    var t1, t2;
    t1 = J.get$opacity$x(material);
    t2 = this._contextGlobalAlpha;
  ...
  renderFace3$9: function(v1, v2, v3, uv1, uv2, uv3, element, material, scene) {
    ...
    if (typeof t1 !== "number")
      throw t1.$add();
    t2.faces = t1 + 1;
    t1 = material.get$opacity(material);
...
RenderableFace: {"": "Object;material<,faceMaterial<,z>",
...
RenderableFace4: {"": "RenderableFace;vertices,centroidWorld,centroidScreen,normalWorld,vertexNormalsWorld,uvs,material,faceMaterial,z", $isRenderableFace4: true},
...
init.globalFunctions.onDocumentMouseDown$closure = S.onDocumentMouseDown$closure = new S.Closure$1(S.onDocumentMouseDown, "onDocumentMouseDown$closure");
init.globalFunctions.onDocumentMouseMove$closure = S.onDocumentMouseMove$closure = new S.Closure$1(S.onDocumentMouseMove, "onDocumentMouseMove$closure");
init.globalFunctions.onDocumentMouseUp$closure = S.onDocumentMouseUp$closure = new S.Closure$1(S.onDocumentMouseUp, "onDocumentMouseUp$closure");
init.globalFunctions.onDocumentMouseOut$closure = S.onDocumentMouseOut$closure = new S.Closure$1(S.onDocumentMouseOut, "onDocumentMouseOut$closure");
init.globalFunctions.onDocumentTouchStart$closure = S.onDocumentTouchStart$closure = new S.Closure$1(S.onDocumentTouchStart, "onDocumentTouchStart$closure");
init.globalFunctions.onDocumentTouchMove$closure = S.onDocumentTouchMove$closure = new S.Closure$1(S.onDocumentTouchMove, "onDocumentTouchMove$closure");
init.globalFunctions.animate$closure = S.animate$closure = new S.Closure$1(S.animate, "animate$closure");
...
Isolate.$lazy($, "evtSubscriptions", "evtSubscriptions", "get$evtSubscriptions", function() {
  return [];
});
