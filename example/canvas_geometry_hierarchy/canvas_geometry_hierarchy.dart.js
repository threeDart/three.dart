...
Interceptor: {"": "Object;",
  ...
  "%": "ArrayBuffer|CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|SVGAnimatedTransformList"
},
...
["", "canvas_geometry_hierarchy.dart", , N, {
main: function() {
  var t1, t2;
  t1 = new W._EventStream(document, C.EventStreamProvider_mousemove._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(N.onDocumentMouseMove$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  N.init();
  t2 = window;
  C.Window_methods._ensureRequestAnimationFrame$0(t2);
  C.Window_methods._requestAnimationFrame$1(t2, W._wrapZone(N.animate$closure));
  N.render();
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, materials, i, material, mesh;
  ...
  t1 = $.MaterialCount;
  $.MaterialCount = t1 + 1;
  material = new S.MeshNormalMaterial(1, false, 1, null, null, "", t1, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
  $.group = S.Object3D$();
  for (i = 0; i < 200; ++i) {
    mesh = S.Mesh$($.geometry, material);
    t1 = mesh.position.storage;
    t1[0] = (Math.random() * 2000 >>> 0) - 1000;
    t1[1] = (Math.random() * 2000 >>> 0) - 1000;
    t1[2] = (Math.random() * 2000 >>> 0) - 1000;
    t1 = mesh.rotation;
    t1.storage[0] = (Math.random() * 360 >>> 0) * 0.017453292519943295;
    t1 = mesh.rotation;
    t1.storage[1] = (Math.random() * 360 >>> 0) * 0.017453292519943295;
  ...
  t1 = $.renderer;
  t1._sortObjects = false;
  J.get$nodes$x($.container)._this.appendChild(t1.domElement);
},
...
render: function() {
  ...
  oscillate = new N.render_closure(P.DateTime$_now().millisecondsSinceEpoch);
  $.group.rotation.storage[0] = oscillate.call$1(0.0007);
  $.group.rotation.storage[1] = oscillate.call$1(0.0003);
  $.group.rotation.storage[2] = oscillate.call$1(0.0002);
  $.renderer.render$2($.scene, $.camera);
},

render_closure: {"": "Closure;t_0",
  call$1: function(rate) {
    if (typeof rate !== "number")
      throw H.iae(rate);
    return Math.sin(this.t_0 * rate) * 0.5;
  },
  $is_args1: true
}},
1],
...
InputElement: {"": "HtmlElement;height},size=,width}", "%": "HTMLInputElement"},
...
SelectElement: {"": "HtmlElement;length=,size=", "%": "HTMLSelectElement"},
...
CanvasRenderer: {"": "Object;domElement,_autoClear,_sortObjects,_sortElements,_canvasWidth,_canvasHeight,_canvasWidthHalf,_canvasHeightHalf,_clearColor,_clearOpacity,_camera,_canvas,_context,_contextGlobalAlpha,_contextGlobalCompositeOperation,_contextStrokeStyle,_contextFillStyle,_contextLineCap,_contextLineJoin,_contextLineWidth,_clipRect,_clearRect,_bboxRect,_info,_renderData,_three$_elements,_lights,_projector,_v5,_v6,_v1x,_v1y,_v2x,_v2y,_v3x,_v3y,_v4x,_v4y,_v5x,_v5y,_v6x,_v6y,_color,_color1,_color2,_color3,_color4,_patterns,_imagedatas,_near,_far,_image,_uvs,_uv1x,_uv1y,_uv2x,_uv2y,_uv3x,_uv3y,_enableLighting,_ambientLight,_directionalLights,_pointLights,_pi2,_vector3,_pixelMapImage,_pixelMapData,_gradientMapQuality,_pixelMap,_pixelMapContext,_gradientMap,_gradientMapContext,debug",
  ...
  renderFace3$9: function(v1, v2, v3, uv1, uv2, uv3, element, material, scene) {
    var t1, t2, t3, t4, t5, t6, component;
    t1 = this._info.render;
    t2 = t1.vertices;
    if (typeof t2 !== "number")
      throw t2.$add();
    ...
    if (!!material.$isMeshBasicMaterial) {
      ...
      t1 = this._color;
      t2 = element.normalWorld.storage;
      component = (t2[0] + 1) * 0.5;
      if (component < 0)
        t3 = 0;
      else
        t3 = component > 1 ? 1 : component;
      t1._r = t3;
      t3 = this._color;
      component = (t2[1] + 1) * 0.5;
      if (component < 0)
        t1 = 0;
      else
        t1 = component > 1 ? 1 : component;
      t3._g = t1;
      t1 = this._color;
      component = (t2[2] + 1) * 0.5;
      if (component < 0)
        t2 = 0;
      else
        t2 = component > 1 ? 1 : component;
      t1._b = t2;
      t1 = this._color;
      if (material.wireframe) {
        t2 = material.wireframeLinewidth;
        ...
        t5 = this._contextLineCap;
        if (t5 == null ? t3 != null : t5 !== t3) {
          t5 = this._context;
          this._contextLineCap = t3;
          J.set$lineCap$x(t5, t3);
        }
        t3 = this._contextLineJoin;
        if (t3 == null ? t4 != null : t3 !== t4) {
          t3 = this._context;
          this._contextLineJoin = t4;
          J.set$lineJoin$x(t3, t4);
  ...
  renderFace4$9: function(v1, v2, v3, v4, v5, v6, element, material, scene) {
    var t1, t2, t3, t4, t5, t6, t7, t8, component;
    t1 = this._info.render;
    t2 = t1.vertices;
    if (typeof t2 !== "number")
      throw t2.$add();
    ...
    if (!!material.$isMeshBasicMaterial) {
      ...
      t8 = this._v4y;
      J.beginPath$0$x(this._context);
      J.moveTo$2$x(this._context, t2, t1);
      J.lineTo$2$x(this._context, t3, t4);
      J.lineTo$2$x(this._context, t5, t6);
      J.lineTo$2$x(this._context, t7, t8);
      J.lineTo$2$x(this._context, t2, t1);
      J.closePath$0$x(this._context);
      t1 = this._color;
      if (material.wireframe) {
        t2 = material.wireframeLinewidth;
...
init.globalFunctions.onDocumentMouseMove$closure = N.onDocumentMouseMove$closure = new N.Closure$1(N.onDocumentMouseMove, "onDocumentMouseMove$closure");
