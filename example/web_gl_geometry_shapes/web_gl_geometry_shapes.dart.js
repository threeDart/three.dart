...
["FontUtils", "package:three/extras/font_utils.dart", , Y, {
process: function(contour, indices) {
  var t1, n, result, verts, vertIndices, t2, v, t3, count, nv, count0, u, w, w0, a, b, c, t, s;
  t1 = J.getInterceptor$asx(contour);
  ...
  if (n < 3)
    return;
  result = [];
  verts = P.List_List(n, null);
  vertIndices = [];
  if (Y.area(contour) > 0)
    for (t2 = verts.length, v = 0; v < n; ++v) {
      if (v >= t2)
        throw H.ioore(verts, v);
      verts[v] = v;
    }
  else
    for (t2 = n - 1, t3 = verts.length, v = 0; v < n; ++v) {
      if (v >= t3)
        throw H.ioore(verts, v);
      verts[v] = t2 - v;
    }
  count = 2 * n;
  for (v = n - 1, t2 = verts.length, nv = n; nv > 2;) {
    count0 = count - 1;
    if (count <= 0) {
      H.printToConsole("Warning, unable to triangulate polygon!");
      if (indices)
        return vertIndices;
      return result;
    }
    ...
    w = v + 1;
    w0 = nv <= w ? 0 : w;
    if (Y.snip(contour, u, v, w0, nv, verts)) {
      if (u >>> 0 !== u || u >= t2)
        throw H.ioore(verts, u);
      a = verts[u];
      if (v >>> 0 !== v || v >= t2)
        throw H.ioore(verts, v);
      b = verts[v];
      if (w0 >>> 0 !== w0 || w0 >= t2)
        throw H.ioore(verts, w0);
      c = verts[w0];
      result.push([t1.$index(contour, a), t1.$index(contour, b), t1.$index(contour, c)]);
      C.JSArray_methods.addAll$1(vertIndices, [verts[u], verts[v], verts[w0]]);
      for (t = w, s = v; t < nv; ++t) {
        if (t >>> 0 !== t || t >= t2)
          throw H.ioore(verts, t);
        t3 = verts[t];
        if (s >= t2)
          throw H.ioore(verts, s);
        verts[s] = t3;
        ++s;
      }
      --nv;
...
area: function(contour) {
  ...
  a = 0;
  q = 0;
  for (; q < n; q0 = q + 1, p = q, q = q0) {
    t2 = J.get$x$x(t1.$index(contour, p));
    t3 = J.get$y$x(t1.$index(contour, q));
    if (typeof t2 !== "number")
      throw t2.$mul();
    if (typeof t3 !== "number")
      throw H.iae(t3);
    t4 = J.get$x$x(t1.$index(contour, q));
    t5 = J.get$y$x(t1.$index(contour, p));
    if (typeof t4 !== "number")
      throw t4.$mul();
    if (typeof t5 !== "number")
      throw H.iae(t5);
...
insideTriangle: function(ax, ay, bx, by, cx, cy, px, py) {
  ...
  if (typeof py !== "number")
    throw py.$sub();
  return (cx - bx) * (py - by) - (cy - by) * (px - bx) >= 0 && (ax - cx) * (py - cy) - (ay - cy) * (px - cx) >= 0 && (bx - ax) * (py - ay) - (by - ay) * (px - ax) >= 0;
},

snip: function(contour, u, v, w, n, verts) {
  var t1, t2, ax, ay, bx, by, cx, cy, t3, p, px, py;
  t1 = verts.length;
  if (u >>> 0 !== u || u >= t1)
    throw H.ioore(verts, u);
  t2 = J.getInterceptor$asx(contour);
  ax = J.get$x$x(t2.$index(contour, verts[u]));
  ay = J.get$y$x(t2.$index(contour, verts[u]));
  if (v >>> 0 !== v || v >= t1)
    throw H.ioore(verts, v);
  bx = J.get$x$x(t2.$index(contour, verts[v]));
  by = J.get$y$x(t2.$index(contour, verts[v]));
  if (w >>> 0 !== w || w >= t1)
    throw H.ioore(verts, w);
  cx = J.get$x$x(t2.$index(contour, verts[w]));
  cy = J.get$y$x(t2.$index(contour, verts[w]));
  t3 = $.EPSILON;
  if (typeof bx !== "number")
    throw bx.$sub();
  if (typeof ax !== "number")
  ...
  if (typeof cx !== "number")
    throw cx.$sub();
  if (t3 > (bx - ax) * (cy - ay) - (by - ay) * (cx - ax))
    return false;
  for (p = 0, px = null, py = null; p < n; ++p) {
    if (p === u || p === v || p === w)
      continue;
    if (p >= t1)
      throw H.ioore(verts, p);
    px = J.get$x$x(t2.$index(contour, verts[p]));
    py = J.get$y$x(t2.$index(contour, verts[p]));
    if (Y.insideTriangle(ax, ay, bx, by, cx, cy, px, py))
      return false;
  }
  return true;
}}],
["GeometryUtils", "package:three/extras/geometry_utils.dart", , N, {
clone: function(geometry) {
  var cloneGeo, vertices, faces, uvs, t1, il, i, uv, uvCopy, t2, jl, j;
  cloneGeo = S.Geometry$();
  vertices = geometry.vertices;
  faces = geometry.faces;
  uvs = geometry.faceVertexUvs[0];
  cloneGeo.materials = P.List_List$from(geometry.materials, true, null);
  t1 = J.map$1$ax(vertices, new N.clone_closure());
  cloneGeo.vertices = t1.toList$0(t1);
  t1 = new H.MappedListIterable(faces, new N.clone_closure0());
  H.setRuntimeTypeInfo(t1, [null, null]);
  cloneGeo.faces = t1.toList$0(t1);
  il = uvs.length;
  for (t1 = cloneGeo.faceVertexUvs, i = 0; i < il; ++i) {
    if (i >= uvs.length)
      throw H.ioore(uvs, i);
    uv = uvs[i];
    uvCopy = [];
    t2 = J.getInterceptor$asx(uv);
    jl = t2.get$length(uv);
    if (typeof jl !== "number")
      throw H.iae(jl);
    j = 0;
    for (; j < jl; ++j)
      uvCopy.push(new S.UV(t2.$index(uv, j).get$u(), t2.$index(uv, j).get$v()));
    t1[0].push(uvCopy);
  }
  return cloneGeo;
},

clone_closure: {"": "Closure;",
  call$1: function(vertex) {
    return J.clone$0$x(vertex);
  },
  $is_args1: true
},

clone_closure0: {"": "Closure;",
  call$1: function(face) {
    return J.clone$0$x(face);
  },
  $is_args1: true
}}],
["SceneUtils", "package:three/extras/scene_utils.dart", , L, {
createMultiMaterialObject: function(geometry, materials) {
  var group = S.Object3D$();
  H.IterableMixinWorkaround_forEach(materials, new L.createMultiMaterialObject_closure(geometry, group));
  return group;
},

createMultiMaterialObject_closure: {"": "Closure;geometry_0,group_1",
  call$1: function(material) {
    var t1 = this.group_1;
    t1.add$1(t1, S.Mesh$(this.geometry_0, material));
  },
  $is_args1: true
}}],
["ShapeUtils", "package:three/extras/core/shape_utils.dart", , O, {
removeHoles: function(contour, holes) {
  var shape, allpoints, verts, t1, holeIndex, shapeIndex, h, d, p, pts1, pts2, t2, hole, h2, shortest, t3, dist, prevShapeVert, prevHoleVert, t4, t5, areaa, areab, holeIndex0, shapeIndex0, areaa2, tmpShape1, tmpShape2, tmpHole1, tmpHole2, t6, t7;
  shape = P.List_List$from(contour, true, null);
  allpoints = P.List_List$from(shape, true, null);
  verts = [];
  t1 = J.getInterceptor$asx(holes);
  holeIndex = null;
  shapeIndex = null;
  h = 0;
  d = null;
  ...
  pts2 = null;
  while (true) {
    t2 = t1.get$length(holes);
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (!(h < t2))
      break;
    hole = t1.$index(holes, h);
    C.JSArray_methods.addAll$1(allpoints, hole);
    t2 = J.getInterceptor$asx(hole);
    h2 = 0;
    shortest = 1 / 0;
    while (true) {
      t3 = t2.get$length(hole);
      if (typeof t3 !== "number")
        throw H.iae(t3);
      if (!(h2 < t3))
        break;
      ...
      dist = [];
      for (t3 = J.getInterceptor$n(pts1), p = 0; p < shape.length; ++p) {
        pts2 = shape[p];
        d = t3.$sub(pts1, pts2).get$length2();
        dist.push(d);
        if (d < shortest) {
          shortest = d;
          shapeIndex = p;
    ...
    if (shapeIndex < 0 || shapeIndex >= t4)
      throw H.ioore(shape, shapeIndex);
    t5 = shape[shapeIndex];
    if (prevShapeVert < 0 || prevShapeVert >= t4)
      throw H.ioore(shape, prevShapeVert);
    areaa = Y.area([t3, t5, shape[prevShapeVert]]);
    t5 = t2.$index(hole, holeIndex);
    t3 = t2.$index(hole, prevHoleVert);
    if (shapeIndex >= shape.length)
      throw H.ioore(shape, shapeIndex);
    areab = Y.area([t5, t3, shape[shapeIndex]]);
    holeIndex0 = holeIndex + -1;
    shapeIndex0 = C.JSInt_methods.$mod(shapeIndex + 1, shape.length);
    if (holeIndex0 < 0) {
      t3 = t2.get$length(hole);
      if (typeof t3 !== "number")
        throw H.iae(t3);
    ...
    if (typeof t3 !== "number")
      throw H.iae(t3);
    holeIndex0 = C.JSNumber_methods.$mod(holeIndex0, t3);
    prevShapeVert = shapeIndex0 - 1;
    prevShapeVert = prevShapeVert >= 0 ? prevShapeVert : shape.length - 1;
    prevHoleVert = holeIndex0 - 1;
    if (prevHoleVert >= 0)
      ;
    else {
      t3 = t2.get$length(hole);
    ...
    t3 = t2.$index(hole, holeIndex0);
    t4 = shape.length;
    if (shapeIndex0 < 0 || shapeIndex0 >= t4)
      throw H.ioore(shape, shapeIndex0);
    t5 = shape[shapeIndex0];
    if (prevShapeVert < 0 || prevShapeVert >= t4)
      throw H.ioore(shape, prevShapeVert);
    areaa2 = Y.area([t3, t5, shape[prevShapeVert]]);
    t5 = t2.$index(hole, holeIndex0);
    t3 = t2.$index(hole, prevHoleVert);
    if (shapeIndex0 >= shape.length)
      throw H.ioore(shape, shapeIndex0);
    if (areaa + areab > areaa2 + Y.area([t5, t3, shape[shapeIndex0]])) {
      shapeIndex = C.JSInt_methods.$mod(shapeIndex, shape.length);
      if (holeIndex < 0) {
        t3 = t2.get$length(hole);
        if (typeof t3 !== "number")
          throw H.iae(t3);
      ...
      if (typeof t3 !== "number")
        throw H.iae(t3);
      holeIndex = C.JSNumber_methods.$mod(holeIndex, t3);
      prevShapeVert = shapeIndex - 1;
      prevShapeVert = prevShapeVert >= 0 ? prevShapeVert : shape.length - 1;
      prevHoleVert = holeIndex - 1;
      if (prevHoleVert >= 0)
    ...
    if (shapeIndex < 0 || shapeIndex > shape.length)
      H.throwExpression(P.RangeError$range(shapeIndex, 0, shape.length));
    tmpShape1 = new H.SubListIterable(shape, 0, shapeIndex);
    tmpShape1.$builtinTypeInfo = [null];
    t4 = tmpShape1._start;
    if (t4 < 0)
      H.throwExpression(P.RangeError$value(t4));
    t5 = tmpShape1._endOrLength;
    if (t5 != null) {
      if (typeof t5 !== "number")
        throw t5.$lt();
      if (t5 < 0)
      ...
      if (t4 > t5)
        H.throwExpression(P.RangeError$range(t4, 0, t5));
    }
    t4 = shape.length;
    if (shapeIndex < 0 || shapeIndex > t4)
      H.throwExpression(P.RangeError$range(shapeIndex, 0, t4));
    if (t4 < shapeIndex || t4 > t4)
      H.throwExpression(P.RangeError$range(t4, shapeIndex, t4));
    tmpShape2 = new H.SubListIterable(shape, shapeIndex, t4);
    tmpShape2.$builtinTypeInfo = [null];
    t3 = tmpShape2._start;
    if (t3 < 0)
      H.throwExpression(P.RangeError$value(t3));
    t4 = tmpShape2._endOrLength;
    if (t4 != null) {
      if (typeof t4 !== "number")
        throw t4.$lt();
      if (t4 < 0)
    ...
    tmpHole1 = t2.getRange$2(hole, holeIndex, t2.get$length(hole));
    ...
    if (prevShapeVert < 0 || prevShapeVert >= t4)
      throw H.ioore(shape, prevShapeVert);
    t4 = shape[prevShapeVert];
    t6 = t2.$index(hole, holeIndex);
    ...
    verts.push([t6, t2, t7]);
    shape = [];
    C.JSArray_methods.addAll$1(shape, tmpShape1);
    C.JSArray_methods.addAll$1(shape, tmpHole1);
    C.JSArray_methods.addAll$1(shape, tmpHole2);
    C.JSArray_methods.addAll$1(shape, tmpShape2);
    ++h;
  }
  return H.fillLiteralMap(["shape", shape, "isolatedPts", verts, "allpoints", allpoints], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
},

triangulateShape: function(contour, holes) {
  var shapeWithoutHoles, shape, allpoints, isolatedPts, triangles, allPointsMap, t1, i, key, t2, line, face, f;
  shapeWithoutHoles = O.removeHoles(contour, holes);
  shape = shapeWithoutHoles.$index(shapeWithoutHoles, "shape");
  allpoints = shapeWithoutHoles.$index(shapeWithoutHoles, "allpoints");
  isolatedPts = shapeWithoutHoles.$index(shapeWithoutHoles, "isolatedPts");
  triangles = Y.process(shape, false);
  allPointsMap = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  t1 = J.getInterceptor$asx(allpoints);
  i = 0;
  key = null;
  while (true) {
    t2 = t1.get$length(allpoints);
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (!(i < t2))
      break;
    key = H.S(J.get$x$x(t1.$index(allpoints, i))) + ":" + H.S(J.get$y$x(t1.$index(allpoints, i)));
    if (allPointsMap.containsKey$1(allPointsMap, key)) {
      line = "Duplicate point " + key;
      H.printToConsole(line);
    }
    allPointsMap.$indexSet(allPointsMap, key, i);
    ++i;
  }
  for (i = 0; i < triangles.length; ++i) {
    face = triangles[i];
    for (t1 = J.getInterceptor$asx(face), f = 0; f < 3; ++f) {
      key = H.S(J.get$x$x(t1.$index(face, f))) + ":" + H.S(J.get$y$x(t1.$index(face, f)));
      if (allPointsMap.containsKey$1(allPointsMap, key))
        t1.$indexSet(face, f, allPointsMap.$index(allPointsMap, key));
    }
  }
  t1 = J.getInterceptor$asx(isolatedPts);
  i = 0;
  while (true) {
    t2 = t1.get$length(isolatedPts);
    if (typeof t2 !== "number")
      throw H.iae(t2);
    if (!(i < t2))
      break;
    face = t1.$index(isolatedPts, i);
    for (t2 = J.getInterceptor$asx(face), f = 0; f < 3; ++f) {
      key = H.S(J.get$x$x(t2.$index(face, f))) + ":" + H.S(J.get$y$x(t2.$index(face, f)));
      if (allPointsMap.containsKey$1(allPointsMap, key))
        t2.$indexSet(face, f, allPointsMap.$index(allPointsMap, key));
    }
    ++i;
  }
  C.JSArray_methods.addAll$1(triangles, isolatedPts);
  return triangles;
}}],
...
JSArray: {"": "List/Interceptor;",
  ...
  get$map: function(_receiver) {
    return new P.BoundClosure$i10(this, J.JSArray.prototype.map$1, _receiver, "map$1");
  },
...
Primitives_stringFromCodePoints: function(codePoints) {
  ...
  for (t1 = C.JSArray_methods.get$iterator(codePoints); t1.moveNext$0();) {
    i = t1._current;
...
Primitives_stringFromCharCodes: function(charCodes) {
  var t1, i;
  for (t1 = C.JSArray_methods.get$iterator(charCodes); t1.moveNext$0();) {
    i = t1._current;
    if (typeof i !== "number" || Math.floor(i) !== i)
      throw H.wrapException(P.ArgumentError$(i));
    if (i < 0)
...
ListIterable: {"": "IterableBase;",
  ...
  get$map: function(_receiver) {
    return new P.BoundClosure$i10(this, H.ListIterable.prototype.map$1, _receiver, "map$1");
  },
...
Stream: {"": "Object;",
  ...
  get$map: function(_receiver) {
    return new P.BoundClosure$i10(this, P.Stream.prototype.map$1, _receiver, "map$1");
  },
  forEach$1: function(_, action) {
    var t1, future;
    t1 = {};
...
IterableBase: {"": "Object;",
  ...
  get$map: function(_receiver) {
    return new P.BoundClosure$i10(this, P.IterableBase.prototype.map$1, _receiver, "map$1");
  },
  forEach$1: function(_, f) {
    var t1;
...
ListMixin: {"": "Object;",
  ...
  get$map: function(_receiver) {
    return new P.BoundClosure$i10(this, P.ListMixin.prototype.map$1, _receiver, "map$1");
  },
  toList$1$growable: function(receiver, growable) {
    var result, i, t1;
    if (growable) {
...
Blob: {"": "Interceptor;size=,type=", $isBlob: true, "%": ";Blob"},
...
CssVariablesMap: {"": "Interceptor;size=", "%": "CSSVariablesMap"},
...
EmbedElement: {"": "HtmlElement;height%,name=,type=,width%", "%": "HTMLEmbedElement"},
...
ImageElement: {"": "HtmlElement;height%,width%", $isImageElement: true, "%": "HTMLImageElement"},

InputElement: {"": "HtmlElement;height%,name=,size=,type=,value%,width%", $isNode: true, "%": "HTMLInputElement"},
...
TextTrackCue: {"": "EventTarget;id%,size=", "%": "TextTrackCue"},
...
ActiveInfo: {"": "Interceptor;size=,type=", "%": "WebGLActiveInfo"},
...
RenderingContext: {"": "CanvasRenderingContext;",
  ...
  get$blendEquation: function(_receiver) {
    return new P.BoundClosure$i10(this, P.RenderingContext.prototype.blendEquation$1, _receiver, "blendEquation$1");
  },
  ...
  get$polygonOffset: function(_receiver) {
    return new P.BoundClosure$i2(this, P.RenderingContext.prototype.polygonOffset$2, _receiver, "polygonOffset$2");
  },
...
makeRotationAxis: function(m, axis, angle) {
  var c, s, t, t1, x, y, z, tx, ty, t2, t3, t4, t5, t6;
  c = Math.cos(angle);
  s = Math.sin(angle);
  t = 1 - c;
  t1 = J.getInterceptor$x(axis);
  x = t1.get$x(axis);
  y = t1.get$y(axis);
  z = t1.get$z(axis);
  tx = t * x;
  ...
  t5 = ty * z;
  t6 = s * x;
  m.setValues$16(tx * x + c, t1 - t2, t3 + t4, 0, t1 + t2, ty * y + c, t5 - t6, 0, t3 - t4, t5 + t6, t * z * z + c, 0, 0, 0, 0, 1);
  return m;
},
...
CubicBezierCurve: {"": "Curve2D;v0,v1,v2,v3,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  getPoint$1: function(t) {
    var t1, t2, t3, t4, t5, t6, t7, t8, k, t9, t10, t11, t12, t13, t14;
    t1 = this.v0.storage;
    t2 = t1[0];
    t3 = this.v1.storage;
    t4 = t3[0];
    ...
    t13 = new T.Vector2(t13);
    t14 = t13.storage;
    t14[0] = t9 * t2 + t11 * t4 + t10 * t6 + t12 * t8;
    t14[1] = t9 * t1 + t11 * t3 + t10 * t5 + t12 * t7;
    return t13;
  }
},
...
Curve: {"": "Object;needsUpdate@",
  ...
  getLengths$1$divisions: function(divisions) {
    var t1, cache, last, sum, p, current, distance, t2, t3, t4, t5, t6;
    ...
    for (sum = 0, p = 1; p <= 200; ++p, last = current) {
      ...
      if (typeof current === "object" && current !== null && !!current.$isVector3) {
        t1 = current.$sub(current, H.interceptedTypeCast(last, "$isVector3"));
        distance = t1.get$length(t1);
      } else {
        H.interceptedTypeCast(current, "$isVector2");
        H.interceptedTypeCast(last, "$isVector2");
        t1 = current.storage;
        t2 = t1[0];
        t3 = last.storage;
        t4 = t3[0];
  ...
  getUtoTmapping$2$distance: function(u, distance) {
    var arcLengths, il, t1, targetArcLength, high, high0, low, i, comparison, lengthAfter, segmentFraction;
    arcLengths = this.getLengths$0();
    il = arcLengths.length;
    t1 = il - 1;
    if (t1 < 0)
      throw H.ioore(arcLengths, t1);
    targetArcLength = J.$mul$n(u, arcLengths[t1]);
    high = il - 1;
    for (high0 = high, low = 0; low <= high0;) {
      i = C.JSInt_methods.toInt$0(C.JSNumber_methods.toInt$0(Math.floor(low + (high0 - low) / 2)));
      if (i < 0 || i >= arcLengths.length)
        throw H.ioore(arcLengths, i);
      t1 = arcLengths[i];
      if (typeof targetArcLength !== "number")
        throw H.iae(targetArcLength);
      comparison = t1 - targetArcLength;
      if (comparison < 0) {
        low = i + 1;
        continue;
    ...
    if (high0 < 0 || high0 >= arcLengths.length)
      throw H.ioore(arcLengths, high0);
    t1 = arcLengths[high0];
    if (t1 === targetArcLength)
      return high0 / high;
    lengthAfter = arcLengths.$index(arcLengths, high0 + 1);
    segmentFraction = J.$div$n(J.$sub$n(targetArcLength, t1), lengthAfter - t1);
    if (typeof segmentFraction !== "number")
      throw H.iae(segmentFraction);
    return (high0 + segmentFraction) / high;
  },
  getUtoTmapping$1: function(u) {
    return this.getUtoTmapping$2$distance(u, null);
  },
  getTangent$1: function(t) {
    var t1, t2, pt1, pt2, vec;
    t1 = t - 0.0001;
    t2 = t + 0.0001;
    if (t1 < 0)
      t1 = 0;
    ...
    pt2 = this.getPoint$1(t2);
    vec = pt2.$sub(pt2, pt1);
    return vec.normalize$0(vec);
  }
},
...
CurvePath: {"": "Curve;",
  add$1: function(_, curve) {
    return J.add$1$ax(this.curves, curve);
  },
  getPoint$1: function(t) {
    var d, curveLengths, t1, i, diff, curve;
    d = t * J.get$last$ax(this.getCurveLengths$0());
    curveLengths = this.getCurveLengths$0();
    for (t1 = curveLengths.length, i = 0; i < t1;) {
      if (curveLengths[i] >= d) {
        t1 = curveLengths.$index(curveLengths, i);
        diff = t1.$sub(t1, d);
        curve = J.$index$asx(this.curves, i);
        return curve.getPointAt$1(1 - diff.$div(diff, J.get$length$asx(curve)));
      }
      ++i;
    }
    return;
  ...
  get$length: function(_) {
    return J.get$last$ax(this.getCurveLengths$0());
  },
  getCurveLengths$0: function() {
    var t1, lengths, t2, il, sums, i, t3;
    t1 = this.cacheLengths;
    if (t1 != null && t1.length === J.get$length$asx(this.curves))
    ...
    i = 0;
    for (; i < il; ++i) {
      t3 = J.get$length$asx(t2.$index(t1, i));
      if (typeof t3 !== "number")
        throw H.iae(t3);
      sums += t3;
      lengths.push(sums);
  ...
  getBoundingBox$0: function() {
    var points, t1, t2, v3, sum, il, maxX, maxY, maxZ, minX, minY, minZ, i, p, minZ0, ret;
    points = this.getPoints$0();
    if (0 >= points.length)
      throw H.ioore(points, 0);
    t1 = points[0];
    t2 = J.getInterceptor(t1);
    v3 = typeof t1 === "object" && t1 !== null && !!t2.$isVector3;
    if (v3) {
      t1 = new Float32Array(3);
      t1.$dartCachedLength = t1.length;
      sum = new T.Vector3(t1);
    } else {
      t1 = new Float32Array(2);
      t1.$dartCachedLength = t1.length;
      sum = new T.Vector2(t1);
    }
    il = points.length;
    for (maxX = -1 / 0, maxY = -1 / 0, maxZ = null, minX = 1 / 0, minY = 1 / 0, minZ = null, i = 0; i < il; ++i) {
      if (i >= points.length)
      ...
      if (v3) {
        H.interceptedTypeCast(p, "$isVector3");
        minZ0 = p.storage[2];
        ...
        H.interceptedTypeCast(sum, "$isVector3");
        sum.add$1(sum, p);
      } else {
        H.interceptedTypeCast(sum, "$isVector2");
        sum.add$1(sum, p);
      }
    }
    ret = H.fillLiteralMap(["minX", minX, "minY", minY, "maxX", maxX, "maxY", maxY, "centroid", sum.scale$1(sum, 1 / il)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    if (v3) {
      ret.$indexSet(ret, "maxZ", maxZ);
      ret.$indexSet(ret, "minZ", minZ);
    }
    return ret;
  },
  createGeometry$1: function(points) {
    var geometry, i, t1, t2, z, t3, t4, t5;
    geometry = S.Geometry$();
    for (i = 0; i < points.length; ++i) {
      t1 = points[i];
      t2 = J.getInterceptor$x(t1);
      z = typeof t1 === "object" && t1 !== null && !!t2.$isVector3 ? t2.get$z(t1) : 0;
      t1 = geometry.vertices;
      if (i >= points.length)
        throw H.ioore(points, i);
      t2 = J.get$x$x(points[i]);
      if (i >= points.length)
        throw H.ioore(points, i);
      t3 = J.get$y$x(points[i]);
      t4 = new Float32Array(3);
      t4.$dartCachedLength = t4.length;
      t4 = new T.Vector3(t4);
      t5 = t4.storage;
  ...
  getWrapPoints$2: function(oldPts, path) {
    var bounds, i, p, t1, oldX, oldY, t2, xNorm, pathPt, normal;
    ...
    for (i = 0; i < oldPts.length; ++i) {
      ...
      if (typeof oldX !== "number")
        throw oldX.$div();
      xNorm = path.getUtoTmapping$2(C.JSNumber_methods.$div(oldX, t2), oldX);
      pathPt = path.getPoint$1(xNorm);
      t2 = path.getNormalVector$1(xNorm);
      normal = t2.scale$1(t2, oldY);
      t2 = pathPt.get$x(pathPt);
      t1.set$x(p, t2.$add(t2, normal.get$x(normal)));
      t2 = pathPt.get$y(pathPt);
      t1.set$y(p, t2.$add(t2, normal.get$y(normal)));
    }
    return oldPts;
  }
},
...
EllipseCurve: {"": "Curve2D;aX,aY,xRadius,yRadius,aStartAngle,aEndAngle,aClockwise,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  getPoint$1: function(t) {
    var t1, angle, t2, t3, t4;
    t1 = this.aStartAngle;
    if (!this.aClockwise)
      t = 1 - t;
    angle = t1 + t * (this.aEndAngle - t1);
    t1 = Math.cos(angle);
    t2 = Math.sin(angle);
    ...
    t3 = new T.Vector2(t3);
    t4 = t3.storage;
    t4[0] = this.aX + this.xRadius * t1;
    t4[1] = this.aY + this.yRadius * t2;
    return t3;
  }
},
...
PathAction: {"": "Object;action,args", static: {
"": "PathAction_MOVE_TO,PathAction_LINE_TO,PathAction_QUADRATIC_CURVE_TO,PathAction_BEZIER_CURVE_TO,PathAction_CSPLINE_THRU,PathAction_ARC,PathAction_ELLIPSE",
}
},
...
Path: {"": "CurvePath;useSpacedPoints,_points,actions,curves,_bends,autoClose,cacheLengths,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  _fromPoints$1: function(vectors) {
    var t1, vlen, v;
    if (0 >= vectors.length)
      throw H.ioore(vectors, 0);
    t1 = vectors[0].storage;
    this.actions.push(new S.PathAction("moveTo", [t1[0], t1[1]]));
    for (vlen = vectors.length, v = 1; v < vlen; ++v) {
      if (v >= vectors.length)
        throw H.ioore(vectors, v);
      t1 = vectors[v].storage;
      this.lineTo$2(this, t1[0], t1[1]);
    }
  },
  lineTo$2: function(_, x, y) {
    var t1, lastargs, t2, t3, x0, y0, t4;
    t1 = this.actions;
    lastargs = C.JSArray_methods.get$last(t1).args;
    t2 = lastargs.length;
    t3 = t2 - 2;
    if (t3 < 0)
      throw H.ioore(lastargs, t3);
    x0 = lastargs[t3];
    t3 = t2 - 1;
    if (t3 < 0)
      throw H.ioore(lastargs, t3);
    ...
    t4[0] = x;
    t4[1] = y;
    J.add$1$ax(this.curves, new S.LineCurve(t3, t2, null, null, false));
    t1.push(new S.PathAction("lineTo", [x, y]));
  },
  quadraticCurveTo$4: function(_, aCPx, aCPy, aX, aY) {
    var t1, lastargs, t2, t3, x0, y0, t4, t5;
    t1 = this.actions;
    lastargs = C.JSArray_methods.get$last(t1).args;
    t2 = lastargs.length;
    t3 = t2 - 2;
    if (t3 < 0)
      throw H.ioore(lastargs, t3);
    x0 = J.toDouble$0$n(lastargs[t3]);
    t3 = t2 - 1;
    if (t3 < 0)
      throw H.ioore(lastargs, t3);
    y0 = J.toDouble$0$n(lastargs[t3]);
    t3 = new Float32Array(2);
    t3.$dartCachedLength = t3.length;
    t3 = new T.Vector2(t3);
    t2 = t3.storage;
    ...
    t5[0] = aX;
    t5[1] = aY;
    J.add$1$ax(this.curves, new S.QuadraticBezierCurve(t3, t2, t4, null, null, false));
    t1.push(new S.PathAction("quadraticCurveTo", [aCPx, aCPy, aX, aY]));
  },
  bezierCurveTo$6: function(_, aCP1x, aCP1y, aCP2x, aCP2y, aX, aY) {
    var t1, lastargs, t2, t3, x0, y0, t4, t5, t6;
    t1 = this.actions;
    lastargs = C.JSArray_methods.get$last(t1).args;
    t2 = lastargs.length;
    t3 = t2 - 2;
    ...
    t6[0] = aX;
    t6[1] = aY;
    J.add$1$ax(this.curves, new S.CubicBezierCurve(t3, t2, t4, t5, null, null, false));
    t1.push(new S.PathAction("bezierCurveTo", [aCP1x, aCP1y, aCP2x, aCP2y, aX, aY]));
  },
  splineThru$1: function(pts) {
    var t1, lastargs, t2, t3, x0, y0, npts;
    t1 = this.actions;
    lastargs = C.JSArray_methods.get$last(t1).args;
    t2 = lastargs.length;
    t3 = t2 - 2;
    ...
    t2[1] = y0;
    npts = [t3];
    C.JSArray_methods.addAll$1(npts, pts);
    J.add$1$ax(this.curves, new S.SplineCurve(npts, null, null, false));
    t1.push(new S.PathAction("splineThru", [pts]));
  },
  absellipse$7: function(aX, aY, xRadius, yRadius, aStartAngle, aEndAngle, aClockwise) {
    ...
    curve = new S.EllipseCurve(aX, aY, xRadius, yRadius, aStartAngle, aEndAngle, aClockwise, null, null, false);
    J.add$1$ax(this.curves, curve);
    t1 = curve.getPoint$1(aClockwise ? 1 : 0).storage;
    args.push(t1[0]);
    args.push(t1[1]);
    this.actions.push(new S.PathAction("ellipse", args));
  },
  getSpacedPoints$2: function(divisions, closedPath) {
    var points, i;
    if (divisions == null)
  ...
  getPoints$2: function(divisions, closedPath) {
    var points, t1, i, cpx, cpy, cpx2, cpy2, cpx1, cpy1, cpx0, cpy0, laste, j, t, tx, ty, t2, item, args, t3, t4, t5, k, last, spts, n, spline, aX, aY, aRadius, aStartAngle, aEndAngle, deltaAngle, angle, xRadius, yRadius, lastPoint;
    if (this.useSpacedPoints)
      return this.getSpacedPoints$2(divisions, closedPath);
    points = [];
    for (t1 = this.actions, i = 0, cpx = null, cpy = null, cpx2 = null, cpy2 = null, cpx1 = null, cpy1 = null, cpx0 = null, cpy0 = null, laste = null, j = null, t = null, tx = null, ty = null; t2 = t1.length, i < t2; ++i) {
      item = t1[i];
      args = item.args;
      switch (item.action) {
        case "moveTo":
        ...
        case "bezierCurveTo":
          t3 = args.length;
          if (4 >= t3)
            throw H.ioore(args, 4);
          cpx = args[4];
          if (5 >= t3)
            throw H.ioore(args, 5);
          cpy = args[5];
          cpx1 = args[0];
          cpy1 = args[1];
          cpx2 = args[2];
          ...
          for (j = 1; j <= 12; ++j) {
            ...
            if (typeof cpx !== "number")
              throw H.iae(cpx);
            tx = t2 * cpx0 + t4 * cpx1 + t3 * cpx2 + t5 * cpx;
            if (typeof cpy0 !== "number")
              throw H.iae(cpy0);
            if (typeof cpy1 !== "number")
              throw H.iae(cpy1);
            ...
            if (typeof cpy !== "number")
              throw H.iae(cpy);
            ty = t2 * cpy0 + t4 * cpy1 + t3 * cpy2 + t5 * cpy;
            t5 = new Float32Array(2);
            t5.$dartCachedLength = t5.length;
            t5 = new T.Vector2(t5);
            t3 = t5.storage;
        ...
        case "splineThru":
          ...
          t4 = t3 - 1;
          if (t4 < 0)
            throw H.ioore(laste, t4);
          t4 = laste[t4];
          t3 = new Float32Array(2);
          t3.$dartCachedLength = t3.length;
          last = new T.Vector2(t3);
          t3 = last.storage;
          t3[0] = t2;
          t3[1] = t4;
          spts = [last];
          if (0 >= args.length)
            throw H.ioore(args, 0);
          t4 = args[0];
          n = 12 * J.get$length$asx(t4);
          C.JSArray_methods.addAll$1(spts, t4);
          spline = new S.SplineCurve(spts, null, null, false);
          for (j = 1; j <= n; ++j)
            points.push(spline.getPoint$1(spline.getUtoTmapping$1(j / n)));
          break;
        case "arc":
          t3 = i - 1;
          if (t3 < 0)
          ...
          if (5 >= t3)
            throw H.ioore(args, 5);
          t3 = args[5];
          if (typeof aEndAngle !== "number")
            throw aEndAngle.$sub();
          if (typeof aStartAngle !== "number")
            throw H.iae(aStartAngle);
          deltaAngle = aEndAngle - aStartAngle;
          for (t2 = t3 !== true, j = 1; j <= 24; ++j) {
            t = j / 24;
            if (t2)
              t = 1 - t;
    ...
    lastPoint = points[t2];
    t1 = J.getInterceptor$x(lastPoint);
    t2 = t1.get$x(lastPoint);
    if (0 >= points.length)
      throw H.ioore(points, 0);
    t3 = J.get$x$x(points[0]);
    if (typeof t2 !== "number")
      throw t2.$sub();
    if (typeof t3 !== "number")
      throw H.iae(t3);
    if (Math.abs(t2 - t3) < 1e-10) {
      t1 = t1.get$y(lastPoint);
      if (0 >= points.length)
        throw H.ioore(points, 0);
      t2 = J.get$y$x(points[0]);
      if (typeof t1 !== "number")
        throw t1.$sub();
      if (typeof t2 !== "number")
        throw H.iae(t2);
      t2 = Math.abs(t1 - t2) < 1e-10;
      t1 = t2;
    } else
      t1 = false;
    if (t1) {
...
Path$: function(points) {
  var t1 = new S.Path(false, null, [], [], [], false, null, null, null, false);
  t1.Path$1(points);
  return t1;
}}
...
QuadraticBezierCurve: {"": "Curve2D;v0,v1,v2,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  getPoint$1: function(t) {
    var t1, t2, t3, t4, t5, t6, k, t7, t8, t9, t10, t11;
    t1 = this.v0.storage;
    t2 = t1[0];
    t3 = this.v1.storage;
    t4 = t3[0];
    ...
    t10 = new T.Vector2(t10);
    t11 = t10.storage;
    t11[0] = t7 * t2 + t8 * t4 + t9 * t6;
    t11[1] = t7 * t1 + t8 * t3 + t9 * t5;
    return t10;
  }
},
...
Shape: {"": "Path;holes,useSpacedPoints,_points,actions,curves,_bends,autoClose,cacheLengths,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  extrude$11$amount$bendPath$bevelEnabled$bevelSegments$bevelSize$bevelThickness$curveSegments$extrudeMaterial$extrudePath$material$steps: function(amount, bendPath, bevelEnabled, bevelSegments, bevelSize, bevelThickness, curveSegments, extrudeMaterial, extrudePath, material, steps) {
    ...
    return S.ExtrudeGeometry$([this], amount, bendPath, bevelEnabled, bevelSegments, bevelSize, bevelThickness, curveSegments, extrudeMaterial, extrudePath, null, material, steps);
  },
  extrude$4$amount$bevelEnabled$bevelSegments$steps: function(amount, bevelEnabled, bevelSegments, steps) {
    return this.extrude$11$amount$bendPath$bevelEnabled$bevelSegments$bevelSize$bevelThickness$curveSegments$extrudeMaterial$extrudePath$material$steps(amount, null, bevelEnabled, bevelSegments, null, 6, 12, null, null, null, steps);
  },
  ...
  extractPoints$1: function(divisions) {
    if (this.useSpacedPoints)
      return H.fillLiteralMap(["shape", this.getTransformedSpacedPoints$1(divisions), "holes", this.getSpacedPointsHoles$1(divisions)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    return H.fillLiteralMap(["shape", this.getTransformedPoints$1(divisions), "holes", this.getPointsHoles$1(divisions)], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  },
...
SplineCurve: {"": "Curve2D;points,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  getPoint$1: function(t) {
    var t1, v, c, point, intPoint, weight, t2, t3, t4, t5, t6;
    t1 = new Float32Array(2);
    t1.$dartCachedLength = t1.length;
    v = new T.Vector2(t1);
    c = P.List_List(4, null);
    point = (this.points.length - 1) * t;
    intPoint = C.JSInt_methods.toInt$0(C.JSNumber_methods.toInt$0(Math.floor(point)));
    weight = point - intPoint;
    c[0] = intPoint === 0 ? intPoint : intPoint - 1;
    c[1] = intPoint;
    t1 = this.points;
    t2 = t1.length;
    c[2] = intPoint > t2 - 2 ? t2 - 1 : intPoint + 1;
    c[3] = intPoint > t2 - 3 ? t2 - 1 : intPoint + 2;
    t3 = c[0];
    if (t3 >>> 0 !== t3 || t3 >= t2)
      throw H.ioore(t1, t3);
    t3 = J.get$x$x(t1[t3]);
    ...
    if (t5 >>> 0 !== t5 || t5 >= t1.length)
      throw H.ioore(t1, t5);
    t6 = v.storage;
    t6[0] = E.interpolate(t3, t2, t4, J.get$x$x(t1[t5]), weight);
    t5 = this.points;
    t1 = c[0];
    ...
    if (t3 >>> 0 !== t3 || t3 >= t5.length)
      throw H.ioore(t5, t3);
    t6[1] = E.interpolate(t1, t4, t2, J.get$y$x(t5[t3]), weight);
    return v;
  }
},
...
SplineCurve3: {"": "Curve3D;points,_arcLengthDivisions,cacheArcLengths,needsUpdate",
  getPoint$1: function(t) {
    var t1, v, c, point, intPoint, weight, t2, t3, pt0, pt1, pt2, pt3;
    t1 = new Float32Array(3);
    t1.$dartCachedLength = t1.length;
    v = new T.Vector3(t1);
    c = P.List_List(4, J.JSInt);
    c.$builtinTypeInfo = [J.JSInt];
    point = (this.points.length - 1) * t;
    intPoint = C.JSInt_methods.toInt$0(C.JSNumber_methods.toInt$0(Math.floor(point)));
    weight = point - intPoint;
    c[0] = intPoint === 0 ? intPoint : intPoint - 1;
    ...
    pt3 = pt3.storage;
    t3 = v.storage;
    t3[0] = E.interpolate(pt0[0], pt1[0], pt2[0], pt3[0], weight);
    t3[1] = E.interpolate(pt0[1], pt1[1], pt2[1], pt3[1], weight);
    t3[2] = E.interpolate(pt0[2], pt1[2], pt2[2], pt3[2], weight);
    return v;
  }
},

ExtrudeGeometry: {"": "Geometry;shapes,shapebb,id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  _getBevelVec2$3: function(pt_i, pt_j, pt_k) {
    var a, b, v_hat, w_hat, p, q, t1, t2, t3, t4, t5, t6, v, w, v_dot_w_hat, q_sub_p_dot_w_hat, s;
    a = S.ExtrudeGeometry___v1();
    b = S.ExtrudeGeometry___v2();
    v_hat = S.ExtrudeGeometry___v3();
    w_hat = S.ExtrudeGeometry___v4();
    p = S.ExtrudeGeometry___v5();
    q = S.ExtrudeGeometry___v6();
    t1 = J.getInterceptor$x(pt_i);
    t2 = t1.get$x(pt_i);
    t3 = J.getInterceptor$x(pt_j);
    t4 = t3.get$x(pt_j);
    if (typeof t2 !== "number")
      throw t2.$sub();
    if (typeof t4 !== "number")
    ...
    q_sub_p_dot_w_hat = q.sub$1(p).dot$1(w_hat);
    if (v_dot_w_hat === 0) {
      P.print("Either infinite or no solutions!");
      if (q_sub_p_dot_w_hat === 0)
        P.print("Its finite solutions.");
      else
        P.print("Too bad, no solutions.");
    }
    s = q_sub_p_dot_w_hat / v_dot_w_hat;
    if (s < 0)
      return this._getBevelVec1$3(pt_i, pt_j, pt_k);
    t1 = v.scale$1(v, s);
    t1 = t1.add$1(t1, p).sub$1(pt_i);
    t2 = new Float32Array(2);
    t2.$dartCachedLength = t2.length;
    t2 = new T.Vector2(t2);
    t2.setFrom$1(t1);
  ...
  _getBevelVec1$3: function(pt_i, pt_j, pt_k) {
    var t1, t2, t3, t4, t5, anglea, angleb, anglec, vec;
    t1 = J.getInterceptor$x(pt_j);
    t2 = t1.get$y(pt_j);
    t3 = J.getInterceptor$x(pt_i);
    t4 = t3.get$y(pt_i);
    if (typeof t2 !== "number")
      throw t2.$sub();
    if (typeof t4 !== "number")
    ...
    if (typeof t5 !== "number")
      throw H.iae(t5);
    anglea = Math.atan2(t2 - t4, t1 - t5);
    t1 = J.getInterceptor$x(pt_k);
    t2 = t1.get$y(pt_k);
    t4 = t3.get$y(pt_i);
    if (typeof t2 !== "number")
      throw t2.$sub();
  ...
  addShape$14$UVGenerator: function(shape, amount, bevelThickness, bevelSize, bevelSegments, bevelEnabled, curveSegments, steps, bendPath, extrudePath, $frames, material, extrudeMaterial, UVGenerator) {
    var t1, uvgen, extrudePts, t2, t3, splineTube, binormal, normal, position2, extrudeByPath, shapesOffset, shapePoints, vertices, holes, ahole, h, faces, vertices0, vlen, flen, t4, contourMovements, il, j, t5, i, k, t6, holesMovements, verticesMovements, oneHoleMovements, t7, t8, b, vert, t, bs, t9, t10, t11, t12, t13, s, t14, t15, z, t16, offset, face, layeroffset;
    t1 = {};
    t1.bevelSegments_0 = bevelSegments;
    uvgen = new S.ExtrudeGeometryWorldUVGenerator();
    if (extrudePath != null) {
      extrudePts = extrudePath.getSpacedPoints$1(steps);
      t2 = $.GeometryCount;
      $.GeometryCount = t2 + 1;
      t3 = [];
      t3.$builtinTypeInfo = [T.Vector3];
      splineTube = new S.TubeGeometry(null, null, null, null, null, null, null, null, null, null, null, t2, "", t3, [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, null);
      splineTube._frenetFrames$3(extrudePath, steps, false);
      t2 = new Float32Array(3);
      t2.$dartCachedLength = t2.length;
      binormal = new T.Vector3(t2);
      t2 = new Float32Array(3);
      t2.$dartCachedLength = t2.length;
      normal = new T.Vector3(t2);
      t2 = new Float32Array(3);
      t2.$dartCachedLength = t2.length;
      position2 = new T.Vector3(t2);
      bevelEnabled = false;
      extrudeByPath = true;
    } else {
      extrudePts = null;
    ...
    shapesOffset = J.get$length$asx(this.vertices);
    shapePoints = shape.extractPoints$0();
    vertices = shapePoints.$index(shapePoints, "shape");
    holes = shapePoints.$index(shapePoints, "holes");
    if (!(Y.area(vertices) < 0)) {
      vertices = this._reverse$1(vertices);
      t2 = J.getInterceptor$asx(holes);
      ahole = null;
      h = 0;
      while (true) {
        t3 = t2.get$length(holes);
        if (typeof t3 !== "number")
          throw H.iae(t3);
        if (!(h < t3))
          break;
        ahole = t2.$index(holes, h);
        if (Y.area(ahole) < 0)
          t2.$indexSet(holes, h, this._reverse$1(ahole));
        ++h;
      }
    } else
      ahole = null;
    faces = O.triangulateShape(vertices, holes);
    t2 = J.getInterceptor$asx(holes);
    vertices0 = vertices;
    h = 0;
    while (true) {
      ...
      if (!(h < t3))
        break;
      ahole = t2.$index(holes, h);
      vertices0 = P.List_List$from(vertices0, true, null);
      C.JSArray_methods.addAll$1(vertices0, ahole);
      ++h;
    }
    t3 = J.getInterceptor$asx(vertices0);
    vlen = t3.get$length(vertices0);
    flen = faces.length;
    t4 = J.getInterceptor$asx(vertices);
    t4.get$length(vertices);
    contourMovements = P.List_List(t4.get$length(vertices), null);
    il = t4.get$length(vertices);
    if (typeof il !== "number")
      throw il.$sub();
    j = il - 1;
    for (t5 = contourMovements.length, i = 0, k = 1; i < il; ++i) {
      if (j === il)
        j = 0;
      if (k === il)
        k = 0;
      ...
      t4.$index(vertices, j);
      t4.$index(vertices, k);
      t6 = this._getBevelVec2$3(t4.$index(vertices, i), t4.$index(vertices, j), t4.$index(vertices, k));
      if (i >= t5)
        throw H.ioore(contourMovements, i);
      contourMovements[i] = t6;
      ++j;
      ++k;
    }
    holesMovements = [];
    verticesMovements = P.List_List$from(contourMovements, true, null);
    h = 0;
    oneHoleMovements = null;
    while (true) {
      t6 = t2.get$length(holes);
      if (typeof t6 !== "number")
        throw H.iae(t6);
      if (!(h < t6))
        break;
      ahole = t2.$index(holes, h);
      t6 = J.getInterceptor$asx(ahole);
      oneHoleMovements = P.List_List(t6.get$length(ahole), null);
      il = t6.get$length(ahole);
      if (typeof il !== "number")
        throw il.$sub();
      j = il - 1;
      for (t7 = oneHoleMovements.length, i = 0, k = 1; i < il; ++i) {
        if (j === il)
          j = 0;
        if (k === il)
          k = 0;
        t8 = this._getBevelVec2$3(t6.$index(ahole, i), t6.$index(ahole, j), t6.$index(ahole, k));
        if (i >= t7)
          throw H.ioore(oneHoleMovements, i);
        oneHoleMovements[i] = t8;
        ++j;
        ++k;
      }
      holesMovements.push(oneHoleMovements);
      C.JSArray_methods.addAll$1(verticesMovements, oneHoleMovements);
      ++h;
    }
    for (b = 0, vert = null; t6 = t1.bevelSegments_0, b < t6; ++b) {
      t = b / t6;
      t6 = Math.sin(t * 3.141592653589793 / 2);
      if (typeof bevelSize !== "number")
        throw bevelSize.$mul();
      bs = bevelSize * t6;
      t6 = -(bevelThickness * (1 - t));
      i = 0;
      while (true) {
        t7 = t4.get$length(vertices);
        if (typeof t7 !== "number")
          throw H.iae(t7);
        if (!(i < t7))
          break;
        t7 = t4.$index(vertices, i);
        if (i >= t5)
          throw H.ioore(contourMovements, i);
        t8 = contourMovements[i];
        if (t8 == null)
          H.printToConsole("die");
        t8 = t8.clone$0(t8);
        t8 = t8.scale$1(t8, bs);
        vert = t8.add$1(t8, t7);
        t7 = vert.get$x(vert);
      ...
      while (true) {
        ...
        if (h >= holesMovements.length)
          throw H.ioore(holesMovements, h);
        oneHoleMovements = holesMovements[h];
        t7 = J.getInterceptor$asx(ahole);
        t8 = oneHoleMovements.length;
        i = 0;
        while (true) {
          t9 = t7.get$length(ahole);
          if (typeof t9 !== "number")
            throw H.iae(t9);
          if (!(i < t9))
            break;
          ...
          if (i >= t8)
            throw H.ioore(oneHoleMovements, i);
          t10 = oneHoleMovements[i];
          if (t10 == null)
            H.printToConsole("die");
          vert = J.add$1$ax(J.scale$1$x(J.clone$0$x(t10), bs), t9);
          t9 = J.getInterceptor$x(vert);
          t10 = t9.get$x(vert);
          t9 = t9.get$y(vert);
          t11 = this.vertices;
          t12 = new Float32Array(3);
    ...
    if (typeof vlen !== "number")
      throw H.iae(vlen);
    t6 = position2.storage;
    t7 = !extrudeByPath;
    i = 0;
    for (; i < vlen; ++i) {
      if (bevelEnabled) {
        t8 = t3.$index(vertices0, i);
        if (i >= verticesMovements.length)
          throw H.ioore(verticesMovements, i);
        t9 = verticesMovements[i];
        if (t9 == null)
          H.printToConsole("die");
        vert = J.add$1$ax(J.scale$1$x(J.clone$0$x(t9), bevelSize), t8);
      } else
        vert = t3.$index(vertices0, i);
      t8 = J.getInterceptor$x(vert);
      if (t7) {
        t9 = t8.get$x(vert);
        t8 = t8.get$y(vert);
        t10 = this.vertices;
        ...
        t9 = splineTube.normals;
        if (0 >= t9.length)
          throw H.ioore(t9, 0);
        t9 = normal.setFrom$1(t9[0]);
        t9.scale$1(t9, t8.get$x(vert));
        t9 = splineTube.binormals;
        if (0 >= t9.length)
          throw H.ioore(t9, 0);
        t9 = binormal.setFrom$1(t9[0]);
        t9.scale$1(t9, t8.get$y(vert));
        if (0 >= extrudePts.length)
          throw H.ioore(extrudePts, 0);
        t8 = position2.setFrom$1(extrudePts[0]);
        t8 = t8.add$1(t8, normal);
        t8.add$1(t8, binormal);
        t8 = t6[0];
        t9 = t6[1];
        t10 = t6[2];
        t11 = this.vertices;
    ...
    for (t8 = amount / steps, s = 1; s <= steps; ++s)
      for (t9 = t8 * s, i = 0; i < vlen; ++i) {
        if (bevelEnabled) {
          t10 = t3.$index(vertices0, i);
          if (i >= verticesMovements.length)
            throw H.ioore(verticesMovements, i);
          t11 = verticesMovements[i];
          if (t11 == null)
            H.printToConsole("die");
          vert = J.add$1$ax(J.scale$1$x(J.clone$0$x(t11), bevelSize), t10);
        } else
          vert = t3.$index(vertices0, i);
        t10 = J.getInterceptor$x(vert);
        if (t7) {
          t11 = t10.get$x(vert);
          t10 = t10.get$y(vert);
          t12 = this.vertices;
          ...
          t11 = splineTube.normals;
          if (s >= t11.length)
            throw H.ioore(t11, s);
          t11 = normal.setFrom$1(t11[s]);
          t11.scale$1(t11, t10.get$x(vert));
          t11 = splineTube.binormals;
          if (s >= t11.length)
            throw H.ioore(t11, s);
          t11 = binormal.setFrom$1(t11[s]);
          t11.scale$1(t11, t10.get$y(vert));
          if (s >= extrudePts.length)
            throw H.ioore(extrudePts, s);
          t10 = position2.setFrom$1(extrudePts[s]);
          t10 = t10.add$1(t10, normal);
          t10.add$1(t10, binormal);
          t10 = t6[0];
          t11 = t6[1];
          t12 = t6[2];
          t13 = this.vertices;
    ...
    for (b = t1.bevelSegments_0 - 1, t3 = steps - 1; b >= 0; --b) {
      t = b / t1.bevelSegments_0;
      ...
      i = 0;
      while (true) {
        t8 = t4.get$length(vertices);
        if (typeof t8 !== "number")
          throw H.iae(t8);
        if (!(i < t8))
          break;
        t8 = t4.$index(vertices, i);
        if (i >= t5)
          throw H.ioore(contourMovements, i);
        t9 = contourMovements[i];
        if (t9 == null)
          H.printToConsole("die");
        t9 = t9.clone$0(t9);
        t9 = t9.scale$1(t9, bs);
      ...
      while (true) {
        ...
        if (h >= holesMovements.length)
          throw H.ioore(holesMovements, h);
        oneHoleMovements = holesMovements[h];
        t8 = J.getInterceptor$asx(ahole);
        t9 = oneHoleMovements.length;
        i = 0;
        while (true) {
          ...
          if (!(i < t10))
            break;
          t10 = t8.$index(ahole, i);
          if (i >= t9)
            throw H.ioore(oneHoleMovements, i);
          t11 = oneHoleMovements[i];
          if (t11 == null)
            H.printToConsole("die");
          vert = J.add$1$ax(J.scale$1$x(J.clone$0$x(t11), bs), t10);
          t10 = J.getInterceptor$x(vert);
          if (t7) {
            t11 = t10.get$x(vert);
            t10 = t10.get$y(vert);
            ...
            t11 = t10.get$x(vert);
            t10 = t10.get$y(vert);
            if (t3 < 0 || t3 >= extrudePts.length)
              throw H.ioore(extrudePts, t3);
            t12 = J.get$y$x(extrudePts[t3]);
            if (typeof t10 !== "number")
              throw t10.$add();
            if (typeof t12 !== "number")
              throw H.iae(t12);
            if (t3 >= extrudePts.length)
              throw H.ioore(extrudePts, t3);
            t13 = J.get$x$x(extrudePts[t3]);
    ...
    t3 = new S.ExtrudeGeometry_addShape_f3(this, shape, material, uvgen, shapesOffset);
    if (bevelEnabled) {
      offset = vlen * 0;
      for (i = 0; i < flen; ++i) {
        if (i >= faces.length)
          throw H.ioore(faces, i);
        face = faces[i];
        t5 = J.getInterceptor$asx(face);
        t3.call$4(J.$add$ns(t5.$index(face, 2), offset), J.$add$ns(t5.$index(face, 1), offset), J.$add$ns(t5.$index(face, 0), offset), true);
      }
      offset = vlen * (steps + t1.bevelSegments_0 * 2);
      for (i = 0; i < flen; ++i) {
        if (i >= faces.length)
          throw H.ioore(faces, i);
        face = faces[i];
        t5 = J.getInterceptor$asx(face);
        t3.call$4(J.$add$ns(t5.$index(face, 0), offset), J.$add$ns(t5.$index(face, 1), offset), J.$add$ns(t5.$index(face, 2), offset), false);
      }
    } else {
      for (i = 0; i < flen; ++i) {
        if (i >= faces.length)
        ...
        face = faces[i];
        t5 = J.getInterceptor$asx(face);
        t3.call$4(t5.$index(face, 2), t5.$index(face, 1), t5.$index(face, 0), true);
      }
      for (t5 = vlen * steps, i = 0; i < flen; ++i) {
        if (i >= faces.length)
          throw H.ioore(faces, i);
        face = faces[i];
        t6 = J.getInterceptor$asx(face);
        t3.call$4(J.$add$ns(t6.$index(face, 0), t5), J.$add$ns(t6.$index(face, 1), t5), J.$add$ns(t6.$index(face, 2), t5), false);
      }
    }
    t1 = new S.ExtrudeGeometry_addShape_sidewalls(t1, steps, vlen, new S.ExtrudeGeometry_addShape_f4(this, shape, extrudeMaterial, uvgen, shapesOffset));
    t1.call$2(vertices, 0);
    t4 = t4.get$length(vertices);
    if (typeof t4 !== "number")
      throw H.iae(t4);
    layeroffset = 0 + t4;
    h = 0;
  ...
  ExtrudeGeometry$13$amount$bendPath$bevelEnabled$bevelSegments$bevelSize$bevelThickness$curveSegments$extrudeMaterial$extrudePath$frames$material$steps: function(shapes, amount, bendPath, bevelEnabled, bevelSegments, bevelSize, bevelThickness, curveSegments, extrudeMaterial, extrudePath, $frames, material, steps) {
    if (bevelSize == null)
      bevelSize = bevelThickness - 2;
    this.shapebb = C.JSArray_methods.get$last(this.shapes).getBoundingBox$0();
  ...
  static: {
"": "ExtrudeGeometry_RAD_TO_DEGREES,ExtrudeGeometry____v1,ExtrudeGeometry____v2,ExtrudeGeometry____v3,ExtrudeGeometry____v4,ExtrudeGeometry____v5,ExtrudeGeometry____v6",
ExtrudeGeometry$: function(shapes, amount, bendPath, bevelEnabled, bevelSegments, bevelSize, bevelThickness, curveSegments, extrudeMaterial, extrudePath, $frames, material, steps) {
  ...
  t2 = new S.ExtrudeGeometry(shapes, null, t1, "", t2, [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, null);
  t2.ExtrudeGeometry$13$amount$bendPath$bevelEnabled$bevelSegments$bevelSize$bevelThickness$curveSegments$extrudeMaterial$extrudePath$frames$material$steps(shapes, amount, bendPath, bevelEnabled, bevelSegments, bevelSize, bevelThickness, curveSegments, extrudeMaterial, extrudePath, $frames, material, steps);
  return t2;
},
...
ExtrudeGeometry_addShape_f3: {"": "Closure;this_1,shape_2,material_3,uvgen_4,shapesOffset_5",
  call$4: function(a, b, c, isBottom) {
    ...
    t3 = this.material_3;
    t4 = [a, b, c];
    t5 = new S.Face3(t4, null, null, null, null, null, t3, null);
    t5.Face$4(t4, null, null, t3);
    C.JSArray_methods.add$1(t2, t5);
    t2 = this.uvgen_4;
    t3 = this.shape_2;
    uvs = isBottom === true ? t2.generateTopUV$6(t1, t3, null, a, b, c) : t2.generateTopUV$6(t1, t3, null, a, b, c);
    t1.faceVertexUvs[0].push(uvs);
  }
},
...
ExtrudeGeometry_addShape_f4: {"": "Closure;this_6,shape_7,extrudeMaterial_8,uvgen_9,shapesOffset_10",
  call$7: function(a, b, c, d, wallContour, stepIndex, stepsLength) {
    ...
    t1 = this.this_6;
    t2 = t1.faces;
    t3 = this.extrudeMaterial_8;
    t4 = [a, b, c, d];
    t5 = new S.Face4(t4, null, null, null, null, null, t3, null);
    t5.Face$4(t4, null, null, t3);
    C.JSArray_methods.add$1(t2, t5);
    uvs = this.uvgen_9.generateSideWallUV$10(t1, this.shape_7, wallContour, null, a, b, c, d, stepIndex, stepsLength);
    t1.faceVertexUvs[0].push(uvs);
  }
},
...
ExtrudeGeometry_addShape_sidewalls: {"": "Closure;box_0,nSteps_11,vlen_12,f4_13",
  call$2: function(contour, layeroffset) {
    var t1, i, t2, t3, t4, t5, t6, k, t7, sl, s, slen1, s0, slen2;
    t1 = J.getInterceptor$asx(contour);
    i = t1.get$length(contour);
    t2 = this.vlen_12;
    t3 = J.getInterceptor$ns(layeroffset);
    t4 = this.f4_13;
    t5 = this.nSteps_11;
    t6 = this.box_0;
    while (true) {
      ...
      k = i - 1;
      if (k < 0) {
        t7 = t1.get$length(contour);
        if (typeof t7 !== "number")
          throw t7.$sub();
        k = t7 - 1;
      }
      sl = t5 + t6.bevelSegments_0 * 2;
      for (s = 0; s < sl; s = s0) {
        if (typeof t2 !== "number")
          throw t2.$mul();
        slen1 = t2 * s;
        s0 = s + 1;
        slen2 = t2 * s0;
        t4.call$7(J.$add$ns(t3.$add(layeroffset, i), slen1), J.$add$ns(t3.$add(layeroffset, k), slen1), J.$add$ns(t3.$add(layeroffset, k), slen2), J.$add$ns(t3.$add(layeroffset, i), slen2), contour, s, sl);
      }
    }
  },
  $is_args2: true
...
ExtrudeGeometryWorldUVGenerator: {"": "Object;",
  generateTopUV$6: function(geometry, extrudedShape, extrudeOptions, indexA, indexB, indexC) {
    ...
    ax = J.get$x$x(J.$index$asx(geometry.vertices, indexA));
    ay = J.get$y$x(J.$index$asx(geometry.vertices, indexA));
    bx = J.get$x$x(J.$index$asx(geometry.vertices, indexB));
    by = J.get$y$x(J.$index$asx(geometry.vertices, indexB));
    cx = J.get$x$x(J.$index$asx(geometry.vertices, indexC));
    cy = J.get$y$x(J.$index$asx(geometry.vertices, indexC));
    if (typeof ay !== "number")
      throw H.iae(ay);
    if (typeof by !== "number")
      throw H.iae(by);
    if (typeof cy !== "number")
      throw H.iae(cy);
    return [new S.UV(ax, 1 - ay), new S.UV(bx, 1 - by), new S.UV(cx, 1 - cy)];
  },
  generateSideWallUV$10: function(geometry, extrudedShape, wallContour, extrudeOptions, indexA, indexB, indexC, indexD, stepIndex, stepsLength) {
    ...
    ax = J.get$x$x(J.$index$asx(geometry.vertices, indexA));
    ay = J.get$y$x(J.$index$asx(geometry.vertices, indexA));
    az = J.get$z$x(J.$index$asx(geometry.vertices, indexA));
    bx = J.get$x$x(J.$index$asx(geometry.vertices, indexB));
    by = J.get$y$x(J.$index$asx(geometry.vertices, indexB));
    bz = J.get$z$x(J.$index$asx(geometry.vertices, indexB));
    cx = J.get$x$x(J.$index$asx(geometry.vertices, indexC));
    cy = J.get$y$x(J.$index$asx(geometry.vertices, indexC));
    cz = J.get$z$x(J.$index$asx(geometry.vertices, indexC));
    dx = J.get$x$x(J.$index$asx(geometry.vertices, indexD));
    dy = J.get$y$x(J.$index$asx(geometry.vertices, indexD));
    dz = J.get$z$x(J.$index$asx(geometry.vertices, indexD));
    if (typeof ay !== "number")
      throw ay.$sub();
    if (typeof by !== "number")
      throw H.iae(by);
    if (Math.abs(ay - by) < 0.01)
      return [new S.UV(ax, az), new S.UV(bx, bz), new S.UV(cx, cz), new S.UV(dx, dz)];
    else
      return [new S.UV(ay, az), new S.UV(by, bz), new S.UV(cy, cz), new S.UV(dy, dz)];
  }
},

TubeGeometry: {"": "Geometry;path,segments,nSegments,radius,segmentsRadius,closed,grid,tangents,normals,binormals,debug,id,name,vertices,colors,three$Geometry$normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  _frenetFrames$3: function(ppath, psegments, pclosed) {
    var t1, t2, t3, mat, i, numpoints, t4, theta, vec, t5;
    t1 = {};
    this.path = ppath;
    ...
    if (typeof t3 === "number") {
      ...
      i = 1;
      for (; i <= t3; ++i)
        J.add$1$ax(this.segments, i / t3);
    }
    this.nSegments = J.get$length$asx(this.segments);
    t3 = this.nSegments;
    if (typeof t3 !== "number")
      throw t3.$add();
    numpoints = t3 + 1;
    t3 = P.List_List(numpoints, T.Vector3);
    H.setRuntimeTypeInfo(t3, [T.Vector3]);
    this.tangents = t3;
    t3 = P.List_List(numpoints, T.Vector3);
    H.setRuntimeTypeInfo(t3, [T.Vector3]);
    this.normals = t3;
    ...
    for (i = 0; i < numpoints; ++i) {
      t3 = this.tangents;
      t4 = this.path;
      t4 = i === 0 ? t4.getTangent$1(t4.getUtoTmapping$1(0)) : t4.getTangent$1(t4.getUtoTmapping$1(J.$index$asx(this.segments, i - 1)));
      if (i >= t3.length)
        throw H.ioore(t3, i);
      t3[i] = t4;
      t4 = this.tangents;
    ...
    new S.TubeGeometry__frenetFrames__initialNormal3(t1, this, new T.Vector3(t2)).call$0();
    for (theta = null, i = 1; i < numpoints; ++i) {
      t1 = this.normals;
      t2 = i - 1;
      t3 = t1.length;
      if (t2 >= t3)
        throw H.ioore(t1, t2);
      t4 = J.clone$0$x(t1[t2]);
      if (i >= t3)
        throw H.ioore(t1, i);
      t1[i] = t4;
      t4 = this.binormals;
      ...
      if (i >= t4)
        throw H.ioore(t3, i);
      vec = t1.cross$1(t3[i]);
      t1 = J.getInterceptor$asx(vec);
      if (t1.get$length(vec) > 0.0001) {
        t1.normalize$0(vec);
        t1 = this.tangents;
        t3 = t1.length;
        if (t2 >= t3)
        ...
        if (i >= t1.length)
          throw H.ioore(t1, i);
        t1[i].applyProjection$1(S.makeRotationAxis(mat, vec, theta));
      }
      t1 = this.binormals;
      t2 = this.tangents;
      if (i >= t2.length)
    ...
    if (this.closed === true) {
      ...
      if (t4 >= t3)
        throw H.ioore(t2, t4);
      if (t1.dot$1(t5.cross$1(t2[t4])) > 0)
        theta = -theta;
      for (i = 1; i < numpoints; ++i) {
        ...
        if (i >= t2.length)
          throw H.ioore(t2, i);
        t1.applyProjection$1(S.makeRotationAxis(mat, t2[i], theta * i));
        t2 = this.binormals;
        t1 = this.tangents;
        if (i >= t1.length)
          throw H.ioore(t1, i);
...
TubeGeometry__frenetFrames__initialNormal1: {"": "Closure;this_1",
  call$1: function(lastBinormal) {
    ...
    if (lastBinormal == null) {
      t1 = new Float32Array(3);
      t1.$dartCachedLength = t1.length;
      lastBinormal = new T.Vector3(t1);
      lastBinormal.setValues$3(0, 0, 1);
    }
    t1 = this.this_1;
    t2 = t1.normals;
    t3 = t1.tangents;
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    t3 = J.normalize$0$x(lastBinormal.cross$1(t3[0]));
    if (0 >= t2.length)
      throw H.ioore(t2, 0);
    t2[0] = t3;
    t3 = t1.binormals;
    ...
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    t1 = J.normalize$0$x(t2.cross$1(t1[0]));
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    t3[0] = t1;
  },
...
TubeGeometry__frenetFrames__initialNormal2: {"": "Closure;this_2,epsilon_3",
  call$0: function() {
    ...
    t1 = this.this_2;
    t2 = t1.path;
    t2 = t2.getTangent$1(t2.getUtoTmapping$1(this.epsilon_3));
    t3 = t1.normals;
    t4 = t1.tangents;
    if (0 >= t4.length)
      throw H.ioore(t4, 0);
    t4 = t2.$sub(t2, t4[0]);
    t4 = t4.normalize$0(t4);
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    t3[0] = t4;
    t4 = t1.binormals;
...
TubeGeometry__frenetFrames__initialNormal3: {"": "Closure;box_0,this_4,normal_5",
  call$0: function() {
    var t1, t2, t3, t4, vec;
    t1 = this.box_0;
    t1.smallest_0 = 1 / 0;
    ...
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    t3 = t3[0];
    t1.tx_1 = Math.abs(t3.get$x(t3));
    t3 = t2.tangents;
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    t3 = t3[0];
    t1.ty_2 = Math.abs(t3.get$y(t3));
    t3 = t2.tangents;
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    t3 = t3[0];
    t1.tz_3 = Math.abs(t3.get$z(t3));
    t3 = t1.tx_1;
    t4 = t1.smallest_0;
    if (typeof t3 !== "number")
      throw t3.$le();
    ...
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    vec = J.normalize$0$x(t1[0].cross$1(this.normal_5));
    t1 = t2.normals;
    t3 = t2.tangents;
    if (0 >= t3.length)
      throw H.ioore(t3, 0);
    ...
    for (t1 = this._frustum, i = 0, j = null, jl = null, shadowMap = null, shadowMatrix = null, shadowCamera = null, buffer = null, material = null, webglObject = null, object = null, renderList = null; i < il; ++i) {
      ...
      for (; j < jl; ++j) {
        ...
        if (object.get$visible(object) && object.get$castShadow())
          if (!object.$isMesh || !object.frustumCulled || t1.contains$1(t1, object)) {
...
Face: {"": "Object;normal@,vertexNormals<,vertexColors<,vertexTangents<,color>,centroid<",
  get$size: function(_) {
  ...
  setFrom$1: function(other) {
    ...
    t1 = new H.MappedListIterable(other.vertexNormals, new S.Face_setFrom_closure());
    H.setRuntimeTypeInfo(t1, [null, null]);
    this.vertexNormals = t1.toList$0(t1);
    t1 = new H.MappedListIterable(other.vertexColors, new S.Face_setFrom_closure0());
    H.setRuntimeTypeInfo(t1, [null, null]);
    this.vertexColors = t1.toList$0(t1);
    t1 = new H.MappedListIterable(other.vertexTangents, new S.Face_setFrom_closure1());
    H.setRuntimeTypeInfo(t1, [null, null]);
    this.vertexTangents = t1.toList$0(t1);
    return this;
  },
  Face$4: function(indices, normalOrVertexNormals, colorOrVertexColors, materialIndex) {
    ...
    t1 = new Float32Array(3);
    t1.$dartCachedLength = t1.length;
    this.centroid = new T.Vector3(t1);
  }
},

Face_setFrom_closure: {"": "Closure;",
  call$1: function(v) {
...
Face3: {"": "Face;indices,normal,vertexNormals,vertexColors,vertexTangents,color,materialIndex,centroid",
  get$a: function(_) {
    var t1 = this.indices;
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
...
Face4: {"": "Face;indices,normal,vertexNormals,vertexColors,vertexTangents,color,materialIndex,centroid",
  get$a: function(_) {
    var t1 = this.indices;
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
...
Geometry: {"": "Object;id*,name,vertices@,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets<,morphColors,morphNormals<,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  computeFaceNormals$0: function() {
    H.IterableMixinWorkaround_forEach(this.faces, new S.Geometry_computeFaceNormals_closure(this));
  },
...
Geometry_computeCentroids_closure: {"": "Closure;this_0",
  call$1: function(face) {
    var t1, t2;
    face.get$centroid().setValues$3(0, 0, 0);
    t1 = face.indices;
    H.IterableMixinWorkaround_forEach(t1, new S.Geometry_computeCentroids__closure(this.this_0, face));
    t2 = face.centroid;
    face.centroid = t2.$div(t2, t1.length);
  },
  $is_args1: true
},

Geometry_computeCentroids__closure: {"": "Closure;this_1,face_2",
  call$1: function(idx) {
    var t1 = this.face_2.centroid;
    t1.add$1(t1, J.$index$asx(this.this_1.vertices, idx));
  },
  $is_args1: true
},

Geometry_computeFaceNormals_closure: {"": "Closure;this_0",
  call$1: function(face) {
    var t1, t2, vA, vB, cb;
    t1 = this.this_0;
...
DirectionalLight: {"": "ShadowCaster;position>,target>,intensity<,distance,shadowCameraLeft,shadowCameraRight,shadowCameraTop,shadowCameraBottom,shadowCascade,shadowCascadeOffset,shadowCascadeCount<,shadowCascadeBias,shadowCascadeWidth,shadowCascadeHeight,shadowCascadeNearZ,shadowCascadeFarZ,shadowCascadeArray,castShadow,onlyShadow,shadowCameraNear,shadowCameraFar,shadowCameraFov,shadowCameraVisible,shadowBias,shadowDarkness,shadowMapWidth,shadowMapHeight,shadowMap,shadowMapSize,shadowCamera,shadowMatrix,cameraHelper,color,id,name,properties,parent,children,up,three$Object3D$position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,three$Object3D$castShadow,receiveShadow,frustumCulled,_vector,customDepthMaterial,__data",
...
DirectionalLight$: function(hex, intensity, distance) {
  ...
  t10 = new T.Matrix4(t10);
  t10.setIdentity$0();
  t11 = T.Quaternion$identity();
  t12 = new Float32Array(3);
  t12.$dartCachedLength = t12.length;
  t12 = new S.DirectionalLight(null, null, intensity, distance, null, null, null, null, null, null, null, null, null, null, null, null, null, false, false, 50, 5000, 50, false, 0, 0.5, 512, 512, null, null, null, null, null, t1, t2, "", t3, null, [], t4, t5, t6, t7, "XYZ", null, null, null, true, null, t8, t9, t10, true, true, t11, false, 0, 1, true, false, false, true, new T.Vector3(t12), null, null);
  t12.DirectionalLight$3(hex, intensity, distance);
  return t12;
}}
...
Material: {"": "Object;id*,side<,opacity>,blending<,blendSrc<,blendDst<,blendEquation>,alphaTest<,polygonOffset>,polygonOffsetFactor<,polygonOffsetUnits<,transparent<,depthTest<,depthWrite<,visible>,needsUpdate@",
  get$_data: function() {
    if (this.__data == null)
      this.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    return this.__data;
...
ParticleBasicMaterial: {"": "Material;color>,map>,size>,sizeAttenuation,vertexColors<,fog<,name,id,side,opacity,blending,blendSrc,blendDst,blendEquation,alphaTest,polygonOffset,polygonOffsetFactor,polygonOffsetUnits,transparent,depthTest,depthWrite,overdraw,visible,needsUpdate,__data",
  map$1: function($receiver, arg0) {
    return this.map.call$1(arg0);
  },
...
Mesh: {"": "Object3D;geometry<,material<,morphTargetBase<,morphTargetForcedOrder,morphTargetInfluences,_morphTargetDictionary,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,customDepthMaterial,__data",
  Mesh$2: function(geometry, material) {
    ...
    if (this.material == null) {
      t1 = S.Color$(C.C__Random.nextInt$1(16777215));
      t2 = $.MaterialCount;
      $.MaterialCount = t2 + 1;
...
Mesh$: function(geometry, material) {
  ...
  t11 = new Float32Array(3);
  t11.$dartCachedLength = t11.length;
  t11 = new S.Mesh(geometry, material, 0, null, null, null, t1, "", t2, null, [], t3, t4, t5, t6, "XYZ", null, null, null, true, null, t7, t8, t9, true, true, t10, false, 0, 1, true, false, false, true, new T.Vector3(t11), null, null);
  t11.Mesh$2(geometry, material);
  return t11;
}}
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  initMeshBuffers$2: function(geometryGroup, object) {
    var t1, t2, geometry, faces3, faces4, t3, t4, nvertices, material, uvType, normalType, vertexColorType, t5, t6, ml, m;
    t1 = object.object;
    t2 = !t1.$isMesh;
    geometry = !!t1.$isMesh || !!t1.$isParticleSystem || !!t1.$isLine ? t1.get$geometry() : null;
    ...
    t5 = nvertices * 3;
    t6 = new Float32Array(t5);
    t6.$dartCachedLength = t6.length;
    geometryGroup.__vertexArray = t6;
    if (normalType !== 0) {
      t6 = new Float32Array(t5);
      t6.$dartCachedLength = t6.length;
      geometryGroup.__normalArray = t6;
    }
    if (geometry.hasTangents) {
      t6 = new Float32Array(nvertices * 4);
      t6.$dartCachedLength = t6.length;
      geometryGroup.__tangentArray = t6;
    }
    if (vertexColorType === true) {
      t6 = new Float32Array(t5);
      t6.$dartCachedLength = t6.length;
      geometryGroup.__colorArray = t6;
    }
    if (uvType) {
      t6 = new Float32Array(nvertices * 2);
      t6.$dartCachedLength = t6.length;
      geometryGroup.__uvArray = t6;
    }
    (!!t1.$isMesh || !!t1.$isParticleSystem || !!t1.$isLine ? t1.get$geometry() : null).skinWeights;
    t1 = (t3 * 1 + t4 * 2) * 3;
    t2 = new Uint16Array(t1);
    t2.$dartCachedLength = t2.length;
    geometryGroup.__faceArray = t2;
    t2 = nvertices * 2;
    t3 = new Uint16Array(t2);
    t3.$dartCachedLength = t3.length;
    geometryGroup.__lineArray = t3;
    geometryGroup.__morphTargetsArrays = [];
    ml = geometryGroup.numMorphTargets;
    for (m = 0; m < ml; ++m) {
      t3 = geometryGroup.__morphTargetsArrays;
      t4 = new Float32Array(t5);
      t4.$dartCachedLength = t4.length;
      t3.push(t4);
    }
  ...
  setParticleBuffers$3: function(geometry, hint, object) {
    ...
    if (t1) {
      ...
      if (customAttributes != null) {
        ...
        for (index = null, i = 0, ca = null, cal = null, value = null; i < il; ++i) {
          customAttributes[i].get$boundTo();
          continue;
        }
      }
    } else {
    ...
    if (customAttributes != null) {
      ...
      for (i = 0; i < il; ++i) {
        ...
        customAttribute.get$needsUpdate();
        if (t1) {
  ...
  setLineBuffers$2: function(geometry, hint) {
    var vertices, t1, colors, lineDistances, vl, cl, vertexArray, colorArray, lineDistanceArray, t2, dirtyVertices, dirtyColors, dirtyLineDistances, customAttributes, v, offset, vertex, t3, c, color, t4, d, il, i, ca, cal, value;
    vertices = geometry.get$vertices();
    t1 = geometry._geometry;
    colors = t1.colors;
  ...
  setMeshBuffers$5: function(geometryGroup, object, hint, dispose, material) {
    var normalType, vertexColorType, uvType, needsSmoothNormals, vertexArray, uvArray, uv2Array, normalArray, tangentArray, colorArray, morphTargetsArrays, morphNormalsArrays, customAttributes, faceArray, lineArray, t1, t2, t3, geometry, dirtyVertices, dirtyElements, dirtyUvs, dirtyNormals, dirtyTangents, dirtyColors, dirtyMorphTargets, vertices, chunk_faces3, chunk_faces4, obj_faces, obj_uvs, morphTargets, morphNormals, fl, f, face, v1, v2, v3, offset, t4, t5, v4, n1, n2, n3, n4, vk, vka, nka, chf, faceVertexNormals, offset_morphTarget, t6, t7, t8, t9, t10, t11, t12, t13, t14, offset_color, vertexColors, faceColor, c1, c2, c3, c4, offset_tangent, vertexTangents, i, vn, offset_normal, vertexNormals, faceNormal, uvi, offset_uv, fi, uv, uv2i, offset_uv2, uv2, vertexIndex, offset_face, offset_line, il, offset_custom, offset_customSrc, value;
    ...
    t1 = object.object;
    t2 = !t1.$isMesh;
    if ((!!t1.$isMesh || !!t1.$isParticleSystem || !!t1.$isLine ? t1.get$geometry() : null) != null) {
      t1 = !!t1.$isMesh || !!t1.$isParticleSystem || !!t1.$isLine ? t1.get$geometry() : null;
      if (t1.__data == null)
    ...
    if (t2.containsKey$1(t2, "elementsNeedUpdate")) {
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      dirtyElements = t2.$index(t2, "elementsNeedUpdate");
    } else
      dirtyElements = false;
    t2 = t1.__data;
    if (t2.containsKey$1(t2, "uvsNeedUpdate")) {
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      dirtyUvs = t2.$index(t2, "uvsNeedUpdate");
    } else
      dirtyUvs = false;
    t2 = t1.__data;
    if (t2.containsKey$1(t2, "normalsNeedUpdate")) {
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      dirtyNormals = t2.$index(t2, "normalsNeedUpdate");
    } else
      dirtyNormals = false;
    t2 = t1.__data;
    if (t2.containsKey$1(t2, "tangentsNeedUpdate")) {
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      dirtyTangents = t2.$index(t2, "tangentsNeedUpdate");
    } else
      dirtyTangents = false;
    t2 = t1.__data;
    if (t2.containsKey$1(t2, "colorsNeedUpdate")) {
      ...
      dirtyColors = false;
    t2 = t1.__data;
    if (t2.containsKey$1(t2, "morphTargetsNeedUpdate")) {
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      dirtyMorphTargets = t2.$index(t2, "morphTargetsNeedUpdate");
    } else
    ...
    if (dirtyVertices === true) {
      ...
      for (t2 = J.getInterceptor$asx(vertices), f = 0, face = null, v1 = null, v2 = null, v3 = null, offset = 0; f < fl; ++f) {
        if (f >= chunk_faces3.length)
          throw H.ioore(chunk_faces3, f);
        t3 = chunk_faces3[f];
        if (t3 < 0 || t3 >= obj_faces.length)
          throw H.ioore(obj_faces, t3);
        face = obj_faces[t3];
        ...
        t4 = t3.get$x(v1);
        if (offset >= C.JS_CONST_ZYJ(vertexArray))
          throw H.ioore(vertexArray, offset);
        ...
        t5 = offset + 2;
        t3 = t3.get$z(v1);
        if (t5 >= C.JS_CONST_ZYJ(vertexArray))
          throw H.ioore(vertexArray, t5);
        vertexArray[t5] = t3;
        t3 = offset + 3;
    ...
    if (dirtyMorphTargets === true)
      for (n1 = null, n2 = null, n3 = null, n4 = null, vk = 0, vka = null, nka = null, chf = null, faceVertexNormals = null; false; ++vk) {
        fl = chunk_faces3.length;
        for (f = 0, offset_morphTarget = 0; f < fl; ++f) {
          ...
          if (chf < 0 || chf >= obj_faces.length)
            throw H.ioore(obj_faces, chf);
          face = obj_faces[chf];
          if (vk >= 0)
            throw H.ioore(morphTargets, vk);
          t2 = morphTargets[vk].get$vertices();
          t3 = J.getInterceptor$x(face);
          v1 = t2.$index(t2, t3.get$a(face));
          t2 = morphTargets[vk].get$vertices();
          v2 = t2.$index(t2, t3.get$b(face));
          t2 = morphTargets[vk].get$vertices();
          v3 = t2.$index(t2, t3.get$c(face));
          morphTargetsArrays.length;
          vka = morphTargetsArrays[vk];
          t3 = v1.get$x(v1);
          t2 = C.JS_CONST_ZYJ(vka);
          if (offset_morphTarget >= t2)
            throw H.ioore(vka, offset_morphTarget);
          vka[offset_morphTarget] = t3;
          t3 = offset_morphTarget + 1;
          t4 = v1.get$y(v1);
          if (t3 >= t2)
            throw H.ioore(vka, t3);
          vka[t3] = t4;
          t4 = offset_morphTarget + 2;
          t5 = v1.get$z(v1);
          if (t4 >= t2)
            throw H.ioore(vka, t4);
          vka[t4] = t5;
          t5 = offset_morphTarget + 3;
          t6 = v2.get$x(v2);
          if (t5 >= t2)
            throw H.ioore(vka, t5);
          vka[t5] = t6;
          t6 = offset_morphTarget + 4;
          t7 = v2.get$y(v2);
          if (t6 >= t2)
            throw H.ioore(vka, t6);
          vka[t6] = t7;
          t7 = offset_morphTarget + 5;
          t8 = v2.get$z(v2);
          if (t7 >= t2)
            throw H.ioore(vka, t7);
          vka[t7] = t8;
          t8 = offset_morphTarget + 6;
          t9 = v3.get$x(v3);
          if (t8 >= t2)
            throw H.ioore(vka, t8);
          vka[t8] = t9;
          t9 = offset_morphTarget + 7;
          t10 = v3.get$y(v3);
          if (t9 >= t2)
            throw H.ioore(vka, t9);
          vka[t9] = t10;
          t10 = offset_morphTarget + 8;
          t11 = v3.get$z(v3);
          if (t10 >= t2)
            throw H.ioore(vka, t10);
          vka[t10] = t11;
          if (material.get$morphNormals() === true) {
            t2 = morphNormals[vk];
            if (needsSmoothNormals) {
              t2 = t2.get$vertexNormals();
              faceVertexNormals = t2.$index(t2, chf);
              ...
              t2 = t2.get$faceNormals();
              n1 = t2.$index(t2, chf);
              n3 = n1;
              n2 = n3;
            }
            morphNormalsArrays.length;
            nka = morphNormalsArrays[vk];
            t2 = n1.get$x(n1);
            t11 = C.JS_CONST_ZYJ(nka);
            if (offset_morphTarget >= t11)
              throw H.ioore(nka, offset_morphTarget);
            nka[offset_morphTarget] = t2;
            t2 = n1.get$y(n1);
            if (t3 >= t11)
              throw H.ioore(nka, t3);
            nka[t3] = t2;
            t2 = n1.get$z(n1);
            if (t4 >= t11)
              throw H.ioore(nka, t4);
            nka[t4] = t2;
            t2 = n2.get$x(n2);
            if (t5 >= t11)
              throw H.ioore(nka, t5);
            nka[t5] = t2;
            t2 = n2.get$y(n2);
            if (t6 >= t11)
              throw H.ioore(nka, t6);
            nka[t6] = t2;
            t2 = n2.get$z(n2);
            if (t7 >= t11)
              throw H.ioore(nka, t7);
            nka[t7] = t2;
            t2 = n3.get$x(n3);
            if (t8 >= t11)
              throw H.ioore(nka, t8);
            nka[t8] = t2;
            t2 = n3.get$y(n3);
            if (t9 >= t11)
              throw H.ioore(nka, t9);
            nka[t9] = t2;
            t2 = n3.get$z(n3);
            if (t10 >= t11)
              throw H.ioore(nka, t10);
            nka[t10] = t2;
          }
        ...
        for (f = 0; f < fl; ++f) {
          ...
          t12 = v4.get$x(v4);
          if (t11 >= t2)
            throw H.ioore(vka, t11);
          vka[t11] = t12;
          t12 = offset_morphTarget + 10;
          t13 = v4.get$y(v4);
          if (t12 >= t2)
            throw H.ioore(vka, t12);
          vka[t12] = t13;
          t13 = offset_morphTarget + 11;
          t14 = v4.get$z(v4);
          if (t13 >= t2)
            throw H.ioore(vka, t13);
          vka[t13] = t14;
          if (material.get$morphNormals() === true) {
            t2 = morphNormals[vk];
            if (needsSmoothNormals) {
            ...
            t2 = n4.get$x(n4);
            if (t11 >= t14)
              throw H.ioore(nka, t11);
            nka[t11] = t2;
            t2 = n4.get$y(n4);
            if (t12 >= t14)
              throw H.ioore(nka, t12);
            nka[t12] = t2;
            t2 = n4.get$z(n4);
            if (t13 >= t14)
              throw H.ioore(nka, t13);
            nka[t13] = t2;
          }
        ...
        if (vk >= morphTargetsArrays.length)
          throw H.ioore(morphTargetsArrays, vk);
        ...
        if (material.get$morphNormals() === true) {
          ...
          if (vk >= morphNormalsArrays.length)
            throw H.ioore(morphNormalsArrays, vk);
    ...
    if (dirtyColors === true && vertexColorType === true) {
      ...
      for (t2 = vertexColorType === 2, f = 0, offset_color = 0; f < fl; ++f) {
        ...
        if (J.get$length$asx(vertexColors) === 3 && t2) {
          ...
          if (0 >= t3)
            throw H.ioore(vertexColors, 0);
          c1 = vertexColors[0];
          if (1 >= t3)
            throw H.ioore(vertexColors, 1);
          c2 = vertexColors[1];
          if (2 >= t3)
            throw H.ioore(vertexColors, 2);
          c3 = vertexColors[2];
        } else {
          c3 = faceColor;
          c2 = c3;
        ...
        t4 = t3.get$r(c1);
        if (offset_color >= C.JS_CONST_ZYJ(colorArray))
          throw H.ioore(colorArray, offset_color);
        colorArray[offset_color] = t4;
        t4 = offset_color + 1;
        t5 = c1.get$g();
        if (t4 >= C.JS_CONST_ZYJ(colorArray))
          throw H.ioore(colorArray, t4);
        colorArray[t4] = t5;
        t5 = offset_color + 2;
        t3 = t3.get$b(c1);
        if (t5 >= C.JS_CONST_ZYJ(colorArray))
          throw H.ioore(colorArray, t5);
        colorArray[t5] = t3;
        t3 = offset_color + 3;
        t5 = J.getInterceptor$x(c2);
        t4 = t5.get$r(c2);
        if (t3 >= C.JS_CONST_ZYJ(colorArray))
          throw H.ioore(colorArray, t3);
        colorArray[t3] = t4;
        t4 = offset_color + 4;
        t3 = c2.get$g();
    ...
    if (dirtyTangents === true && t1.hasTangents) {
      ...
      for (f = 0, offset_tangent = 0; f < fl; ++f) {
        ...
        if (t1 < 0 || t1 >= obj_faces.length)
          throw H.ioore(obj_faces, t1);
        face = obj_faces[t1];
        vertexTangents = face.get$vertexTangents();
        t1 = vertexTangents.length;
        if (0 >= t1)
          throw H.ioore(vertexTangents, 0);
        t10 = vertexTangents[0];
        if (1 >= t1)
          throw H.ioore(vertexTangents, 1);
        t2 = vertexTangents[1];
        if (2 >= t1)
          throw H.ioore(vertexTangents, 2);
        t3 = vertexTangents[2];
        t1 = J.getInterceptor$x(t10);
        t4 = t1.get$x(t10);
        if (offset_tangent >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, offset_tangent);
        tangentArray[offset_tangent] = t4;
        t4 = offset_tangent + 1;
        t5 = t1.get$y(t10);
        if (t4 >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, t4);
        tangentArray[t4] = t5;
        t5 = offset_tangent + 2;
        t1 = t1.get$z(t10);
        if (t5 >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, t5);
        tangentArray[t5] = t1;
        t1 = offset_tangent + 3;
        t10 = t10.get$w();
        if (t1 >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, t1);
        tangentArray[t1] = t10;
        t10 = offset_tangent + 4;
        t1 = J.getInterceptor$x(t2);
        t5 = t1.get$x(t2);
        if (t10 >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, t10);
        tangentArray[t10] = t5;
        t5 = offset_tangent + 5;
        t10 = t1.get$y(t2);
        if (t5 >= C.JS_CONST_ZYJ(tangentArray))
        ...
        t10 = t1.get$x(t3);
        if (t2 >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, t2);
        tangentArray[t2] = t10;
      ...
      for (f = 0; f < fl; ++f) {
        ...
        t3 = vertexTangents[2];
        if (3 >= t1)
          throw H.ioore(vertexTangents, 3);
        t4 = vertexTangents[3];
        t1 = J.getInterceptor$x(t10);
        t5 = t1.get$x(t10);
        if (offset_tangent >= C.JS_CONST_ZYJ(tangentArray))
        ...
        t6 = offset_tangent + 2;
        t1 = t1.get$z(t10);
        if (t6 >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, t6);
        tangentArray[t6] = t1;
        t1 = offset_tangent + 3;
        t10 = t10.get$w();
        if (t1 >= C.JS_CONST_ZYJ(tangentArray))
        ...
        t2 = t1.get$x(t4);
        if (t3 >= C.JS_CONST_ZYJ(tangentArray))
          throw H.ioore(tangentArray, t3);
        tangentArray[t3] = t2;
        ...
        if (vertexNormals.length === 3 && needsSmoothNormals)
          for (i = 0; i < 3; ++i) {
            if (i >= vertexNormals.length)
              throw H.ioore(vertexNormals, i);
            vn = vertexNormals[i];
            t1 = J.getInterceptor$x(vn);
            t2 = t1.get$x(vn);
            if (offset_normal < 0 || offset_normal >= C.JS_CONST_ZYJ(normalArray))
              throw H.ioore(normalArray, offset_normal);
            normalArray[offset_normal] = t2;
            t2 = offset_normal + 1;
            t3 = t1.get$y(vn);
            if (t2 >= C.JS_CONST_ZYJ(normalArray))
              throw H.ioore(normalArray, t2);
            normalArray[t2] = t3;
            t3 = offset_normal + 2;
            t1 = t1.get$z(vn);
            if (t3 >= C.JS_CONST_ZYJ(normalArray))
              throw H.ioore(normalArray, t3);
            normalArray[t3] = t1;
            offset_normal += 3;
          }
        else
    ...
    if (t1 && obj_uvs.length !== 0 && uvType) {
      ...
      for (f = 0, uvi = null, offset_uv = 0; f < fl; ++f) {
        ...
        if (fi < 0 || fi >= obj_uvs.length)
          throw H.ioore(obj_uvs, fi);
        uv = obj_uvs[fi];
        if (uv == null)
          continue;
        for (t2 = J.getInterceptor$asx(uv), i = 0; i < 3; ++i) {
          uvi = t2.$index(uv, i);
          t3 = uvi.get$u();
          t4 = C.JS_CONST_ZYJ(uvArray);
          if (offset_uv < 0 || offset_uv >= t4)
            throw H.ioore(uvArray, offset_uv);
          uvArray[offset_uv] = t3;
          t3 = offset_uv + 1;
          t5 = uvi.v;
          if (t3 >= t4)
            throw H.ioore(uvArray, t3);
          uvArray[t3] = t5;
          offset_uv += 2;
        }
      }
    ...
    if (t1) {
      ...
      for (f = 0, uv2i = null, offset_uv2 = 0; f < fl; ++f) {
        ...
        if (fi < 0 || fi >= null.length)
          throw H.ioore(null, fi);
        uv2 = null[fi];
        if (uv2 == null)
          continue;
        for (t1 = J.getInterceptor$asx(uv2), i = 0; i < 3; ++i) {
          uv2i = t1.$index(uv2, i);
          t2 = uv2i.get$u();
          t3 = C.JS_CONST_ZYJ(uv2Array);
          if (offset_uv2 < 0 || offset_uv2 >= t3)
            throw H.ioore(uv2Array, offset_uv2);
          uv2Array[offset_uv2] = t2;
          t2 = offset_uv2 + 1;
          t4 = uv2i.v;
          if (t2 >= t3)
            throw H.ioore(uv2Array, t2);
          uv2Array[t2] = t4;
          offset_uv2 += 2;
        }
      }
    ...
    if (dirtyElements === true) {
      fl = chunk_faces3.length;
      for (t1 = C.JS_CONST_ZYJ(faceArray), t2 = C.JS_CONST_ZYJ(lineArray), f = 0, vertexIndex = 0, offset_face = 0, offset_line = 0; f < fl; ++f) {
        if (offset_face >= t1)
          throw H.ioore(faceArray, offset_face);
        faceArray[offset_face] = vertexIndex;
        t3 = offset_face + 1;
        t4 = vertexIndex + 1;
        if (t3 >= t1)
          throw H.ioore(faceArray, t3);
        faceArray[t3] = t4;
        t3 = offset_face + 2;
        t5 = vertexIndex + 2;
        if (t3 >= t1)
        ...
        offset_face += 3;
        if (offset_line >= t2)
          throw H.ioore(lineArray, offset_line);
        lineArray[offset_line] = vertexIndex;
        t3 = offset_line + 1;
        if (t3 >= t2)
          throw H.ioore(lineArray, t3);
        lineArray[t3] = t4;
        t3 = offset_line + 2;
        if (t3 >= t2)
          throw H.ioore(lineArray, t3);
        lineArray[t3] = vertexIndex;
        t3 = offset_line + 3;
        if (t3 >= t2)
          throw H.ioore(lineArray, t3);
        lineArray[t3] = t5;
  ...
  renderBufferDirect$6: function(camera, lights, fog, material, webglgeometry, webglobject) {
    var program, attributes, wireframeBit, t1, t2, geometryHash, updateBuffers, object, geometry, index, offsets, il, i, startIndex, position, positionSize, t3, t4, normal, normalSize, uv, uvSize, color, colorSize, tangent, tangentSize;
    ...
    if (!!object.$isMesh) {
      ...
      while (true) {
        if (typeof i !== "number")
          throw i.$lt();
        if (!C.JSInt_methods.$lt(i, il))
          break;
        t2 = offsets.$index(offsets, i);
        startIndex = t2.get$index(t2);
        if (updateBuffers) {
          t2 = geometry.get$attributes(geometry);
          position = t2.$index(t2, "position");
          ...
          t2 = this._gl;
          t3 = attributes.$index(attributes, "position");
          t4 = startIndex.$mul(startIndex, positionSize);
          J.vertexAttribPointer$6$x(t2, t3, positionSize, 5126, false, 0, t4.$mul(t4, 4));
          t4 = geometry.get$attributes(geometry);
          normal = t4.$index(t4, "normal");
          if (J.$ge$n(attributes.$index(attributes, "normal"), 0) && true) {
            ...
            t2 = this._gl;
            t3 = attributes.$index(attributes, "normal");
            t4 = startIndex.$mul(startIndex, normalSize);
            J.vertexAttribPointer$6$x(t2, t3, normalSize, 5126, false, 0, t4.$mul(t4, 4));
          }
          t2 = geometry.get$attributes(geometry);
          uv = t2.$index(t2, "uv");
          if (J.$ge$n(attributes.$index(attributes, "uv"), 0) && true) {
            uvSize = uv.get$itemSize();
            uv.get$buffer(uv).bind$1(34962);
            this.enableAttribute$1(attributes.$index(attributes, "uv"));
            t2 = this._gl;
            t3 = attributes.$index(attributes, "uv");
            t4 = startIndex.$mul(startIndex, uvSize);
            J.vertexAttribPointer$6$x(t2, t3, uvSize, 5126, false, 0, t4.$mul(t4, 4));
          }
          t2 = geometry.get$attributes(geometry);
          color = t2.$index(t2, "color");
          if (J.$ge$n(attributes.$index(attributes, "color"), 0) && true) {
            ...
            t2 = this._gl;
            t3 = attributes.$index(attributes, "color");
            t4 = startIndex.$mul(startIndex, colorSize);
            J.vertexAttribPointer$6$x(t2, t3, colorSize, 5126, false, 0, t4.$mul(t4, 4));
          }
          t2 = geometry.get$attributes(geometry);
          tangent = t2.$index(t2, "tangent");
          if (J.$ge$n(attributes.$index(attributes, "tangent"), 0) && true) {
            ...
            t2 = this._gl;
            t3 = attributes.$index(attributes, "tangent");
            t4 = startIndex.$mul(startIndex, tangentSize);
            J.vertexAttribPointer$6$x(t2, t3, tangentSize, 5126, false, 0, t4.$mul(t4, 4));
          }
          index.get$buffer(index).bind$1(34963);
        }
        t2 = this._gl;
        t3 = offsets.$index(offsets, i);
        t3 = t3.get$count(t3);
        t4 = offsets.$index(offsets, i);
        t4 = t4.get$start(t4);
        J.drawElements$4$x(t2, 4, t3, 5123, t4.$mul(t4, 2));
        t4 = t1.render;
        t4.calls = t4.calls + 1;
        t4 = t1.render;
        t3 = t4.vertices;
        t2 = offsets.$index(offsets, i);
        t4.vertices = C.JSNumber_methods.$add(t3, t2.get$count(t2));
        t2 = t1.render;
        t3 = t2.faces;
        t4 = offsets.$index(offsets, i);
        t4 = t4.get$count(t4);
        t2.faces = C.JSNumber_methods.$add(t3, t4.$tdiv(t4, 3));
        ++i;
      }
  ...
  renderBuffer$6: function(camera, lights, fog, material, geometryGroup, object) {
    var webglobject, webglcamera, t1, t2, program, attributes, wireframeBit, geometryGroupHash, updateBuffers, il, i, attribute, t3, t4, primitives;
    ...
    if (updateBuffers)
      this.disableAttributes$0();
    if (material.get$morphTargets() !== true && J.$ge$n(attributes.$index(attributes, "position"), 0)) {
      if (updateBuffers) {
      ...
      if (geometryGroup.get$__webglCustomAttributesList() != null) {
        ...
        while (true) {
          ...
          if (i < 0 || i >= t1.length)
            throw H.ioore(t1, i);
          attribute = t1[i];
          if (J.$ge$n(attributes.$index(attributes, attribute.get$buffer(attribute).get$belongsToAttribute()), 0)) {
            t1 = attribute.get$buffer(attribute);
            t1.bind$1(34962);
            this.enableAttribute$1(attributes.$index(attributes, t1.get$belongsToAttribute()));
            J.vertexAttribPointer$6$x(this._gl, attributes.$index(attributes, attribute.get$buffer(attribute).get$belongsToAttribute()), attribute.get$size(attribute), 5126, false, 0, 0);
          }
          if (typeof 1 !== "number")
            throw H.iae(1);
          ++i;
    ...
    if (!!object.$isMesh) {
      ...
      t1 = t1.render;
      t4 = t1.faces;
      t2 = geometryGroup.__webglFaceCount;
      if (typeof t2 !== "number")
        throw t2.$tdiv();
      if (typeof 3 !== "number")
        throw H.iae(3);
      t1.faces = t4 + C.JSInt_methods.$tdiv(t2, 3);
  ...
  setupMorphTargets$3: function(material, geometryGroup, object) {
    var attributes, t1, t2, t3, t4, activeInfluenceIndices, influences, il, i, influence, influenceIndex, m, t5;
    attributes = material.get$program().attributes;
    t1 = object.object;
    if (t1.get$morphTargetBase() !== -1 && J.$ge$n(attributes.$index(attributes, "position"), 0)) {
      t2 = this._gl;
    ...
    for (t1 = material._material, t2 = J.getInterceptor(t1), t3 = typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial, t2 = typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial, influenceIndex = null, m = 0; m < material.numSupportedMorphTargets;) {
      t4 = activeInfluenceIndices.length;
      if (m < t4) {
        t5 = activeInfluenceIndices[m];
        t5 = t5 != null && t5.length !== 0;
      } else
        t5 = false;
      if (t5) {
        if (m >= t4)
          throw H.ioore(activeInfluenceIndices, m);
        ...
        if (influenceIndex >>> 0 !== influenceIndex || influenceIndex >= t5.length)
          throw H.ioore(t5, influenceIndex);
        J.bindBuffer$2$x(t4, 34962, t5[influenceIndex]);
        this.enableAttribute$1(attributes.$index(attributes, "morphTarget" + m));
        J.vertexAttribPointer$6$x(this._gl, attributes.$index(attributes, "morphTarget" + m), 3, 5126, false, 0, 0);
        if (t3)
          t4 = t2;
        else
          t4 = true;
        if ((t4 && t1.get$morphNormals()) === true) {
          t4 = this._gl;
          t5 = geometryGroup.__webglMorphNormalsBuffers;
          if (influenceIndex >= t5.length)
            throw H.ioore(t5, influenceIndex);
          J.bindBuffer$2$x(t4, 34962, t5[influenceIndex]);
          this.enableAttribute$1(attributes.$index(attributes, "morphNormal" + m));
          J.vertexAttribPointer$6$x(this._gl, attributes.$index(attributes, "morphNormal" + m), 3, 5126, false, 0, 0);
        }
        t4 = object.__webglMorphTargetInfluences;
        if (influenceIndex >= influences.length)
          throw H.ioore(influences, influenceIndex);
        t5 = influences[influenceIndex];
        if (m >= C.JS_CONST_ZYJ(t4))
          throw H.ioore(t4, m);
        t4[m] = t5;
      } else {
        t4 = object.__webglMorphTargetInfluences;
  ...
  _render$4$forceClear$renderTarget: function(scene, c, forceClear, renderTarget) {
    var lights, fog, camera, t1, t2, renderList, il, i, webglObject, object, t3;
    ...
    for (; i < il; ++i) {
      ...
      if (object.get$visible(object))
        if (!(!!object.$isMesh || !!object.$isParticleSystem) || !object.frustumCulled || t1.contains$1(t1, object)) {
          t3 = camera.get$matrixWorldInverse();
          webglObject._modelViewMatrix = t3.$mul(t3, webglObject.object.get$matrixWorld());
  ...
  unrollImmediateBufferMaterial$1: function(webglobject) {
    ...
    t2 = J.getInterceptor$asx(t1);
    if (t2.$index(t1, "__webglMaterial") == null)
      t2.$indexSet(t1, "__webglMaterial", new S.WebGLMaterial(t1, null, null, null, null, null, 0, 0, false));
    material = t2.$index(t1, "__webglMaterial");
  ...
  unrollBufferMaterial$1: function(object) {
    ...
    if (t3.$index(t2, "__webglMaterial") == null)
      t3.$indexSet(t2, "__webglMaterial", new S.WebGLMaterial(t2, null, null, null, null, null, 0, 0, false));
    meshMaterial = t3.$index(t2, "__webglMaterial");
    t1.get$material();
  ...
  sortFacesByMaterial$2: function(geometry, material) {
    var hash_map, t1, fl, f, t2, face, groupHash, vertices, t3, t4;
    hash_map = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    t1 = geometry._geometry;
    t1.morphNormals;
    geometry.geometryGroups = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    fl = t1.faces.length;
    for (f = 0; f < fl; ++f) {
      t2 = t1.faces;
      if (f >= t2.length)
        throw H.ioore(t2, f);
      face = t2[f];
      if (hash_map.$index(hash_map, "0") == null)
        hash_map.$indexSet(hash_map, "0", H.fillLiteralMap(["hash", "0", "counter", 0], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
      groupHash = H.S(J.$index$asx(hash_map.$index(hash_map, "0"), "hash")) + "_" + H.S(J.$index$asx(hash_map.$index(hash_map, "0"), "counter"));
      t2 = geometry.geometryGroups;
      if (t2.$index(t2, groupHash) == null) {
        t2 = geometry.geometryGroups;
        t2.$indexSet(t2, groupHash, new S.WebGLGeometry(null, 0, [], [], H.Primitives_parseInt("0", null, null), 0, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null));
      }
      t2 = J.getInterceptor$x(face);
      vertices = t2.get$size(face);
      t3 = geometry.geometryGroups;
      t3 = t3.$index(t3, groupHash).get$vertices();
      if (typeof t3 !== "number")
        throw t3.$add();
      if (typeof vertices !== "number")
        throw H.iae(vertices);
      if (t3 + vertices > 65535) {
        t3 = hash_map.$index(hash_map, "0");
        t4 = J.getInterceptor$asx(t3);
        t4.$indexSet(t3, "counter", J.$add$ns(t4.$index(t3, "counter"), 1));
        groupHash = H.S(J.$index$asx(hash_map.$index(hash_map, "0"), "hash")) + "_" + H.S(J.$index$asx(hash_map.$index(hash_map, "0"), "counter"));
        t3 = geometry.geometryGroups;
        if (t3.$index(t3, groupHash) == null) {
          t3 = geometry.geometryGroups;
          t3.$indexSet(t3, groupHash, new S.WebGLGeometry(null, 0, [], [], H.Primitives_parseInt("0", null, null), 0, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null));
        }
      }
      t2 = t2.get$size(face);
      t3 = geometry.geometryGroups;
      if (t2 === 3)
        t3.$index(t3, groupHash).get$faces3().push(f);
      else
        t3.$index(t3, groupHash).get$faces4().push(f);
      t2 = geometry.geometryGroups;
      t2 = t2.$index(t2, groupHash);
      t3 = t2.get$vertices();
      if (typeof t3 !== "number")
        throw t3.$add();
      t2.set$vertices(t3 + vertices);
    }
    geometry.geometryGroupsList = [];
    t1 = geometry.geometryGroups;
    t1.forEach$1(t1, new S.WebGLRenderer_sortFacesByMaterial_closure(this, geometry));
    return;
  },
  ...
  addObject$2: function(object, scene) {
    var webglobject, geometry, t1, material, t2;
    if (object.$index(object, "__webglObject") == null)
      object.$indexSet(object, "__webglObject", new S.WebGLObject(false, false, null, null, null, null, null, null, object, null, null, true, 0, null));
    webglobject = object.$index(object, "__webglObject");
    ...
    if (!webglobject.__webglInit) {
      ...
      if (!!object.$isMesh) {
        ...
        if (typeof t1 === "object" && t1 !== null && !!t2.$isGeometry && true) {
          ...
          t1 = geometry.geometryGroups;
          t1.forEach$1(t1, new S.WebGLRenderer_addObject_closure(this, webglobject, geometry));
        }
      } else if (!!object.$isLine) {
    ...
    if (!webglobject.__webglActive) {
      if (!!object.$isMesh) {
        ...
        t1.forEach$1(t1, new S.WebGLRenderer_addObject_closure0(this, scene, webglobject));
      } else if (!!object.$isLine || !!object.$isParticleSystem) {
  ...
  updateObject$1: function(webglobject) {
    ...
    if ((!!t1.$isMesh || !!t1.$isParticleSystem || !!t1.$isLine ? t1.get$geometry() : null) != null) {
      ...
      geometry = null;
    if (!!object.$isMesh) {
      for (il = geometry.get$geometryGroupsList().length, t1 = geometry._geometry, material = null, i = 0; i < il; ++i) {
        ...
        t2 = t1.__data;
        if (t2.containsKey$1(t2, "buffersNeedUpdate")) {
          if (t1.__data == null)
            t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
          t2 = t1.__data;
          t2 = t2.$index(t2, "buffersNeedUpdate");
        } else
          t2 = false;
        if (t2 === true)
        ...
        if (t2.containsKey$1(t2, "verticesNeedUpdate")) {
          if (t1.__data == null)
            t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
          t2 = t1.__data;
          t2 = t2.$index(t2, "verticesNeedUpdate");
        } else
          t2 = false;
        if (t2 !== true) {
          t2 = t1.__data;
          if (t2.containsKey$1(t2, "morphTargetsNeedUpdate")) {
            if (t1.__data == null)
              t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
            t2 = t1.__data;
            t2 = t2.$index(t2, "morphTargetsNeedUpdate");
          } else
            t2 = false;
          if (t2 !== true) {
            t2 = t1.__data;
            if (t2.containsKey$1(t2, "elementsNeedUpdate")) {
              if (t1.__data == null)
                t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
              t2 = t1.__data;
              t2 = t2.$index(t2, "elementsNeedUpdate");
            } else
              t2 = false;
            if (t2 !== true) {
              t2 = t1.__data;
              ...
              if (t2 !== true) {
                ...
                if (t2.containsKey$1(t2, "normalsNeedUpdate")) {
                  if (t1.__data == null)
                    t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
                  t2 = t1.__data;
                  t2 = t2.$index(t2, "normalsNeedUpdate");
                } else
                  t2 = false;
                if (t2 !== true) {
                  t2 = t1.__data;
                  ...
                  if (t2 !== true) {
                    ...
                    if (t2.containsKey$1(t2, "tangentsNeedUpdate")) {
                      if (t1.__data == null)
                        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
                      t2 = t1.__data;
                      t2 = t2.$index(t2, "tangentsNeedUpdate");
                    } else
                      t2 = false;
      ...
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      t2.$indexSet(t2, "verticesNeedUpdate", false);
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      t2.$indexSet(t2, "morphTargetsNeedUpdate", false);
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      t2.$indexSet(t2, "elementsNeedUpdate", false);
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      t2.$indexSet(t2, "uvsNeedUpdate", false);
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      t2.$indexSet(t2, "normalsNeedUpdate", false);
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      ...
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t2 = t1.__data;
      t2.$indexSet(t2, "tangentsNeedUpdate", false);
      if (t1.__data == null)
        t1.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t1 = t1.__data;
      t1.$indexSet(t1, "buffersNeedUpdate", false);
  ...
  removeObject$2: function(object, scene) {
    ...
    if (object.$index(object, "__webglObject") == null)
      object.$indexSet(object, "__webglObject", new S.WebGLObject(false, false, null, null, null, null, null, null, object, null, null, true, 0, null));
    webglobject = object.$index(object, "__webglObject");
    if (!!object.$isMesh || !!object.$isParticleSystem || !!object.$isLine) {
      if (scene.__data == null)
        scene.__data = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      t1 = scene.__data;
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    var object, t1, t2, shaderID, maxLightCount, maxShadows, maxBones, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, attributes, i;
    object = webglobject.get$object();
    t1 = material._material;
    t2 = J.getInterceptor(t1);
    if (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial)
      shaderID = "basic";
    else if (typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial)
      shaderID = "lambert";
    else if (typeof t1 === "object" && t1 !== null && !!t2.$isLineBasicMaterial)
      shaderID = "basic";
    else
      shaderID = typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial ? "particle_basic" : null;
    if (shaderID != null) {
      t1 = S.ShaderLib();
    ...
    t3 = typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial;
    t4 = t3 ? H.interceptedTypeCast(t1, "$isShaderMaterial").fragmentShader : material._fragmentShader;
    t5 = t3 ? H.interceptedTypeCast(t1, "$isShaderMaterial").vertexShader : material._vertexShader;
    t6 = t3 ? H.interceptedTypeCast(t1, "$isShaderMaterial").uniforms : material._uniforms;
    t7 = t3 ? H.interceptedTypeCast(t1, "$isShaderMaterial").attributes : null;
    t8 = t3 ? H.interceptedTypeCast(t1, "$isShaderMaterial").defines : H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    t9 = typeof t1 !== "object" || t1 === null || !t2.$isMeshBasicMaterial;
    t10 = typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial ? t2.get$map(t1) : null;
    t11 = typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$envMap() : null;
    t12 = typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$lightMap() : null;
    t13 = typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$specularMap() : null;
    t14 = material.get$_hasVertexColors() ? t1.get$vertexColors() : 0;
    t15 = material.get$_hasFog() && t1.get$fog();
    t16 = typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial && H.interceptedTypeCast(t1, "$isParticleBasicMaterial").sizeAttenuation;
    if (t9)
      if (typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial)
        t17 = t3;
      else
        t17 = true;
    else
      t17 = true;
    t17 = t17 && t1.get$skinning();
    ...
    if (t9)
      ...
      t19 = true;
    t19 = t19 && t1.get$morphTargets();
    t2 = typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial;
    if (t2)
      t20 = t3;
    else
      t20 = true;
    t20 = t20 && t1.get$morphNormals();
    t21 = this.maxMorphTargets;
    t22 = this.maxMorphNormals;
    t23 = maxLightCount.$index(maxLightCount, "directional");
    t24 = maxLightCount.$index(maxLightCount, "point");
    t25 = maxLightCount.$index(maxLightCount, "spot");
    t26 = maxLightCount.$index(maxLightCount, "hemi");
    t27 = this.shadowMapEnabled && object.get$receiveShadow();
    t28 = t1.get$alphaTest();
    t29 = (typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false) && t1.get$wrapAround();
    material.program = this.buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround(shaderID, t4, t5, t6, t7, t8, t28, null, null, null, t1.get$side() === 2, t11, t1.get$side() === 1, fog, false, t12, t10, maxBones, t23, t26, t22, t21, t24, maxShadows, t25, false, t20, t19, null, false, this.shadowMapCascade, this.shadowMapDebug, t27, this.shadowMapType, t16, t17, t13, t15, t18, t14, t29);
    ...
    if (t9)
      ...
      t4 = true;
    if ((t4 && t1.get$morphTargets()) === true) {
    ...
    if (t2)
      ...
      t2 = true;
    if ((t2 && t1.get$morphNormals()) === true) {
    ...
    t1 = t3 ? H.interceptedTypeCast(t1, "$isShaderMaterial").uniforms : material._uniforms;
  ...
  setProgram$5: function(camera, lights, fog, material, object) {
    var t1, program, p_uniforms, t2, t3, m_uniforms, t4, refreshMaterial, t5;
    ...
    if (material.get$needsUpdate()) {
      ...
      material._material.set$needsUpdate(false);
    }
    ...
    t2 = J.getInterceptor$x(t1);
    t3 = typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial;
    m_uniforms = t3 ? H.interceptedTypeCast(t1, "$isShaderMaterial").uniforms : material._uniforms;
    t4 = this._currentProgram;
    if (program == null ? t4 != null : program !== t4) {
    ...
    t4 = t2.get$id(t1);
    t5 = this._currentMaterialId;
    if (t4 == null ? t5 != null : t4 !== t5) {
      this._currentMaterialId = t2.get$id(t1);
      refreshMaterial = true;
    }
    ...
    t4 = typeof t1 !== "object" || t1 === null || !t2.$isMeshBasicMaterial;
    if (t4)
      if (typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial)
        t5 = t3;
      else
      ...
      t5 = true;
    if (t5 && t1.get$skinning()) {
      if (this.supportsBoneTextures === true)
        object.get$useVertexTexture();
      t5 = p_uniforms.get$boneGlobalMatrices();
      J.uniformMatrix4fv$3$x(this._gl, t5, false, object.get$boneMatrices());
    }
    if (refreshMaterial) {
      if (fog != null)
        t5 = (material.get$_hasFog() && t1.get$fog()) === true;
      else
        t5 = false;
      if (t5)
        this.refreshUniformsFog$2(m_uniforms, fog);
      if (typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial)
        t5 = t3 && H.interceptedTypeCast(t1, "$isShaderMaterial").lights;
      else
        t5 = true;
      if (t5) {
      ...
      if (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false)
        this.refreshUniformsCommon$2(m_uniforms, material);
      if (typeof t1 === "object" && t1 !== null && !!t2.$isLineBasicMaterial)
        this.refreshUniformsLine$2(m_uniforms, material);
      else if (typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial)
      ...
      if (t5)
        if (p_uniforms.$index(p_uniforms, "cameraPosition") != null) {
          ...
          J.uniform3f$4$x(this._gl, p_uniforms.$index(p_uniforms, "cameraPosition"), t5[0], t5[1], t5[2]);
        }
      t2 = typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial;
      if (t2)
        if (t3) {
  ...
  refreshUniformsCommon$2: function(uniforms, material) {
    var t1, t2, t3, t4, t5, uvScaleMap, offset, repeat;
    t1 = material._material;
    t2 = J.getInterceptor$x(t1);
    J.set$value$x(uniforms.$index(uniforms, "opacity"), t2.get$opacity(t1));
    t3 = this.gammaInput;
    if (t3)
      J.get$value$x(uniforms.$index(uniforms, "diffuse")).copyGammaToLinear$1(t2.get$color(t1));
    else
      J.set$value$x(uniforms.$index(uniforms, "diffuse"), t2.get$color(t1));
    t4 = uniforms.$index(uniforms, "map");
    t5 = typeof t1 !== "object" || t1 === null || !t2.$isMeshBasicMaterial;
    J.set$value$x(t4, typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial ? t2.get$map(t1) : null);
    t4 = uniforms.$index(uniforms, "lightMap");
    J.set$value$x(t4, typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$lightMap() : null);
    t4 = uniforms.$index(uniforms, "specularMap");
    J.set$value$x(t4, typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$specularMap() : null);
    if ((typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial ? t2.get$map(t1) : null) != null)
      uvScaleMap = typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial ? t2.get$map(t1) : null;
    else {
      if (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false)
        ;
      uvScaleMap = null;
    ...
    if (uvScaleMap != null) {
      offset = uvScaleMap.get$offset(uvScaleMap);
      repeat = uvScaleMap.get$repeat();
      J.get$value$x(uniforms.$index(uniforms, "offsetRepeat")).setValues$4(offset.get$x(offset), offset.get$y(offset), repeat.get$x(repeat), repeat.get$y(repeat));
    }
    t4 = uniforms.$index(uniforms, "envMap");
    J.set$value$x(t4, typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$envMap() : null);
    t4 = uniforms.$index(uniforms, "flipEnvMap");
    if (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false)
      ;
    J.set$value$x(t4, -1);
    if (t3)
      J.set$value$x(uniforms.$index(uniforms, "reflectivity"), t1.get$reflectivity());
    else
      J.set$value$x(uniforms.$index(uniforms, "reflectivity"), t1.get$reflectivity());
    J.set$value$x(uniforms.$index(uniforms, "refractionRatio"), t1.get$refractionRatio());
    J.set$value$x(uniforms.$index(uniforms, "combine"), t1.get$combine());
    t3 = uniforms.$index(uniforms, "useRefract");
    if (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false)
      ;
    J.set$value$x(t3, 0);
  },
  ...
  refreshUniformsParticle$2: function(uniforms, material) {
    ...
    t1 = material._material;
    t2 = J.getInterceptor$x(t1);
    J.set$value$x(uniforms.$index(uniforms, "psColor"), t2.get$color(t1));
    J.set$value$x(uniforms.$index(uniforms, "opacity"), t2.get$opacity(t1));
    t3 = uniforms.$index(uniforms, "size");
    t4 = typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial;
    J.set$value$x(t3, t4 ? H.interceptedTypeCast(t1, "$isParticleBasicMaterial").size : null);
    t3 = uniforms.$index(uniforms, "scale");
    t5 = J.get$height$x(this.canvas);
    if (typeof t5 !== "number")
      throw t5.$div();
    J.set$value$x(t3, t5 / 2);
    t5 = uniforms.$index(uniforms, "map");
    if (typeof t1 !== "object" || t1 === null || !t2.$isMeshBasicMaterial)
      if (typeof t1 !== "object" || t1 === null || !t2.$isMeshLambertMaterial)
        t3 = t4;
      else
      ...
      t3 = true;
    J.set$value$x(t5, t3 ? t2.get$map(t1) : null);
  },
  ...
  refreshUniformsLambert$2: function(uniforms, material) {
    ...
    t1 = material._material;
    if (this.gammaInput) {
      J.get$value$x(uniforms.$index(uniforms, "ambient")).copyGammaToLinear$1(t1.get$ambient());
      J.get$value$x(uniforms.$index(uniforms, "emissive")).copyGammaToLinear$1(t1.get$emissive());
    } else {
      J.set$value$x(uniforms.$index(uniforms, "ambient"), t1.get$ambient());
      J.set$value$x(uniforms.$index(uniforms, "emissive"), t1.get$emissive());
    }
    t1 = material._material;
    t2 = J.getInterceptor(t1);
    if ((typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false) && t1.get$wrapAround())
      J.get$value$x(uniforms.$index(uniforms, "wrapRGB")).copy$1(material.get$wrapRGB());
  },
  ...
  buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround: function(shaderID, fragmentShader, vertexShader, uniforms, attributes, defines, alphaTest, boneTextureHeight, boneTextureWidth, bumpMap, doubleSided, envMap, flipSided, fog, fogExp, lightMap, map, maxBones, maxDirLights, maxHemiLights, maxMorphNormals, maxMorphTargets, maxPointLights, maxShadows, maxSpotLights, metal, morphNormals, morphTargets, normalMap, perPixel, shadowMapCascade, shadowMapDebug, shadowMapEnabled, shadowMapType, sizeAttenuation, skinning, specularMap, useFog, useVertexTexture, vertexColors, wrapAround) {
    var t1, chunks, code, t2, pl, p, program, shadowMapTypeDefine, customDefines, glprogram, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, prefix_vertex, glFragmentShader, glVertexShader, $status, error, i;
    t1 = {};
    chunks = [];
    if (shaderID != null)
...
WebGLRenderer_initCustomAttributes_closure: {"": "Closure;this_0,geometry_1,nvertices_2",
  call$2: function(key, attribute) {
    ...
    t1 = new Float32Array(C.JSInt_methods.$mul(this.nvertices_2, attribute.get$size(attribute)));
    t1.$dartCachedLength = t1.length;
    attribute.set$array(t1);
    t1 = new S.Buffer(this.this_0._gl, null, null);
    t1._glbuffer = J.createBuffer$0$x(t1.context);
    attribute.set$buffer(attribute, t1);
...
WebGLRenderer_initMeshBuffers_closure: {"": "Closure;this_0,geometryGroup_1,nvertices_2",
  call$2: function(key, attribute) {
    ...
    attribute.set$buffer(attribute, buffer);
    originalAttribute = attribute.clone$0(attribute);
...
WebGLRenderer_sortFacesByMaterial_closure: {"": "Closure;this_0,geometry_1",
  call$2: function(k, g) {
    var t1, t2;
    t1 = this.this_0;
    t2 = t1._geometryGroupCounter;
    t1._geometryGroupCounter = t2 + 1;
    J.set$id$x(g, t2);
...
WebGLObject: {"": "Object;__webglInit@,__webglActive?,_modelViewMatrix<,_normalMatrix,_normalMatrixArray,_modelViewMatrixArray,modelMatrixArray,buffer,object<,opaque,transparent<,render<,z>,__webglMorphTargetInfluences<",
  ...
  get$_hasGeometry: function() {
    var t1 = this.object;
    return !!t1.$isMesh || !!t1.$isParticleSystem || !!t1.$isLine;
  },
...
WebGLMaterial: {"": "Object;_material,program<,_fragmentShader,_vertexShader,_uniforms,uniformsList,numSupportedMorphTargets,numSupportedMorphNormals,shadowPass?",
  get$attributes: function(_) {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial ? H.interceptedTypeCast(t1, "$isShaderMaterial").attributes : null;
  },
  set$fragmentShader: function(v) {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    if (typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial)
  ...
  get$lights: function() {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial && H.interceptedTypeCast(t1, "$isShaderMaterial").lights;
  },
  get$morphTargets: function() {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial) && t1.get$morphTargets();
  },
  get$morphNormals: function() {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return (typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial) && t1.get$morphNormals();
  },
  get$wrapAround: function() {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return (typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false) && t1.get$wrapAround();
  },
  get$fog: function() {
  ...
  get$map: function(_) {
    ...
    t1 = this._material;
    t2 = J.getInterceptor$ax(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial ? t2.get$map(t1) : null;
  },
  map$1: function($receiver, arg0) {
  ...
  get$envMap: function() {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$envMap() : null;
  },
  get$lightMap: function() {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$lightMap() : null;
  },
  ...
  get$specularMap: function() {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || false ? t1.get$specularMap() : null;
  },
  get$wireframe: function() {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return (typeof t1 !== "object" || t1 === null || !t2.$isLineBasicMaterial) && (typeof t1 !== "object" || t1 === null || !t2.$isParticleBasicMaterial) && t1.get$wireframe();
  },
  ...
  get$linewidth: function() {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isLineBasicMaterial ? t1.get$linewidth() : null;
  },
  ...
  get$skinning: function() {
    ...
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return (typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial) && t1.get$skinning();
  },
  get$size: function(_) {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial ? H.interceptedTypeCast(t1, "$isParticleBasicMaterial").size : null;
  },
  get$isShaderMaterial: function() {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial;
  },
  get$_hasVertexColors: function() {
    var t1, t2;
    t1 = this._material;
    t2 = J.getInterceptor(t1);
    return typeof t1 === "object" && t1 !== null && !!t2.$isLineBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isMeshLambertMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isParticleBasicMaterial || typeof t1 === "object" && t1 !== null && !!t2.$isShaderMaterial;
  },
...
Matrix3: {"": "Object;storage<",
  ...
  _mul_vector$1: function(arg) {
    ...
    t3 = t2[5];
    t5 = arg.get$storage();
    t5 = C.JSNumber_methods.$mul(t3, t5.$index(t5, 1));
    t3 = t2[8];
    t6 = arg.get$storage();
    t1[2] = t4 + t5 + C.JSNumber_methods.$mul(t3, t6.$index(t6, 2));
    t6 = t2[1];
    t3 = arg.get$storage();
    t3 = C.JSNumber_methods.$mul(t6, t3.$index(t3, 0));
    t6 = t2[4];
    t5 = arg.get$storage();
    t5 = C.JSNumber_methods.$mul(t6, t5.$index(t5, 1));
    t6 = t2[7];
    t4 = arg.get$storage();
    t1[1] = t3 + t5 + C.JSNumber_methods.$mul(t6, t4.$index(t4, 2));
    t4 = t2[0];
    t6 = arg.get$storage();
    t6 = C.JSNumber_methods.$mul(t4, t6.$index(t6, 0));
    t4 = t2[3];
    t5 = arg.get$storage();
    t5 = C.JSNumber_methods.$mul(t4, t5.$index(t5, 1));
    t2 = t2[6];
    t4 = arg.get$storage();
    t1[0] = t6 + t5 + C.JSNumber_methods.$mul(t2, t4.$index(t4, 2));
    return r;
  },
  $mul: function(_, arg) {
    var t1;
  ...
  $add: function(_, arg) {
    ...
    t4 = t2[1];
    t3 = arg.get$storage();
    t1[1] = C.JSNumber_methods.$add(t4, t3.$index(t3, 1));
    t3 = t2[2];
    t4 = arg.get$storage();
    t1[2] = C.JSNumber_methods.$add(t3, t4.$index(t4, 2));
    t4 = t2[3];
    t3 = arg.get$storage();
    t1[3] = C.JSNumber_methods.$add(t4, t3.$index(t3, 3));
    t3 = t2[4];
    t4 = arg.get$storage();
    t1[4] = C.JSNumber_methods.$add(t3, t4.$index(t4, 4));
    t4 = t2[5];
    t3 = arg.get$storage();
    t1[5] = C.JSNumber_methods.$add(t4, t3.$index(t3, 5));
    t3 = t2[6];
    t4 = arg.get$storage();
    t1[6] = C.JSNumber_methods.$add(t3, t4.$index(t4, 6));
    t4 = t2[7];
    t3 = arg.get$storage();
    t1[7] = C.JSNumber_methods.$add(t4, t3.$index(t3, 7));
    t2 = t2[8];
    t3 = arg.get$storage();
...
Matrix4: {"": "Object;storage<",
  ...
  $add: function(_, arg) {
    ...
    t3 = t2[8];
    t4 = arg.get$storage();
    t1[8] = C.JSNumber_methods.$add(t3, t4.$index(t4, 8));
    t4 = t2[9];
    t3 = arg.get$storage();
    t1[9] = C.JSNumber_methods.$add(t4, t3.$index(t3, 9));
    t3 = t2[10];
    t4 = arg.get$storage();
    t1[10] = C.JSNumber_methods.$add(t3, t4.$index(t4, 10));
    t4 = t2[11];
    t3 = arg.get$storage();
    t1[11] = C.JSNumber_methods.$add(t4, t3.$index(t3, 11));
    t3 = t2[12];
    t4 = arg.get$storage();
    t1[12] = C.JSNumber_methods.$add(t3, t4.$index(t4, 12));
    t4 = t2[13];
    t3 = arg.get$storage();
    t1[13] = C.JSNumber_methods.$add(t4, t3.$index(t3, 13));
    t3 = t2[14];
    t4 = arg.get$storage();
    t1[14] = C.JSNumber_methods.$add(t3, t4.$index(t4, 14));
    t2 = t2[15];
    t4 = arg.get$storage();
    t1[15] = C.JSNumber_methods.$add(t2, t4.$index(t4, 15));
    return r;
  },
  $sub: function(_, arg) {
    var t1, r, t2, t3, t4;
  ...
  scale$3: function(_, x, y, z) {
    ...
    if (typeof x === "object" && x !== null && !!t1.$isVector3 || false) {
      sx = t1.get$x(x);
      sy = t1.get$y(x);
      sz = t1.get$z(x);
    } else {
...
Quaternion: {"": "Object;storage<",
  ...
  $add: function(_, other) {
    ...
    return T.Quaternion$(t3, t4, t5, C.JSNumber_methods.$add(t1, t2.$index(t2, 3)));
  },
  $sub: function(_, other) {
...
Vector2: {"": "Object;storage<",
  ...
  $add: function(_, other) {
    ...
    t1 = t1[1];
    t2 = other.get$storage();
    t2 = C.JSNumber_methods.$add(t1, t2.$index(t2, 1));
    t1 = new Float32Array(2);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector2(t1);
    t4 = t1.storage;
...
main: function() {
  ...
  C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(S.animate$closure));
  S.render();
},

addGeometry: function(geometry, points, spacedPoints, color, x, y, z, rx, ry, rz, s) {
  var t1, t2, t3, t4, t5, t6, t7, mesh, line, pgeo, particles, particles2;
  t1 = S.Color$(color);
  t2 = S.Color$(16777215);
  t3 = S.Color$(0);
  t4 = new Float32Array(3);
  ...
  t7 = $.MaterialCount;
  $.MaterialCount = t7 + 1;
  mesh = L.createMultiMaterialObject(geometry, [new S.MeshLambertMaterial(null, t1, t2, t3, false, t4, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t5, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), new S.MeshBasicMaterial(t6, null, null, null, null, 0, 1, 0.98, 2, true, 1, "round", "round", false, false, 0, true, "", t7, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, true, true, true, false, true, true, null)]);
  mesh.position.setValues$3(x, y, z - 75);
  mesh.rotation.setValues$3(rx, ry, rz);
  ...
  t6 = $.MaterialCount;
  $.MaterialCount = t6 + 1;
  line = S.Line$(points, new S.LineBasicMaterial(t7, 2, "round", "round", true, false, "", t6, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), 0);
  line.position.setValues$3(x, y, z + 25);
  line.rotation.setValues$3(rx, ry, rz);
  line.scale.setValues$3(s, s, s);
  t6 = $.parent;
  t6.add$1(t6, line);
  t6 = S.Color$(color);
  t7 = $.MaterialCount;
  $.MaterialCount = t7 + 1;
  line = S.Line$(points, new S.LineBasicMaterial(t6, 1, "round", "round", true, false, "", t7, 0, 0.5, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), 0);
  t7 = z + 75;
  line.position.setValues$3(x, y, t7);
  line.rotation.setValues$3(rx, ry, rz);
  line.scale.setValues$3(s, s, s);
  t6 = $.parent;
  t6.add$1(t6, line);
  ...
  t5 = $.MaterialCount;
  $.MaterialCount = t5 + 1;
  particles = S.ParticleSystem$(pgeo, new S.ParticleBasicMaterial(t6, null, 2, true, 0, true, "", t5, 0, 0.75, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  particles.position.setValues$3(x, y, t7);
  particles.rotation.setValues$3(rx, ry, rz);
  particles.scale.setValues$3(s, s, s);
  t7 = $.parent;
  t7.add$1(t7, particles);
  t7 = S.Color$(color);
  t5 = $.MaterialCount;
  $.MaterialCount = t5 + 1;
  line = S.Line$(spacedPoints, new S.LineBasicMaterial(t7, 1, "round", "round", true, false, "", t5, 0, 0.2, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), 0);
  t5 = z + 100;
  line.position.setValues$3(x, y, t5);
  line.rotation.setValues$3(rx, ry, rz);
  line.scale.setValues$3(s, s, s);
  t7 = $.parent;
  t7.add$1(t7, line);
  pgeo = N.clone(spacedPoints);
  t7 = S.Color$(color);
  t6 = $.MaterialCount;
  $.MaterialCount = t6 + 1;
  particles2 = S.ParticleSystem$(pgeo, new S.ParticleBasicMaterial(t7, null, 2, true, 0, true, "", t6, 0, 0.5, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  particles2.position.setValues$3(x, y, t5);
  particles2.rotation.setValues$3(rx, ry, rz);
  particles2.scale.setValues$3(s, s, s);
  t5 = $.parent;
  t5.add$1(t5, particles2);
},

roundedRect: function(ctx, x, y, width, height, radius) {
  var t1, t2, t3, t4, t5, t6;
  t1 = y + radius;
  ctx.actions.push(new S.PathAction("moveTo", [x, t1]));
  t2 = y + height;
  t3 = t2 - radius;
  ctx.lineTo$2(ctx, x, t3);
  t4 = x + radius;
  ctx.quadraticCurveTo$4(ctx, x, t2, t4, t2);
  t5 = x + width;
  t6 = t5 - radius;
  ctx.lineTo$2(ctx, t6, t2);
  ctx.quadraticCurveTo$4(ctx, t5, t2, t5, t3);
  ctx.lineTo$2(ctx, t5, t1);
  ctx.quadraticCurveTo$4(ctx, t5, y, t6, y);
  ctx.lineTo$2(ctx, t4, y);
  ctx.quadraticCurveTo$4(ctx, x, y, x, t1);
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, light, californiaPts, californiaShape, california3d, californiaPoints, californiaSpacedPoints, triangleShape, triangle3d, trianglePoints, triangleSpacedPoints, heartShape, heart3d, heartPoints, heartSpacedPoints, squareShape, square3d, squarePoints, squareSpacedPoints, rectShape, roundedRectShape, roundedRect3d, roundedRectPoints, roundedRectSpacedPoints, circleShape, circle3d, circlePoints, circleSpacedPoints, fishShape, fish3d, fishPoints, fishSpacedPoints, arcShape, holePath, arc3d, arcPoints, arcSpacedPoints, smileyShape, smileyEye1Path, smileyEye2Path, smileyMouthPath, smiley3d, smileyPoints, smileySpacedPoints, splinepts, splineShape, apath, splineShape3d, splinePoints, splineSpacedPoints;
  ...
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  t16 = new S.PerspectiveCamera(50, t1 / t2, null, null, null, null, null, null, t3, t4, t5, 1, 1000, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  t16.updateProjectionMatrix$0();
  $.camera = t16;
  $.camera.position.setValues$3(0, 150, 500);
  $.scene = S.Scene$();
  light = S.DirectionalLight$(16777215, 1, 0);
  light.position.setValues$3(0, 0, 1);
  t16 = $.scene;
  t16.add$1(t16, light);
  $.parent = S.Object3D$();
  t16 = $.parent;
  t16.position.storage[1] = 50;
  t15 = $.scene;
  t15.add$1(t15, t16);
  californiaPts = [];
  t16 = new Float32Array(2);
  t16.$dartCachedLength = t16.length;
  t16 = new T.Vector2(t16);
  t15 = t16.storage;
  t15[0] = 610;
  t15[1] = 320;
  californiaPts.push(t16);
  t16 = new Float32Array(2);
  t16.$dartCachedLength = t16.length;
  t16 = new T.Vector2(t16);
  t15 = t16.storage;
  ...
  t15[1] = 320;
  californiaPts.push(t16);
  californiaShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  californiaShape.Path$1(californiaPts);
  california3d = S.ExtrudeGeometry$([californiaShape], 20, null, true, 3, null, 6, 12, null, null, null, null, 1);
  californiaPoints = californiaShape.createGeometry$1(californiaShape.getPoints$2(null, true));
  californiaSpacedPoints = californiaShape.createGeometry$1(californiaShape.getSpacedPoints$2(100, true));
  triangleShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  triangleShape.Path$1(null);
  triangleShape.actions.push(new S.PathAction("moveTo", [80, 20]));
  triangleShape.lineTo$2(triangleShape, 40, 80);
  triangleShape.lineTo$2(triangleShape, 120, 80);
  triangleShape.lineTo$2(triangleShape, 80, 20);
  triangle3d = triangleShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  trianglePoints = triangleShape.createGeometry$1(triangleShape.getPoints$2(null, true));
  triangleSpacedPoints = triangleShape.createGeometry$1(triangleShape.getSpacedPoints$2(null, true));
  heartShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  heartShape.Path$1(null);
  heartShape.actions.push(new S.PathAction("moveTo", [25, 25]));
  heartShape.bezierCurveTo$6(heartShape, 25, 25, 20, 0, 0, 0);
  heartShape.bezierCurveTo$6(heartShape, -30, 0, -30, 35, -30, 35);
  heartShape.bezierCurveTo$6(heartShape, -30, 55, -10, 77, 25, 95);
  heartShape.bezierCurveTo$6(heartShape, 60, 77, 80, 55, 80, 35);
  heartShape.bezierCurveTo$6(heartShape, 80, 35, 80, 0, 50, 0);
  heartShape.bezierCurveTo$6(heartShape, 35, 0, 25, 25, 25, 25);
  heart3d = heartShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  heartPoints = heartShape.createGeometry$1(heartShape.getPoints$2(null, true));
  heartSpacedPoints = heartShape.createGeometry$1(heartShape.getSpacedPoints$2(null, true));
  squareShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  squareShape.Path$1(null);
  squareShape.actions.push(new S.PathAction("moveTo", [0, 0]));
  squareShape.lineTo$2(squareShape, 0, 80);
  squareShape.lineTo$2(squareShape, 80, 80);
  squareShape.lineTo$2(squareShape, 80, 0);
  squareShape.lineTo$2(squareShape, 0, 0);
  square3d = squareShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  squarePoints = squareShape.createGeometry$1(squareShape.getPoints$2(null, true));
  squareSpacedPoints = squareShape.createGeometry$1(squareShape.getSpacedPoints$2(null, true));
  rectShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  rectShape.Path$1(null);
  rectShape.actions.push(new S.PathAction("moveTo", [0, 0]));
  rectShape.lineTo$2(rectShape, 0, 40);
  rectShape.lineTo$2(rectShape, 120, 40);
  rectShape.lineTo$2(rectShape, 120, 0);
  rectShape.lineTo$2(rectShape, 0, 0);
  rectShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  rectShape.createGeometry$1(rectShape.getPoints$2(null, true));
  rectShape.createGeometry$1(rectShape.getSpacedPoints$2(null, true));
  roundedRectShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  roundedRectShape.Path$1(null);
  S.roundedRect(roundedRectShape, 0, 0, 50, 50, 20);
  roundedRect3d = roundedRectShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  roundedRectPoints = roundedRectShape.createGeometry$1(roundedRectShape.getPoints$2(null, true));
  roundedRectSpacedPoints = roundedRectShape.createGeometry$1(roundedRectShape.getSpacedPoints$2(null, true));
  circleShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  circleShape.Path$1(null);
  circleShape.actions.push(new S.PathAction("moveTo", [0, 40]));
  circleShape.quadraticCurveTo$4(circleShape, 40, 40, 40, 0);
  circleShape.quadraticCurveTo$4(circleShape, 40, -40, 0, -40);
  circleShape.quadraticCurveTo$4(circleShape, -40, -40, -40, 0);
  circleShape.quadraticCurveTo$4(circleShape, -40, 40, 0, 40);
  circle3d = circleShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  circlePoints = circleShape.createGeometry$1(circleShape.getPoints$2(null, true));
  circleSpacedPoints = circleShape.createGeometry$1(circleShape.getSpacedPoints$2(null, true));
  fishShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  fishShape.Path$1(null);
  fishShape.actions.push(new S.PathAction("moveTo", [0, 0]));
  fishShape.quadraticCurveTo$4(fishShape, 50, -80, 90, -10);
  fishShape.quadraticCurveTo$4(fishShape, 100, -10, 115, -40);
  fishShape.quadraticCurveTo$4(fishShape, 115, 0, 115, 40);
  fishShape.quadraticCurveTo$4(fishShape, 100, 10, 90, 10);
  fishShape.quadraticCurveTo$4(fishShape, 50, 80, 0, 0);
  fish3d = fishShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  fishPoints = fishShape.createGeometry$1(fishShape.getPoints$2(null, true));
  fishSpacedPoints = fishShape.createGeometry$1(fishShape.getSpacedPoints$2(null, true));
  arcShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  arcShape.Path$1(null);
  arcShape.actions.push(new S.PathAction("moveTo", [50, 10]));
  arcShape.absellipse$7(10, 10, 40, 40, 0, 6.283185307179586, false);
  holePath = S.Path$(null);
  holePath.actions.push(new S.PathAction("moveTo", [20, 10]));
  holePath.absellipse$7(10, 10, 10, 10, 0, 6.283185307179586, true);
  arcShape.holes.push(holePath);
  arc3d = arcShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  arcPoints = arcShape.createGeometry$1(arcShape.getPoints$2(null, true));
  arcSpacedPoints = arcShape.createGeometry$1(arcShape.getSpacedPoints$2(null, true));
  smileyShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  smileyShape.Path$1(null);
  smileyShape.actions.push(new S.PathAction("moveTo", [80, 40]));
  smileyShape.absellipse$7(40, 40, 40, 40, 0, 6.283185307179586, false);
  smileyEye1Path = S.Path$(null);
  smileyEye1Path.actions.push(new S.PathAction("moveTo", [35, 20]));
  smileyEye1Path.absellipse$7(25, 20, 10, 10, 0, 6.283185307179586, true);
  t16 = smileyShape.holes;
  t16.push(smileyEye1Path);
  smileyEye2Path = S.Path$(null);
  smileyEye2Path.actions.push(new S.PathAction("moveTo", [65, 20]));
  smileyEye2Path.absellipse$7(55, 20, 10, 10, 0, 6.283185307179586, true);
  t16.push(smileyEye2Path);
  smileyMouthPath = S.Path$(null);
  smileyMouthPath.actions.push(new S.PathAction("moveTo", [20, 40]));
  smileyMouthPath.quadraticCurveTo$4(smileyMouthPath, 40, 60, 60, 40);
  smileyMouthPath.bezierCurveTo$6(smileyMouthPath, 70, 45, 70, 50, 60, 60);
  smileyMouthPath.quadraticCurveTo$4(smileyMouthPath, 40, 80, 20, 60);
  smileyMouthPath.quadraticCurveTo$4(smileyMouthPath, 5, 50, 20, 40);
  t16.push(smileyMouthPath);
  smiley3d = smileyShape.extrude$4$amount$bevelEnabled$bevelSegments$steps(20, true, 2, 2);
  smileyPoints = smileyShape.createGeometry$1(smileyShape.getPoints$2(null, true));
  smileySpacedPoints = smileyShape.createGeometry$1(smileyShape.getSpacedPoints$2(null, true));
  splinepts = [];
  t16 = new Float32Array(2);
  t16.$dartCachedLength = t16.length;
  t16 = new T.Vector2(t16);
  ...
  t16 = new Float32Array(2);
  t16.$dartCachedLength = t16.length;
  splinepts.push(new T.Vector2(t16));
  splineShape = new S.Shape([], false, null, [], [], [], false, null, null, null, false);
  splineShape.Path$1(null);
  splineShape.actions.push(new S.PathAction("moveTo", [0, 0]));
  splineShape.splineThru$1(splinepts);
  apath = new S.SplineCurve3(null, null, null, false);
  if (apath.points == null)
    apath.points = [];
  t1 = apath.points;
  t2 = new Float32Array(3);
  t2.$dartCachedLength = t2.length;
  t2 = new T.Vector3(t2);
  t2.setValues$3(-50, 150, 10);
  t1.push(t2);
  t2 = apath.points;
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  t1 = new T.Vector3(t1);
  t1.setValues$3(-20, 180, 20);
  t2.push(t1);
  t1 = apath.points;
  t2 = new Float32Array(3);
  t2.$dartCachedLength = t2.length;
  t2 = new T.Vector3(t2);
  t2.setValues$3(40, 220, 50);
  t1.push(t2);
  t2 = apath.points;
  t1 = new Float32Array(3);
  t1.$dartCachedLength = t1.length;
  t1 = new T.Vector3(t1);
  t1.setValues$3(200, 290, 100);
  t2.push(t1);
  splineShape3d = splineShape.extrude$5$amount$bevelEnabled$bevelSegments$extrudePath$steps(20, false, 2, apath, 20);
  splinePoints = splineShape.createGeometry$1(splineShape.getPoints$2(null, true));
  splineSpacedPoints = splineShape.createGeometry$1(splineShape.getSpacedPoints$2(null, true));
  S.addGeometry(california3d, californiaPoints, californiaSpacedPoints, 16755200, -300, -100, 0, 0, 0, 0, 0.25);
  S.addGeometry(triangle3d, trianglePoints, triangleSpacedPoints, 16772608, -180, 0, 0, 0, 0, 0, 1);
  S.addGeometry(roundedRect3d, roundedRectPoints, roundedRectSpacedPoints, 21760, -150, 150, 0, 0, 0, 0, 1);
  S.addGeometry(square3d, squarePoints, squareSpacedPoints, 22015, 150, 100, 0, 0, 0, 0, 1);
  S.addGeometry(heart3d, heartPoints, heartSpacedPoints, 16716032, 0, 100, 0, 3.141592653589793, 0, 0, 1);
  S.addGeometry(circle3d, circlePoints, circleSpacedPoints, 65297, 120, 250, 0, 0, 0, 0, 1);
  S.addGeometry(fish3d, fishPoints, fishSpacedPoints, 2236962, -60, 200, 0, 0, 0, 0, 1);
  S.addGeometry(splineShape3d, splinePoints, splineSpacedPoints, 8947848, -50, -100, -50, 0, 0, 0, 0.2);
  S.addGeometry(arc3d, arcPoints, arcSpacedPoints, 12272674, 150, 0, 0, 0, 0, 0, 1);
  S.addGeometry(smiley3d, smileyPoints, smileySpacedPoints, 15597823, -270, 250, 0, 3.141592653589793, 0, 0, 1);
  ...
  heart3d = $.renderer;
  heart3d.sortObjects = false;
  J.get$nodes$x($.container)._this.appendChild(heart3d.canvas);
  heart3d = new W._EventStream(document, C.EventStreamProvider_mousedown._eventType, false);
  H.setRuntimeTypeInfo(heart3d, [null]);
  roundedRect3d = new W._EventStreamSubscription(0, heart3d._target, heart3d._eventType, W._wrapZone(S.onDocumentMouseDown$closure), heart3d._useCapture);
  H.setRuntimeTypeInfo(roundedRect3d, [H.getRuntimeTypeArgument(heart3d, "_EventStream", 0)]);
  roundedRect3d._tryResume$0();
  heart3d = new W._EventStream(document, C.EventStreamProvider_touchstart._eventType, false);
  H.setRuntimeTypeInfo(heart3d, [null]);
  t1 = new W._EventStreamSubscription(0, heart3d._target, heart3d._eventType, W._wrapZone(S.onDocumentTouchStart$closure), heart3d._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(heart3d, "_EventStream", 0)]);
  t1._tryResume$0();
  heart3d = new W._EventStream(document, C.EventStreamProvider_touchmove._eventType, false);
  H.setRuntimeTypeInfo(heart3d, [null]);
  t2 = new W._EventStreamSubscription(0, heart3d._target, heart3d._eventType, W._wrapZone(S.onDocumentTouchMove$closure), heart3d._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(heart3d, "_EventStream", 0)]);
  t2._tryResume$0();
  $.mouseEvts = [roundedRect3d, t1, t2];
  t2 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(S.onWindowResize$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
},
...
cancelMouseEvts: function() {
  H.IterableMixinWorkaround_forEach($.get$mouseEvts(), new S.cancelMouseEvts_closure());
  $.mouseEvts = [];
},
...
onDocumentMouseDown: function($event) {
  ...
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(S.onDocumentMouseMove$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  t2 = new W._EventStream(document, C.EventStreamProvider_mouseup._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t4 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(S.onDocumentMouseUp$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t4, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t4._tryResume$0();
  t2 = new W._EventStream(document, C.EventStreamProvider_mouseout._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t5 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(S.onDocumentMouseOut$closure), t2._useCapture);
...
render: function() {
  var t1, t2;
  t1 = $.parent.rotation.storage;
  t2 = t1[1];
  t1[1] = t2 + ($.targetRotation - t2) * 0.05;
  $.renderer._render$2($.scene, $.camera);
},

cancelMouseEvts_closure: {"": "Closure;",
  call$1: function(s) {
...
init.globalFunctions.onWindowResize$closure = S.onWindowResize$closure = new H.Closure$1(S.onWindowResize, "onWindowResize$closure");
init.globalFunctions.onDocumentMouseDown$closure = S.onDocumentMouseDown$closure = new H.Closure$1(S.onDocumentMouseDown, "onDocumentMouseDown$closure");
init.globalFunctions.onDocumentMouseMove$closure = S.onDocumentMouseMove$closure = new H.Closure$1(S.onDocumentMouseMove, "onDocumentMouseMove$closure");
init.globalFunctions.onDocumentMouseUp$closure = S.onDocumentMouseUp$closure = new H.Closure$1(S.onDocumentMouseUp, "onDocumentMouseUp$closure");
init.globalFunctions.onDocumentMouseOut$closure = S.onDocumentMouseOut$closure = new H.Closure$1(S.onDocumentMouseOut, "onDocumentMouseOut$closure");
init.globalFunctions.onDocumentTouchStart$closure = S.onDocumentTouchStart$closure = new H.Closure$1(S.onDocumentTouchStart, "onDocumentTouchStart$closure");
init.globalFunctions.onDocumentTouchMove$closure = S.onDocumentTouchMove$closure = new H.Closure$1(S.onDocumentTouchMove, "onDocumentTouchMove$closure");
init.globalFunctions.animate$closure = S.animate$closure = new H.Closure$1(S.animate, "animate$closure");
...
Isolate.$lazy($, "mouseEvts", "mouseEvts", "get$mouseEvts", function() {
  return [];
});
// Native classes
...
//# sourceMappingURL=web_gl_geometry_shapes.dart.js.map
//@ sourceMappingURL=web_gl_geometry_shapes.dart.js.map
