...
$$.Canvas_Camera_Orthographic = {"":
 ...
 init$0: function() {
  ...
  $.add$1(geometry.vertices, $.Vector3$(-500, 0, 0));
  $.add$1(geometry.vertices, $.Vector3$(500, 0, 0));
  for (var i = 0; i <= 20; ++i) {
    var line = $.Line$(geometry, $.LineBasicMaterial$(0, 1, 'round', 'round', 0, true, '', 0, 0.2, false, 1, 204, 205, 100, true, true, false, 0, 0, 0, false, true), 0);
    t1 = i * 50 - 500;
    line.position.set$z(t1);
    $.add$1(this.scene, line);
    line = $.Line$(geometry, $.LineBasicMaterial$(0, 1, 'round', 'round', 0, true, '', 0, 0.2, false, 1, 204, 205, 100, true, true, false, 0, 0, 0, false, true), 0);
    line.position.set$x(t1);
    line.rotation.set$y(1.5707963267948966);
    $.add$1(this.scene, line);
  }
  geometry = $.CubeGeometry$(50, 50, 50, 1, 1, 1, null, null);
  var material = $.MeshLambertMaterial$(null, 16777215, 16777215, 0, false, null, null, null, null, 0, 1, 0.98, 2, 0, true, false, 1, 'round', 'round', false, false, false, '', 0, 1, false, 1, 204, 205, 100, true, true, false, 0, 0, 0, true, true);
...
$$.CanvasRenderer = {"":
                      ...
                      case 74:
                        if (state === 74 || state === 0 && !t1)
                          switch (state) {
                            case 0:
                            case 74:
                              if (state === 74 || state === 0 && material.shading === 2)
                                switch (state) {
                                  case 0:
                                    t2 = $.get$length(element.get$vertexNormalsWorld());
                                  case 74:
 ...
 renderFace4$9: function(v1, v2, v3, v4, v5, v6, element, material, scene) {
  ...
  if (typeof material === 'object' && material !== null && !!material.is$MeshBasicMaterial) {
    ...
    if (this._enableLighting === true) {
      t1 = material.wireframe;
      t2 = !t1 && material.shading === 2 && element.vertexNormalsWorld.length === 4;
