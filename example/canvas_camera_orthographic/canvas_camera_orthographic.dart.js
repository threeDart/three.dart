...
$$.Closure$1 = [U, {"": "Closure;call$1,$name", $is_args1: true}];
...
JSArray: {"": "List/Interceptor;",
  ...
  addAll$1: function(receiver, collection) {
    var t1;
    for (t1 = new H.ListIterator(collection, 4, 0, null); t1.moveNext$0();)
...
["", "canvas_camera_orthographic.dart", , U, {
main: function() {
  U.init();
  var t1 = window;
...
init: function() {
  var t1, info, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, geometry, i, line, material, cube, directionalLight;
  ...
  info = W._ElementFactoryProvider_createElement_tag("div", null);
  t1 = J.getInterceptor$x(info);
  J.set$position$x(t1.get$style(info), "absolute");
  J.set$top$x(info.style, "10px");
  J.set$width$x(info.style, "100%");
  J.set$textAlign$x(info.style, "center");
  t1.set$innerHtml(info, "three.dart - orthographic view");
  J.get$nodes$x($.container)._this.appendChild(info);
  t1 = $.windowHalfX;
  if (typeof t1 !== "number")
    throw t1.$negate();
  t2 = $.windowHalfY;
  ...
  t16 = new S.OrthographicCamera(-t1, t1, t2, -t2, t3, t4, t5, -2000, 1000, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  ...
  for (i = 0; i <= 20; ++i) {
    ...
    t2 = $.MaterialCount;
    $.MaterialCount = t2 + 1;
    line = S.Line$(geometry, new S.LineBasicMaterial(t1, 1, "round", "round", true, false, "", t2, 0, 0.2, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), 0);
    t2 = i * 50 - 500;
    line.position.storage[2] = t2;
    t1 = $.scene;
    t1.add$1(t1, line);
    t1 = new S.Color(1, 1, 1);
    t1.setHex$1(0);
    t3 = $.MaterialCount;
    $.MaterialCount = t3 + 1;
    line = S.Line$(geometry, new S.LineBasicMaterial(t1, 1, "round", "round", true, false, "", t3, 0, 0.2, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null), 0);
    line.position.storage[0] = t2;
    line.rotation.storage[1] = 1.5707963267948966;
    t2 = $.scene;
    t2.add$1(t2, line);
  }
  geometry = S.CubeGeometry$(50, 50, 50, 1, 1, 1, null, null);
  t1 = S.Color$(16777215);
  t2 = S.Color$(16777215);
  t3 = S.Color$(0);
  ...
  t5 = $.MaterialCount;
  $.MaterialCount = t5 + 1;
  material = new S.MeshLambertMaterial(null, t1, t2, t3, false, t4, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t5, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, true, true, true, null);
  for (i = 0; i < 100; ++i) {
    cube = S.Mesh$(geometry, material);
    t1 = cube.scale.storage;
    t1[1] = (Math.random() * 2 >>> 0) + 1;
    t2 = cube.position;
    t2.storage[0] = C.JSNumber_methods.toInt$0(Math.floor(((Math.random() * 1000 >>> 0) - 500) / 50)) * 50 + 25;
    t2 = cube.position;
    t2 = t2.storage;
    t2[1] = t1[1] * 50 / 2;
    t2[2] = C.JSNumber_methods.toInt$0(Math.floor(((Math.random() * 1000 >>> 0) - 500) / 50)) * 50 + 25;
    t1 = $.scene;
    t1.add$1(t1, cube);
  }
  t1 = S.Color$(Math.random() * 16);
  t2 = $.Object3DCount;
  $.Object3DCount = t2 + 1;
  ...
  t12.$dartCachedLength = t12.length;
  t13 = $.scene;
  t13.add$1(t13, new S.AmbientLight(t1, t2, "", t3, null, [], t4, t5, t6, t7, "XYZ", null, null, null, true, null, t8, t9, t10, true, true, t11, false, 0, 1, true, false, false, true, new T.Vector3(t12), null, null));
  directionalLight = S.DirectionalLight$(Math.random() * 16777215, 1, 0);
  ...
  t12 = $.scene;
  t12.add$1(t12, directionalLight);
  directionalLight = S.DirectionalLight$(Math.random() * 16777215, 1, 0);
  directionalLight.position.storage[0] = Math.random() - 0.5;
  directionalLight.position.storage[1] = Math.random() - 0.5;
  directionalLight.position.storage[2] = Math.random() - 0.5;
  ...
  t12 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t12, [null]);
  t11 = new W._EventStreamSubscription(0, t12._target, t12._eventType, W._wrapZone(U.onWindowResize$closure), t12._useCapture);
  H.setRuntimeTypeInfo(t11, [H.getRuntimeTypeArgument(t12, "_EventStream", 0)]);
  t11._tryResume$0();
},
...
render: function() {
  ...
  t1 = $.camera.position;
  t1.storage[0] = Math.cos(timer) * 200;
  t1 = $.camera.position;
  t1.storage[2] = Math.sin(timer) * 200;
...
Blob: {"": "Interceptor;size=", "%": "Blob|File"},
...
InputElement: {"": "HtmlElement;height%,name=,size=,value=,width%", $isElement: true, "%": "HTMLInputElement"},
...
OrthographicCamera: {"": "Camera;left,right,top,bottom,matrixWorldInverse,projectionMatrix,projectionMatrixInverse,near,far,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,castShadow,receiveShadow,frustumCulled,_vector,customDepthMaterial,__data",
  updateProjectionMatrix$0: function() {
    T.setOrthographicMatrix(this.projectionMatrix, this.left, this.right, this.bottom, this.top, this.near, this.far);
  }
},
...
Face: {"": "Object;indices<,centroid<",
  get$size: function(_) {
    return 4;
  },
  setFrom$1: function(other) {
    var t1;
    this.normal.setFrom$1(other.normal);
...
Geometry: {"": "Object;id,name,vertices,colors,normals,materials,faces,faceUvs,faceVertexUvs,morphTargets,morphColors,morphNormals,skinWeights,skinIndices,lineDistances,__tmpVertices,boundingBox,boundingSphere,hasTangents,_dynamic,bones,animation,__data",
  ...
  mergeVertices$0: function() {
    var verticesMap, unique, changes, precision, il, i, t1, v, key, t2;
    ...
    for (i = 0; i < il; ++i) {
      ...
      v = t1[i];
      t1 = v.storage;
      key = C.JSArray_methods.join$1([C.JSInt_methods.toStringAsFixed$1(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1[0] * precision)), 0), C.JSInt_methods.toStringAsFixed$1(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1[1] * precision)), 0), C.JSInt_methods.toStringAsFixed$1(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1[2] * precision)), 0)], "_");
...
Projector: {"": "Object;_objectPool,_vertexPool,_face4Pool,_face3Pool,_linePool,_particlePool,_objectCount,_vertexCount,_face3Count,_face4Count,_lineCount,_particleCount,_object,_vertex,_line,_particle,_vector3,_vector4,_clippedVertex1PositionScreen,_clippedVertex2PositionScreen,_renderData,_viewProjectionMatrix,_modelViewProjectionMatrix,_frustum",
  ...
  getNextFace4InPool$0: function() {
    var t1, t2, t3, face, t4, t5, t6, t7, t8;
    t1 = this._face4Count;
    t2 = this._face4Pool;
    t3 = t2.length;
    if (typeof t1 !== "number")
    ...
    if (t1 < t3) {
      ...
      t8 = new Float32Array(3);
      t8.$dartCachedLength = t8.length;
      face = new S.RenderableFace4(null, new T.Vector3(t1), new T.Vector3(t3), new T.Vector3(t4), [new T.Vector3(t5), new T.Vector3(t6), new T.Vector3(t7), new T.Vector3(t8)], [[]], null, null, null);
      face.RenderableFace$1(4);
      t2.push(face);
    }
    t1 = this._face4Count;
    if (typeof t1 !== "number")
...
Projector_projectScene_closure: {"": "Closure;box_0,this_1,near_2,far_3",
  call$1: function(o) {
    var t1, t2, t3, t4, material, vtx, t5, t6, t7, t8, visible, uvs, vec, step, t9;
    t1 = this.box_0;
    ...
    t3 = t1.object_11;
    t4 = J.getInterceptor(t3);
    if (typeof t3 === "object" && t3 !== null && !!t4.$isMesh) {
      t1.geometry_14 = t3.get$geometry();
      t1.geometryMaterials_15 = t1.object_11.get$geometry().materials;
      t1.vertices_16 = t1.geometry_14.vertices;
      t1.faces_18 = t1.geometry_14.faces;
      t1.faceVertexUvs_22 = t1.geometry_14.faceVertexUvs;
      S.extractRotation(t1.object_11.matrixRotationWorld, t1.modelMatrix_12);
      t1.rotationMatrix_13 = t1.object_11.matrixRotationWorld;
      t1.object_11.get$material();
      t1.isFaceMaterial_25 = false;
      t1.side_27 = t1.object_11.get$material().side;
      t3 = t1.vertices_16;
      t3.toString;
      H.IterableMixinWorkaround_forEach(t3, new S.Projector_projectScene__closure(t1, t2, this.near_2, this.far_3));
      t1.fl_4 = t1.faces_18.length;
      t1.f_3 = 0;
      while (true) {
        t3 = t1.f_3;
        t4 = t1.fl_4;
        ...
        c$0: {
          ...
          if (t3 < 0 || t3 >= t4.length)
            throw H.ioore(t4, t3);
          t1.face_19 = t4[t3];
          if (t1.isFaceMaterial_25 === true) {
            t3 = t1.geometryMaterials_15;
            t4 = t1.face_19.materialIndex;
            if (t4 >>> 0 !== t4 || t4 >= t3.length)
              throw H.ioore(t3, t4);
            material = t3[t4];
          } else
            material = t1.object_11.get$material();
          t1.material_26 = material;
          t3 = t1.material_26;
          if (t3 == null)
            break c$0;
          t1.side_27 = t3.side;
          t3 = new H.MappedListIterable(t1.face_19.indices, new S.Projector_projectScene__closure0(t2));
          t3.$builtinTypeInfo = [null, null];
          vtx = t3.toList$0(t3);
          if (H.IterableMixinWorkaround_every(vtx, new S.Projector_projectScene__closure1())) {
            t1.face_19.indices;
            if (3 >= vtx.length)
              throw H.ioore(vtx, 3);
            t3 = vtx[3].get$positionScreen().storage;
            t4 = t3[0];
            t5 = vtx[0].get$positionScreen().storage;
            t6 = t5[0];
            t7 = vtx[1].get$positionScreen().storage;
            t8 = t7[1];
            t5 = t5[1];
            t3 = t3[1];
            t7 = t7[0];
            if (!((t4 - t6) * (t8 - t5) - (t3 - t5) * (t7 - t6) < 0)) {
              t5 = vtx[2].get$positionScreen().storage;
              t6 = t5[0];
              t5 = t5[1];
              visible = (t7 - t6) * (t3 - t5) - (t8 - t5) * (t4 - t6) < 0;
            } else
              visible = true;
            t1.visible_0 = visible;
            t3 = t1.side_27;
            if (t3 === 2 || t1.visible_0 === (t3 === 0)) {
              t1.face_19.indices;
              t1._face_20 = t2.getNextFace4InPool$0();
              t3 = t1._face_20;
              t4 = new H.MappedListIterable(vtx, new S.Projector_projectScene__closure2());
              t4.$builtinTypeInfo = [null, null];
              t3.vertices = t4.toList$1$growable(t4, false);
            } else
              break c$0;
          } else
            break c$0;
          t1._face_20.normalWorld.setFrom$1(t1.face_19.normal);
          if (!t1.visible_0) {
            t3 = t1.side_27;
            t3 = t3 === 1 || t3 === 2;
          } else
            t3 = false;
          if (t3)
            t1._face_20.normalWorld.negate$0();
          t1._face_20.normalWorld.applyProjection$1(t1.rotationMatrix_13);
          t1._face_20.centroidWorld.setFrom$1(t1.face_19.centroid);
          t1._face_20.centroidWorld.applyProjection$1(t1.modelMatrix_12);
          t3 = t1._face_20;
          t3.centroidScreen.setFrom$1(t3.centroidWorld);
          t1._face_20.centroidScreen.applyProjection$1(t2._viewProjectionMatrix);
          t1.faceVertexNormals_21 = t1.face_19.vertexNormals;
          t1.nl_6 = t1.faceVertexNormals_21.length;
          t1.n_5 = 0;
          while (true) {
            t3 = t1.n_5;
            t4 = t1.nl_6;
            ...
            if (!(t3 < t4))
              break;
            t4 = t1._face_20.vertexNormalsWorld;
            if (t3 < 0 || t3 >= 4)
              throw H.ioore(t4, t3);
            t1.normal_17 = t4[t3];
            t3 = t1.normal_17;
            t4 = t1.faceVertexNormals_21;
            t5 = t1.n_5;
            ...
            t1.normal_17.applyProjection$1(t1.rotationMatrix_13);
            t3 = t1.n_5;
            if (typeof t3 !== "number")
              throw t3.$add();
            t1.n_5 = t3 + 1;
          }
          t1.faceVertexUvs_22.length;
          t1.cl_8 = 1;
          t1.c_7 = 0;
          while (true) {
            t3 = t1.c_7;
          ...
          t1._face_20.material = t1.material_26;
          t3 = t1._face_20;
          t4 = t1.face_19.materialIndex;
          if (t4 != null) {
            t5 = t1.geometryMaterials_15;
          ...
          t3.faceMaterial = t4;
          t4 = t1._face_20;
          t4.z = t4.centroidScreen.storage[2];
          t2._renderData.elements.push(t1._face_20);
        }
        t3 = t1.f_3;
        if (typeof t3 !== "number")
          throw t3.$add();
    ...
    } else if (typeof t3 === "object" && t3 !== null && !!t4.$isLine) {
...
CanvasRenderer: {"": "Object;domElement,_autoClear,_sortObjects,_sortElements,_canvasWidth,_canvasHeight,_canvasWidthHalf,_canvasHeightHalf,_clearColor,_clearOpacity,_camera,_canvas,_context,_contextGlobalAlpha,_contextGlobalCompositeOperation,_contextStrokeStyle,_contextFillStyle,_contextLineCap,_contextLineJoin,_contextLineWidth,_clipRect,_clearRect,_bboxRect,_info,_renderData,_three$_elements,_lights,_projector,_v5,_v6,_v1x,_v1y,_v2x,_v2y,_v3x,_v3y,_v4x,_v4y,_v5x,_v5y,_v6x,_v6y,_color,_color1,_color2,_color3,_color4,_patterns,_imagedatas,_near,_far,_image,_uvs,_uv1x,_uv1y,_uv2x,_uv2y,_uv3x,_uv3y,_enableLighting,_ambientLight,_directionalLights,_pointLights,_pi2,_vector3,_pixelMapImage,_pixelMapData,_gradientMapQuality,_pixelMap,_pixelMapContext,_gradientMap,_gradientMapContext,debug",
  ...
  calculateLights$1: function(lights) {
    ...
    for (l = 0; l < ll; ++l) {
      ...
      if (!!light.$isAmbientLight) {
        ...
        t1._r = t1._r + lightColor._r;
        t1 = this._ambientLight;
        t1._g = t1._g + lightColor._g;
        t1 = this._ambientLight;
        t1._b = t1._b + lightColor._b;
  ...
  calculateLight$4: function(lights, position, normal, color) {
    ...
    for (l = 0, lightPosition = null, amount = null; l < ll; ++l) {
      ...
      if (!!light.$isDirectionalLight) {
        lightPosition = light.matrixWorld.getTranslation$0();
        amount = normal.dot$1(lightPosition);
        if (amount <= 0)
          continue;
        amount *= light.intensity;
        color._r = color._r + lightColor._r * amount;
        color._g = color._g + lightColor._g * amount;
        color._b = color._b + lightColor._b * amount;
      }
    }
  },
  ...
  renderFace3$9: function(v1, v2, v3, uv1, uv2, uv3, element, material, scene) {
    ...
    if (!!material.$isMeshBasicMaterial) {
      ...
      if (material.wireframe) {
        t2 = material.wireframeLinewidth;
        t3 = material.wireframeLinecap;
        t4 = material.wireframeLinejoin;
        if (this._contextLineWidth !== t2) {
          t5 = this._context;
          this._contextLineWidth = t2;
          J.set$lineWidth$x(t5, t2);
        }
        if (this._contextLineCap !== t3) {
          t5 = this._context;
          this._contextLineCap = t3;
          J.set$lineCap$x(t5, t3);
        }
        if (this._contextLineJoin !== t4) {
          t3 = this._context;
          this._contextLineJoin = t4;
          J.set$lineJoin$x(t3, t4);
        }
        ...
        if (this._contextStrokeStyle !== t1) {
          t3 = this._context;
          this._contextStrokeStyle = t1;
          J.set$strokeStyle$x(t3, t1);
        }
        J.stroke$0$x(this._context);
        t1 = this._bboxRect;
        t2 *= 2;
        t1._left = t1._left - t2;
        t1._top = t1._top - t2;
        t3 = t1._right;
        if (typeof t3 !== "number")
          throw t3.$add();
      ...
      if (this._enableLighting) {
        ...
        if (t2) {
          ...
          t3 = this._color2;
          t1 = this._color3;
          t2 = this._ambientLight._b;
          t1._b = t2;
          t3._b = t2;
          t4._b = t2;
          t2 = element.vertexNormalsWorld;
          this.calculateLight$4(this._lights, element.get$v1().get$positionWorld(), t2[0], this._color1);
          this.calculateLight$4(this._lights, element.get$v2().get$positionWorld(), t2[1], this._color2);
          this.calculateLight$4(this._lights, element.get$v3().get$positionWorld(), t2[2], this._color3);
          t2 = this._color1;
          t2._r = P.max(0, P.min(material.color._r * t2._r, 1));
          t2 = this._color1;
          t2._g = P.max(0, P.min(material.color._g * t2._g, 1));
          t2 = this._color1;
          t2._b = P.max(0, P.min(material.color._b * t2._b, 1));
          t2 = this._color2;
          t2._r = P.max(0, P.min(material.color._r * t2._r, 1));
          t2 = this._color2;
          t2._g = P.max(0, P.min(material.color._g * t2._g, 1));
          ...
          t2 = this._color3;
          t2._b = P.max(0, P.min(material.color._b * t2._b, 1));
          this._color4._r = (this._color2._r + this._color3._r) * 0.5;
          this._color4._g = (this._color2._g + this._color3._g) * 0.5;
          this._color4._b = (this._color2._b + this._color3._b) * 0.5;
          ...
          this._color._r = t3._r;
          this._color._g = this._ambientLight._g;
          this._color._b = this._ambientLight._b;
          ...
          t2 = this._color;
          if (t1) {
            t1 = material.wireframeLinewidth;
            t3 = material.wireframeLinecap;
            t4 = material.wireframeLinejoin;
            if (this._contextLineWidth !== t1) {
              t5 = this._context;
              this._contextLineWidth = t1;
              J.set$lineWidth$x(t5, t1);
            }
            if (this._contextLineCap !== t3) {
              t5 = this._context;
              this._contextLineCap = t3;
            ...
            t1 = "rgb(" + C.JSNumber_methods.toInt$0(Math.floor(t2._r * 255)) + "," + C.JSNumber_methods.toInt$0(Math.floor(t2._g * 255)) + "," + C.JSNumber_methods.toInt$0(Math.floor(t2._b * 255)) + ")";
            if (this._contextFillStyle !== t1) {
              this._contextFillStyle = t1;
              J.set$fillStyle$x(this._context, this._contextFillStyle);
            }
  ...
  renderFace4$9: function(v1, v2, v3, v4, v5, v6, element, material, scene) {
    ...
    this.setBlending$1(material.blending);
    if (!!material.$isITextureMapMaterial) {
    ...
    if (!!material.$isMeshBasicMaterial) {
      ...
      J.lineTo$2$x(this._context, t3, t4);
      J.lineTo$2$x(this._context, t5, t6);
      J.lineTo$2$x(this._context, t7, t8);
      J.lineTo$2$x(this._context, t1, t2);
      J.closePath$0$x(this._context);
      t1 = material.color;
      if (material.wireframe) {
      ...
      if (this._enableLighting) {
        ...
        if (t2) {
          ...
          this.calculateLight$4(t4, t5[0].get$positionWorld(), t3[0], this._color1);
          t5 = this._lights;
          t4 = element.vertices;
          if (1 >= t4.length)
            throw H.ioore(t4, 1);
          this.calculateLight$4(t5, t4[1].get$positionWorld(), t3[1], this._color2);
          t4 = this._lights;
          t5 = element.vertices;
          if (3 >= t5.length)
            throw H.ioore(t5, 3);
          this.calculateLight$4(t4, t5[3].get$positionWorld(), t3[3], this._color3);
          t5 = this._lights;
          t4 = element.vertices;
          if (2 >= t4.length)
            throw H.ioore(t4, 2);
          this.calculateLight$4(t5, t4[2].get$positionWorld(), t3[2], this._color4);
          t3 = this._color1;
          t3._r = P.max(0, P.min(material.color._r * t3._r, 1));
          t3 = this._color1;
          t3._g = P.max(0, P.min(material.color._g * t3._g, 1));
          t3 = this._color1;
          t3._b = P.max(0, P.min(material.color._b * t3._b, 1));
          t3 = this._color2;
          t3._r = P.max(0, P.min(material.color._r * t3._r, 1));
          t3 = this._color2;
          t3._g = P.max(0, P.min(material.color._g * t3._g, 1));
          ...
          t6 = this._v4y;
          J.beginPath$0$x(this._context);
          J.moveTo$2$x(this._context, t3, t4);
          J.lineTo$2$x(this._context, t5, t1);
          J.lineTo$2$x(this._context, t2, t6);
          J.lineTo$2$x(this._context, t3, t4);
          J.closePath$0$x(this._context);
          ...
          t5 = this._v6y;
          J.beginPath$0$x(this._context);
          J.moveTo$2$x(this._context, t4, t3);
          J.lineTo$2$x(this._context, t6, t2);
          J.lineTo$2$x(this._context, t1, t5);
          J.lineTo$2$x(this._context, t4, t3);
          J.closePath$0$x(this._context);
          ...
          t9 = this._v4y;
          J.beginPath$0$x(this._context);
          J.moveTo$2$x(this._context, t2, t3);
          J.lineTo$2$x(this._context, t4, t5);
          J.lineTo$2$x(this._context, t6, t7);
          J.lineTo$2$x(this._context, t8, t9);
          J.lineTo$2$x(this._context, t2, t3);
          J.closePath$0$x(this._context);
          t2 = this._color;
          if (t1) {
            t1 = material.wireframeLinewidth;
  ...
  clipImage$13: function(x0, y0, x1, y1, x2, y2, u0, v0, u1, v1, u2, v2, image) {
    var t1, width, height, idet, a, b, c, d;
    t1 = J.getInterceptor$x(image);
    width = J.$sub$n(t1.get$width(image), 1);
    height = J.$sub$n(t1.get$height(image), 1);
    ...
    J.transform$6$x(this._context, a, b, c, d, x0 - a * u0 - c * v0, y0 - b * u0 - d * v0);
    J.clip$0$x(this._context);
    J.drawImage$3$x(this._context, image, 0, 0);
    J.restore$0$x(this._context);
  },
  getGradientTexture$4: function(color1, color2, color3, color4) {
    var c1r, c1g, c1b, c2r, c2g, c2b, c3r, c3g, c3b, c4r, c4g, c4b, t1, t2, t3;
    c1r = C.JSNumber_methods.toInt$0(Math.floor(color1._r * 255));
    c1g = C.JSNumber_methods.toInt$0(Math.floor(color1._g * 255));
    c1b = C.JSNumber_methods.toInt$0(Math.floor(color1._b * 255));
    c2r = C.JSNumber_methods.toInt$0(Math.floor(color2._r * 255));
    c2g = C.JSNumber_methods.toInt$0(Math.floor(color2._g * 255));
    c2b = C.JSNumber_methods.toInt$0(Math.floor(color2._b * 255));
    c3r = C.JSNumber_methods.toInt$0(Math.floor(color3._r * 255));
    c3g = C.JSNumber_methods.toInt$0(Math.floor(color3._g * 255));
    c3b = C.JSNumber_methods.toInt$0(Math.floor(color3._b * 255));
    c4r = C.JSNumber_methods.toInt$0(Math.floor(color4._r * 255));
    c4g = C.JSNumber_methods.toInt$0(Math.floor(color4._g * 255));
    c4b = C.JSNumber_methods.toInt$0(Math.floor(color4._b * 255));
    ...
    if (14 >= t3)
      throw H.ioore(t1, 14);
    t1[14] = t2;
    J.putImageData$3$x(this._pixelMapContext, this._pixelMapImage, 0, 0);
    J.drawImage$3$x(this._gradientMapContext, this._pixelMap, 0, 0);
...
RenderableFace: {"": "Object;material<,z>",
  RenderableFace$1: function(size) {
    this.vertices = P.List_List$generate(size, new S.RenderableFace_closure(), false, null);
  }
},

RenderableFace_closure: {"": "Closure;",
  call$1: function(_) {
    return S.RenderableVertex$();
  },
  $is_args1: true
},

RenderableFace4: {"": "RenderableFace;vertices,centroidWorld,centroidScreen,normalWorld,vertexNormalsWorld,uvs,material,faceMaterial,z",
  get$v1: function() {
...
Matrix4: {"": "Object;storage<",
  ...
  $sub: function(_, arg) {
    ...
    t3 = t2[0];
    t4 = arg.get$storage();
    t1[0] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 0));
    t4 = t2[1];
    t3 = arg.get$storage();
    t1[1] = C.JSNumber_methods.$sub(t4, t3.$index(t3, 1));
    t3 = t2[2];
    t4 = arg.get$storage();
    t1[2] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 2));
    t4 = t2[3];
    t3 = arg.get$storage();
    t1[3] = C.JSNumber_methods.$sub(t4, t3.$index(t3, 3));
    t3 = t2[4];
    t4 = arg.get$storage();
    t1[4] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 4));
    t4 = t2[5];
    t3 = arg.get$storage();
    t1[5] = C.JSNumber_methods.$sub(t4, t3.$index(t3, 5));
    t3 = t2[6];
    t4 = arg.get$storage();
    t1[6] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 6));
    t4 = t2[7];
    t3 = arg.get$storage();
    t1[7] = C.JSNumber_methods.$sub(t4, t3.$index(t3, 7));
    t3 = t2[8];
    t4 = arg.get$storage();
    t1[8] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 8));
    t4 = t2[9];
    t3 = arg.get$storage();
    t1[9] = C.JSNumber_methods.$sub(t4, t3.$index(t3, 9));
    t3 = t2[10];
    t4 = arg.get$storage();
    t1[10] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 10));
    t4 = t2[11];
    t3 = arg.get$storage();
    t1[11] = C.JSNumber_methods.$sub(t4, t3.$index(t3, 11));
    t3 = t2[12];
    t4 = arg.get$storage();
    t1[12] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 12));
    t4 = t2[13];
    t3 = arg.get$storage();
    t1[13] = C.JSNumber_methods.$sub(t4, t3.$index(t3, 13));
    t3 = t2[14];
    t4 = arg.get$storage();
    t1[14] = C.JSNumber_methods.$sub(t3, t4.$index(t4, 14));
    t2 = t2[15];
    t4 = arg.get$storage();
    t1[15] = C.JSNumber_methods.$sub(t2, t4.$index(t4, 15));
    return r;
  },
...
Quaternion: {"": "Object;storage<",
  ...
  $sub: function(_, other) {
    ...
    t3 = C.JSNumber_methods.$sub(t2, t3.$index(t3, 0));
    t2 = t1[1];
    t4 = other.get$storage();
    t4 = C.JSNumber_methods.$sub(t2, t4.$index(t4, 1));
    t2 = t1[2];
    t5 = other.get$storage();
    t5 = C.JSNumber_methods.$sub(t2, t5.$index(t5, 2));
    t1 = t1[3];
    t2 = other.get$storage();
    return T.Quaternion$(t3, t4, t5, C.JSNumber_methods.$sub(t1, t2.$index(t2, 3)));
  },
  $negate: function(_) {
    var t1 = this.storage;
...
init.globalFunctions.onWindowResize$closure = U.onWindowResize$closure = new U.Closure$1(U.onWindowResize, "onWindowResize$closure");
init.globalFunctions.animate$closure = U.animate$closure = new U.Closure$1(U.animate, "animate$closure");
...
init.globalFunctions._nullDataHandler$closure = P._nullDataHandler$closure = new U.Closure$1(P._nullDataHandler, "_nullDataHandler$closure");
...
init.globalFunctions._defaultHashCode$closure = P._defaultHashCode$closure = new U.Closure$1(P._defaultHashCode, "_defaultHashCode$closure");
...
init.globalFunctions.identityHashCode$closure = P.identityHashCode$closure = new U.Closure$1(P.identityHashCode, "identityHashCode$closure");
