...
_BroadcastStreamController: {"": "Object;_async$_next?,_async$_previous?",
  ...
  get$add: function(_receiver) {
    return new J.BoundClosure$i10(this, P._BroadcastStreamController.prototype.add$1, _receiver, "add$1");
  },
...
InputElement: {"": "HtmlElement;height%,name=,size=,type=,value%,valueAsNumber=,width%", $isElement: true, "%": "HTMLInputElement"},
...
_FrozenElementList: {"": "ListBase;_nodeList,_elementList",
  ...
  get$onChange: function(_) {
    var t1 = new W._ElementListEventStreamImpl(this, false, C.EventStreamProvider_change._eventType);
    H.setRuntimeTypeInfo(t1, [null]);
    return t1;
  },
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
    ...
    if (dirtyMorphTargets === true) {
      ...
      for (n1 = null, n2 = null, n3 = null, n4 = null, vk = 0, vka = null, nka = null, chf = null, faceVertexNormals = null; vk < vkl; ++vk) {
        ...
        for (f = 0, offset_morphTarget = 0; f < fl; ++f) {
          ...
          t2 = face.indices;
          v1 = J.$index$asx(morphTargets[vk].vertices, t2[0]);
          if (vk >= morphTargets.length)
            throw H.ioore(morphTargets, vk);
          v2 = J.$index$asx(morphTargets[vk].vertices, t2[1]);
          if (vk >= morphTargets.length)
            throw H.ioore(morphTargets, vk);
          v3 = J.$index$asx(morphTargets[vk].vertices, t2[2]);
        ...
        for (f = 0; f < fl; ++f) {
          ...
          if (vk >= morphTargets.length)
            throw H.ioore(morphTargets, vk);
          v4 = J.$index$asx(morphTargets[vk].vertices, t2[3]);
          if (vk >= morphTargetsArrays.length)
            throw H.ioore(morphTargetsArrays, vk);
          vka = morphTargetsArrays[vk];
          t2 = J.getInterceptor$x(v1);
  ...
  sortFacesByMaterial$2: function(geometry, material) {
    var hash_map, t1, numMorphTargets, fl, f, t2, groupHash, t3;
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    var object, t1, shaderID, maxLightCount, maxShadows, maxBones, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, attributes, i;
    object = webglobject.get$object();
...
init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, light, geometry, i, vertices, v;
  t1 = {};
  t1.idx_0 = 0;
  t2 = W._FrozenElementList$_wrap(document.querySelectorAll("input[type='range']"), null);
  t2.forEach$1(t2, new Y.init_closure(t1));
  ...
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  t16 = new S.PerspectiveCamera(45, t1 / t2, null, null, null, null, null, null, t3, t4, t5, 1, 15000, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  t16.updateProjectionMatrix$0();
  $.camera = t16;
  $.camera.position.storage[2] = 500;
  $.scene = S.Scene$();
  t16 = S.Color$(16720384);
  t15 = $.Object3DCount;
  $.Object3DCount = t15 + 1;
  ...
  t5 = new Float32Array(3);
  t5.$dartCachedLength = t5.length;
  light = new S.PointLight(null, 1, 0, t16, t15, "", t14, null, [], t13, t12, t11, t10, "XYZ", null, null, null, true, null, t9, t8, t7, true, true, t6, false, 0, 1, true, false, false, true, new T.Vector3(t5), null, null);
  t5 = new Float32Array(3);
  t5.$dartCachedLength = t5.length;
  light._three$_position = new T.Vector3(t5);
  light.position.setValues$3(100, 100, 100);
  t5 = $.scene;
  t5.add$1(t5, light);
  t5 = $.scene;
  t6 = S.Color$(1118481);
  ...
  t4 = new Float32Array(3);
  t4.$dartCachedLength = t4.length;
  t5.add$1(t5, new S.AmbientLight(t6, t7, "", t8, null, [], t9, t10, t11, t12, "XYZ", null, null, null, true, null, t13, t14, t15, true, true, t16, false, 0, 1, true, false, false, true, new T.Vector3(t4), null, null));
  geometry = S.CubeGeometry$(100, 100, 100, 1, 1, 1, null, null);
  t4 = S.Color$(16777215);
  ...
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  for (t3 = geometry.morphTargets, i = 0; i < J.get$length$asx(geometry.vertices); ++i) {
    vertices = [];
    for (v = 0; t5 = geometry.vertices, v < J.get$length$asx(t5); ++v) {
      if (v < 0 || v >= t5.length)
        throw H.ioore(t5, v);
      vertices.push(J.clone$0$x(t5[v]));
      if (v === i) {
        t5 = vertices.length;
        t6 = t5 - 1;
        if (t6 < 0)
    ...
    t3.push(new S.MorphTarget("target" + i, vertices));
  }
  $.mesh = S.Mesh$(geometry, new S.MeshLambertMaterial(null, t4, t16, t15, false, t1, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, true, false, 0, true, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t1 = $.scene;
  t1.add$1(t1, $.mesh);
  $.renderer = S.WebGLRenderer$(true, true, null, 1, 2236962, null, "highp", true, false, true);
  ...
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(Y.onDocumentMouseMove$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
},
...
init_closure: {"": "Closure;box_0",
  call$1: function(input) {
    ...
    n = t1.idx_0;
    t1.idx_0 = n + 1;
    J.get$onChange$x(input).listen$1(new Y.init__closure(input, n));
  },
  $is_args1: true
},

init__closure: {"": "Closure;input_1,n_2",
  call$1: function(_) {
    var t1, t2, t3;
    t1 = $.mesh.morphTargetInfluences;
    t2 = this.n_2;
    t3 = J.get$valueAsNumber$x(this.input_1);
    if (typeof t3 !== "number")
      throw t3.$div();
    t3 /= 100;
...
init.globalFunctions.onDocumentMouseMove$closure = Y.onDocumentMouseMove$closure = new H.Closure$1(Y.onDocumentMouseMove, "onDocumentMouseMove$closure");
...
//# sourceMappingURL=web_gl_morph_targets.dart.js.map
//@ sourceMappingURL=web_gl_morph_targets.dart.js.map
