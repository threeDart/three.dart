...
$$.Canvas_Lines = {"":
 ["container", "camera", "scene", "renderer", "material=", "geometry?", "mouseX", "mouseY", "windowHalfX", "windowHalfY"],
 "super": "Object",
 init$0: function() {
  ...
  this.material = $.ParticleCanvasMaterial$(16777215, new $.Canvas_Lines_init_anon(6.283185307179586), '', 0, 1, false, 1, 204, 205, 100, true, true, false, 0, 0, 0, false, true);
  this.geometry = $.Geometry$();
  var rnd = $.Random_Random(null);
  for (var particle = null, i = 0; i < 100; ++i) {
    particle = $.Particle$(this.material);
    var t1 = $.sub($.mul(rnd.nextDouble$0(), 2), 1);
    var t2 = particle.position;
    t2.set$x(t1);
    t2.set$y($.sub($.mul(rnd.nextDouble$0(), 2), 1));
    t2.set$z($.sub($.mul(rnd.nextDouble$0(), 2), 1));
    t2.normalize$0();
    ...
    $.add$1(this.geometry.get$vertices(), t2);
  }
  var line = $.Line$(this.geometry, $.LineBasicMaterial$(16777215, 1, 'round', 'round', 0, true, '', 0, 0.5, false, 1, 204, 205, 100, true, true, false, 0, 0, 0, false, true), 0);
...
$$.Object3D = {"":
 ["id?", "parent=", "children?", "position?", "rotation=", "scale?", "matrixWorld?", "matrixRotationWorld?", "visible=", "frustumCulled?"],
 "super": "Object",
...
$$.Material = {"":
 ["id?", "side?", "opacity?", "blending?", "overdraw?", "visible=", "needsUpdate="],
 "super": "Object",
 get$_data: function() {
  if (this.__data == null)
    this.__data = $.makeLiteralMap([]);
...
$.$defineNativeClass('HTMLAppletElement', ["height=", "object=", "width="], {
 is$Element: function() { return true; }
});
...
$.$defineNativeClass('DOMWindow', ["innerHeight?", "innerWidth?", "length?", "navigator?", "parent?"], {
 get$on: function() {
