...
$$.Canvas_Interactive_Cubes = {"":
 ...
 init$0: function() {
  ...
  var info = $.Element_Element$tag('div');
...
$$.Frustum = {"":
 ...
 contains$1: function(object) {
  ...
  var radius = $.mul($.neg(object.get$geometry().get$boundingSphere().get$radius()), matrix.getMaxScaleOnAxis$0());
...
$$.CubeGeometry = {"":
 ...
 CubeGeometry$8: function(width, height, depth, segmentsWidth, segmentsHeight, segmentsDepth, materialOrList, sides) {
  ...
  for (var t1 = $.iterator(sides), t2 = this._sides; t1.hasNext$0() === true;) {
    var t3 = t1.next$0();
    if (!(t2.operator$index$1(t3) == null)) {
      if (t3 !== (t3 | 0))
        throw $.iae(t3);
      if (t3 < 0 || t3 >= sides.length)
        throw $.ioore(t3);
      t2.operator$indexSet$2(t3, sides[t3]);
    }
  }
  t1 = this._sides;
  if (t1.px === true)
...
$$.CanvasRenderer = {"":
 ...
 render$2: function(scene, camera) {
  ...
  var el = $.get$length(this._lib1_elements);
  if (typeof el !== 'number')
 ...
 patternPath$13: function(x0, y0, x1, y1, x2, y2, u0, v0, u1, v1, u2, v2, texture) {
  ...
  if ($.eqB(det, 0)) {
    ...
    if (t2 < 0 || t2 >= t1.length)
      throw $.ioore(t2);
    if (t1[t2] == null) {
      var canvas = $.Element_Element$tag('canvas');
 ...
 call$1: function(o) {
  ...
  if (typeof t3 === 'object' && t3 !== null && !!t3.is$Mesh) {
    ...
    for (t1.f_4 = 0, t3 = t2._vertexPool, t4 = t2._viewProjectionMatrix; $.ltB(t1.f_4, t1.fl_5); t1.f_4 = $.add(t1.f_4, 1)) {
      ...
      t5 = t1._face_21.get$centroidScreen().get$z();
      t1._face_21.set$z(t5);
...
$.CTC37 = 'Cannot removeRange on immutable List.';
...
$.CTC41 = 'structured clone of File';
