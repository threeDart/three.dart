...
["", "canvas_interactive_cubes.dart", , N, {
main: function() {
  N.init();
  var t1 = window;
...
init: function() {
  var t1, info, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, geometry, i, particle, object;
  $.objects = [];
  ...
  t1.set$innerHtml(info, "<a href=\"http://github.com/robsilv/three.dart\" target=\"_blank\">three.dart</a> - clickable objects");
  ...
  for (i = 0; i < 10; ++i) {
    ...
    t12.storage[0] = (Math.random() * 800 >>> 0) - 400;
    t1 = particle.position;
    t1.storage[1] = (Math.random() * 800 >>> 0) - 400;
    t1 = particle.position;
    t1.storage[2] = (Math.random() * 800 >>> 0) - 400;
    t1 = particle.scale.storage;
    t1[1] = 8;
    t1[0] = 8;
    t1 = $.scene;
    t1.add$1(t1, particle);
    t1 = Math.random();
    t2 = new S.Color(1, 1, 1);
    t2.setHex$1(t1 * 16777215);
    t1 = $.MaterialCount;
    $.MaterialCount = t1 + 1;
    object = S.Mesh$(geometry, new S.MeshBasicMaterial(t2, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, 0, true, "", t1, 0, 0.5, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
    t1 = object.position;
    t1.storage[0] = (Math.random() * 800 >>> 0) - 400;
    t1 = object.position;
    t1.storage[1] = (Math.random() * 800 >>> 0) - 400;
    t1 = object.position;
    t1.storage[2] = (Math.random() * 800 >>> 0) - 400;
  ...
  $.particleMaterial = S.ParticleCanvasMaterial$(0, 205, 100, 204, 1, 0, true, true, "", 1, false, false, 0, 0, new N.init_closure(), 0, false, true);
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(N.onDocumentMouseDown$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
},

onDocumentMouseDown: function($event) {
  var t1, t2, t3, t4, t5, vector, intersects, intersect, material, t6, t7, t8, t9, t10, t11, t12, particle;
  ...
  if (typeof t2 !== "number")
    throw H.iae(t2);
  t3 = new P.Point($event.clientX, $event.clientY);
  ...
  t5 = new Float32Array(3);
  t5.$dartCachedLength = t5.length;
  vector = new T.Vector3(t5);
  vector.setValues$3(t1 / t2 * 2 - 1, -(t3 / t4) * 2 + 1, 0.5);
  $.projector.unprojectVector$2(vector, $.camera);
  t4 = $.camera.position;
  intersects = S.Ray$(t4, vector.sub$1(t4).normalize$0(), 0, 1 / 0).intersectObjects$1($.objects);
  if (intersects.length > 0) {
    intersect = intersects[0];
    material = intersect.get$object().get$material();
    material.get$color(material).setHex$1(Math.random() * 16777215);
    t1 = $.particleMaterial;
    t2 = $.Object3DCount;
    $.Object3DCount = t2 + 1;
    t3 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    ...
    t12 = particle.scale.storage;
    t12[1] = 8;
    t12[0] = 8;
    t12 = $.scene;
    t12.add$1(t12, particle);
  }
},
...
render: function() {
  ...
  t1 = $.camera.position;
  t2 = $.theta;
  t1.storage[0] = 600 * Math.sin(t2 * 3.141592653589793 / 360);
  t1 = $.camera.position;
  t2 = $.theta;
  t1.storage[1] = 600 * Math.sin(t2 * 3.141592653589793 / 360);
  t1 = $.camera.position;
  t2 = $.theta;
  t1.storage[2] = 600 * Math.cos(t2 * 3.141592653589793 / 360);
...
Object3D: {"": "Object;children>,visible<",
...
Projector: {"": "Object;_objectPool,_vertexPool,_face4Pool,_face3Pool,_linePool,_particlePool,_objectCount,_vertexCount,_face3Count,_face4Count,_lineCount,_particleCount,_object,_vertex,_line,_particle,_vector3,_vector4,_clippedVertex1PositionScreen,_clippedVertex2PositionScreen,_renderData,_viewProjectionMatrix,_modelViewProjectionMatrix,_frustum",
  unprojectVector$2: function(vector, camera) {
    var t1, t2;
    t1 = camera.projectionMatrixInverse;
    t1.copyInverse$1(camera.projectionMatrix);
    t2 = camera.matrixWorld;
    this._viewProjectionMatrix = t2.$mul(t2, t1);
...
Ray: {"": "Object;origin,direction,near,far,precision",
  ...
  intersectObject$2$recursive: function(object, recursive) {
    ...
    if (typeof object === "object" && object !== null && !!t2.$isParticle) {
      distance = this._distanceFromIntersection$3(this.origin, this.direction, object.matrixWorld.getTranslation$0());
      if (distance > object.scale.storage[0])
        return [];
      intersects.push(new S.Intersect(distance, object.position, null, object));
    } else if (typeof object === "object" && object !== null && !!t2.$isMesh) {
      distance = this._distanceFromIntersection$3(this.origin, this.direction, object.matrixWorld.getTranslation$0());
      t2 = S.Frustum___v1();
...
Ray_intersectObject_closure1: {"": "Closure;box_0,vertices_3",
  call$1: function(idx) {
    ...
    t2 = new T.Vector3(t2);
    t2.setFrom$1(t1);
    return t2.applyProjection$1(this.box_0.objMatrix_0);
  },
  $is_args1: true
},
...
Ray_intersectObjects_closure0: {"": "Closure;",
  call$2: function(a, b) {
    return C.JSDouble_methods.compareTo$1(a.get$distance(), b.get$distance());
  },
  $is_args2: true
},
...
init.globalFunctions.onDocumentMouseDown$closure = N.onDocumentMouseDown$closure = new N.Closure$1(N.onDocumentMouseDown, "onDocumentMouseDown$closure");
init.globalFunctions.animate$closure = N.animate$closure = new N.Closure$1(N.animate, "animate$closure");
