...
TrackballControls: {"": "EventEmitter;_TrackballControls0$_state,_prevState,object<,domElement,enabled,screen,rotateSpeed,zoomSpeed,panSpeed,noRotate,noZoom,noPan,noRoll,staticMoving,dynamicDampingFactor,minDistance,maxDistance,keys,target,_eye,_rotateStart,_rotateEnd,_zoomStart,_zoomEnd,_panStart,_panEnd,lastPosition,mouseMoveStream,mouseUpStream,keydownStream,changeEvent,listeners",
  handleResize$0: function() {
    ...
    if (t1 === document) {
      t1 = new P.Rectangle(0, 0, window.innerWidth, window.innerHeight);
      H.setRuntimeTypeInfo(t1, [null]);
      this.screen = t1;
    } else
      this.screen = J.getBoundingClientRect$0$x(t1);
  },
  ...
  getMouseProjectionOnBall$2: function(clientX, clientY) {
    ...
    if (this.noRoll)
      ...
      mouseOnBall.normalize$0(mouseOnBall);
    else
      mouseOnBall.storage[2] = Math.sqrt(1 - $length * $length);
    t1 = this.object;
    this._eye.setFrom$1(t1.position).sub$1(this.target);
    t1 = t1.up;
    t2 = new Float32Array(3);
    t2.$dartCachedLength = t2.length;
    t2 = new T.Vector3(t2);
    t2.setFrom$1(t1);
    t2 = t2.normalize$0(t2);
    t3 = mouseOnBall.storage;
    projection = t2.scale$1(t2, t3[1]);
    t1 = t1.cross$1(this._eye);
    t1 = t1.normalize$0(t1);
    projection.add$1(projection, t1.scale$1(t1, t3[0]));
    t1 = this._eye;
    t1 = t1.normalize$0(t1);
    projection.add$1(projection, t1.scale$1(t1, t3[2]));
    return projection;
  },
  rotateCamera$0: function() {
    ...
    if (!isNaN(angle) && angle !== 0) {
      t1 = this._rotateStart.cross$1(this._rotateEnd);
      axis = t1.normalize$0(t1);
  ...
  panCamera$0: function() {
    var t1, mouseChange, t2, t3, t4, pan;
    t1 = this._panEnd;
    ...
    if (mouseChange.get$length(mouseChange) !== 0) {
      ...
      t1 = t1.cross$1(t3);
      t1 = t1.normalize$0(t1);
      t4 = mouseChange.storage;
      pan = t1.scale$1(t1, t4[0]);
      t1 = new Float32Array(3);
      t1.$dartCachedLength = t1.length;
      t1 = new T.Vector3(t1);
      t1.setFrom$1(t3);
      t1 = t1.normalize$0(t1);
      pan = pan.$add(pan, t1.scale$1(t1, t4[1]));
      t2 = t2.position;
      t2.add$1(t2, pan);
      t2 = this.target;
      t2.add$1(t2, pan);
  ...
  checkDistances$0: function() {
    ...
    if (!this.noZoom || !this.noPan) {
      t1 = this.object;
      t2 = t1.position.get$length2();
      t3 = this.maxDistance;
      if (t2 > t3 * t3) {
        t2 = t1.position;
        t2 = t2.normalize$0(t2);
        t2.scale$1(t2, this.maxDistance);
      }
      t2 = this._eye.get$length2();
      t3 = this.minDistance;
      if (t2 < t3 * t3) {
        t2 = this.target;
        t3 = this._eye;
  ...
  update$0: function(_) {
    ...
    t1.lookAt$1(this.target);
    t2 = this.lastPosition;
    if (t2.$sub(t2, t1.position).get$length2() > 0) {
      this.dispatchEvent$1(this, this.changeEvent);
      this.lastPosition.setFrom$1(t1.position);
    }
  },
  ...
  mouseup$1: function($event) {
    ...
    $event.stopPropagation();
    this._TrackballControls0$_state = -1;
    t1 = this.mouseMoveStream;
    t1.cancel$0(t1);
    t1 = this.mouseUpStream;
    t1.cancel$0(t1);
  },
  ...
  TrackballControls$2: function(object, domElement) {
    ...
    domElement.toString;
    t1 = C.EventStreamProvider_contextmenu.forElement$1(domElement);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.TrackballControls_closure()), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_mousedown.forElement$1(domElement);
    t1 = this.get$mousedown();
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = C._CustomEventStreamProvider__determineMouseWheelEventType.forElement$1(domElement);
    t2 = this.get$mousewheel();
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t2), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_touchstart.forElement$1(domElement);
    t1 = this.get$touchstart();
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = C.EventStreamProvider_touchend.forElement$1(domElement);
    t2 = this.get$touchstart();
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(t2), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
    t2 = C.EventStreamProvider_touchmove.forElement$1(domElement);
    t1 = this.get$touchmove();
    t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1), t2._useCapture);
    H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t1._tryResume$0();
    t1 = C.EventStreamProvider_keydown.forTarget$1(window);
...
["", "shadows.dart", , U, {
init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, sundial, geometry, texture, material, mesh;
  $.renderer = S.WebGLRenderer$(true, true, null, 0, 0, null, "highp", true, false, true);
  t1 = $.renderer;
  t1.shadowMapEnabled = true;
  t1.shadowMapType = 2;
  t1.setClearColorHex$2(0, 1);
  ...
  t16 = new S.PerspectiveCamera(70, t1 / t2, null, null, null, null, null, null, t3, t4, t5, 1, 10000, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  t16.updateProjectionMatrix$0();
  $.camera = t16;
  $.camera.position.setValues$3(0, 2, 14);
  t16 = $.scene;
  t16.add$1(t16, $.camera);
  $.cameraControls = B.TrackballControls$($.camera, $.renderer.canvas);
  t16 = $.cameraControls;
  t15 = new Float32Array(3);
  t15.$dartCachedLength = t15.length;
  t15 = new T.Vector3(t15);
  t15.setValues$3(0, 2, 0);
  t16.target = t15;
  t15 = S.Color$(4473924);
  t16 = $.Object3DCount;
  $.Object3DCount = t16 + 1;
  ...
  t5.$dartCachedLength = t5.length;
  t4 = $.scene;
  t4.add$1(t4, new S.AmbientLight(t15, t16, "", t14, null, [], t13, t12, t11, t10, "XYZ", null, null, null, true, null, t9, t8, t7, true, true, t6, false, 0, 1, true, false, false, true, new T.Vector3(t5), null, null));
  $.dirLight = S.DirectionalLight$(4474060, 1, 0);
  t5 = $.dirLight.position.setValues$3(1, -1, 1);
  t5.normalize$0(t5);
  t5 = $.scene;
  t5.add$1(t5, $.dirLight);
  $.spot1 = S.SpotLight$(8947967, 2, 0, 1.5707963267948966, 10);
  $.spot1.target.position.setValues$3(0, 2, 0);
  t5 = $.spot1;
  t5.shadowCameraNear = 0.01;
  t5.castShadow = true;
  t5.shadowDarkness = 0.5;
  t6 = $.scene;
  t6.add$1(t6, t5);
  $.spot2 = S.SpotLight$(16755336, 2, 0, 1.5707963267948966, 10);
  $.spot2.target.position.setValues$3(0, 2, 0);
  t5 = $.spot2;
  t5.shadowCameraNear = 0.01;
  t5.castShadow = true;
  t5.shadowDarkness = 0.5;
  t5.shadowCameraVisible = true;
  t6 = $.scene;
  t6.add$1(t6, t5);
  sundial = S.Object3D$();
  sundial.position.storage[1] = -1;
  t5 = $.scene;
  t5.add$1(t5, sundial);
  geometry = S.TorusKnotGeometry$(25, 8, 75, 20, 2, 3, 1);
  texture = L.loadTexture("images/water.jpg", null, null, null);
  t5 = texture.repeat.storage;
  t5[0] = 0.7;
  t5[1] = 1;
  texture.wrapT = 0;
  texture.wrapS = 0;
  ...
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  material = new S.MeshPhongMaterial(t5, t6, t7, t8, 300, false, false, false, t1, texture, null, null, 1, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
  if (material.normalScale == null) {
    ...
    t2[0] = 1;
    t2[1] = 1;
    material.normalScale = t1;
  }
  mesh = S.Mesh$(geometry, material);
  t1 = mesh.scale;
  t1.scale$1(t1, 0.05555555555555555);
  mesh.castShadow = true;
  mesh.receiveShadow = false;
  mesh.position.storage[1] = 4;
  sundial.add$1(sundial, mesh);
  $.mainObj = mesh;
  geometry = S.CubeGeometry$(10, 0.5, 10, 1, 1, 1, null, null);
  texture = L.loadTexture("images/water.jpg", null, null, null);
  t1 = texture.repeat.storage;
  t1[0] = 0.5;
  t1[1] = 0.8;
  texture.wrapT = 0;
  texture.wrapS = 0;
  ...
  t6 = $.MaterialCount;
  $.MaterialCount = t6 + 1;
  material = new S.MeshPhongMaterial(t1, t2, t3, t4, 150, false, false, false, t5, texture, null, null, 1, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t6, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null);
  if (material.normalScale == null) {
    t1 = new Float32Array(2);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector2(t1);
...
render: function() {
  var piPerSeconds, t1, t2;
  piPerSeconds = P.DateTime$_now().millisecondsSinceEpoch / 1000 * 3.141592653589793;
  t1 = $.spot1.position;
  t2 = piPerSeconds * 0.05;
  t1.storage[0] = Math.cos(t2) * 12;
  t1 = $.spot1.position.storage;
  t1[1] = 10;
  t1[2] = Math.sin(t2) * 12;
  t1 = $.spot2.position;
  t2 = piPerSeconds * -0.1;
  t1.storage[0] = Math.cos(t2) * 15;
  t1 = $.spot2.position;
  t1.storage[1] = 8 + Math.sin(piPerSeconds * 0.5) * 4;
  t1 = $.spot2.position;
  t1.storage[2] = Math.sin(t2) * 15;
  t1 = $.mainObj.rotation.storage;
  t1[0] = t1[0] + 0.005;
  t1[1] = t1[1] + 0.03;
  t1[2] = t1[2] + 0.02;
  t1 = $.cameraControls;
  t1.update$0(t1);
  t1 = $.camera.position.storage;
  t1[1] = P.max(t1[1], 3);
    ...
    for (t1 = this._frustum, i = 0, j = null, jl = null, shadowMap = null, shadowMatrix = null, shadowCamera = null, buffer = null, material = null, webglObject = null, object = null, renderList = null; i < il; ++i) {
      ...
      if (light.shadowCamera == null) {
        if (!!light.$isSpotLight) {
          t2 = light.shadowCameraFov;
          t3 = light.shadowMapWidth;
          t4 = light.shadowMapHeight;
          t5 = light.shadowCameraNear;
          t6 = light.shadowCameraFar;
          t7 = new Float32Array(16);
          t7.$dartCachedLength = t7.length;
          t7 = new T.Matrix4(t7);
          t7.setIdentity$0();
          ...
          t10 = $.Object3DCount;
          $.Object3DCount = t10 + 1;
          t11 = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
          t12 = new Float32Array(3);
          t12.$dartCachedLength = t12.length;
          t12 = new T.Vector3(t12);
          t13 = t12.storage;
          ...
          t16[1] = 1;
          t16[2] = 1;
          t16 = new Float32Array(16);
          t16.$dartCachedLength = t16.length;
          t16 = new T.Matrix4(t16);
          t16.setIdentity$0();
          ...
          t18.setIdentity$0();
          t19 = new Float32Array(4);
          t19.$dartCachedLength = t19.length;
          t19 = new T.Quaternion(t19);
          t19.storage[3] = 1;
          t20 = new Float32Array(3);
          t20.$dartCachedLength = t20.length;
          t20 = new S.PerspectiveCamera(t2, t3 / t4, null, null, null, null, null, null, t7, t8, t9, t5, t6, t10, "", t11, null, [], t12, t13, t14, t15, "XYZ", null, null, null, true, null, t16, t17, t18, true, true, t19, false, 0, 1, true, false, false, true, new T.Vector3(t20), null, null);
          t20.updateProjectionMatrix$0();
          light.shadowCamera = t20;
      ...
      for (; j < jl; ++j) {
        ...
        if (object.get$visible(object) && object.get$castShadow())
          if (typeof object !== "object" || object === null || !object.$isMesh || !object.frustumCulled || t1.contains$1(t1, object)) {
...
SpotLight: {"": "ShadowCaster;target>,intensity<,distance<,angle,exponent,castShadow,onlyShadow,shadowCameraNear,shadowCameraFar,shadowCameraFov,shadowCameraVisible,shadowBias,shadowDarkness,shadowMapWidth,shadowMapHeight,shadowMap,shadowMapSize,shadowCamera,shadowMatrix,cameraHelper,color,id,name,properties,parent,children,up,position,rotation,scale,eulerOrder,_dynamic,doubleSided,flipSided,rotationAutoUpdate,renderDepth,matrix,matrixWorld,matrixRotationWorld,matrixAutoUpdate,matrixWorldNeedsUpdate,quaternion,useQuaternion,boundRadius,boundRadiusScale,visible,three$Object3D$castShadow,receiveShadow,frustumCulled,_vector,customDepthMaterial,__data",
  SpotLight$5: function(hex, intensity, distance, angle, exponent) {
    var t1 = new Float32Array(3);
    t1.$dartCachedLength = t1.length;
    t1 = new T.Vector3(t1);
    t1.setValues$3(0, 1, 0);
  ...
  $isSpotLight: true,
  static: {
SpotLight$: function(hex, intensity, distance, angle, exponent) {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12;
  t1 = S.Color$(hex);
  t2 = $.Object3DCount;
  $.Object3DCount = t2 + 1;
  ...
  t12 = new Float32Array(3);
  t12.$dartCachedLength = t12.length;
  t12 = new S.SpotLight(null, intensity, distance, angle, exponent, false, false, 50, 5000, 50, false, 0, 0.5, 512, 512, null, null, null, null, null, t1, t2, "", t3, null, [], t4, t5, t6, t7, "XYZ", null, null, null, true, null, t8, t9, t10, true, true, t11, false, 0, 1, true, false, false, true, new T.Vector3(t12), null, null);
  t12.SpotLight$5(hex, intensity, distance, angle, exponent);
  return t12;
}}
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  _render$4$forceClear$renderTarget: function(scene, c, forceClear, renderTarget) {
    ...
    for (; i < il; ++i) {
      ...
      if (object.get$visible(object))
        if (!(typeof object === "object" && object !== null && !!object.$isMesh || false) || !object.frustumCulled || t1.contains$1(t1, object)) {
          t4 = camera.get$matrixWorldInverse();
          webglObject._modelViewMatrix = t4.$mul(t4, webglObject.get$matrixWorld());
    ...
    for (; i < il; ++i) {
      ...
      if (object.get$visible(object)) {
        ...
        webglObject._modelViewMatrix = t2.$mul(t2, webglObject.get$matrixWorld());
        webglObject._normalMatrix = S.calcInverse(webglObject._modelViewMatrix);
        webglObject._normalMatrix.transpose$0();
  ...
  sortFacesByMaterial$2: function(geometry, material) {
    var hash_map, t1, fl, f, t2, groupHash, t3;
    ...
    for (f = 0; f < fl; ++f) {
      ...
      t2 = geometry.geometryGroups;
      t2 = t2.$index(t2, groupHash).get$vertices();
      if (typeof t2 !== "number")
        throw t2.$add();
      if (t2 + 4 > 65535) {
  ...
  updateObject$1: function(webglobject) {
    var object, geometry, t1, il, material, i, t2, geometryGroup, customAttributesDirty, t3;
    object = webglobject.get$object();
    geometry = webglobject.get$webglgeometry();
    t1 = J.getInterceptor(object);
    if (typeof object === "object" && object !== null && !!t1.$isMesh) {
  ...
  refreshUniformsCommon$2: function(uniforms, material) {
    var t1, t2, t3, t4, uvScaleMap, t5, offset, repeat, t6;
    t1 = material._material;
    ...
    if (t3)
      ;
    if ((!!t1.$isMeshBasicMaterial || t3 || false ? t1.get$map(t1) : null) != null)
      uvScaleMap = !!t1.$isMeshBasicMaterial || t3 || false ? t1.get$map(t1) : null;
    else {
      if (t4)
        t5 = t3;
      else
    ...
    if (uvScaleMap != null) {
      ...
      t5 = offset.storage;
      t6 = repeat.storage;
      J.get$value$x(uniforms.$index(uniforms, "offsetRepeat")).setValues$4(t5[0], t5[1], t6[0], t6[1]);
    }
  ...
  setupLights$2: function(program, lights) {
    var zlights, dirColors, dirPositions, pointColors, pointDistances, spotColors, spotPositions, spotDistances, spotDirections, spotAnglesCos, spotExponents, hemiSkyColors, hemiGroundColors, ll, t1, t2, t3, t4, t5, t6, t7, t8, t9, l, r, g, b, color, skyColor, groundColor, intensity, intensitySq, position, distance, dirLength, pointLength, spotLength, hemiLength, dirCount, pointCount, spotCount, hemiCount, dirOffset, pointOffset, spotOffset, hemiOffset, light, t10, t11, t12, spotLength0, l0;
    ...
    spotPositions = J.$index$asx(zlights.$index(zlights, "spot"), "positions");
    spotDistances = J.$index$asx(zlights.$index(zlights, "spot"), "distances");
    spotDirections = J.$index$asx(zlights.$index(zlights, "spot"), "directions");
    spotAnglesCos = J.$index$asx(zlights.$index(zlights, "spot"), "anglesCos");
    spotExponents = J.$index$asx(zlights.$index(zlights, "spot"), "exponents");
    ...
    for (t1 = J.getInterceptor$asx(spotAnglesCos), t2 = J.getInterceptor$asx(spotExponents), t3 = this.gammaInput, t4 = J.getInterceptor$asx(spotColors), t5 = J.getInterceptor$asx(spotPositions), t6 = J.getInterceptor$asx(spotDirections), t7 = J.getInterceptor$asx(spotDistances), t8 = J.getInterceptor$asx(dirColors), t9 = J.getInterceptor$asx(dirPositions), l = 0, r = 0, g = 0, b = 0, color = null, skyColor = null, groundColor = null, intensity = null, intensitySq = null, position = null, distance = null, dirLength = 0, pointLength = 0, spotLength = 0, hemiLength = 0, dirCount = 0, pointCount = 0, spotCount = 0, hemiCount = 0, dirOffset = 0, pointOffset = 0, spotOffset = 0, hemiOffset = 0; l < ll; ++l) {
      if (l >= lights.length)
        throw H.ioore(lights, l);
      light = lights[l];
      t10 = J.getInterceptor(light);
      t11 = typeof light === "object" && light !== null && !!t10.$isDirectionalLight;
      t12 = !t11;
      if ((t11 || typeof light === "object" && light !== null && !!t10.$isSpotLight) && light.get$onlyShadow() || t10.get$visible(light) !== true)
        continue;
      color = t10.get$color(light);
      if (t11 || typeof light === "object" && light !== null && !!t10.$isSpotLight || false) {
        intensity = light.get$intensity();
        distance = light.get$distance();
      }
      if (typeof light === "object" && light !== null && !!t10.$isAmbientLight) {
        if (!light.visible)
          continue;
        t10 = J.getInterceptor$x(color);
        if (t3) {
          r += t10.get$r(color) * t10.get$r(color);
        ...
        t10 = this._direction;
        t10.normalize$0(t10);
        t10 = this._direction.storage;
        if (t10[0] === 0 && t10[1] === 0 && t10[2] === 0)
          continue;
        dirOffset = dirLength * 3;
        t10 = dirOffset + 3;
        t8.set$length(dirColors, t10);
        t9.set$length(dirPositions, t10);
        t9.$indexSet(dirPositions, dirOffset, this._direction.storage[0]);
        t9.$indexSet(dirPositions, dirOffset + 1, this._direction.storage[1]);
        t9.$indexSet(dirPositions, dirOffset + 2, this._direction.storage[2]);
        if (t3) {
          if (typeof intensity !== "number")
            throw intensity.$mul();
        ...
        ++dirLength;
      } else if (typeof light === "object" && light !== null && !!t10.$isSpotLight) {
        ++spotCount;
        spotOffset = spotLength * 3;
        if (!light.visible)
          continue;
        t10 = spotOffset + 3;
        t4.set$length(spotColors, t10);
        t5.set$length(spotPositions, t10);
        t6.set$length(spotDirections, t10);
        spotLength0 = spotLength + 1;
        t7.set$length(spotDistances, spotLength0);
        if (t3) {
          if (typeof intensity !== "number")
            throw intensity.$mul();
          this.setColorGamma$4(spotColors, spotOffset, color, intensity * intensity);
        } else
          this.setColorLinear$4(spotColors, spotOffset, color, intensity);
        position = light.matrixWorld.getTranslation$0();
        t10 = position.storage;
        t5.$indexSet(spotPositions, spotOffset, t10[0]);
        t11 = spotOffset + 1;
        t5.$indexSet(spotPositions, t11, t10[1]);
        t12 = spotOffset + 2;
        t5.$indexSet(spotPositions, t12, t10[2]);
        t7.$indexSet(spotDistances, spotLength, distance);
        this._direction.setFrom$1(position);
        this._direction.sub$1(light.target.matrixWorld.getTranslation$0());
        t10 = this._direction;
        t10.normalize$0(t10);
        t6.$indexSet(spotDirections, spotOffset, this._direction.storage[0]);
        t6.$indexSet(spotDirections, t11, this._direction.storage[1]);
        t6.$indexSet(spotDirections, t12, this._direction.storage[2]);
        t1.set$length(spotAnglesCos, spotLength0);
        t2.set$length(spotExponents, spotLength0);
        t12 = light.angle;
        t1.$indexSet(spotAnglesCos, spotLength, Math.cos(t12));
        t2.$indexSet(spotExponents, spotLength, light.exponent);
        spotLength = spotLength0;
      }
    }
    ll = P.max(t8.get$length(dirColors), dirCount * 3);
    for (l = dirLength * 3; l < ll; ++l)
      t8.$indexSet(dirColors, l, 0);
    ...
    ll = P.max(t4.get$length(spotColors), spotCount * 3);
    for (l = spotLength * 3; l < ll; ++l)
      t4.$indexSet(spotColors, l, 0);
  ...
  buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround: function(shaderID, fragmentShader, vertexShader, uniforms, attributes, defines, alphaTest, boneTextureHeight, boneTextureWidth, bumpMap, doubleSided, envMap, flipSided, fog, fogExp, lightMap, map, maxBones, maxDirLights, maxHemiLights, maxMorphNormals, maxMorphTargets, maxPointLights, maxShadows, maxSpotLights, metal, morphNormals, morphTargets, normalMap, perPixel, shadowMapCascade, shadowMapDebug, shadowMapEnabled, shadowMapType, sizeAttenuation, skinning, specularMap, useFog, useVertexTexture, vertexColors, wrapAround) {
    ...
    t22 = morphTargets ? "#define USE_MORPHTARGETS" : "";
    t23 = morphNormals ? "#define USE_MORPHNORMALS" : "";
    ...
    glFragmentShader = this.getShader$2("fragment", C.JSArray_methods.join$1([t2, "", customDefines, "", t3, t5, t7, t9, t10, t11, t4, t6, t8, t12, "", t13, "", "", "", "", "", t14, t15, t16, t17, t18, t19, t20, t21, t22, shadowMapCascade ? "#define SHADOWMAP_CASCADE" : "", "uniform mat4 viewMatrix;", "uniform vec3 cameraPosition;", ""], "\n") + H.S(fragmentShader));
  ...
  allocateLights$1: function(lights) {
    ...
    for (t1 = lights.length, l = 0, dirLights = 0, pointLights = 0, spotLights = 0, hemiLights = 0; l < ll; ++l) {
      ...
      if ((t3 || typeof light === "object" && light !== null && !!t2.$isSpotLight) && light.get$onlyShadow())
        continue;
      if (t3)
        ++dirLights;
      if (typeof light === "object" && light !== null && !!t2.$isSpotLight)
        ++spotLights;
    }
...
//# sourceMappingURL=shadows.dart.js.map
//@ sourceMappingURL=shadows.dart.js.map
