...
FileWriter: {"": "EventTarget;error=,length=,position=",
...
InputElement: {"": "HtmlElement;height%,name=,size=,type=,value%,width%", "%": "HTMLInputElement"},
...
TextTrackCue: {"": "EventTarget;id%,position=,size=", "%": "TextTrackCue"},
...
main: function() {
  var t1, t2;
  t1 = document.body;
  new W._ChildrenElementList(t1, t1.children)._element.appendChild($.get$song());
  t1 = document.body;
  new W._ChildrenElementList(t1, t1.children)._element.appendChild($.get$song2());
  $.get$song().src = "nyanlooped.ogg";
  $.get$song2().src = "nyanslow.ogg";
  $.get$song().loop = true;
  $.get$song2().loop = true;
  $.get$song().play();
  t1 = new W._EventStream(document, C.EventStreamProvider_mousemove._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(D.onDocumentMouseMove$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = new W._EventStream(document, C.EventStreamProvider_mousedown._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(D.onDocumentMouseDown$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
  D.init();
  t1 = window;
  C.Window_methods._ensureRequestAnimationFrame$0(t1);
  C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(D.animate$closure));
  D.render(0);
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, c, yOffset, xOffset, state, star, pointLight;
  $.container = document.createElement("div", null);
  t1 = document.body;
  new W._ChildrenElementList(t1, t1.children)._element.appendChild($.container);
  ...
  t16 = new S.PerspectiveCamera(45, t1 / t2, null, null, null, null, null, null, t3, t4, t5, 0.1, 10000, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  t16.updateProjectionMatrix$0();
  $.camera = t16;
  t16 = $.camera.position.storage;
  t16[2] = 30;
  t16[0] = 0;
  t16[1] = 0;
  $.scene = S.Scene$();
  $.scene.fog = new S.FogExp2(S.Color$(13158), 0.0095);
  $.poptart = S.Object3D$();
  D.helper($.poptart, 0, -2, -1, 21, 14, 3, 2236962);
  D.helper($.poptart, 1, -1, -1, 19, 16, 3, 2236962);
  D.helper($.poptart, 2, 0, -1, 17, 18, 3, 2236962);
  D.helper($.poptart, 1, -2, -1.5, 19, 14, 4, 16764057);
  D.helper($.poptart, 2, -1, -1.5, 17, 16, 4, 16764057);
  D.helper($.poptart, 2, -4, 2, 17, 10, 0.6, 16751103);
  D.helper($.poptart, 3, -3, 2, 15, 12, 0.6, 16751103);
  D.helper($.poptart, 4, -2, 2, 13, 14, 0.6, 16751103);
  D.helper($.poptart, 4, -4, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 9, -3, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 12, -3, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 16, -5, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 8, -7, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 5, -9, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 9, -10, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 3, -11, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 7, -13, 2, 1, 1, 0.7, 16724889);
  D.helper($.poptart, 4, -14, 2, 1, 1, 0.7, 16724889);
  t16 = $.poptart;
  t15 = t16.position.storage;
  t15[0] = -10.5;
  t15[1] = 9;
  t15 = $.scene;
  t15.add$1(t15, t16);
  $.feet = S.Object3D$();
  D.helper($.feet, 0, -2, 0.49, 3, 3, 1, 2236962);
  D.helper($.feet, 1, -1, 0.49, 3, 3, 1, 2236962);
  D.helper($.feet, 1, -2, -0.01, 2, 2, 2, 10066329);
  D.helper($.feet, 2, -1, -0.01, 2, 2, 2, 10066329);
  D.helper($.feet, 6, -2, -0.5, 3, 3, 1, 2236962);
  D.helper($.feet, 6, -2, -0.5, 4, 2, 1, 2236962);
  D.helper($.feet, 7, -2, -0.99, 2, 2, 2, 10066329);
  D.helper($.feet, 16, -3, 0.49, 3, 2, 1, 2236962);
  D.helper($.feet, 15, -2, 0.49, 3, 2, 1, 2236962);
  D.helper($.feet, 15, -2, -0.01, 2, 1, 2, 10066329);
  D.helper($.feet, 16, -3, -0.01, 2, 1, 2, 10066329);
  D.helper($.feet, 21, -3, -0.5, 3, 2, 1, 2236962);
  D.helper($.feet, 20, -2, -0.5, 3, 2, 1, 2236962);
  D.helper($.feet, 20, -2, -0.99, 2, 1, 2, 10066329);
  D.helper($.feet, 21, -3, -0.99, 2, 1, 2, 10066329);
  t16 = $.feet;
  t15 = t16.position.storage;
  t15[0] = -12.5;
  t15[1] = -6;
  ...
  t15.add$1(t15, t16);
  $.tail = S.Object3D$();
  D.helper($.tail, 0, 0, -0.25, 4, 3, 1.5, 2236962);
  D.helper($.tail, 1, -1, -0.25, 4, 3, 1.5, 2236962);
  D.helper($.tail, 2, -2, -0.25, 4, 3, 1.5, 2236962);
  D.helper($.tail, 3, -3, -0.25, 4, 3, 1.5, 2236962);
  D.helper($.tail, 1, -1, -0.5, 2, 1, 2, 10066329);
  D.helper($.tail, 2, -2, -0.5, 2, 1, 2, 10066329);
  D.helper($.tail, 3, -3, -0.5, 2, 1, 2, 10066329);
  D.helper($.tail, 4, -4, -0.5, 2, 1, 2, 10066329);
  t16 = $.tail;
  t15 = t16.position.storage;
  t15[0] = -16.5;
  t15[1] = 2;
  ...
  t15.add$1(t15, t16);
  $.face = S.Object3D$();
  D.helper($.face, 2, -3, -3, 12, 9, 4, 2236962);
  D.helper($.face, 0, -5, 0, 16, 5, 1, 2236962);
  D.helper($.face, 1, -1, 0, 4, 10, 1, 2236962);
  D.helper($.face, 11, -1, 0, 4, 10, 1, 2236962);
  D.helper($.face, 3, -11, 0, 10, 2, 1, 2236962);
  D.helper($.face, 2, 0, 0, 2, 2, 1, 2236962);
  D.helper($.face, 4, -2, 0, 2, 2, 1, 2236962);
  D.helper($.face, 12, 0, 0, 2, 2, 1, 2236962);
  D.helper($.face, 10, -2, 0, 2, 2, 1, 2236962);
  D.helper($.face, 1, -5, 0.5, 14, 5, 1, 10066329);
  D.helper($.face, 3, -4, 0.5, 10, 8, 1, 10066329);
  D.helper($.face, 2, -1, 0.5, 2, 10, 1, 10066329);
  D.helper($.face, 12, -1, 0.5, 2, 10, 1, 10066329);
  D.helper($.face, 4, -2, 0.5, 1, 2, 1, 10066329);
  D.helper($.face, 5, -3, 0.5, 1, 1, 1, 10066329);
  D.helper($.face, 11, -2, 0.5, 1, 2, 1, 10066329);
  D.helper($.face, 10, -3, 0.5, 1, 1, 1, 10066329);
  D.helper($.face, 4, -6, 0.6, 2, 2, 1, 2236962);
  D.helper($.face, 11, -6, 0.6, 2, 2, 1, 2236962);
  D.helper($.face, 3.99, -5.99, 0.6, 1.01, 1.01, 1.01, 16777215);
  D.helper($.face, 10.99, -5.99, 0.6, 1.01, 1.01, 1.01, 16777215);
  D.helper($.face, 5, -10, 0.6, 7, 1, 1, 2236962);
  D.helper($.face, 5, -9, 0.6, 1, 2, 1, 2236962);
  D.helper($.face, 8, -9, 0.6, 1, 2, 1, 2236962);
  D.helper($.face, 11, -9, 0.6, 1, 2, 1, 2236962);
  D.helper($.face, 2, -8, 0.6, 2, 2, 0.91, 16751001);
  D.helper($.face, 13, -8, 0.6, 2, 2, 0.91, 16751001);
  t16 = $.face;
  t15 = t16.position.storage;
  t15[0] = -0.5;
  t15[1] = 4;
  ...
  t15.add$1(t15, t16);
  $.rainbow = S.Object3D$();
  for (c = 0; c < $.numRainChunks - 1; ++c) {
    yOffset = C.JSInt_methods.$mod(c, 2) === 1 ? 7 : 8;
    xOffset = -c * 8 - 16.5;
    D.helper($.rainbow, xOffset, yOffset, 0, 8, 3, 1, 16711680);
    D.helper($.rainbow, xOffset, yOffset - 3, 0, 8, 3, 1, 16750848);
    D.helper($.rainbow, xOffset, yOffset - 6, 0, 8, 3, 1, 16776960);
    D.helper($.rainbow, xOffset, yOffset - 9, 0, 8, 3, 1, 3407616);
    D.helper($.rainbow, xOffset, yOffset - 12, 0, 8, 3, 1, 39423);
    D.helper($.rainbow, xOffset, yOffset - 15, 0, 8, 3, 1, 6697983);
  }
  t1 = $.scene;
  t1.add$1(t1, $.rainbow);
  $.rainChunk = S.Object3D$();
  D.helper($.rainChunk, -16.5, 7, 0, 8, 3, 1, 16711680);
  D.helper($.rainChunk, -16.5, 4, 0, 8, 3, 1, 16750848);
  D.helper($.rainChunk, -16.5, 1, 0, 8, 3, 1, 16776960);
  D.helper($.rainChunk, -16.5, -2, 0, 8, 3, 1, 3407616);
  D.helper($.rainChunk, -16.5, -5, 0, 8, 3, 1, 39423);
  D.helper($.rainChunk, -16.5, -8, 0, 8, 3, 1, 6697983);
  t1 = $.rainChunk;
  t2 = t1.position.storage;
  t2[0] = t2[0] - 8 * ($.numRainChunks - 1);
  t2 = $.scene;
  t2.add$1(t2, t1);
  $.stars = P.List_List(null, null);
  for (state = 0; state < 6; ++state) {
    $.stars.push(P.List_List(null, null));
    for (c = 0; c < $.numStars; ++c) {
      star = S.Object3D$();
      t1 = star.position;
      $.get$rand().toString;
      t1.storage[0] = Math.random() * 200 - 100;
      t1 = star.position;
      $.get$rand().toString;
      t1.storage[1] = Math.random() * 200 - 100;
      t1 = star.position;
      $.get$rand().toString;
      t1.storage[2] = Math.random() * 200 - 100;
      D.buildStar(star, state);
      t1 = $.scene;
      t1.add$1(t1, star);
      t1 = $.stars;
      if (state >= t1.length)
        throw H.ioore(t1, state);
      t1[state].push(star);
    }
  }
  t1 = S.Color$(16777215);
  ...
  t12.$dartCachedLength = t12.length;
  pointLight = new S.PointLight(null, 1, 0, t1, t2, "", t3, null, [], t4, t5, t6, t7, "XYZ", null, null, null, true, null, t8, t9, t10, true, true, t11, false, 0, 1, true, false, false, true, new T.Vector3(t12), null, null);
  t12 = new Float32Array(3);
  t12.$dartCachedLength = t12.length;
  pointLight._three$_position = new T.Vector3(t12);
  pointLight.position.storage[2] = 1000;
  t12 = $.scene;
  t12.add$1(t12, pointLight);
  ...
  t12 = $.container;
  t12.toString;
  new W._ChildNodeListLazy(t12)._this.appendChild($.renderer.canvas);
},
...
render: function(t) {
  var t1, c, tempX, tempY, tempZ, state, t2, t3, star, star2;
  if ($.running) {
    t1 = $.deltaSum;
    if (typeof t !== "number")
      throw H.iae(t);
  ...
  t1 = $.deltaSum;
  if (t1 > 0.07) {
    $.deltaSum = C.JSNumber_methods.$mod(t1, 0.07);
    $.frame = C.JSInt_methods.$mod($.frame + 1, 12);
    for (c = 0; c < $.numStars; ++c) {
      t1 = $.stars;
      if (5 >= t1.length)
        throw H.ioore(t1, 5);
      ...
      if (c >= t1.length)
        throw H.ioore(t1, c);
      tempX = J.get$x$x(J.get$position$x(t1[c]));
      t1 = $.stars;
      if (5 >= t1.length)
        throw H.ioore(t1, 5);
      t1 = t1[5];
      if (c >= t1.length)
        throw H.ioore(t1, c);
      tempY = J.get$y$x(J.get$position$x(t1[c]));
      t1 = $.stars;
      if (5 >= t1.length)
        throw H.ioore(t1, 5);
      t1 = t1[5];
      if (c >= t1.length)
        throw H.ioore(t1, c);
      tempZ = J.get$z$x(J.get$position$x(t1[c]));
      for (state = 5; t1 = $.stars, state > 0;) {
        t2 = t1.length;
        if (state >= t2)
          throw H.ioore(t1, state);
        t3 = t1[state];
        ...
        if (c >= t1.length)
          throw H.ioore(t1, c);
        star2 = t1[c];
        t1 = J.getInterceptor$x(star);
        t2 = J.getInterceptor$x(star2);
        J.set$x$x(t1.get$position(star), J.get$x$x(t2.get$position(star2)) - 8);
        J.set$y$x(t1.get$position(star), J.get$y$x(t2.get$position(star2)));
        J.set$z$x(t1.get$position(star), J.get$z$x(t2.get$position(star2)));
        if (J.get$x$x(t1.get$position(star)) < -100) {
          t2 = t1.get$position(star);
          t3 = J.getInterceptor$x(t2);
          t3.set$x(t2, t3.get$x(t2) + 200);
          t2 = t1.get$position(star);
          $.get$rand().toString;
          J.set$y$x(t2, Math.random() * 200 - 100);
          t1 = t1.get$position(star);
          $.get$rand().toString;
          J.set$z$x(t1, Math.random() * 200 - 100);
        }
      }
      if (0 >= t1.length)
        throw H.ioore(t1, 0);
      ...
      if (c >= t1.length)
        throw H.ioore(t1, c);
      J.set$x$x(J.get$position$x(t1[c]), tempX);
      t1 = $.stars;
      if (0 >= t1.length)
        throw H.ioore(t1, 0);
      t1 = t1[0];
      if (c >= t1.length)
        throw H.ioore(t1, c);
      J.set$y$x(J.get$position$x(t1[c]), tempY);
      t1 = $.stars;
      if (0 >= t1.length)
        throw H.ioore(t1, 0);
      t1 = t1[0];
      if (c >= t1.length)
        throw H.ioore(t1, c);
      J.set$z$x(J.get$position$x(t1[c]), tempZ);
    }
    switch ($.frame) {
      case 0:
        t1 = $.face.position.storage;
        t1[0] = t1[0] + 1;
        t1 = $.feet.position.storage;
        t1[0] = t1[0] + 1;
        break;
      case 1:
        t1 = $.face.position.storage;
        ...
        t1[0] = t1[0] + 1;
        t1[1] = t1[1] - 1;
        t1 = $.poptart.position.storage;
        t1[1] = t1[1] - 1;
        t1 = $.rainbow.position.storage;
        t1[0] = t1[0] - 9;
        t1 = $.rainChunk.position.storage;
        t1[0] = t1[0] + (8 * ($.numRainChunks - 1) - 1);
        break;
      case 2:
        t1 = $.feet.position.storage;
        t1[0] = t1[0] - 1;
  ...
  t2 = t1.position.storage;
  t3 = t2[0];
  t2[0] = t3 + ($.mouseX - t3) * 0.005;
  t3 = t2[1];
  t2[1] = t3 + (-$.mouseY - t3) * 0.005;
  t1.lookAt$1($.scene.position);
  $.renderer._render$2($.scene, $.camera);
},

helper: function(o, x, y, z, w, h, d, c) {
  var t1, t2, t3, t4, t5, mesh;
  ...
  t5 = $.MaterialCount;
  $.MaterialCount = t5 + 1;
  mesh = S.Mesh$(S.CubeGeometry$(w, h, d, 1, 1, 1, null, null), new S.MeshLambertMaterial(null, t1, t2, t3, false, t4, null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, true, "", t5, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t5 = mesh.position.storage;
  t5[0] = x + w / 2;
  t5[1] = y - h / 2;
  t5[2] = z + d / 2;
  o.add$1(o, mesh);
...
buildStar: function(star, state) {
  switch (state) {
    case 0:
      D.helper(star, 0, 0, 0, 1, 1, 1, 16777215);
      break;
    case 1:
      D.helper(star, 1, 0, 0, 1, 1, 1, 16777215);
      D.helper(star, -1, 0, 0, 1, 1, 1, 16777215);
      D.helper(star, 0, 1, 0, 1, 1, 1, 16777215);
      D.helper(star, 0, -1, 0, 1, 1, 1, 16777215);
      break;
    case 2:
      D.helper(star, 1, 0, 0, 2, 1, 1, 16777215);
      D.helper(star, -2, 0, 0, 2, 1, 1, 16777215);
      D.helper(star, 0, 2, 0, 1, 2, 1, 16777215);
      D.helper(star, 0, -1, 0, 1, 2, 1, 16777215);
      break;
    case 3:
      D.helper(star, 0, 0, 0, 1, 1, 1, 16777215);
      D.helper(star, 2, 0, 0, 2, 1, 1, 16777215);
      D.helper(star, -3, 0, 0, 2, 1, 1, 16777215);
      D.helper(star, 0, 3, 0, 1, 2, 1, 16777215);
      D.helper(star, 0, -2, 0, 1, 2, 1, 16777215);
      break;
    case 4:
      D.helper(star, 0, 3, 0, 1, 1, 1, 16777215);
      D.helper(star, 2, 2, 0, 1, 1, 1, 16777215);
      D.helper(star, 3, 0, 0, 1, 1, 1, 16777215);
      D.helper(star, 2, -2, 0, 1, 1, 1, 16777215);
      D.helper(star, 0, -3, 0, 1, 1, 1, 16777215);
      D.helper(star, -2, -2, 0, 1, 1, 1, 16777215);
      D.helper(star, -3, 0, 0, 1, 1, 1, 16777215);
      ...
      break;
    case 5:
      D.helper(star, 2, 0, 0, 1, 1, 1, 16777215);
      D.helper(star, -2, 0, 0, 1, 1, 1, 16777215);
      D.helper(star, 0, 2, 0, 1, 1, 1, 16777215);
      D.helper(star, 0, -2, 0, 1, 1, 1, 16777215);
      break;
    default:
  }
...
onDocumentMouseMove: function($event) {
  ...
  $.mouseY = t1.$sub(t1, $.get$windowHalfY());
},
...
Face: {"": "Object;indices<,normal<,vertexColors<,color>,centroid<",
  get$size: function(_) {
    return 4;
  },
...
DirectionalLight: {"": "ShadowCaster;position>,target>,intensity<,distance<,shadowCascadeCount<",
...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
    ...
    if (dirtyNormals === true && normalType !== 0) {
      ...
      for (f = 0, i = null, vn = null, offset_normal = 0; f < fl; ++f) {
        ...
        if (vertexNormals.length === 3 && needsSmoothNormals)
          ...
          for (t1 = faceNormal.storage, t2 = C.JS_CONST_ZYJ(normalArray), i = 0; i < 3; ++i) {
            t3 = t1[0];
      ...
      for (f = 0; f < fl; ++f) {
        ...
        if (vertexNormals.length === 4 && needsSmoothNormals)
          ...
          for (t1 = faceNormal.storage, t2 = C.JS_CONST_ZYJ(normalArray), i = 0; i < 4; ++i) {
            t3 = t1[0];
            if (offset_normal < 0 || offset_normal >= t2)
              throw H.ioore(normalArray, offset_normal);
            normalArray[offset_normal] = t3;
  ...
  setupMorphTargets$3: function(material, geometryGroup, object) {
    ...
    for (t1 = material._material, t2 = !t1.$isMeshLambertMaterial, t3 = !!t1.$isShaderMaterial, influenceIndex = null, m = 0; m < material.numSupportedMorphTargets;) {
  ...
  initMaterial$4: function(material, lights, fog, webglobject) {
    var object, t1, shaderID, maxLightCount, maxShadows, maxBones, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, attributes, i;
    object = webglobject.get$object();
    ...
    t10 = !!t1.$isMeshBasicMaterial || !!t1.$isMeshLambertMaterial || false ? t1.get$envMap() : null;
    t11 = !!t1.$isMeshBasicMaterial || !!t1.$isMeshLambertMaterial || false ? t1.get$lightMap() : null;
    t12 = !!t1.$isMeshBasicMaterial || !!t1.$isMeshLambertMaterial || false ? t1.get$specularMap() : null;
    t13 = material.get$_hasVertexColors() ? t1.get$vertexColors() : 0;
    t14 = material.get$_hasFog() && t1.get$fog();
    t15 = J.getInterceptor(fog);
    if (t8)
      if (!t1.$isMeshLambertMaterial)
        t16 = t2;
      else
  ...
  refreshUniformsCommon$2: function(uniforms, material) {
    ...
    J.set$value$x(t3, !!t1.$isMeshBasicMaterial || !!t1.$isMeshLambertMaterial || false ? t1.get$lightMap() : null);
    t3 = uniforms.$index(uniforms, "specularMap");
    J.set$value$x(t3, !!t1.$isMeshBasicMaterial || !!t1.$isMeshLambertMaterial || false ? t1.get$specularMap() : null);
    if (t4)
      if (!t1.$isMeshLambertMaterial)
        t3 = false;
      else
    ...
    J.set$value$x(t3, !!t1.$isMeshBasicMaterial || !!t1.$isMeshLambertMaterial || false ? t1.get$envMap() : null);
  ...
  refreshUniformsFog$2: function(uniforms, fog) {
    ...
    J.set$value$x(uniforms.$index(uniforms, "fogDensity"), fog.density);
  },
  refreshUniformsLambert$2: function(uniforms, material) {
    ...
    if (this.gammaInput) {
      ...
      J.get$value$x(uniforms.$index(uniforms, "emissive")).copyGammaToLinear$1(t1.emissive);
    } else {
      J.set$value$x(uniforms.$index(uniforms, "ambient"), t1.get$ambient());
      J.set$value$x(uniforms.$index(uniforms, "emissive"), t1.emissive);
    }
    t1 = material._material;
    if ((!!t1.$isMeshLambertMaterial || false) && t1.get$wrapAround())
  ...
  buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround: function(shaderID, fragmentShader, vertexShader, uniforms, attributes, defines, alphaTest, boneTextureHeight, boneTextureWidth, bumpMap, doubleSided, envMap, flipSided, fog, fogExp, lightMap, map, maxBones, maxDirLights, maxHemiLights, maxMorphNormals, maxMorphTargets, maxPointLights, maxShadows, maxSpotLights, metal, morphNormals, morphTargets, normalMap, perPixel, shadowMapCascade, shadowMapDebug, shadowMapEnabled, shadowMapType, sizeAttenuation, skinning, specularMap, useFog, useVertexTexture, vertexColors, wrapAround) {
    ...
    if (useFog) {
      t13 = J.getInterceptor(fog);
      t13 = typeof fog === "object" && fog !== null && !!t13.$isFogExp2;
    } else
      t13 = false;
    t13 = t13 ? "#define FOG_EXP2" : "";
    if (!(t16 && vertexColors))
...
FogExp2: {"": "Object;color>,density", $isFogExp2: true},
...
init.globalFunctions.animate$closure = D.animate$closure = new H.Closure$1(D.animate, "animate$closure");
init.globalFunctions.onDocumentMouseMove$closure = D.onDocumentMouseMove$closure = new H.Closure$1(D.onDocumentMouseMove, "onDocumentMouseMove$closure");
init.globalFunctions.onDocumentMouseDown$closure = D.onDocumentMouseDown$closure = new H.Closure$1(D.onDocumentMouseDown, "onDocumentMouseDown$closure");
...
Isolate.$lazy($, "windowHalfX", "windowHalfX", "get$windowHalfX", function() {
  var t1 = window.innerWidth;
  if (typeof t1 !== "number")
    throw t1.$div();
  return t1 / 2;
});
Isolate.$lazy($, "windowHalfY", "windowHalfY", "get$windowHalfY", function() {
  var t1 = window.innerHeight;
  if (typeof t1 !== "number")
    throw t1.$div();
  return t1 / 2;
});
Isolate.$lazy($, "song", "song", "get$song", function() {
  return W.AudioElement_AudioElement(null);
});
Isolate.$lazy($, "song2", "song2", "get$song2", function() {
  return W.AudioElement_AudioElement(null);
});
...
//# sourceMappingURL=nyan_cat.dart.js.map
//@ sourceMappingURL=nyan_cat.dart.js.map
