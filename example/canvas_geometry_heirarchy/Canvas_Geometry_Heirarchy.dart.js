...
$$.Canvas_Geometry_Heirarchy = {"":
 ["container", "camera", "scene", "renderer", "geometry?", "group", "mouseX", "mouseY", "windowHalfX", "windowHalfY"],
 "super": "Object",
 run$0: function() {
 ...
 init$0: function() {
  ...
  for (var i = 0; i < 6; ++i)
    materials.push($.MeshBasicMaterial$(null, $.mul(rnd.nextDouble$0(), 16777215), null, null, null, 0, 1, 0.98, 2, 0, true, false, 1, 'round', 'round', false, false, '', 0, 1, false, 1, 204, 205, 100, true, true, false, 0, 0, 0, false, true));
  this.geometry = $.CubeGeometry$(100, 100, 100, 1, 1, 1, null, null);
  var material = $.MeshNormalMaterial$(1, false, 1, '', 0, 1, false, 1, 204, 205, 100, true, true, false, 0, 0, 0, false, true);
  this.group = $.Object3D$();
  for (i = 0; i < 200; ++i) {
    var mesh = $.Mesh$(this.geometry, material);
    var t1 = $.sub(rnd.nextInt$1(2000), 1000);
    var t2 = mesh.position;
    t2.set$x(t1);
    t2.set$y($.sub(rnd.nextInt$1(2000), 1000));
    t2.set$z($.sub(rnd.nextInt$1(2000), 1000));
...
$$.Matrix4 = {"":
 ...
 multiplyVector3$1: function(v) {
  ...
  var vy = v.get$y();
  var vz = v.get$z();
  var t1 = $.add($.add($.add($.mul($.index(te, 3), vx), $.mul($.index(te, 7), vy)), $.mul($.index(te, 11), vz)), $.index(te, 15));
  if (typeof t1 !== 'number')
    throw $.iae(t1);
  var d = 1 / t1;
  v.set$x($.mul($.add($.add($.add($.mul($.index(te, 0), vx), $.mul($.index(te, 4), vy)), $.mul($.index(te, 8), vz)), $.index(te, 12)), d));
  v.set$y($.mul($.add($.add($.add($.mul($.index(te, 1), vx), $.mul($.index(te, 5), vy)), $.mul($.index(te, 9), vz)), $.index(te, 13)), d));
  v.set$z($.mul($.add($.add($.add($.mul($.index(te, 2), vx), $.mul($.index(te, 6), vy)), $.mul($.index(te, 10), vz)), $.index(te, 14)), d));
  return v;
},
 ...
 getPosition$0: function() {
  return $.Matrix4___v1().setValues$3($.index(this.elements, 12), $.index(this.elements, 13), $.index(this.elements, 14));
},
...
$$.MeshNormalMaterial = {"":
 ["shading", "wireframe", "wireframeLinewidth", "wireframeLinecap", "wireframeLinejoin", "name", "id", "side", "opacity", "blending", "blendSrc", "blendDst", "blendEquation", "alphaTest", "polygonOffset", "polygonOffsetFactor", "polygonOffsetUnits", "transparent", "depthTest", "depthWrite", "overdraw", "visible", "needsUpdate", "__data"],
 "super": "Material",
...
$$.Canvas_Geometry_Heirarchy_render_anon = {"":
 ...
 call$1: function(rate) {
  return $.sin($.mul(this.t_0, rate)) * 0.5;
}
};
...
$.Canvas_Geometry_Heirarchy$ = function() {
  return new $.Canvas_Geometry_Heirarchy(null, null, null, null, null, null, 0, 0, null, null);
};
...
$.MeshNormalMaterial$ = function(shading, wireframe, wireframeLinewidth, name$, side, opacity, transparent, blending, blendSrc, blendDst, blendEquation, depthTest, depthWrite, polygonOffset, polygonOffsetFactor, polygonOffsetUnits, alphaTest, overdraw, visible) {
...
$.CTC21 = new Isolate.$isolateProperties.NotImplementedException('structured clone of ArrayBufferView');
$.CTC26 = '';
$.CTC9 = new Isolate.$isolateProperties.UnsupportedOperationException('');
$.CTC27 = 'structured clone of ArrayBuffer';
$.CTC20 = new Isolate.$isolateProperties.NotImplementedException('structured clone of ArrayBuffer');
$.CTC5 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC28 = 'Cannot sort immutable List.';
$.CTC11 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot sort immutable List.');
...
$.CTC8 = new Isolate.$isolateProperties.NotImplementedException('IDBKey containing Date');
$.CTC33 = 'Incorrect number or type of arguments';
$.CTC13 = new Isolate.$isolateProperties.ExceptionImplementation('Incorrect number or type of arguments');
...
$.CTC18 = new Isolate.$isolateProperties.NotImplementedException('structured clone of Blob');
...
$.CTC19 = new Isolate.$isolateProperties.NotImplementedException('structured clone of FileList');
$.CTC14 = new Isolate.$isolateProperties._Random();
$.CTC38 = 'structured clone of File';
$.CTC17 = new Isolate.$isolateProperties.NotImplementedException('structured clone of File');
$.CTC39 = 'structured clone of other type';
$.CTC22 = new Isolate.$isolateProperties.NotImplementedException('structured clone of other type');
$.CTC40 = null;
...
$.CTC16 = new Isolate.$isolateProperties.NotImplementedException(null);
$.Three_DoubleSide = 2;
...
//@ sourceMappingURL=Canvas_Geometry_Heirarchy.dart.js.map