...
WebGLRenderer: {"": "Object;canvas,_gl,precision,_clearColor,_clearAlpha,devicePixelRatio,alpha,premultipliedAlpha,antialias,stencil,preserveDrawingBuffer,autoClear,autoClearColor,autoClearDepth,autoClearStencil,sortObjects,autoUpdateObjects,autoUpdateScene,gammaInput,gammaOutput,physicallyBasedShading,shadowMapEnabled,shadowMapAutoUpdate,shadowMapDebug,shadowMapCascade,shadowMapType,shadowMapCullFrontFaces,maxMorphTargets,maxMorphNormals,autoScaleCubemaps,renderPluginsPre,renderPluginsPost,info,_programs,_programs_counter,_currentProgram,_currentFramebuffer,_currentMaterialId,_currentGeometryGroupHash,_currentCamera,_geometryGroupCounter,_usedTextureUnits,_enabledAttributes,_oldDoubleSided,_oldFlipSided,_oldBlending,_oldBlendEquation,_oldBlendSrc,_oldBlendDst,_oldDepthTest,_oldDepthWrite,_oldPolygonOffset,_oldPolygonOffsetFactor,_oldPolygonOffsetUnits,_oldLineWidth,_viewportX,_viewportY,_viewportWidth,_viewportHeight,_currentWidth,_currentHeight,_frustum,_projScreenMatrix,_projScreenMatrixPS,_vector3,_direction,_lights,_lightsNeedUpdate,_glExtensionTextureFloat,_glExtensionStandardDerivatives,_glExtensionTextureFilterAnisotropic,_glExtensionCompressedTextureS3TC,maxAnisotropy,supportsVertexTextures,supportsBoneTextures,shadowMapPlugin,maxTextures,maxVertexTextures,maxTextureSize,maxCubemapSize",
  ...
  setParticleBuffers$3: function(geometry, hint, object) {
    var vertices, t1, vl, colors, cl, vertexArray, colorArray, sortArray, dirtyVertices, dirtyColors, customAttributes, t2, t3, v, vertex, t4, offset, t5, c, color, il, index, i, ca, cal, value, customAttribute, t6;
    ...
    if (t2) {
      ...
      t3.multiply$1(t3, object.matrixWorld);
      for (v = 0; v < vl; ++v) {
      ...
      for (t1 = colors.length, t3 = C.JS_CONST_ZYJ(colorArray), c = 0; c < cl; ++c) {
        offset = c * 3;
        sortArray.length;
        if (c >= 0)
          ...
          if (t1) {
            ...
            if (t1.get$size(customAttribute) === 1) {
              ...
              for (; ca < cal; ++ca) {
                ...
                t4 = J.$index$asx(t1.get$value(customAttribute), ca);
                if (ca >= C.JS_CONST_ZYJ(t3))
                  throw H.ioore(t3, ca);
                t3[ca] = t4;
              }
              offset = 0;
              ...
              for (; ca < cal; ++ca) {
                ...
                t5 = t4.get$x(value);
                if (offset >= C.JS_CONST_ZYJ(t3))
                  throw H.ioore(t3, offset);
                t3[offset] = t5;
                t5 = customAttribute.get$array();
                t3 = offset + 1;
                t4 = t4.get$y(value);
                if (t3 >= C.JS_CONST_ZYJ(t5))
                  throw H.ioore(t5, t3);
                t5[t3] = t4;
                offset += 2;
              }
  ...
  renderBufferDirect$6: function(camera, lights, fog, material, webglgeometry, webglobject) {
    var program, attributes, wireframeBit, geometryHash, updateBuffers, object, geometry, t1, position, positionSize, color, colorSize, t2;
    ...
    t1 = J.getInterceptor(object);
    if (typeof object === "object" && object !== null && !!t1.$isParticleSystem)
      if (updateBuffers) {
        ...
        J.drawArrays$3$x(this._gl, 0, 0, C.JSInt_methods.$tdiv(position.get$numItems(), 3));
        t1 = this.info;
        t2 = t1.render;
        t2.set$calls(t2.get$calls() + 1);
        t1 = t1.render;
        t2 = J.getInterceptor$x(t1);
        t2.set$points(t1, t2.get$points(t1) + C.JSInt_methods.$tdiv(position.get$numItems(), 3));
      }
  },
  renderBuffer$6: function(camera, lights, fog, material, geometryGroup, object) {
    var t1, webglobject, webglcamera, t2, t3, program, attributes, wireframeBit, geometryGroupHash, updateBuffers, il, i, attribute, primitives, t4;
    ...
    t1 = J.getInterceptor(object);
    if (typeof object === "object" && object !== null && !!t1.$isLine) {
      ...
      if (typeof 1 !== "number")
        throw H.iae(1);
      t1.set$calls(t2 + 1);
    } else if (typeof object === "object" && object !== null && !!t1.$isParticleSystem) {
  ...
  setupMorphTargets$3: function(material, geometryGroup, object) {
    ...
    il = influences.get$length(influences);
    for (i = 0; C.JSInt_methods.$lt(i, il); ++i) {
      influence = influences.$index(influences, i);
      influence.$gt(influence, 0);
    }
    ...
    for (influenceIndex = null, m = 0; m < material.get$numSupportedMorphTargets();) {
      ...
      if (t2) {
        ...
        t2 = influences.$index(influences, influenceIndex);
        t2 = t2.toDouble$0(t2);
  ...
  _render$4$forceClear$renderTarget: function(scene, c, forceClear, renderTarget) {
    ...
    for (; i < il; ++i) {
      ...
      if (t5.get$visible(object) === true)
        if (!(typeof object === "object" && object !== null && !!t5.$isParticleSystem) || !object.get$frustumCulled() || t1.contains$1(t1, object)) {
  ...
  addObject$2: function(object, scene) {
    var t1, webglobject, geometry, t2, t3;
    t1 = J.getInterceptor$asx(object);
    if (t1.$index(object, "__webglObject") == null)
      t1.$indexSet(object, "__webglObject", new S.WebGLObject(false, false, null, null, null, null, null, null, object, null, null, true, 0, null));
    webglobject = t1.$index(object, "__webglObject");
    ...
    if (!webglobject.get$__webglActive()) {
      if (typeof object === "object" && object !== null && !!t1.$isLine || typeof object === "object" && object !== null && !!t1.$isParticleSystem)
  ...
  updateObject$1: function(webglobject) {
    var object, geometry, t1, material, customAttributesDirty;
    object = webglobject.get$object();
    geometry = webglobject.get$webglgeometry();
    t1 = J.getInterceptor(object);
    if (typeof object === "object" && object !== null && !!t1.$isLine) {
      ...
      t1 = J.getInterceptor(geometry);
      if (typeof geometry === "object" && geometry !== null && !!t1.$isBufferGeometry) {
        geometry.get$verticesNeedUpdate();
        geometry.get$colorsNeedUpdate();
        geometry.set$verticesNeedUpdate(false);
        geometry.set$colorsNeedUpdate(false);
      } else {
  ...
  removeObject$2: function(object, scene) {
    ...
    if (t1.$index(object, "__webglObject") == null)
      t1.$indexSet(object, "__webglObject", new S.WebGLObject(false, false, null, null, null, null, null, null, object, null, null, true, 0, null));
    webglobject = t1.$index(object, "__webglObject");
    if (typeof object === "object" && object !== null && !!t1.$isParticleSystem || typeof object === "object" && object !== null && !!t1.$isLine)
  ...
  refreshUniformsFog$2: function(uniforms, fog) {
    var t1 = J.getInterceptor$x(fog);
    J.set$value$x(uniforms.$index(uniforms, "fogColor"), t1.get$color(fog));
    if (typeof fog === "object" && fog !== null && !!t1.$isFogLinear) {
  ...
  cacheAttributeLocations$2: function(program, identifiers) {
    ...
    for (t1 = program.glProgram, i = 0; i < l; ++i) {
      ...
      t2.$indexSet(t2, id, J.getAttribLocation$2$x(this._gl, t1, id));
    }
  },
...
WebGLObject: {"": "Object;__webglInit@,__webglActive@,_modelViewMatrix@,_normalMatrix@,_normalMatrixArray,_modelViewMatrixArray,modelMatrixArray,buffer*,object<,opaque@,transparent@,render@,z*,__webglMorphTargetInfluences@",
  ...
  get$_hasGeometry: function() {
    ...
    t1 = this.object;
    t2 = J.getInterceptor(t1);
    t1 = typeof t1 === "object" && t1 !== null && !!t2.$isParticleSystem || typeof t1 === "object" && t1 !== null && !!t2.$isLine;
    return t1;
  },
...
WebGLMaterial: {"": "Object;_material,program@,_fragmentShader,_vertexShader,_uniforms,uniformsList@,numSupportedMorphTargets@,numSupportedMorphNormals@,shadowPass@",
  ...
  get$sizeAttenuation: function() {
    var t1 = this._material;
    return !!t1.$isParticleBasicMaterial && H.interceptedTypeCast(t1, "$isParticleBasicMaterial").sizeAttenuation;
  },
  get$size: function(_) {
    var t1 = this._material;
    return !!t1.$isParticleBasicMaterial ? H.interceptedTypeCast(t1, "$isParticleBasicMaterial").size : null;
  },
  ...
  get$isParticleBasicMaterial: function() {
    var t1 = this._material;
    return !!t1.$isParticleBasicMaterial;
  },
...
FogLinear: {"": "Object;color>,near<,far<", $isFogLinear: true},
...
["", "web_gl_buffer_geometry_particles.dart", , G, {
main: function() {
  G.init();
  var t1 = window;
  C.Window_methods._ensureRequestAnimationFrame$0(t1);
  C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(G.animate$closure));
  G.render();
},

init: function() {
  var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, positions, colors, geometry, color, i, x, y, z;
  ...
  t16 = new Float32Array(3);
  t16.$dartCachedLength = t16.length;
  t16 = new S.PerspectiveCamera(27, t1 / t2, null, null, null, null, null, null, t3, t4, t5, 5, 3500, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(t16), null, null);
  t16.updateProjectionMatrix$0();
  t15 = t16.position;
  t15.set$z(t15, 2750);
  $.camera = t16;
  t16 = S.Scene$();
  t16.fog = new S.FogLinear(S.Color$(328965), 2000, 3500);
  $.scene = t16;
  t16 = new Float32Array(1500000);
  t16.$dartCachedLength = t16.length;
  positions = new S.GeometryAttribute(1500000, 3, t16, null);
  t16 = new Float32Array(1500000);
  t16.$dartCachedLength = t16.length;
  colors = new S.GeometryAttribute(1500000, 3, t16, null);
  t16 = $.GeometryCount;
  $.GeometryCount = t16 + 1;
  geometry = new S.BufferGeometry(t16, H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)), [], false, null, null, null, [], [], null);
  geometry.attributes = H.fillLiteralMap(["position", positions, "color", colors], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
  color = S.Color$(null);
  for (i = 0; i < C.JS_CONST_ZYJ(positions.array); i += 3) {
    $.get$rnd().toString;
  ...
  t2 = $.MaterialCount;
  $.MaterialCount = t2 + 1;
  $.particleSystem = S.ParticleSystem$(geometry, new S.ParticleBasicMaterial(t1, null, 15, true, 2, true, "", t2, 0, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, null));
  t2 = $.scene;
  t2.add$1(t2, $.particleSystem);
  t2 = S.WebGLRenderer$(true, true, null, 0, 0, null, "highp", true, false, true);
  t2.setClearColor$2($.scene.fog.color, 1);
  t2.setSize$2(window.innerWidth, window.innerHeight);
  $.renderer = t2;
  t2 = J.get$children$x($.container);
  t2.add$1(t2, $.renderer.canvas);
  t2 = new W._EventStream(window, C.EventStreamProvider_resize._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(G.onWindowResize$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
},
...
render: function() {
  var t1 = $.particleSystem.rotation.storage;
  t1[0] = t1[0] + 0.0025;
  t1[1] = t1[1] + 0.005;
...
init.globalFunctions.onWindowResize$closure = G.onWindowResize$closure = new H.Closure$1(G.onWindowResize, "onWindowResize$closure");
init.globalFunctions.animate$closure = G.animate$closure = new H.Closure$1(G.animate, "animate$closure");
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "get$g,get$w,bind$1,call$0,call$1,call$2,call$3,call$4,call$5,call$6,call$9,copy$1,eval$1,get$_id,get$far,get$fog,_close$0,get$near,get$side,lookup$1,render$1,render$4,get$_name,get$_next,get$_zone,get$array,get$calls,get$image,get$metal,get$wrapS,get$wrapT,perform$1,process$0,set$array,set$calls,set$faces,_onValue$1,get$_error,get$_value,get$colors,get$envMap,get$faces3,get$faces4,get$hasUvs,get$lights,get$object,get$opaque,get$render,get$repeat,set$_value,set$opaque,set$render,visitMap$1,writeAll$2,_addError$2,_complete$1,_setError$2,_setValue$1,get$_camera,get$ambient,get$boundTo,get$bumpMap,get$combine,get$defines,get$faceUvs,get$length2,get$mipmaps,get$program,get$shading,get$storage,get$varData,get$wrapRGB,set$program,set$varData,visitList$1,catchError$1,get$_onError,get$_onPause,get$_onValue,get$blendDst,get$blendSrc,get$blending,get$distance,get$emissive,get$geometry,get$itemSize,get$lightMap,get$material,get$numItems,get$onUpdate,get$perPixel,get$skinning,get$specular,get$uniforms,get$vertices,set$uniforms,set$vertices,_addPending$1,get$_contents,get$_duration,get$_geometry,get$_hasError,get$_onCancel,get$_onListen,get$_onResume,get$_previous,get$alphaTest,get$depthTest,get$dimension,get$hasColors,get$intensity,get$linewidth,get$magFilter,get$minFilter,get$normalMap,get$shadowMap,get$shininess,get$wireframe,set$__uvArray,set$shadowMap,get$_errorTest,get$anisotropy,get$castShadow,get$depthWrite,get$hasNormals,get$memberName,get$onlyShadow,get$shadowBias,get$shadowPass,get$stackTrace,get$typedValue,get$wrapAround,set$__original,set$_isChained,set$shadowPass,get$__sortArray,get$__webglInit,get$_controller,get$_isComplete,get$matrixWorld,get$needsUpdate,get$renderDepth,get$skinWeights,get$specularMap,get$transparent,set$__faceArray,set$__lineArray,set$__sortArray,set$__webglInit,set$needsUpdate,set$transparent,visitSendPort$1,_completeError$2,cancelSchedule$0,get$__colorArray,get$boneMatrices,get$cameraHelper,get$hasPositions,get$lineDistance,get$morphNormals,get$morphTargets,get$needsNormals,get$reflectivity,get$shadowCamera,get$shadowMatrix,get$uniformsList,get$vertexColors,get$vertexShader,set$__colorArray,set$cameraHelper,set$shadowMatrix,set$uniformsList,set$vertexShader,visitPrimitive$1,get$__vertexArray,get$__webglActive,get$_async$_value,get$_nextListener,get$_normalMatrix,get$_three$_array,get$faceVertexUvs,get$frustumCulled,get$lineDistances,get$receiveShadow,get$shadowMapSize,get$webglgeometry,get$webglmaterial,set$__normalArray,set$__vertexArray,set$__webglActive,set$_nextListener,set$_normalMatrix,set$_three$_array,set$shadowMapSize,set$uvsNeedUpdate,_removeListeners$0,get$__objectsAdded,get$fragmentShader,get$inMilliseconds,get$isolateStatics,get$namedArguments,get$originalCamera,get$shadowDarkness,get$shadowMapWidth,set$__tangentArray,set$fragmentShader,set$originalCamera,copyGammaToLinear$1,get$__webglUVBuffer,get$generateMipmaps,get$morphTargetBase,get$numMorphNormals,get$numMorphTargets,get$refractionRatio,get$shadowMapHeight,get$sizeAttenuation,get$unpackAlignment,set$__inittedArrays,set$__webglUVBuffer,set$generateMipmaps,updateMatrixWorld$0,updateMatrixWorld$1,get$__objectsRemoved,get$__webglLineCount,get$__webglUV2Buffer,get$_modelViewMatrix,get$colorsNeedUpdate,get$isBufferGeometry,get$isShaderMaterial,get$overrideMaterial,get$premultiplyAlpha,get$projectionMatrix,get$useVertexTexture,set$__webglFaceCount,set$__webglLineCount,set$__webglUV2Buffer,set$_modelViewMatrix,set$colorsNeedUpdate,_whenCompleteAction$0,deserializeSendPort$1,set$__webglFaceBuffer,set$__webglLineBuffer,set$normalsNeedUpdate,get$__webglColorBuffer,get$__webglInitialized,get$belongsToAttribute,get$boneGlobalMatrices,get$elementsNeedUpdate,get$matrixWorldInverse,get$needsSmoothNormals,get$polygonOffsetUnits,get$shadowCascadeArray,get$shadowCascadeCount,get$verticesNeedUpdate,set$__webglColorBuffer,set$__webglInitialized,set$belongsToAttribute,set$elementsNeedUpdate,set$tangentsNeedUpdate,set$verticesNeedUpdate,get$__lineDistanceArray,get$__webglNormalBuffer,get$__webglVertexBuffer,get$_whenCompleteAction,get$customDepthMaterial,get$isLineBasicMaterial,get$isMeshBasicMaterial,get$isMeshDepthMaterial,get$isMeshPhongMaterial,get$polygonOffsetFactor,get$positionalArguments,get$shadowCameraVisible,get$shadowCascadeOffset,set$__lineDistanceArray,set$__webglNormalBuffer,set$__webglVertexBuffer,get$__morphNormalsArrays,get$__morphTargetsArrays,get$__webglParticleCount,get$__webglTangentBuffer,get$isMeshNormalMaterial,set$__morphNormalsArrays,set$__morphTargetsArrays,set$__webglParticleCount,set$__webglTangentBuffer,get$isMeshLambertMaterial,get$morphTargetInfluences,get$millisecondsSinceEpoch,get$morphTargetForcedOrder,set$morphTargetsNeedUpdate,get$immediateRenderCallback,get$isParticleBasicMaterial,get$lineDistancesNeedUpdate,get$projectionMatrixInverse,set$lineDistancesNeedUpdate,get$__webglSkinIndicesBuffer,get$__webglSkinWeightsBuffer,get$numSupportedMorphNormals,get$numSupportedMorphTargets,set$__webglSkinIndicesBuffer,set$__webglSkinWeightsBuffer,set$numSupportedMorphNormals,set$numSupportedMorphTargets,get$__webglLineDistanceBuffer,set$__webglLineDistanceBuffer,get$__webglMorphNormalsBuffers,get$__webglMorphTargetsBuffers,set$__webglMorphNormalsBuffers,set$__webglMorphTargetsBuffers,get$__webglCustomAttributesList,set$__webglCustomAttributesList,get$__webglMorphTargetInfluences,set$__webglMorphTargetInfluences".split(","), longNames = "g,w,bind,call,call,call,call,call,call,call,call,copy,eval,_id,far,fog,_close,near,side,lookup,render,render,_name,_next,_zone,array,calls,image,metal,wrapS,wrapT,perform,process,array=,calls=,faces=,_onValue,_error,_value,colors,envMap,faces3,faces4,hasUvs,lights,object,opaque,render,repeat,_value=,opaque=,render=,visitMap,writeAll,_addError,_complete,_setError,_setValue,_camera,ambient,boundTo,bumpMap,combine,defines,faceUvs,length2,mipmaps,program,shading,storage,varData,wrapRGB,program=,varData=,visitList,catchError,_onError,_onPause,_onValue,blendDst,blendSrc,blending,distance,emissive,geometry,itemSize,lightMap,material,numItems,onUpdate,perPixel,skinning,specular,uniforms,vertices,uniforms=,vertices=,_addPending,_contents,_duration,_geometry,_hasError,_onCancel,_onListen,_onResume,_previous,alphaTest,depthTest,dimension,hasColors,intensity,linewidth,magFilter,minFilter,normalMap,shadowMap,shininess,wireframe,__uvArray=,shadowMap=,_errorTest,anisotropy,castShadow,depthWrite,hasNormals,memberName,onlyShadow,shadowBias,shadowPass,stackTrace,typedValue,wrapAround,__original=,_isChained=,shadowPass=,__sortArray,__webglInit,_controller,_isComplete,matrixWorld,needsUpdate,renderDepth,skinWeights,specularMap,transparent,__faceArray=,__lineArray=,__sortArray=,__webglInit=,needsUpdate=,transparent=,visitSendPort,_completeError,cancelSchedule,__colorArray,boneMatrices,cameraHelper,hasPositions,lineDistance,morphNormals,morphTargets,needsNormals,reflectivity,shadowCamera,shadowMatrix,uniformsList,vertexColors,vertexShader,__colorArray=,cameraHelper=,shadowMatrix=,uniformsList=,vertexShader=,visitPrimitive,__vertexArray,__webglActive,_value,_nextListener,_normalMatrix,_array,faceVertexUvs,frustumCulled,lineDistances,receiveShadow,shadowMapSize,webglgeometry,webglmaterial,__normalArray=,__vertexArray=,__webglActive=,_nextListener=,_normalMatrix=,_array=,shadowMapSize=,uvsNeedUpdate=,_removeListeners,__objectsAdded,fragmentShader,inMilliseconds,isolateStatics,namedArguments,originalCamera,shadowDarkness,shadowMapWidth,__tangentArray=,fragmentShader=,originalCamera=,copyGammaToLinear,__webglUVBuffer,generateMipmaps,morphTargetBase,numMorphNormals,numMorphTargets,refractionRatio,shadowMapHeight,sizeAttenuation,unpackAlignment,__inittedArrays=,__webglUVBuffer=,generateMipmaps=,updateMatrixWorld,updateMatrixWorld,__objectsRemoved,__webglLineCount,__webglUV2Buffer,_modelViewMatrix,colorsNeedUpdate,isBufferGeometry,isShaderMaterial,overrideMaterial,premultiplyAlpha,projectionMatrix,useVertexTexture,__webglFaceCount=,__webglLineCount=,__webglUV2Buffer=,_modelViewMatrix=,colorsNeedUpdate=,_whenCompleteAction,deserializeSendPort,__webglFaceBuffer=,__webglLineBuffer=,normalsNeedUpdate=,__webglColorBuffer,__webglInitialized,belongsToAttribute,boneGlobalMatrices,elementsNeedUpdate,matrixWorldInverse,needsSmoothNormals,polygonOffsetUnits,shadowCascadeArray,shadowCascadeCount,verticesNeedUpdate,__webglColorBuffer=,__webglInitialized=,belongsToAttribute=,elementsNeedUpdate=,tangentsNeedUpdate=,verticesNeedUpdate=,__lineDistanceArray,__webglNormalBuffer,__webglVertexBuffer,_whenCompleteAction,customDepthMaterial,isLineBasicMaterial,isMeshBasicMaterial,isMeshDepthMaterial,isMeshPhongMaterial,polygonOffsetFactor,positionalArguments,shadowCameraVisible,shadowCascadeOffset,__lineDistanceArray=,__webglNormalBuffer=,__webglVertexBuffer=,__morphNormalsArrays,__morphTargetsArrays,__webglParticleCount,__webglTangentBuffer,isMeshNormalMaterial,__morphNormalsArrays=,__morphTargetsArrays=,__webglParticleCount=,__webglTangentBuffer=,isMeshLambertMaterial,morphTargetInfluences,millisecondsSinceEpoch,morphTargetForcedOrder,morphTargetsNeedUpdate=,immediateRenderCallback,isParticleBasicMaterial,lineDistancesNeedUpdate,projectionMatrixInverse,lineDistancesNeedUpdate=,__webglSkinIndicesBuffer,__webglSkinWeightsBuffer,numSupportedMorphNormals,numSupportedMorphTargets,__webglSkinIndicesBuffer=,__webglSkinWeightsBuffer=,numSupportedMorphNormals=,numSupportedMorphTargets=,__webglLineDistanceBuffer,__webglLineDistanceBuffer=,__webglMorphNormalsBuffers,__webglMorphTargetsBuffers,__webglMorphNormalsBuffers=,__webglMorphTargetsBuffers=,__webglCustomAttributesList,__webglCustomAttributesList=,__webglMorphTargetInfluences,__webglMorphTargetInfluences=".split(",");
...
//# sourceMappingURL=web_gl_buffer_geometry_particles.dart.js.map
//@ sourceMappingURL=web_gl_buffer_geometry_particles.dart.js.map
