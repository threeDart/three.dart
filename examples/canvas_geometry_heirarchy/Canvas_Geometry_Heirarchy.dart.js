...
$$.Object = {"":
 ...
 set$sortObjects: function (arg0) {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('set sortObjects', [arg0])
      : $.Object.prototype.noSuchMethod$2.call(this, 'set sortObjects', [arg0])
},
 set$z: function (arg0) {
  return this.noSuchMethod$2
...
$$.Canvas_Geometry_Heirarchy = {"":
 ["windowHalfY", "windowHalfX", "mouseY", "mouseX", "group", "geometry?", "renderer", "scene", "camera", "container"],
 super: "Object",
 render$0: function() {
  ...
  t1.set$y($.add(t1.get$y(), $.mul($.sub($.neg(this.mouseY), this.camera.get$position().get$y()), 0.05)));
  this.camera.lookAt$1(this.scene.get$position());
  var oscillate = new $.Canvas_Geometry_Heirarchy_render_anon($.DateImplementation$now().millisecondsSinceEpoch);
 ...
 init$0: function() {
  ...
  this.geometry = $.CubeGeometry$(100, 100, 100, null, null, null, null, null);
  var material = $.MeshNormalMaterial$(null);
  this.group = $.Object3D$();
  for (i = 0; i < 200; ++i) {
    var mesh = $.Mesh$(this.geometry, material);
    var t1 = $.sub($.mul($.Math_random(), 2000), 1000);
    var t2 = mesh.position;
    t2.set$x(t1);
    t2.set$y($.sub($.mul($.Math_random(), 2000), 1000));
    t2.set$z($.sub($.mul($.Math_random(), 2000), 1000));
    t2 = $.mul($.mul($.Math_random(), 360), 0.017453292519943295);
    mesh.rotation.set$x(t2);
    t2 = $.mul($.mul($.Math_random(), 360), 0.017453292519943295);
    mesh.rotation.set$y(t2);
    mesh.matrixAutoUpdate = false;
    mesh.updateMatrix$0();
    $.add$1(this.group, mesh);
  }
  $.add$1(this.scene, this.group);
  ...
  $.window().setInterval$2(new $.Canvas_Geometry_Heirarchy_init_f(this), 10);
 },
 run$0: function() {
...
$$.MeshNormalMaterial = {"":
 ["_wireframeLinejoin", "_wireframeLinecap", "_wireframeLinewidth", "_wireframe", "_shading", "_overdraw", "_polygonOffset", "_depthWrite", "_depthTest", "_transparent", "_polygonOffsetUnits", "_polygonOffsetFactor", "_alphaTest", "_blending", "_opacity", "_id", "_name"],
 super: "Material",
 get$wireframeLinejoin: function() {
  return this._wireframeLinejoin;
 },
 ...
 MeshNormalMaterial$1: function(parameters) {
  var _parameters = !(parameters == null) ? parameters : $.makeLiteralMap([]);
  this._shading = !(null == $.index(_parameters, 'shading')) ? $.index(_parameters, 'shading') : 1;
  this._wireframe = !(null == $.index(_parameters, 'wireframe')) && $.index(_parameters, 'wireframe');
  this._wireframeLinewidth = !(null == $.index(_parameters, 'wireframeLinewidth')) ? $.index(_parameters, 'wireframeLinewidth') : 1;
 },
 is$MeshNormalMaterial: true
};
...
$$.Canvas_Geometry_Heirarchy_render_anon = {"":
 ["t_0"],
 super: "Closure",
 $call$1: function(rate) {
  return $.mul($.Math_sin($.mul(this.t_0, rate)), 0.5);
 }
};
...
$$.Canvas_Geometry_Heirarchy_init_f = {"":
 ["this_0"],
 super: "Closure",
 $call$0: function() {
...
$.MeshNormalMaterial$ = function(parameters) {
  var t1 = new $.MeshNormalMaterial(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t1.Material$1(parameters);
  t1.MeshNormalMaterial$1(parameters);
  return t1;
};
...
$.main = function() {
  $.Canvas_Geometry_Heirarchy$().run$0();
};
...
$.Canvas_Geometry_Heirarchy$ = function() {
  return new $.Canvas_Geometry_Heirarchy(null, null, 0, 0, null, null, null, null, null, null);
};
