...
$$.Object = {"":
 ...
 get$onDocumentMouseOut: function () {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('get onDocumentMouseOut', [])
      : $.Object.prototype.noSuchMethod$2.call(this, 'get onDocumentMouseOut', [])
},
 ...
 get$onDocumentMouseUp: function () {
  return this.noSuchMethod$2
      ? this.noSuchMethod$2('get onDocumentMouseUp', [])
      : $.Object.prototype.noSuchMethod$2.call(this, 'get onDocumentMouseUp', [])
},
 get$color: function () {
  return this.noSuchMethod$2
...
$$.Canvas_Geometry_Cube = {"":
 ["windowHalfY", "windowHalfX", "mouseXOnMouseDown", "mouseX", "targetRotationOnMouseDown", "targetRotation", "plane", "cube", "renderer", "scene", "camera", "container"],
 super: "Object",
 render$0: function() {
  var t1 = this.cube.get$rotation();
  var t2 = $.add(t1.get$y(), $.mul($.sub(this.targetRotation, this.cube.get$rotation().get$y()), 0.05));
  t1.set$y(t2);
 ...
 onDocumentMouseOut$1: function(event$) {
  $.document().get$on().get$mouseMove().remove$1(this.get$onDocumentMouseMove());
  $.document().get$on().get$mouseUp().remove$1(this.get$onDocumentMouseUp());
  $.document().get$on().get$mouseOut().remove$1(this.get$onDocumentMouseOut());
 },
 get$onDocumentMouseOut: function() { return new $.BoundClosure0(this, 'onDocumentMouseOut$1'); },
 ...
 get$onDocumentMouseUp: function() { return new $.BoundClosure0(this, 'onDocumentMouseUp$1'); },
 ...
 onDocumentMouseDown$1: function(event$) {
  ...
  $.add$1($.document().get$on().get$mouseUp(), this.get$onDocumentMouseUp());
  $.add$1($.document().get$on().get$mouseOut(), this.get$onDocumentMouseOut());
 ...
 init$0: function() {
  ...
  $.add$1(this.scene, this.cube);
  this.plane = $.Mesh$($.PlaneGeometry$(200, 200, null, null), $.MeshBasicMaterial$($.makeLiteralMap(['color', 14737632, 'overdraw', true])));
  this.plane.get$rotation().set$x(-1.5707963267948966);
  $.add$1(this.scene, this.plane);
  ...
  $.add$1($.document().get$on().get$mouseDown(), this.get$onDocumentMouseDown());
  ...
  $.window().setInterval$2(new $.Canvas_Geometry_Cube_init_f(this), 10);
 },
 run$0: function() {
  this.init$0();
  this.animate$0();
...
$$.PlaneGeometry = {"":
 ...
 PlaneGeometry$4: function(width, height, segmentsWidth, segmentsHeight) {
  var width_half = $.div(width, 2);
  if (typeof width_half !== 'number') return this.PlaneGeometry$4$bailout(1, width, height, segmentsWidth, segmentsHeight, width_half, 0, 0, 0);
  var height_half = $.div(height, 2);
  if (typeof height_half !== 'number') return this.PlaneGeometry$4$bailout(2, width, height, segmentsWidth, segmentsHeight, width_half, height_half, 0, 0);
  var gridX = !(segmentsWidth == null) ? segmentsWidth : 1;
  if (typeof gridX !== 'number') return this.PlaneGeometry$4$bailout(3, width, height, segmentsHeight, gridX, width_half, height_half, 0, 0);
  var gridY = !(segmentsHeight == null) ? segmentsHeight : 1;
  if (typeof gridY !== 'number') return this.PlaneGeometry$4$bailout(4, gridY, height, width, gridX, width_half, height_half, 0, 0);
  var gridX1 = gridX + 1;
  var gridY1 = gridY + 1;
  var segment_width = $.div(width, gridX);
  if (typeof segment_width !== 'number') return this.PlaneGeometry$4$bailout(5, gridY, height, gridX1, gridY1, gridX, segment_width, width_half, height_half);
  var segment_height = $.div(height, gridY);
  if (typeof segment_height !== 'number') return this.PlaneGeometry$4$bailout(6, gridY, gridX1, gridY1, gridX, segment_width, segment_height, width_half, height_half);
  var normal = $.Vector3$(0, 0, 1);
  for (var iy = 0, ix = null; iy < gridY1; ++iy) {
    for (var t1 = -(iy * segment_height - height_half), ix = 0; ix < gridX1; ++ix) {
      var x = ix * segment_width - width_half;
      $.add$1(this.get$vertices(), $.Vertex$($.Vector3$(x, t1, 0)));
    }
  }
  for (iy = 0; iy < gridY; ++iy) {
    for (t1 = iy + 1, t2 = gridX1 * iy, t3 = gridX1 * t1, t4 = iy / gridY, t1 /= gridY, ix = 0; ix < gridX; ++ix) {
      ...
      var b = ix + t3;
      var t5 = ix + 1;
      var face = $.Face4$(a, b, t5 + t3, t5 + t2, null, null, null);
      face.get$normal().copy$1(normal);
      $.addAll(face.get$vertexNormals(), [normal.clone$0(), normal.clone$0(), normal.clone$0(), normal.clone$0()]);
      $.add$1(this.get$faces(), face);
      var faceVertexUV = $.index(this.get$faceVertexUvs(), 0);
    ...
    case 6:
      ...
      for (var iy = 0, ix = null; $.ltB(iy, gridY1); ++iy) {
        for (ix = 0; $.ltB(ix, gridX1); ++ix) {
          ...
          $.add$1(this.get$vertices(), $.Vertex$($.Vector3$(x, -y, 0)));
        }
      }
      for (iy = 0; $.ltB(iy, gridY); ++iy) {
        for (t1 = iy + 1, ix = 0; $.ltB(ix, gridX); ++ix) {
          var t2 = $.mul(gridX1, iy);
          if (typeof t2 !== 'number') throw $.iae(t2);
          var a = ix + t2;
          t2 = $.mul(gridX1, t1);
          if (typeof t2 !== 'number') throw $.iae(t2);
          ...
          t3 = $.mul(gridX1, iy);
          if (typeof t3 !== 'number') throw $.iae(t3);
          var face = $.Face4$(a, b, c, t2 + t3, null, null, null);
          face.get$normal().copy$1(normal);
          $.addAll(face.get$vertexNormals(), [normal.clone$0(), normal.clone$0(), normal.clone$0(), normal.clone$0()]);
          $.add$1(this.get$faces(), face);
          var faceVertexUV = $.index(this.get$faceVertexUvs(), 0);
          ...
          t4 = $.UV$(t4, t7);
          t2 /= gridX;
          $.addAll(newUVs, [t6, t4, $.UV$(t2, t7), $.UV$(t2, t5)]);
          $.add$1(faceVertexUV, newUVs);
        }
      }
      this.computeCentroids$0();
...
$.PlaneGeometry$ = function(width, height, segmentsWidth, segmentsHeight) {
  var t1 = new $.PlaneGeometry(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  t1.Geometry$0();
...
$.$defineNativeClass('MouseEvent', ["y?", "x?", "clientX?"], {
});
...
$.$defineNativeClass('Touch', ["pageX?", "clientX?"], {
});
